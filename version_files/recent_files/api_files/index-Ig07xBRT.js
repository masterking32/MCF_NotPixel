...
const qc = {
  ...
  Hn = O("shop/getProducts", async () => (await Y.getProducts()).data),
  ...
  }),
  {
    ...
    setLimitedGoods: Y4,
    clearLimitedGoods: W4,
    showLimitedGoodsPopup: Gc,
    hideLimitedGoodsPopup: K4
  } = $i.actions,
  Qa = t => t.shop.crypto,
  Xc = $i.reducer,
  zs = {
  ...
  _l = (t, n) => n < 5 ? zt[1] : n < 10 ? zt[5] : n < 100 ? zt[10] : n < 500 ? zt[100] : n < 1e3 ? zt[500] : zt[1e3],
  ri = {
    9: Wi,
    10: Ki,
    11: Zi
  ...
  io = (t, n) => na[t] ? na[t](t, n) : na.default(),
  xl = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  Nl = () => !1,
  oo = () => window.location.hostname.includes("dev"),
  Il = () => oo() ? Xn.VITE_ADSGRAM_BLOCK_ID : bl() ? "4853" : "4995",
  _t = {
    isDev: Nl(),
    devServer: oo(),
  ...
  co = t => t.device.contentSafeAreaInset,
  lo = t => t.device.safeAreaInset,
  kl = ro.reducer,
  Rl = () => {
    ...
    return e.jsx("div", {
      ...
      children: ["Star Shop"].map(a => e.jsxs("div", {
        className: `${sa.item} ${t===a?sa.active:""}`,
        onPointerUp: () => {
          n(a)
        },
  ...
  nn = async t => {
  ...
  }, uo = t => new Promise(n => setTimeout(n, t)), nd = t => {
  ...
  }, ja = t => !0, od = "_layout_13e1w_1", rd = "_container_13e1w_10", cd = "_star_13e1w_14", ld = "_move_13e1w_1", Un = {
    layout: od,
    container: rd,
    star: cd,
    move: ld
  ...
  }, () => !1), Ad = "_layout_1nbfl_1", pd = "_button_1nbfl_14", ui = {
    layout: Ad,
    button: pd
  }, hd = () => {
    const t = W();
  ...
  }, gd = "_layout_gx8in_1", _d = "_container_gx8in_5", fd = "_item_gx8in_11", xd = "_active_gx8in_20", yd = "_image_container_gx8in_24", vd = "_image_gx8in_24", wd = "_item_text_container_gx8in_34", jd = "_item_text_gx8in_34", ct = {
    layout: gd,
    container: _d,
    item: fd,
    active: xd,
    ...
    offset: t,
    limit: n
  })).data), Jn = O("user/getPixelsForSaleTotal", async () => (await Y.getUserPixelsCount()).data), Yn = O("user/getUserPixelsSold", async ({
    offset: t,
    limit: n
    ...
    setPixelsSoldOffset: Z4,
    setPixelsSoldTotal: $4,
  ...
  }, Bd = t => t.user.userPic, Ue = t => t.user.user, Ed = Ao.reducer, Et = {
    getPixelsForSale: Vn,
    ...
    return c(Ue), m.useEffect(() => {
      ...
      children: e.jsx("div", {
        ...
        children: n.map(i => {
          ...
          return e.jsxs("div", {
            className: R(ct.item, o ? ct.active : ""),
            onPointerUp: () => {
              t(vn(i.currency_id))
            },
            children: [e.jsx("div", {
  ...
  }, zd = "_text_layout_1xggq_1", Ld = "_text_1xggq_1", qd = "_button_layout_1xggq_14", Hd = "_button_layout_placeholder_1xggq_26", Gd = "_button_1xggq_14", ln = {
    text_layout: zd,
    text: Ld,
    button_layout: qd,
  ...
  }), $d = "_pixels_amount_ngjsa_1", eu = "_general_info_container_ngjsa_6", tu = "_coin_amount_text_ngjsa_12", nu = "_description_container_ngjsa_16", su = "_description_ngjsa_16", On = {
    pixels_amount: $d,
    ...
    logo_container: au
  }, ou = "_layout_1cvcu_1", ru = "_container_1cvcu_10", cu = "_bubble_1cvcu_16", lu = "_move_1cvcu_1", aa = {
    layout: ou,
    container: ru,
    bubble: cu,
    move: lu
  ...
  }, () => !1), uu = "_container_1aw3i_1", mu = "_logo_1aw3i_9", Au = "_animate_1aw3i_1", pu = "_center_1aw3i_18", hu = "_glow_1aw3i_28", Fn = {
    container: uu,
    logo: mu,
    animate: Au,
    center: pu,
  ...
  }), fu = "_container_13oyr_1", xu = "_button_13oyr_11", yu = "_info_13oyr_32", gt = {
    container: fu,
    button: xu,
    info: yu
  };
...
const Kn = O("mining/info", async () => (await Ls.info()).data),
  ...
  Ha = "data:image/png;base64,",
  Tm = () => {
    var o, r;
...
const _i = () => {
  ...
  aA = () => {
    ...
    const t = g(),
      ...
      a = v.adsgram,
      i = v.watchAd;
    c(P => P.mining.tasks[a]);
    const o = c(P => P.mining.tasks[i]),
      r = c(P => P.user.country),
      l = No(),
      [d, u] = m.useState(_i()),
      [h, _] = m.useState(gi),
      j = 16;
  ...
  pA = () => {
    ...
    return c(s => s.user.country), !AA && !n && !_t.isDev, null
  },
  ...
  vA = () => e.jsxs("div", {
    ...
    children: [e.jsx(aA, {}), e.jsx(yA, {}), e.jsx(pA, {}), e.jsx(uA, {}), e.jsx(dA, {}), e.jsx(jm, {}), e.jsx(ra, {
      text: "Quick start"
    }), e.jsx(Nm, {}), e.jsx(Pm, {}), e.jsx(Sm, {}), e.jsx(ra, {
      text: "Special"
    }), e.jsx(Um, {}), e.jsx(oA, {}), e.jsx(cA, {}), e.jsx(Zm, {}), e.jsx(qm, {}), e.jsx(zm, {}), e.jsx(xm, {}), e.jsx(Tm, {}), e.jsx(Bm, {}), e.jsx(Em, {}), e.jsx(Rm, {}), e.jsx(gA, {}), e.jsx(ra, {
      text: "Browser"
    }), e.jsx(ym, {}), e.jsx(vm, {}), e.jsx(Om, {}), e.jsx(Fm, {}), e.jsx(km, {}), e.jsx("div", {
      style: {
        height: 30
      }
    })]
  ...
  Ga = Cs.getSelectors(t => t.user.pixelsForSale);
...
const Po = _n.getSelectors(t => t.tournament.approvedTemplatesList),
  VA = () => {
    ...
    return c(Ga.selectTotal) === 0 && t === A.fulfilled ? e.jsx("div", {
...
let Jt = null;
const Na = O("canvas/getPixelInfo", async ({
    id: t
  }) => (Jt !== null && (Jt.abort(), Jt = null), Jt = new AbortController, (await Y.getPixelInfo({
    id: t,
    signal: Jt.signal
  })).data)),
  ns = O("canvas/getPrices", async () => (await Y.getPrices()).data),
  ...
  np = () => La() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  sp = {
    coords: null,
    animations: np(),
    stats: null,
  ...
  Bo = pe({
    ...
    extraReducers: t => {
      t.addCase(Na.pending, n => {
        n.getPixelInfoFetchStatus = A.pending
      }).addCase(Na.fulfilled, (n, s) => {
...
let Np = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [mp, Ap, pp, hp, gp, _p, fp, xp, yp, vp, wp, jp, bp], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
...
const Ip = "_order_panel_dvy5p_1",
  ...
  fi = window.Telegram.WebApp.CloudStorage;
let Do = class {
  static warn() {
...
const $p = (t, n) => {
    ...
    ja() && (s = {
    ...
    }), nt = new nc(Oa.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), nt.on("connected", function(a) {
      if (console.log(`connected over ${a.transport}`), !ja()) return;
      ...
      o.src = URL.createObjectURL(i), o.onload = () => {
        y.mainImage.loadFromCentrifuge(o).then(() => {
          ...
          }), y.mainImage.selectedPixel.draw(l), mt.dispatch(Dt(l)))
        })
      }
...
const eg = async ({
  ...
  try {
    (await t(zs.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === A.fulfilled && (t(Iu(a)), t(Qs({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: Tt
} = qo.actions, Ho = t => t.layout.isShowSideMenu, sg = qo.reducer;
let qt = null,
  Ht = null;
class Go {
...
wt.startListening({
  ...
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Id(t.payload.totalUserPixels)), n.dispatch(ho(t.payload.userBalance))), n.dispatch(Hc(t.payload.goods))
  }
});
wt.startListening({
...
const Xs = en();
Xs.startListening({
  matcher: fe(qs.getPriceMask.pending, Et.getPixelsForSale.pending, Et.getPixelsSold.pending, Ya.get.pending),
  effect: (t, n) => {
    n.dispatch(st({
      command: ke.start
    }))
...
Xs.startListening({
  matcher: fe(qs.getPriceMask.fulfilled, Et.getPixelsForSale.fulfilled, Et.getPixelsSold.fulfilled, Ya.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(st({
      command: ke.finish
    }))
...
Yo.startListening({
  ...
  effect: (t, n) => {
    n.dispatch(Vo(t.payload.data.league))
  }
});
const Bn = en();
Bn.startListening({
...
class Se {
  ...
  static async getTemplateById({
    ...
    return un !== null && (un.abort(), un = null), un = new AbortController, C.get(`/image/template/${n}`, {
      signal: un.signal
    })
  }
...
const ug = "/assets/halloween2-l9FmXxVI.png",
  ...
  Ca = O("template/getMyTemplate", async ({
    id: t
  ...
  Zo = pe({
    ...
    extraReducers: t => {
      ...
      }).addCase(ls.rejected, (n, s) => {}).addCase(Ca.pending, n => {}).addCase(Ca.fulfilled, (n, s) => {}).addCase(ds.pending, (n, s) => {}).addCase(ds.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: Ke.world
        };
  ...
  us = O("daily/getList", async () => (await Y.getDailyList()).data),
  ms = O("daily/getFirstDaily", async () => (await Y.getFirstDaily()).data),
  tr = pe({
    name: "daily",
    initialState: yg,
    reducers: {
...
const As = O("tournament/getPeriods", async () => (await ar.getPeriods()).data),
  ps = O("tournament/getResults", async () => (await ar.getResults()).data),
  ...
  En = en();
En.startListening({
  matcher: fe(Ce.getMyTemplate.fulfilled),
  effect: (t, n) => {
    const s = n.getState();
...
En.startListening({
  matcher: fe(Ce.getSelectedTemplate.fulfilled, lr),
  effect: (t, n) => {
    const s = n.getState();
...
const Dn = Jr({
    ...
    devTools: !1,
    middleware: t => [Bn.middleware, Yo.middleware, Xs.middleware, wt.middleware, Wo.middleware, En.middleware, ...t()]
  }),
  vs = [],
  Qg = async ({
    dispatch: t,
    ...
    await t(oh({
      ...
      id: at(s),
      color: St(a)
    }), y.mainImage.updateTexture(), await t(Jp(a)), await t(op(s)), await t(Cu());
    try {
      ...
      d && d.balance && (t(ho(d.balance)), d.reward_user && d.reward_user.reward_id && (y.mainImage.reward.add(s), t(Dg({
    ...
    n(Hs()), t && t.push("/energy-over"), n(Dt(s)), y.mainImage.selectedPixel.draw(s)
  }, mr = async ({
    history: t,
    charges: n,
    dispatch: s,
    ...
    const t = g(),
      ...
      P = c(f => f.shop.products[j[d]]);
    return e.jsxs("button", {
      className: oe.button,
      onPointerUp: f => {
        if (l) {
          f.stopPropagation(), t(Hs());
          return
        }
        mr({
          dispatch: t,
...
class b_ {
  ...
  async loadChunk({
    ...
    const s = T.chunkOrder[n],
      a = await this.loadImage(`${Oa}image/block?block_id=${s}`),
  ...
  pixanosRepaint(n, s, a, i) {
    ...
    for (let _ = 0; _ < u.length; _++) {
      ...
      if (_ < 20) {
        const P = Bs(j);
        console.log(`i: ${_}, id: ${j}, x: ${P.x}, y: ${P.y}`)
      }
      this.paintPixel({
        id: j,
        color: h
...
const P_ = () => localStorage.getItem("canvasFps") ? Number(localStorage.getItem("canvasFps")) : 60;
class C_ {
  constructor({
    app: n
  }) {
    this.app = n, this.lastTime = Date.now(), this.lastRenderTime = Date.now(), this.fps = P_(), this.callbacks = [], this.render()
  }
  render(n = 0) {
    const s = Date.now(),
      a = s - this.lastTime;
...
class T_ {
  constructor({
    ...
    }), this.app.ticker.stop(), this.ticker = new C_({
      app: this.app
    }), this.viewport = new I_({
      app: this.app,
      store: Ea
...
const E_ = m.memo(() => (m.useEffect(() => {
  ...
  R_ = () => c(Ga.selectAll).map(n => e.jsx(k_, {
    item: n
  }, at({
    x: n.x,
    y: n.y
  ...
  O_ = () => {
    const t = c(Ga.selectTotal);
    return c(s => s.user.pixelsForSaleFetchStatus) === A.pending && t === 0 ? e.jsx(U_, {}) : t !== 0 ? e.jsxs(YA, {
      children: [e.jsx(R_, {}), e.jsx(M_, {})]
    }) : null
  },
  F_ = () => {
    const t = g();
    return jA(), m.useEffect(() => () => {
      ...
      children: [e.jsx(VA, {}), e.jsx(O_, {})]
    })
  },
  Q_ = "_layout_v8prs_1",
  z_ = "_group_title_container_v8prs_7",
  L_ = "_group_title_v8prs_7",
  q_ = "_group_v8prs_7",
  ws = {
    layout: Q_,
  ...
  V_ = "_image_8sbvi_10",
  J_ = "_content_container_8sbvi_21",
  Y_ = "_content_8sbvi_21",
  W_ = "_item_title_container_8sbvi_33",
  K_ = "_item_reward_container_8sbvi_40",
  Z_ = "_price_text_8sbvi_45",
  $_ = "_dot_8sbvi_49",
  ef = "_level_text_8sbvi_53",
  tf = "_status_container_8sbvi_58",
  nf = "_status_8sbvi_58",
  Ee = {
    boost_item: G_,
    image_container: X_,
    image: V_,
    content_container: J_,
    content: Y_,
    item_title_container: W_,
    item_reward_container: K_,
    price_text: Z_,
    dot: $_,
    level_text: ef,
    status_container: tf,
  ...
  df = "_description_1_1e12r_19",
  uf = "_description_2_1e12r_27",
  mf = "_description_container_1e12r_35",
  Af = "_image_container_1e12r_47",
  pf = "_image_1e12r_47",
  hf = "_buttons_container_1e12r_59",
  gf = "_button_1e12r_59",
  _f = "_cancel_button_1e12r_71",
  ff = "_loading_1e12r_1",
  re = {
    container: cf,
    title_container: lf,
    description_1: df,
    description_2: uf,
    description_container: mf,
    image_container: Af,
    image: pf,
    buttons_container: hf,
    button: gf,
    cancel_button: _f,
    loading: ff
  },
  ...
  yf = () => {
    ...
    return l.ChargeBoost - (r == null ? void 0 : r.ChargeBoost), e.jsxs(si, {
      price: l.Price,
      boost: n,
      children: [e.jsxs("div", {
        className: re.title_container,
  ...
  wf = () => {
    ...
    return e.jsxs(Mt, {
      show: n,
      setShow: a,
      children: [s === Ae.paintReward && e.jsx(xf, {}), s === Ae.reChargeSpeed && e.jsx(yf, {}), s === Ae.energyLimit && e.jsx(vf, {})]
    })
  },
  jf = () => e.jsxs("div", {
    className: ws.layout,
    children: [e.jsxs(H_, {
      title: "Boosters",
      children: [e.jsx(af, {}), e.jsx(of, {}), e.jsx(rf, {})]
    }), e.jsx(wf, {}), e.jsx("div", {
      style: {
        height: "20px"
      }
  ...
  bf = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(wA, {}), t === "tasks" && e.jsx(vA, {}), t === "pixels" && e.jsx(F_, {}), t === "boosts" && e.jsx(jf, {})]
    })
  },
  Nf = () => {
    const t = g(),
    ...
    return e.jsxs(on, {
      children: [e.jsx(Re, {
        active: n === "tasks",
        setActive: () => t(ba("tasks")),
        children: "Tasks"
      }), e.jsx(Re, {
        active: n === "boosts",
        setActive: () => t(ba("boosts")),
        children: "Boosts"
      })]
    })
  },
  If = () => e.jsxs($.Fragment, {
    children: [e.jsx(Nf, {}), e.jsx(bf, {})]
  }),
  Pf = "_more_details_6gp7h_1",
  Cf = {
    more_details: Pf
  },
  rn = ({
    ...
    className: Cf.more_details,
    ...n,
    children: e.jsx("span", {
      children: t
    })
  }),
  Sf = "_container_11l5m_1",
  Tf = "_divider_11l5m_23",
  Bf = "_row_11l5m_28",
  Ef = "_row_title_11l5m_40",
  Df = "_row_title_main_11l5m_44",
  kf = "_row_hint_11l5m_49",
  Rf = "_row_value_11l5m_55",
  Mf = "_row_value_main_11l5m_59",
  Uf = "_mining_percent_11l5m_64",
  Of = "_active_row_11l5m_74",
  Ff = "_button_11l5m_85",
  ji = {
    container: Sf,
    divider: Tf,
  ...
  Jf = "_info_container_zthsq_42",
  Yf = "_base_item_zthsq_49",
  Wf = "_loading_item_zthsq_60",
  Kf = "_rating_item_zthsq_69",
  Zf = "_info_row_zthsq_82",
  $f = "_avatar_container_zthsq_87",
  ex = "_avatar_zthsq_87",
  tx = "_position_zthsq_99",
  nx = "_user_squad_position_zthsq_117",
  sx = "_rating_main_info_zthsq_135",
  ax = "_rating_name_zthsq_148",
  ix = "_rating_value_zthsq_155",
  ox = "_active_league_text_zthsq_163",
  rx = "_icon_leagueflag_zthsq_167",
  cx = "_join_squad_button_zthsq_174",
  lx = "_join_squad_text_zthsq_188",
  dx = "_user_squad_container_zthsq_206",
  ux = "_squad_avatar_container_zthsq_223",
  mx = "_user_squad_info_zthsq_234",
  Ax = "_user_squad_name_zthsq_242",
  px = "_user_squad_your_squad_text_zthsq_246",
  hx = "_user_squad_users_count_zthsq_251",
  Q = {
    ...
    join_squad_text: lx,
    user_squad_container: dx,
    squad_avatar_container: ux,
    user_squad_info: mx,
    user_squad_name: Ax,
    user_squad_your_squad_text: px,
    user_squad_users_count: hx
  },
  gx = ({
    isPlayers: t
  }) => {
  ...
  yx = ({
    ...
    children: ["Squads", "Painters"].map(s => e.jsx("div", {
      className: `${ha.item} ${t===s?ha.active:""}`,
      onPointerUp: () => {
        n(s)
      },
      children: e.jsx("h1", {
  ...
  Tx = () => {
    ...
    return c(s => s.ratings.status) !== A.fulfilled ? null : t.map((s, a) => e.jsx(Sx, {
      item: s,
      index: a
    }, a))
  },
  Bx = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(Px, {}), e.jsx(Cx, {}), e.jsx(Tx, {})]
    })
  },
  Ex = () => e.jsx($.Fragment, {
    children: Array.from(Array(10)).map((t, n) => e.jsx(Ys, {
      children: e.jsx("div", {
  ...
  Mx = () => (c(t => t.ratings.league), c(go), c(Qo), e.jsx("div", {
    className: kx.container,
    children: e.jsx(Rx, {})
  })),
  Ux = "_container_d5ybi_1",
  Ox = {
    container: Ux
  },
  Fx = () => {
  ...
  Qx = "/assets/icon_squad-_NF17RUb.gif",
  ...
  qx = () => {
    ...
    return e.jsxs(ce, {
      children: [e.jsx(Lx, {}), e.jsx(yx, {
        selectedSection: t,
        setSelectedSection: n
      }), e.jsx(Ix, {}), e.jsx(gx, {
        isPlayers: t === "Painters"
      }), e.jsxs(Nx, {
        children: [t === "Painters" && e.jsx(Mx, {}), t === "Squads" && e.jsx(Fx, {}), t === "Squads" && e.jsx(Bx, {}), t === "Painters" && e.jsx(jx, {}), s !== A.fulfilled && e.jsx(Ex, {})]
      })]
    })
  },
  Hx = ({
  ...
  Vx = "_expandable_panel_layout_1v9vd_1",
  Jx = "_expandable_panel_1v9vd_1",
  Yx = "_divider_1v9vd_16",
  Wx = "_divider_spacer_1v9vd_24",
  Kx = "_divider_pointer_1v9vd_28",
  xn = {
    expandable_panel_layout: Vx,
    expandable_panel: Jx,
    divider: Yx,
    divider_spacer: Wx,
    divider_pointer: Kx
  ...
  ey = "_container_1vu8i_1",
  ty = "_owner_1vu8i_10",
  ny = "_id_1vu8i_14",
  sy = "_date_1vu8i_19",
  ay = "_avatar_container_1vu8i_24",
  iy = "_avatar_1vu8i_24",
  oy = "_squad_avatar_container_1vu8i_36",
  ry = "_text_container_1vu8i_48",
  cy = "_dot_1vu8i_54",
  ly = "_user_name_1vu8i_59",
  dy = "_squad_name_1vu8i_64",
  le = {
    container: ey,
    owner: ty,
    id: ny,
    ...
    avatar_container: ay,
    avatar: iy,
    squad_avatar_container: oy,
    text_container: ry,
    dot: cy,
    user_name: ly,
    squad_name: dy
  },
  uy = "_skeleton_k7kmi_1",
  my = "_loading_k7kmi_1",
  Ay = {
    skeleton: uy,
    loading: my
  ...
  kn = ({
    ...
    return n > 0 && (i = Pn(i, n)), e.jsx("span", {
      className: mo.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? de(`https://t.me/${di(t)}`) : tn(`https://t.me/${di(t)}`)
      },
      children: i
    })
  },
  ...
  xy = () => e.jsxs("div", {
    ...
    children: [e.jsx(fy, {}), e.jsx(py, {}), e.jsx(_y, {}), e.jsx(hy, {}), e.jsx(gy, {})]
  }),
  yy = "_category_text_epppt_1",
  vy = "_latest_used_container_epppt_8",
  wy = "_color_line_epppt_15",
  jy = "_color_item_epppt_22",
  by = "_pipette_container_epppt_30",
  Ny = "_child_scale_epppt_48",
  xr = {
    category_text: yy,
    latest_used_container: vy,
    color_line: wy,
    color_item: jy,
    ...
    return e.jsx("div", {
      ...
      onPointerUp: () => {
        ...
        s(!0), a.current !== null && clearTimeout(a.current), a.current = setTimeout(() => {
          s(!1)
        }, 200), i(Xa(t)), (r = (o = window.Telegram.WebApp) == null ? void 0 : o.HapticFeedback) == null || r.notificationOccurred("success")
      }
    })
  },
  Py = ({
    ...
    children: t.map((n, s) => e.jsx(Iy, {
      color: n
    }, `${n}_${s}`))
  }),
  Cy = "_unlock_button_fc8qr_1",
  Sy = "_stars_text_fc8qr_13",
  bi = {
    unlock_button: Cy,
    stars_text: Sy
  },
  Ty = () => e.jsxs("div", {
    className: bi.unlock_button,
    children: [e.jsx("span", {
      children: "Unlock all colors for"
    }), e.jsxs("span", {
      className: bi.stars_text,
  ...
  Dy = ({
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(Ey, {
        ...
        children: [e.jsx(Zx, {
          active: s
        }), s === 1 && e.jsx(By, {}), s === 2 && e.jsx(xy, {})]
      })]
    })
  },
  ky = () => c(Fe) ? null : e.jsxs("button", {
    className: oe.button,
    onPointerUp: () => {
  ...
  Fy = () => c(n => n.canvas.coords) === null ? null : e.jsx($.Fragment, {
    children: e.jsx(Oy, {})
  }),
  Qy = "_layout_14eqc_1",
  ...
  Yy = () => e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [e.jsx(Xy, {}), e.jsx(Jy, {})]
    })
  }),
  Wy = () => null,
  Ky = "_layout_14a3l_1",
  Zy = "_container_14a3l_11",
  $y = "_image_14a3l_26",
  ev = "_text_14a3l_31",
  tv = "_gold_14a3l_37",
  nv = "_winning_14a3l_44",
  ...
  ov = () => {
    const t = W(),
      n = yr(new Date(Date.UTC(2024, 10, 30, 9, 0, 0))),
      s = c(be);
    return e.jsx("div", {
      className: Pe.layout,
      onPointerUp: () => {
  ...
  pv = ({
    ...
    return m.useEffect(() => {
      ...
      children: [Av[t.repaintRewardType], " ", e.jsx("img", {
        alt: "img",
        className: Es.image,
        src: ii
      })]
  ...
  gv = "_panel_1urz2_1",
  _v = "_content_1urz2_16",
  Ni = {
    panel: gv,
    content: _v
  },
  fv = () => c(n => n.canvas.coords) !== null ? null : e.jsx("div", {
    className: Ni.panel,
    children: e.jsx("div", {
  ...
  wv = "_title_container_1v16g_22",
  jv = "_image_container_1v16g_28",
  bv = "_image_1v16g_28",
  Nv = "_first_image_1v16g_45",
  Iv = "_second_image_1v16g_50",
  Pv = "_text_container_1v16g_55",
  Cv = "_button_container_1v16g_60",
  Sv = "_button_1v16g_60",
  Te = {
    layout: xv,
    container: yv,
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsxs("button", {
              className: Te.button,
              onPointerUp: () => {
                s !== null && de(`https://t.me/${Bt}?startapp=${btoa(`id=${s.id}`)}`)
              },
  ...
  Mv = "_buttons_container_srn55_18",
  _a = {
    layout: kv,
    container: Rv,
    buttons_container: Mv
  },
  Uv = "_container_srbwq_1",
  Ov = {
    container: Uv
  },
  Fv = ({
  ...
  zv = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(Fv, {
        ...
        direction: Ct.Direction.Up,
        values: s,
        step: Qv,
        min: Pi,
        max: Ci,
        onChange: o => {
          n(hg(o)), y.mainImage.worldTemplate.setOpacity(Number(o[0])), y.mainImage.tournamentTemplates.setOpacity(Number(o[0]))
        },
        renderTrack: ({
          props: o,
          children: r
          ...
          children: e.jsx("div", {
            ...
            style: {
              ...
              height: "100%",
              borderRadius: "4px",
              background: Ct.getTrackBackground({
                values: s,
  ...
  Lv = () => c(n => n.tournament.activeTournamentTemplate) === null ? null : e.jsx("div", {
    className: Ov.container,
    children: e.jsx(zv, {})
  }),
  qv = "_button_14giw_2",
  Hv = "_image_14giw_22",
  Gv = "_enabled_14giw_29",
  Xv = "_animation_14giw_33",
  Vv = "_scaleInfinity_14giw_1",
  Jv = "_gray_14giw_38",
  Yv = "_indicator_14giw_42",
  pt = {
    button: qv,
    image: Hv,
    enabled: Gv,
  ...
  Zv = () => e.jsx($.Fragment, {
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          className: _a.buttons_container,
          children: [e.jsx(Wv, {}), e.jsx(Kv, {}), e.jsx(Lv, {})]
        })
      })
    })
  }),
  ...
  aw = () => c(n => n.canvas.coords) === null ? null : e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [e.jsx(Wg, {}), e.jsx(Vg, {}), e.jsx(y_, {}), e.jsx(tg, {}), e.jsx(tw, {}), e.jsx(nw, {}), e.jsx(sw, {})]
    })
  }),
  iw = "_layout_swx97_1",
  ow = {
  ...
  rw = () => e.jsxs("div", {
    className: ow.layout,
    children: [e.jsx(aw, {}), e.jsx(Fy, {})]
  }),
  cw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(ov, {}), e.jsx(qy, {}), e.jsx(Zv, {}), e.jsx(Yy, {}), e.jsx(rw, {}), e.jsx(fv, {}), e.jsx(hv, {}), e.jsx(Dv, {}), e.jsx(rv, {}), e.jsx(Wy, {})]
  }),
  lw = "_page_title_13ybj_1",
  dw = "_container_13ybj_9",
  uw = "_item_13ybj_13",
  mw = "_active_13ybj_18",
  Aw = "_info_container_13ybj_34",
  pw = "_dot_13ybj_40",
  hw = "_title_text_13ybj_46",
  gw = "_capitalize_13ybj_50",
  _w = "_hint_text_13ybj_54",
  fw = "_date_text_13ybj_61",
  xw = "_value_container_13ybj_66",
  yw = "_value_text_13ybj_74",
  vw = "_positive_color_13ybj_78",
  ww = "_negative_color_13ybj_85",
  jw = "_last_text_13ybj_92",
  x = {
    page_title: lw,
    container: dw,
    item: uw,
  ...
  kw = ({
    ...
    item: t
  }) : t.action === "league transfer" ? e.jsx(Cw, {
    item: t
  }) : t.action === "referral" ? e.jsx(Sw, {
    item: t
  }) : t.action === "special" ? e.jsx(Tw, {
    item: t
  }) : t.action === "purchase" ? e.jsx(Bw, {
    item: t
  }) : t.action === "complete task" ? e.jsx(Ew, {
    item: t
  ...
  Uw = "_text_layout_1xggq_1",
  Ow = "_text_1xggq_1",
  Fw = "_button_layout_1xggq_14",
  Qw = "_button_layout_placeholder_1xggq_26",
  zw = "_button_1xggq_14",
  mn = {
    text_layout: Uw,
    text: Ow,
  ...
  Yw = "_layout_1drph_1",
  Ww = "_container_1drph_11",
  Kw = "_bold_1drph_22",
  Zw = "_info_container_1drph_26",
  $w = "_title_1drph_33",
  ej = "_description_1drph_38",
  tj = "_image_container_1drph_43",
  nj = "_image_1drph_43",
  sj = "_extra_info_container_1drph_53",
  ...
  we = {
    ...
    image_container: tj,
    image: nj,
    extra_info_container: sj,
    npx_tokens: aj,
    button_container: ij,
    button: oj
  },
  rj = "/assets/intro-Brtd1phH.webp",
  cj = {
    initial: {
      scale: .97,
      opacity: 0,
  ...
  wj = "_close_container_1mu9y_1",
  jj = "_title_container_1mu9y_12",
  bj = "_title_1mu9y_12",
  Nj = "_frens_count_1mu9y_21",
  Ij = "_content_1mu9y_25",
  Pj = "_image_container_1mu9y_32",
  Cj = "_image_1mu9y_32",
  Sj = "_description_container_1mu9y_41",
  Tj = "_white_1mu9y_50",
  Bj = "_gray_1mu9y_54",
  Ej = "_purple_1mu9y_58",
  Dj = "_bold_1mu9y_64",
  kj = "_center_1mu9y_68",
  Rj = "_info_layout_1mu9y_72",
  Mj = "_benefits_container_1mu9y_84",
  Uj = "_benefits_item_1mu9y_92",
  Oj = "_divider_1mu9y_98",
  Fj = "_buttons_container_1mu9y_105",
  Qj = "_button_copy_1mu9y_112",
  zj = "_button_1mu9y_105",
  Lj = "_share_container_1mu9y_137",
  qj = "_share_row_1mu9y_143",
  Hj = "_crypto_image_1mu9y_150",
  E = {
    close_container: wj,
    title_container: jj,
    title: bj,
  ...
  Gj = "/assets/sitting_chars_animation_outl-BdmQzfhn.gif",
  Xj = "_link_a4r15_1",
  Vj = {
    link: Xj
  },
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: E.button,
            onPointerUp: d => {
              d.stopPropagation(), de(`https://t.me/share/url?url=${a}`)
            },
            children: "Share"
          })]
        })]
  ...
  Yj = "_container_10f8u_1",
  Wj = "_text_container_10f8u_9",
  Kj = "_text_block_10f8u_16",
  Zj = "_gray_10f8u_24",
  $j = "_total_10f8u_28",
  eb = "_bold_10f8u_33",
  tb = "_indicator_10f8u_37",
    ...
    children: e.jsx("div", {
      ...
      children: cb.map((t, n) => {
        ...
        return e.jsx("div", {
          className: Qn.stars,
          style: {
            animation: `${Qn.animStar} ${t.speed}s linear infinite`,
            boxShadow: s
          }
        }, n)
      })
  ...
  mb = "_main_info_container_1gqs9_2",
  Ab = "_image_container_1gqs9_11",
  pb = "_image_1gqs9_11",
  hb = "_title_1gqs9_21",
  gb = "_variants_container_1gqs9_25",
  _b = "_variant_item_1gqs9_33",
  fb = "_variant_left_container_1gqs9_39",
  xb = "_variant_middle_container_1gqs9_45",
  yb = "_dot_1gqs9_53",
  vb = "_variant_right_container_1gqs9_59",
  wb = "_button_container_1gqs9_66",
  jb = "_button_1gqs9_66",
  bb = "_bold_1gqs9_96",
  Nb = "_gray_1gqs9_100",
  Ib = "_blue_1gqs9_104",
  Pb = "_text_1gqs9_109",
  q = {
    main_info_container: mb,
    image_container: Ab,
    image: pb,
    title: hb,
    variants_container: gb,
    variant_item: _b,
    variant_left_container: fb,
    variant_middle_container: xb,
    dot: yb,
    variant_right_container: vb,
    button_container: wb,
    button: jb,
    bold: bb,
    gray: Nb,
  ...
  Bb = "_close_container_5xtkt_1",
  Eb = "_title_container_5xtkt_12",
  Db = "_title_5xtkt_12",
  kb = "_small_title_container_5xtkt_23",
  Rb = "_small_title_5xtkt_23",
  Mb = "_content_5xtkt_32",
  Ub = "_image_container_5xtkt_40",
  Ob = "_image_placeholder_5xtkt_46",
  Fb = "_image_5xtkt_40",
  Qb = "_how_container_5xtkt_58",
  zb = "_description_container_5xtkt_63",
  Lb = "_white_5xtkt_72",
  qb = "_gray_5xtkt_76",
  Hb = "_bold_5xtkt_80",
  Gb = "_center_5xtkt_84",
  Xb = "_claim_button_container_5xtkt_88",
  Vb = "_claim_button_5xtkt_88",
  Jb = "_no_button_5xtkt_107",
  Yb = "_info_layout_5xtkt_119",
  Wb = "_rewards_layout_5xtkt_131",
  Kb = "_rewards_grid_container_5xtkt_137",
  Zb = "_reward_item_5xtkt_143",
  $b = "_reward_item_completed_5xtkt_153",
  e1 = "_reward_item_content_container_5xtkt_166",
  t1 = "_reward_item_active_5xtkt_179",
  n1 = "_reward_item_image_container_5xtkt_183",
  s1 = "_reward_item_amount_5xtkt_187",
  a1 = "_reward_item_amount_active_5xtkt_201",
  i1 = "_reward_item_amount_premium_5xtkt_205",
  o1 = "_reward_item_title_5xtkt_210",
  r1 = "_reward_item_title_premium_5xtkt_216",
  ...
  l1 = ({
    ...
    const P = async () => {
      try {
        const f = a.prices[0],
          b = await Y.startShopTransaction({
            buyerWallet: l,
            currencyId: 2,
            daily: !0,
            quantity: f.quantity,
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("div", {
            ...
            children: n.map((o, r) => {
              ...
              let j = d1;
              return r >= 8 && r <= 15 && (j = u1), r >= 16 && r <= 23 && (j = m1), r >= 24 && r <= 31 && (j = A1), e.jsxs("div", {
                className: u.join(" "),
                onPointerUp: () => {
                  t(U({
                    id: performance.now(),
  ...
  C1 = "_general_info_container_fv8d9_1",
  S1 = "_img_container_fv8d9_7",
  T1 = "_image_fv8d9_13",
  B1 = "_title_fv8d9_19",
  E1 = "_description_container_fv8d9_25",
  D1 = "_description_fv8d9_25",
  Gt = {
    general_info_container: C1,
    img_container: S1,
    image: T1,
    title: B1,
  ...
  M1 = "_no_template_container_uihlo_1",
  U1 = "_no_template_button_uihlo_10",
  O1 = "_template_container_uihlo_28",
  F1 = "_template_info_container_uihlo_35",
  Q1 = "_template_info_uihlo_35",
  z1 = "_buttons_container_uihlo_44",
  L1 = "_button_copy_uihlo_53",
  q1 = "_button_uihlo_44",
  H1 = "_create_new_template_uihlo_72",
  Je = {
    no_template_container: M1,
    no_template_button: U1,
    template_container: O1,
    template_info_container: F1,
    template_info: Q1,
    buttons_container: z1,
    button_copy: L1,
    button: q1,
    create_new_template: H1
  },
  G1 = "_instruction_container_14ts7_1",
  X1 = "_img_container_14ts7_9",
  V1 = "_image_14ts7_15",
  J1 = "_instruction_text_14ts7_21",
  Y1 = "_preview_container_14ts7_26",
  W1 = "_preview_image_container_14ts7_32",
  K1 = "_preview_image_14ts7_32",
  Z1 = "_preview_image_loader_14ts7_45",
  $1 = "_template_size_14ts7_60",
  e0 = "_template_title_14ts7_68",
  t0 = "_template_size_container_14ts7_73",
  n0 = "_template_size_item_14ts7_79",
  s0 = "_template_size_item_active_14ts7_87",
  a0 = "_template_coords_14ts7_92",
  i0 = "_template_coordinates_title_14ts7_102",
  o0 = "_template_coords_container_14ts7_107",
  r0 = "_coords_item_14ts7_114",
  c0 = "_coords_input_14ts7_120",
  l0 = "_file_button_container_14ts7_129",
  d0 = "_file_button_14ts7_129",
  ee = {
    instruction_container: G1,
    img_container: X1,
    image: V1,
    instruction_text: J1,
    preview_container: Y1,
    preview_image_container: W1,
    preview_image: K1,
    preview_image_loader: Z1,
    template_size: $1,
    template_title: e0,
    template_size_container: t0,
    template_size_item: n0,
    template_size_item_active: s0,
    template_coords: a0,
    template_coordinates_title: i0,
    template_coords_container: o0,
    coords_item: r0,
    coords_input: c0,
    file_button_container: l0,
    file_button: d0
  },
  Ds = {
    16: 512,
  ...
  A0 = "_template_item_container_srp11_1",
  p0 = "_template_item_inner_srp11_9",
  h0 = "_template_image_srp11_17",
  g0 = "_template_image_info_layout_srp11_24",
  _0 = "_template_image_info_container_srp11_34",
  hn = {
    template_item_container: A0,
    template_item_inner: p0,
    template_image: h0,
    template_image_info_layout: g0,
    template_image_info_container: _0
  },
  wr = ({
    item: t,
    style: n = {}
    ...
    return e.jsx("div", {
      ...
      onPointerUp: async () => {
        t.templateId && t.templateId !== 0 && s(Sa({
          show: !0,
  ...
  y0 = () => e.jsxs("div", {
    children: [e.jsx(m0, {}), e.jsx(x0, {})]
  }),
  v0 = "_layout_94gj5_1",
  w0 = "_container_94gj5_5",
  j0 = "_button_container_94gj5_11",
  b0 = "_button_94gj5_11",
  ks = {
    layout: v0,
    container: w0,
  ...
  P0 = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === "my" && e.jsx(y0, {}), t === "catalog" && e.jsx(I0, {})]
    })
  },
  C0 = () => {
    const t = g(),
  ...
  S0 = () => e.jsxs($.Fragment, {
    children: [e.jsx(C0, {}), e.jsx(P0, {})]
  }),
  Ws = "/assets/paintings_anim2-nk1iBB8J.gif",
  T0 = "_container_1h1qc_1",
  B0 = "_divider_1h1qc_19",
  E0 = "_row_1h1qc_24",
  D0 = "_row_title_1h1qc_36",
  k0 = "_row_title_main_1h1qc_40",
  R0 = "_row_hint_1h1qc_45",
  M0 = "_row_value_1h1qc_51",
  U0 = "_row_value_main_1h1qc_55",
  O0 = "_mining_percent_1h1qc_60",
  F0 = "_active_row_1h1qc_70",
  Q0 = "_button_1h1qc_81",
  Ei = {
    container: T0,
    divider: B0,
  ...
  L0 = "_layout_2uiqn_1",
  q0 = "_container_2uiqn_6",
  H0 = "_close_button_2uiqn_18",
  G0 = "_title_container_2uiqn_26",
  X0 = "_title_2uiqn_26",
  V0 = "_image_container_2uiqn_37",
  J0 = "_image_2uiqn_37",
  Y0 = "_image_placeholder_2uiqn_51",
  W0 = "_info_container_2uiqn_58",
  K0 = "_info_row_2uiqn_64",
  Z0 = "_info_title_2uiqn_69",
  $0 = "_info_value_blue_2uiqn_73",
  eN = "_info_value_white_2uiqn_78",
  tN = "_buttons_container_2uiqn_82",
  nN = "_button_2uiqn_82",
  sN = "_not_button_2uiqn_98",
  ...
  ae = {
    ...
    image_container: V0,
    image: J0,
    image_placeholder: Y0,
    info_container: W0,
    info_row: K0,
    info_title: Z0,
    info_value_blue: $0,
    info_value_white: eN,
    buttons_container: tN,
    button: nN,
    not_button: sN,
    button_copy: aN
  },
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(kt.subscribe({
              ...
              t(gg(h)), y.mainImage.worldTemplate.deleteTemplate(o.id), y.mainImage.worldTemplate.add(h), t($o())
            } else await t(U({
              id: performance.now(),
  ...
  dN = "_id_s1r1v_17",
  uN = "_title_s1r1v_22",
  mN = "_avatar_container_s1r1v_28",
  AN = "_avatar_s1r1v_28",
  pN = "_squad_avatar_container_s1r1v_40",
  hN = "_text_container_s1r1v_52",
  gN = "_dot_s1r1v_58",
  _N = "_user_name_s1r1v_63",
  fN = "_squad_name_s1r1v_69",
  xN = "_divider_s1r1v_75",
  yN = "_tabs_content_s1r1v_81",
  vN = "_content_info_s1r1v_85",
  wN = "_content_info_item_s1r1v_92",
  jN = "_content_info_item_title_s1r1v_96",
  bN = "_content_info_item_value_s1r1v_100",
  NN = "_no_content_s1r1v_106",
  IN = "_achievements_container_s1r1v_115",
  z = {
    container: cN,
    page: lN,
    id: dN,
  ...
  MN = "_not_completed_os5nt_6",
  UN = "_image_container_os5nt_10",
  ON = "_image_os5nt_10",
  FN = "_bold_os5nt_20",
  QN = "_gray_os5nt_24",
  ...
  LN = ({
    ...
    className: R(Nt.container, t ? "" : Nt.not_completed),
    children: [e.jsx("div", {
  ...
  qN = "/assets/0-CBlm-5t2.gif",
  HN = "/assets/1-C1eaF-Lh.gif",
  GN = "/assets/2-Dx7l5fvD.gif",
  ...
  nI = ({
    ...
    children: [t === "info" && e.jsx(kN, {
      isPopupContent: n
    }), t === "achievements" && e.jsx(eI, {
      isPopupContent: n
    }), t === "inventory" && e.jsx(tI, {})]
  }),
  sI = ({
    isPopupContent: t = !0
  }) => {
  ...
  Da = ({
    ...
    return e.jsxs("div", {
      className: R(z.container, !t && z.page),
  ...
  rI = "_container_1bw7p_1",
  cI = {
    container: rI
  },
  lI = "_container_12mk9_1",
  dI = "_page_12mk9_13",
  uI = "_id_12mk9_17",
  mI = "_title_12mk9_22",
  AI = "_avatar_container_12mk9_28",
  pI = "_avatar_12mk9_28",
  hI = "_text_container_12mk9_39",
  gI = "_dot_12mk9_45",
  _I = "_user_name_12mk9_50",
  fI = "_squad_slug_12mk9_56",
  xI = "_your_squad_button_12mk9_62",
  yI = "_join_squad_button_12mk9_75",
  vI = "_red_12mk9_91",
  wI = "_divider_12mk9_95",
  jI = "_tabs_content_12mk9_101",
  bI = "_content_info_12mk9_105",
  NI = "_content_info_item_12mk9_112",
  II = "_content_info_item_title_12mk9_116",
  PI = "_content_info_item_value_12mk9_120",
  CI = "_content_top_12mk9_127",
  SI = "_content_top_item_12mk9_140",
  TI = "_content_top_item_image_12mk9_150",
  BI = "_content_top_name_12mk9_156",
  EI = "_content_top_arrow_12mk9_162",
  DI = "_gray_12mk9_166",
  B = {
    container: lI,
    page: dI,
    ...
    user_name: _I,
    squad_slug: fI,
    your_squad_button: xI,
    join_squad_button: yI,
    red: vI,
    divider: wI,
    tabs_content: jI,
    content_info: bI,
    ...
    content_info_item_value: PI,
    content_top: CI,
    content_top_item: SI,
    content_top_item_image: TI,
    content_top_name: BI,
    content_top_arrow: EI,
    gray: DI
  },
  Nr = ({
    data: t,
  ...
  Cr = ({
    ...
    return n ? s !== null && s.squad.id !== null && s.squad.id === t.squad.id ? e.jsxs("div", {
      ...
      onPointerUp: () => {
        de(`https://t.me/${Bt}?startapp=${btoa(`id=${t.squad.id}`)}`)
      },
      children: [e.jsx("span", {
        className: B.gray,
        children: "Your Squad."
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Se.uploadTemplate({
              ...
              i(_g(P)), i($o()), await y.mainImage.worldTemplate.add(P), i(U({
                id: performance.now(),
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const j = async () => {
          ...
          let L, H;
          b > 1 ? (L = r, H = r / b) : (H = r, L = r * b);
          const Ne = (r - L) / 2,
            X = (r - H) / 2;
          P.width = r, P.height = r, f.drawImage(t, Ne, X, L, H);
          const ve = f.getImageData(0, 0, r, r);
          qI(ve), f.putImageData(ve, 0, 0), a(ve), o(P.toDataURL())
        };
        setTimeout(() => {
          j().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(XI, {}), i !== null && e.jsx(LI, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(u0, {
  ...
  JI = "_general_info_container_1u2nd_1",
  YI = "_img_container_1u2nd_7",
  WI = "_image_1u2nd_17",
  KI = "_image_cup_1u2nd_23",
  ZI = "_image_glow_container_1u2nd_29",
  $I = "_image_glow_1u2nd_29",
  eP = "_rotate_1u2nd_1",
  tP = "_image_glow_reverse_1u2nd_48",
  nP = "_title_1u2nd_53",
  sP = "_description_container_1u2nd_60",
  aP = "_description_1u2nd_60",
  iP = "_gold_1u2nd_73",
  Qe = {
    ...
    image: WI,
    image_cup: KI,
    image_glow_container: ZI,
    image_glow: $I,
    rotate: eP,
    image_glow_reverse: tP,
    title: nP,
    description_container: sP,
    description: aP,
    gold: iP
  },
  oP = "_info_layout_1p9dg_1",
  rP = {
    info_layout: oP
  },
  cP = t => {
  ...
  lP = "_instruction_container_17lvx_1",
  dP = "_img_container_17lvx_9",
  uP = "_img_inner_container_17lvx_16",
  mP = "_image_17lvx_22",
  AP = "_image_status_17lvx_30",
  pP = "_image_status_rejected_17lvx_45",
  hP = "_image_status_review_17lvx_49",
  gP = "_image_status_approved_17lvx_53",
  _P = "_copy_button_container_17lvx_57",
  fP = "_button_copy_17lvx_65",
  xP = "_gray_17lvx_71",
  yP = "_preview_container_17lvx_75",
  vP = "_preview_image_container_17lvx_81",
  wP = "_preview_image_17lvx_81",
  jP = "_preview_image_loader_17lvx_94",
  bP = "_template_size_17lvx_109",
  NP = "_template_title_17lvx_117",
  IP = "_template_size_container_17lvx_122",
  PP = "_template_size_item_17lvx_128",
  CP = "_template_size_item_active_17lvx_136",
  SP = "_template_coords_17lvx_141",
  TP = "_template_coordinates_title_17lvx_151",
  BP = "_template_coords_container_17lvx_156",
  EP = "_coords_item_17lvx_163",
  DP = "_coords_input_17lvx_169",
  kP = "_file_button_container_17lvx_178",
  RP = "_file_button_17lvx_178",
  Z = {
    instruction_container: lP,
    img_container: dP,
    img_inner_container: uP,
    image: mP,
    image_status: AP,
    image_status_rejected: pP,
    image_status_review: hP,
    image_status_approved: gP,
    copy_button_container: _P,
    button_copy: fP,
    gray: xP,
    preview_container: yP,
    preview_image_container: vP,
    preview_image: wP,
    preview_image_loader: jP,
    template_size: bP,
    template_title: NP,
    template_size_container: IP,
    template_size_item: PP,
    template_size_item_active: CP,
    template_coords: SP,
    template_coordinates_title: TP,
    template_coords_container: BP,
    coords_item: EP,
    coords_input: DP,
    file_button_container: kP,
    file_button: RP
  },
  Xt = {
    approved: "approved",
      ...
      children: [n && e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("img", {
            ...
            className: R(Z.image_status, Z.image_status_review),
            children: "On review"
          }), s === Xt.rejected && e.jsx("div", {
            className: R(Z.image_status, Z.image_status_rejected),
            children: "Rejected"
          }), s === Xt.approved && e.jsx("div", {
            className: R(Z.image_status, Z.image_status_approved),
            children: "Approved"
          })]
        })
      }), e.jsx("div", {
    ...
    return m.useEffect(() => {
      if (s !== null) {
        ...
        const f = async () => {
          ...
          let Ne, X;
          H > 1 ? (Ne = d, X = d / H) : (X = d, Ne = d * H);
          const ve = (d - Ne) / 2,
            Rn = (d - X) / 2;
          b.width = d, b.height = d, L.drawImage(s, ve, Rn, Ne, X);
          const cn = L.getImageData(0, 0, d, d);
          cP(cn), L.putImageData(cn, 0, 0), o(cn), l(b.toDataURL())
        };
        setTimeout(() => {
          f().then(() => {
            P(!1)
      ...
      children: [r === null && e.jsx(MP, {}), r !== null && e.jsx(UP, {
        loading: j,
        dataUrl: r,
        templateSize: d
      }), r !== null && e.jsx(OP, {
  ...
  qP = "_layout_1c7e5_1",
  HP = "_container_1c7e5_5",
  GP = "_button_container_1c7e5_11",
  XP = "_button_1c7e5_11",
  ...
  JP = "_template_item_container_1c93x_1",
  YP = "_template_item_inner_1c93x_12",
  WP = "_template_item_picked_1c93x_28",
  KP = "_template_item_rejected_1c93x_43",
  ZP = "_template_item_shadow_1c93x_58",
  $P = "_template_rank_1c93x_70",
  eC = "_template_recolors_1c93x_90",
  tC = "_template_recolors_pixel_1c93x_105",
  nC = "_template_image_1c93x_112",
  $e = {
    template_item_container: JP,
    template_item_inner: YP,
    template_item_picked: WP,
    template_item_rejected: KP,
    template_item_shadow: ZP,
    template_rank: $P,
    template_recolors: eC,
    template_recolors_pixel: tC,
    template_image: nC
  },
  oi = ({
    item: t,
    ...
    return m.useEffect(() => {
      ...
      if (n.current && s === A.fulfilled && a < o) {
        const l = {
          ...
          d = (u, h) => {
            u.forEach(_ => {
              _.intersectionRatio >= 1 && (t(Ce.getApprovedList({
                offset: a,
                limit: i
  ...
  aC = () => {
    const t = g(),
      ...
      a = c(Po.selectAll);
    return m.useEffect(() => (t(Ce.getApprovedList({
      offset: n,
      limit: s
    })), () => {
      t(cr())
  ...
  rC = () => {
    ...
    return m.useEffect(() => (t(Ce.getRandomList()), () => {
      t(cr())
    }), []), e.jsxs("div", {
      className: We.layout,
      children: [e.jsxs("div", {
        className: We.container,
        children: [e.jsx(oC, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(oi, {
          item: i
        }, i.id))]
      }), e.jsx(iC, {})]
    })
  },
  cC = "_round_info_container_1d52c_1",
  lC = "_title_1d52c_7",
  dC = "_description_1d52c_12",
  uC = "_round_status_container_1d52c_17",
  dt = {
    round_info_container: cC,
    title: lC,
    description: dC,
    round_status_container: uC
  },
  mC = "_round_indicator_mgwmo_1",
  AC = "_round_indicator_wait_mgwmo_37",
  Tr = {
    round_indicator: mC,
    round_indicator_wait: AC
  },
  pC = () => e.jsx("div", {
  ...
  hC = () => {
    ...
    return t ? e.jsxs("div", {
      ...
      children: [e.jsxs("div", {
        children: [e.jsxs("div", {
          className: dt.title,
          children: ["Top ", Ua[t].templateThreshold, " ", "templates will win"]
        }), e.jsx("div", {
  ...
  gC = () => {
    ...
    return e.jsxs("div", {
      children: [e.jsx(hC, {}), t && n === A.fulfilled && e.jsx(aC, {}), !t && n === A.fulfilled && e.jsx(rC, {})]
    })
  },
  _C = "_soon_la5q2_1",
  fC = "_active_round_instruction_la5q2_11",
  xC = "_not_active_round_instruction_la5q2_19",
  yC = "_round_container_la5q2_25",
  vC = "_round_title_la5q2_33",
  wC = "_round_title_text_la5q2_38",
  jC = "_round_indicator_la5q2_43",
  bC = "_round_status_success_la5q2_49",
  NC = "_round_status_fail_la5q2_60",
  IC = "_success_la5q2_71",
  PC = "_fail_la5q2_75",
  CC = "_gray_la5q2_79",
  SC = "_round_main_info_la5q2_83",
  TC = "_round_image_container_la5q2_89",
  BC = "_round_image_la5q2_89",
  EC = "_round_lines_container_la5q2_103",
  DC = "_round_line_la5q2_103",
  kC = "_divider_la5q2_117",
  RC = "_pixels_number_la5q2_124",
  MC = "_pixel_la5q2_124",
  UC = "_past_rounds_la5q2_136",
  OC = "_past_rounds_divider_la5q2_145",
  F = {
    soon: _C,
    active_round_instruction: fC,
    not_active_round_instruction: xC,
    round_container: yC,
    round_title: vC,
    round_title_text: wC,
    round_indicator: jC,
    round_status_success: bC,
    round_status_fail: NC,
    success: IC,
    fail: PC,
    gray: CC,
    round_main_info: SC,
    round_image_container: TC,
    round_image: BC,
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: R(l ? F.success : F.fail),
              children: ["👑 ", r]
            })]
          }), e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: R(i ? F.success : F.fail),
              children: t.rank
            })]
          }), e.jsxs("div", {
            className: F.round_line,
  ...
  LC = () => {
    const t = c(be),
      n = c(Js),
      s = yr(new Date(Date.UTC(2024, 10, 30, 9, 0, 0)));
  ...
  qC = () => {
    ...
    return m.useEffect(() => {
      n === A.idle && t(Ce.getResults())
    }, [n]), e.jsxs("div", {
      children: [e.jsx(zC, {}), e.jsx(LC, {}), e.jsx(FC, {}), e.jsx(QC, {})]
    })
  },
  HC = () => {
    const t = c(n => n.tournament.activeTab);
    return e.jsxs("div", {
      className: rP.info_layout,
      children: [t === Be.create && e.jsx(LP, {}), t === Be.main && e.jsx(gC, {}), t === Be.result && e.jsx(qC, {})]
    })
  },
  GC = () => e.jsxs($.Fragment, {
    children: [e.jsx(Cg, {}), e.jsx(HC, {})]
  }),
  XC = "/assets/bg-BNfFdtGI.png",
  ...
  YC = "_title_lc1md_8",
  WC = "_table_container_lc1md_13",
  KC = "_table_row_lc1md_19",
  ZC = "_button_lc1md_26",
  $C = "_active_row_lc1md_50",
  eS = "_row_title_lc1md_50",
  fa = {
    container: JC,
    title: YC,
    table_container: WC,
  ...
  nS = "_layout_17ca7_1",
  sS = "_container_17ca7_6",
  aS = "_close_button_17ca7_20",
  iS = "_title_container_17ca7_28",
  oS = "_title_17ca7_28",
  rS = "_image_container_17ca7_39",
  cS = "_image_17ca7_39",
  lS = "_image_placeholder_17ca7_53",
  dS = "_info_container_17ca7_60",
  uS = "_info_row_17ca7_66",
  mS = "_info_title_17ca7_71",
  AS = "_info_value_blue_17ca7_75",
  pS = "_info_value_white_17ca7_80",
  hS = "_buttons_container_17ca7_84",
  gS = "_button_17ca7_84",
  _S = "_not_button_17ca7_100",
  ...
  Rr = ({
    ...
    return e.jsx("button", {
      ...
      onPointerUp: async () => {
        try {
          if (o) return;
          (await a(Ce.selectTemplate({
            id: t.id
          }))).meta.requestStatus === A.fulfilled && a(lr(t))
        } catch (r) {
  ...
  yS = () => {
    ...
    return c(be), !a || !s ? null : Ze.createPortal(e.jsx(He, {
      onPointerUp: () => t(Aa()),
      show: s,
      children: e.jsx("div", {
        className: K.layout,
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              onPointerUp: () => {
                n.push("/"), t(Aa()), y.viewport.viewport.animate({
                  scale: 4,
                  time: 400,
                  position: {
                    x: a.x + a.imageSize / 2,
  ...
  IS = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  PS = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  TS = "_column_tuzgg_9",
  BS = "_column_rev_tuzgg_17",
  ES = "_title_tuzgg_26",
  DS = "_table_container_tuzgg_32",
  kS = "_table_row_tuzgg_38",
  RS = "_button_tuzgg_45",
  MS = "_value_tuzgg_52",
  US = "_notpixel_icon_tuzgg_58",
  OS = "_active_row_tuzgg_74",
  FS = "_row_title_tuzgg_74",
  je = {
    container: SS,
    column: TS,
    column_rev: BS,
  ...
  GS = () => {
    ...
    return e.jsxs("button", {
      ...
      children: [e.jsx("span", {
        ...
        className: `telegram_icons ${Di.icon}`,
        children: ""
      })]
    })
  },
  XS = () => {
    const t = g();
    return e.jsxs(ce, {
      children: [e.jsx(GS, {}), e.jsxs("div", {
        className: Qe.general_info_container,
        style: {
          backgroundImage: `url(${XC})`,
  ...
  YS = "_image_qn09x_9",
  WS = "_title_container_qn09x_18",
  KS = "_text_container_qn09x_27",
  ZS = "_title_qn09x_18",
  $S = "_gray_qn09x_39",
  e2 = "_bold_qn09x_43",
  t2 = "_input_qn09x_47",
  n2 = "_catalog_container_qn09x_71",
  s2 = "_catalog_title_qn09x_76",
  a2 = "_catalog_items_container_qn09x_81",
  i2 = "_catalog_item_qn09x_81",
  o2 = "_catalog_item_image_container_qn09x_100",
  r2 = "_catalog_item_image_qn09x_100",
  c2 = "_button_container_qn09x_109",
  l2 = "_button_qn09x_109",
  d2 = "_wrong_helper_text_qn09x_124",
  u2 = "_wrong_button_qn09x_129",
  m2 = "_wrong_button_text2_qn09x_142",
  S = {
    container: VS,
    image_container: JS,
    image: YS,
    ...
    catalog_item: i2,
    catalog_item_image_container: o2,
    catalog_item_image: r2,
    button_container: c2,
    button: l2,
    wrong_helper_text: d2,
    wrong_button: u2,
    wrong_button_text2: m2
  },
  A2 = "/assets/box_1-CzUKXu07.gif",
  p2 = "/assets/box_2-wR9cQS7q.gif",
  h2 = "/assets/box_3-g_PL1kKM.gif",
  g2 = "/assets/dogs-D0jtZggB.gif",
  _2 = "/assets/secret_word-BTKB1fAO.gif",
  f2 = "/assets/cube_youtube_2-BqessN1a.gif",
  x2 = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif",
  zn = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
  ...
  y2 = () => {
    ...
    return m.useEffect(() => {
      ...
      (async () => {
        const L = await Y.getSecretStats();
        L.status === 200 && L.data && L.data.forEach(H => {
          H.group_name === zn.Ghost && d({
            count: H.usage_count,
            limit: H.limit
          }), H.group_name === zn.Mythical && h({
            count: H.usage_count,
            limit: H.limit
          }), H.group_name === zn.Magical && j({
            count: H.usage_count,
            limit: H.limit
          }), H.group_name === zn.Dogs && f({
            count: H.usage_count,
            limit: H.limit
          })
        })
  ...
  D2 = "_number_rjvnl_36",
  k2 = "_button_rjvnl_1",
  R2 = "_ratings_button_rjvnl_55",
  M2 = "_stars_button_rjvnl_62",
  U2 = "_shop_button_rjvnl_70",
  O2 = "_burger_button_rjvnl_79",
  ...
  H2 = "_open_menu_button_image_rjvnl_144",
  G2 = "_my_pixels_amount_rjvnl_149",
  X2 = "_header_content_rjvnl_154",
  xe = {
  ...
  ki = $.memo(() => e.jsxs("div", {
    ...
    children: [e.jsxs("div", {
      ...
      children: [e.jsx(Z2, {}), e.jsx(K2, {})]
    }), e.jsx("div", {
      className: `${xe.group} ${xe.middle}`,
      children: e.jsx(J2, {})
    }), e.jsxs("div", {
      className: `${xe.group} ${xe.right}`,
      children: [e.jsx($2, {}), e.jsx(V2, {}), e.jsx(W2, {})]
    })]
  })),
  Ri = {
    bronze: De.bronze,
  ...
  Mi = () => {
    const t = c(s => s.user.user),
      n = [De.league];
    return t !== null && Ri.hasOwnProperty(t.league) ? (n.push(Ri[t.league]), e.jsx("div", {
      className: n.join(" ")
    })) : null
  },
  eT = () => {
...
const tT = () => {
    ...
    return m.useEffect(() => {
      const s = () => {
        v2.includes(t.pathname) ? n.push("/") : n.goBack()
      };
  ...
  aT = () => {
    ...
    return m.useEffect(() => {
      ...
      const h = _ => {
        a === null && (a = _);
        const P = (_ - a) / r;
        o !== _ && (i = Math.min(P * l, l), t.current && (t.current.style.width = `${i}%`)), o = _, i < l && (d = requestAnimationFrame(h))
      };
  ...
  oT = "_header_11ui8_13",
  rT = "_close_container_11ui8_23",
  cT = "_close_11ui8_23",
  lT = "_title_11ui8_48",
  dT = "_frens_count_11ui8_53",
  uT = "_body_11ui8_58",
  mT = "_content_11ui8_68",
  AT = "_image_container_11ui8_75",
  pT = "_image_11ui8_75",
  hT = "_image_container_charges_11ui8_84",
  gT = "_image_charges_11ui8_89",
  _T = "_description_container_11ui8_94",
  fT = "_bold_11ui8_102",
  xT = "_gray_11ui8_107",
  yT = "_center_11ui8_111",
  vT = "_benefits_container_11ui8_115",
  wT = "_benefits_item_11ui8_123",
  jT = "_benefits_icon_container_11ui8_128",
  bT = "_icon_invite_11ui8_132",
  NT = "_footer_11ui8_136",
  ...
  D = {
    ...
    image_container: AT,
    image: pT,
    image_container_charges: hT,
    image_charges: gT,
    description_container: _T,
    bold: fT,
    gray: xT,
    center: yT,
    benefits_container: vT,
    benefits_item: wT,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: D.button,
            onPointerUp: l => {
              l.stopPropagation(), de(`https://t.me/share/url?url=${i}`), t(da())
            },
            children: "Share"
          })]
        })]
  ...
  RT = "_image_19qal_49",
  MT = "_content_container_19qal_60",
  UT = "_description_container_19qal_68",
  OT = "_description_item_19qal_75",
  FT = "_amount_selector_container_19qal_82",
  QT = "_amount_selector_button_19qal_88",
  zT = "_amount_selector_count_19qal_101",
  LT = "_button_container_19qal_112",
  qT = "_crypto_button_container_19qal_118",
  HT = "_error_19qal_132",
  GT = "_not_available_19qal_139",
  XT = "_button_19qal_112",
  VT = "_star_color_19qal_165",
  JT = "_tokens_selector_19qal_171",
  YT = "_tokens_title_19qal_176",
  WT = "_connect_wallet_text_title_19qal_183",
  KT = "_tokens_container_19qal_192",
  ZT = "_token_item_19qal_199",
  $T = "_token_image_container_19qal_210",
  eB = "_token_image_19qal_210",
  tB = "_sale_box_19qal_220",
  ...
  J = {
    ...
    image_container: kT,
    image: RT,
    content_container: MT,
    description_container: UT,
    description_item: OT,
    amount_selector_container: FT,
    amount_selector_button: QT,
    ...
    tokens_selector: JT,
    tokens_title: YT,
    connect_wallet_text_title: WT,
    tokens_container: KT,
    token_item: ZT,
    token_image_container: $T,
    token_image: eB,
    sale_box: tB,
    sale_text: nB
  },
  ...
  cB = ({
    ...
    if (o) return e.jsxs($.Fragment, {
      children: ["Buy for ", e.jsx(rB, {}), Math.round(o * (r ? s : 1) * 100) / 100, e.jsx("div", {
  ...
  lB = ({
    ...
    const s = g(),
      ...
      [d, u] = m.useState(!1),
      [h, _] = Nn(),
      P = (Ne = c(X => X.shop.products[a]).prices.filter(X => X.currency_id === i)[0]) == null ? void 0 : Ne.price,
      f = Ms();
    ...
    const L = async X => {
      ...
      const ve = new $s.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        cn = await new $s.token.jetton.JettonMinter(ve, {
          address: Pt[i]
        }).getJettonWalletAddress(new $s.utils.Address(f)),
        Qr = Xe.Address.parse(f),
        zr = Xe.Address.parse(wa),
        Lr = Xe.beginCell().storeUint(0, 32).storeStringTail(X.txMemCode).endCell(),
        qr = Xe.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(Xe.toNano(X.strAmount)).storeAddress(zr).storeAddress(Qr).storeBit(0).storeCoins(Xe.toNano("0.01")).storeBit(1).storeRef(Lr).endCell(),
        Hr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
    ...
    return P ? e.jsx("button", {
      ...
      onPointerUp: async X => {
        ...
        if (r !== A.pending) {
          l(A.pending);
          try {
            const ve = await Y.startShopTransaction({
              buyerWallet: f,
              currencyId: i,
              quantity: o,
              goodId: a
            ...
            else if (i === 3 || i === 5 || i === 6 || i === 7 || i === 8 || i === 9) await H(ve.data);
    ...
    return c(_ => _.shop.selectedCurrency) !== 1 ? null : e.jsx("div", {
      ...
      onPointerUp: async _ => {
        ...
        try {
          ...
          f.status === 200 && ((P = f == null ? void 0 : f.data) == null ? void 0 : P.ok) === !0 && window.Telegram.WebApp.openInvoice(f.data.result, b => {
            var H, Ne;
            const L = Number(a);
            if (b === "paid") {
              if (L >= 9 && L <= 11) {
              ...
              u(!0), (Ne = (H = window.Telegram.WebApp) == null ? void 0 : H.HapticFeedback) == null || Ne.notificationOccurred("error"), n(!0)
  ...
  pB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(oB, {}), e.jsx(AB, {}), e.jsx(wo, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: J.error,
  ...
  gB = "_container_1rmx4_1",
  _B = "_max_value_1rmx4_9",
  Oi = {
    container: gB,
    max_value: _B
  },
...
const fB = () => {
  ...
  xB = () => e.jsxs("div", {
    ...
    children: [e.jsx(aB, {}), e.jsxs("div", {
      ...
      children: [e.jsx(iB, {}), e.jsx(hB, {}), e.jsx(fB, {})]
    }), e.jsx(pB, {})]
  }),
  yB = () => {
    const t = c(n => n.shop.show);
    return Ze.createPortal(e.jsx(He, {
      show: t,
      children: e.jsxs("div", {
        className: J.container,
        children: [e.jsx(sB, {}), e.jsx(xB, {})]
      })
    }), document.body)
  },
  vB = "_layout_9sf1k_1",
  wB = "_container_9sf1k_13",
  jB = "_header_9sf1k_20",
  bB = "_title_9sf1k_30",
  NB = "_body_9sf1k_35",
  IB = "_image_container_9sf1k_47",
  PB = "_image_9sf1k_47",
  CB = "_shake_9sf1k_1",
  SB = "_description_container_9sf1k_60",
  TB = "_buyer_info_9sf1k_70",
  BB = "_avatar_9sf1k_78",
  EB = "_name_9sf1k_84",
  DB = "_squad_info_9sf1k_88",
  kB = "_squad_avatar_9sf1k_94",
  RB = "_text_container_9sf1k_100",
  MB = "_text_9sf1k_100",
  UB = "_thanos_snap_container_9sf1k_110",
  OB = "_thanos_snap_text_9sf1k_119",
  FB = "_button_container_9sf1k_126",
  QB = "_button_9sf1k_126",
  ue = {
    layout: vB,
    container: wB,
    header: jB,
...
async function XB() {
  w.enable(w.BLEND), w.blendFunc(w.SRC_ALPHA, w.ONE_MINUS_SRC_ALPHA), w.clearColor(0, 0, 0, 0), w.viewport(0, 0, w.canvas.width, w.canvas.height), Ie = await VB(w), w.useProgram(Ie)
}
async function VB(t, n, s) {
  const a = zB,
    i = LB,
...
async function JB(t) {
  YB(), ZB(t), Ur(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function ZB(t) {
  ...
  js = l * l, tt(w, Ie, "u_AnimationDuration", Mr), tt(w, Ie, "u_ParticleSize", qB), tt(w, Ie, "u_ViewportWidth", n), tt(w, Ie, "u_ViewportHeight", s), tt(w, Ie, "u_TextureWidth", a), tt(w, Ie, "u_TextureHeight", i), tt(w, Ie, "u_TextureLeft", o), tt(w, Ie, "u_TextureTop", r);
...
function $B(t) {
  ...
  tt(w, Ie, "u_ElapsedTime", s), w.drawArrays(w.POINTS, 0, js), Ur()
}
...
const eE = () => {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                ...
                t.push("/"), n(ih()), y.mainImage.pixanosRepaint(a.info.seed, T.width, a.info.percentage, a.info.color), (l = (r = window.Telegram.WebApp) == null ? void 0 : r.HapticFeedback) == null || l.notificationOccurred("error")
              },
              children: "Whoosh!"
            })
          })]
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: D.button,
            onPointerUp: l => {
              l.stopPropagation(), window.Telegram.WebApp.openLink(`https://t.me/share/url?url=${i}`), n(ua())
            },
            children: "Share"
          })]
        })]
  ...
  fE = () => {
    ...
    return e.jsx(He, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === Le.userFromPixelInfo && e.jsx(Da, {
          isPopupContent: s
        }), n.dataSource === Le.userFromRating && e.jsx(Da, {
          isPopupContent: s
        }), n.dataSource === Le.squadFromData && e.jsx(_E, {})]
      })
    })
  },
  xE = "_overlay_1vl8z_1",
  yE = "_top_container_1vl8z_10",
  vE = "_bottom_container_1vl8z_15",
  wE = "_side_menu_1vl8z_20",
  jE = "_menu_safe_area_inset_1vl8z_36",
  bE = "_menu_header_1vl8z_40",
  NE = "_close_button_1vl8z_53",
  IE = "_menu_list_1vl8z_58",
  PE = "_icon_1vl8z_79",
  CE = "_icon_not_pixel_1vl8z_87",
  SE = "_gold_pixel_1vl8z_97",
  TE = "_menu_list_li_1vl8z_103",
  BE = "_menu_list_text_1vl8z_109",
  EE = "_menu_list_new_item_1vl8z_113",
  DE = "_button_wrapper_1vl8z_136",
  kE = "_button_content_1vl8z_145",
  RE = "_footer_1vl8z_152",
  ME = "_avatar_1vl8z_158",
  ...
  JE = "_layout_eiymv_1",
  YE = "_container_eiymv_7",
  Hi = {
    layout: JE,
    container: YE
  },
  WE = () => localStorage.getItem("canvasFps") ? [Number(localStorage.getItem("canvasFps"))] : [60],
  KE = () => {
    const [t, n] = $.useState(WE());
    return m.useEffect(() => {
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(yn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(tD, {}), e.jsx(KE, {}), e.jsxs("div", {
...
const uD = "_container_gb8eq_1",
  mD = "_header_gb8eq_11",
  AD = "_title_gb8eq_17",
  pD = "_close_container_gb8eq_23",
  hD = "_close_gb8eq_23",
  gD = "_body_gb8eq_47",
  _D = "_content_gb8eq_59",
  fD = "_time_left_container_gb8eq_65",
  xD = "_timer_gb8eq_69",
  yD = "_image_container_gb8eq_73",
  vD = "_image_gb8eq_73",
  wD = "_glow_container_gb8eq_91",
  jD = "_glow_gb8eq_91",
  bD = "_rotate_gb8eq_1",
  ND = "_glow_reverse_gb8eq_107",
  ID = "_description_container_gb8eq_113",
  PD = "_bold_gb8eq_123",
  CD = "_gray_gb8eq_128",
  SD = "_center_gb8eq_132",
  TD = "_gold_gb8eq_136",
  BD = "_button_gb8eq_144",
  he = {
    container: uD,
    header: mD,
    title: AD,
  ...
  ED = "/assets/cup_glad-DGT2PBmm.png",
  DD = () => {
    const t = W(),
      n = c(Ue),
      [s, a] = m.useState(!1),
      i = "showCreateTournamentTemplatePopup";
    return m.useEffect(() => (La() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(He, {
      show: s,
      children: e.jsx("div", {
  ...
  kD = "_layout_xga4i_1",
  RD = "_container_xga4i_14",
  MD = "_header_xga4i_20",
  UD = "_close_xga4i_25",
  OD = "_body_xga4i_38",
  FD = "_image_container_xga4i_42",
  QD = "_image_xga4i_42",
  zD = "_glow_xga4i_55",
  LD = "_forward_xga4i_62",
  qD = "_rotate_xga4i_1",
  HD = "_reverse_xga4i_66",
  GD = "_text_container_xga4i_70",
  XD = "_title_xga4i_78",
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(ek, {}), e.jsx("img", {
                alt: "glow",
                src: Ba,
                className: R(ge.glow, ge.forward)
              }), e.jsx("img", {
                alt: "glow",
                src: Ba,
                className: R(ge.glow, ge.reverse)
              }), e.jsx("img", {
                alt: "img",
                src: n ? n.image_url : "",
                className: ge.image
...
const nk = "_layout_15tw0_1",
  ...
  uk = () => e.jsxs("div", {
    className: gn.layout,
    children: [e.jsx(aT, {}), e.jsx(eT, {}), e.jsx(E_, {}), e.jsx(w2, {}), e.jsx(tT, {}), e.jsx(nE, {}), e.jsx(gE, {}), e.jsx(fE, {}), e.jsx(CT, {}), e.jsx(tE, {}), e.jsx(DD, {}), e.jsx(tk, {}), e.jsx(dk, {}), e.jsx(yB, {}), e.jsx(eE, {}), e.jsx(rE, {}), e.jsx(sD, {})]
  }),
  mk = () => {
    const t = g(),
  ...
  hk = "_layout_ieygs_1",
  gk = "_container_ieygs_8",
  _k = "_logo_container_ieygs_17",
  fk = "_logo_ieygs_17",
  xk = "_animate_ieygs_1",
  yk = "_center_ieygs_37",
  vk = "_title_ieygs_51",
  wk = "_description_ieygs_58",
  jk = "_button_container_ieygs_63",
  bk = "_button_ieygs_63",
  Nk = "_b_ieygs_63",
  It = {
    layout: hk,
  ...
  Pk = "/assets/loading-D8SQALTR.gif",
  Ck = () => e.jsxs("div", {
  ...
  Sk = () => {
    ...
    m.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(Yp(s)), t(Xa(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(ju(s))
      })
    }, [t])
  ...
  Bk = () => {
    const t = W();
    m.useEffect(() => {
      La() ? localStorage.getItem("skipIntro") || (t.push("/welcome"), localStorage.setItem("skipIntro", "true")) : sn.get("skipIntro", (n, s) => {
  ...
  Uk = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Bc) && pk(), Sk(), Tk(), Bk(), a || o ? e.jsx(Ik, {}) : i ? e.jsx(Ck, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
