...
const Ba = B("canvas/getPixelInfo", async ({
    id: n
  }) => (Xt !== null && (Xt.abort(), Xt = null), Xt = new AbortController, (await F.getPixelInfo({
    id: n,
    signal: Xt.signal
  })).data)),
  ...
  yi = re({
    ...
    extraReducers: n => {
      n.addCase(Ba.pending, t => {
        ...
        t.pixelInfo = s.payload, t.getPixelInfoFetchStatus = m.fulfilled, Xt = null
...
let Wd = class {
  constructor({
    ...
    this.app = t, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [Od, Md, Fd, Qd, zd, Hd, qd, Ld, Vd, Xd, Gd, Yd, Jd], this.textureArray = [];
    for (let o = 0; o < 13; o++) {
...
const hm = async ({
  ...
  var c, d;
  if (!t && i && (t = i.shop.available[1], s = i.mining.charges, a = i.mining.maxCharges, o = i.shop.useProductStatus), !t || t === 0) return n(Ks(10)), n(Xe(1)), n(Ge()), n(Ni()), !1;
  if (s === a) return !1;
...
let Zm = class {
  constructor({
    ...
    this.app = t, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [Bm, Dm, km, Rm, Um, Om, Mm, Fm, Qm, zm, Hm, qm, Lm, Vm, Xm, Gm, Ym, Jm, Wm, Km], this.textureArray = [];
  ...
  Gg = () => {
    ...
    return e.jsxs(K, {
      children: [e.jsx(zg, {}), e.jsx(GA, {
        ...
        children: [t === Vs.squad && e.jsx(Og, {}), t === Vs.user && e.jsx(Ng, {}), a !== m.fulfilled && o === 0 && e.jsx(Mg, {}), e.jsx(Xg, {
          selectedSection: t
        })]
      })]
    })
...
const ro = {
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Me.uploadTemplate({
              ...
              o(Xf(v)), o(io()), await b.mainImage.worldTemplate.add(v), o(U({
                id: performance.now(),
  ...
  KP = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(ao, {
        ...
        className: Gt.rating_main_info,
        children: [e.jsx("span", {
          className: Gt.rating_name,
        ...
        className: Gt.rating_value,
        children: [e.jsx("span", {
          children: s.pixanosCount
        }), e.jsx("img", {
          alt: "pixanos",
          src: Nt,
          className: Gt.pixanos_img
        })]
      })]
    })
  },
  ...
  lC = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [n === Se.create && e.jsx(G0, {}), n === Se.main && e.jsx(xP, {}), n === Se.result && e.jsx(LP, {}), n === Se.pixanos && e.jsx($P, {}), n === Se.finalRating && e.jsx(cC, {})]
    })
  },
...
const MI = () => {
  ...
  VI = "_body_11ui8_58",
  XI = "_content_11ui8_68",
  GI = "_image_container_11ui8_75",
  YI = "_image_11ui8_75",
...
const xB = () => {
  ...
  yB = ({
    ...
    const t = l(c => c.main.timeLimit),
      ...
      i = t;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Ac) && XE(), rB(), cB(), lB(), a || i ? e.jsx(aB, {}) : o ? e.jsx(iB, {}) : e.jsx(e.Fragment, {
      children: n
    })
  },
  vB = () => {
