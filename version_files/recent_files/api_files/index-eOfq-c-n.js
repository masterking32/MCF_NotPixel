...
var Zr = (t, n, s) => n in t ? Wr(t, n, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: s
}) : t[n] = s;
var Qn = (t, n, s) => Zr(t, typeof n != "symbol" ? n + "" : n, s);
import {
  j as e,
  r as m,
  R as te
...
const mc = "_stars_img_container_1wci0_1",
  pc = "_stars_img_1wci0_1",
  hc = "_scalebubble_1wci0_1",
  gc = "_squads_img_1wci0_17",
  _c = "_title_container_1wci0_22",
  fc = "_description_container_1wci0_28",
  xc = "_description_1wci0_28",
  ...
  Nc = "_not_active_1wci0_100",
  Ic = "_selected_1wci0_105",
  Cc = "_row_icon_container_1wci0_110",
  Pc = "_row_icon_1wci0_110",
  Sc = "_row_title_1wci0_133",
  Tc = "_row_amount_1wci0_143",
  Bc = "_row_price_container_1wci0_156",
  Ec = "_main_info_channel_users_1wci0_166",
  Ae = {
    stars_img_container: mc,
    stars_img: pc,
    scalebubble: hc,
    squads_img: gc,
    title_container: _c,
    description_container: fc,
    description: xc,
    info_layout: yc,
    info_container: vc,
    info_row: wc,
    ...
    not_active: Nc,
    selected: Ic,
    row_icon_container: Cc,
    row_icon: Pc,
    row_title: Sc,
    row_amount: Tc,
    row_price_container: Bc,
  ...
  Rc = ["/transaction/user/start", "/repaint/finish", "/transaction/user/complete", "/stars/shop/process", "/mining/status/claim", "/mining/claim", "/mining/status/error", "/repaint/complete", "/stars/shop/reject", "/squads/list/get", "/squads/list/update"],
  Ze = {
    my: "my",
    referred: "referred",
    world: "world"
...
const Fc = "/assets/icon_stars_new-Dk8ap_HZ.png",
...
const Jc = {
  ...
  Vn = Q("shop/getProducts", async () => (await W.getProducts()).data),
  Yn = Q("shop/useProduct", async ({
    pixelId: t,
    productId: n,
    color: s
  }) => (await W.useProduct({
  ...
  }),
  {
    ...
    showLimitedGoodsPopup: Zc,
    hideLimitedGoodsPopup: yR
  } = so.actions,
  Ha = t => t.shop.crypto,
  Kc = so.reducer,
  Gs = {
  ...
  jl = (t, n) => n < 5 ? Lt[1] : n < 10 ? Lt[5] : n < 100 ? Lt[10] : n < 500 ? Lt[100] : n < 1e3 ? Lt[500] : Lt[1e3],
  ui = {
    9: eo,
    10: to,
    11: no
  ...
  El = () => uo() ? Jn.VITE_ADSGRAM_BLOCK_ID : Tl() ? "4853" : "4995",
  _t = {
    isDev: Bl(),
    devServer: uo(),
  ...
  D = (t, n) => Math.floor(Math.random() * (n - t + 1) + t),
  rd = t => `${t.includes("@")?"":"@"}${t}`,
  pi = t => t.replace("@", ""),
  ...
  nn = async t => {
  ...
  }, ho = t => new Promise(n => setTimeout(n, t)), cd = t => {
  ...
  }, Ia = t => !0, Ad = "_layout_13e1w_1", md = "_container_13e1w_10", pd = "_star_13e1w_14", hd = "_move_13e1w_1", Fn = {
    layout: Ad,
    container: md,
    star: pd,
    move: hd
  }, gd = "_link_1fn8i_1", _d = "_telegram_icons_1fn8i_13", go = {
    link: gd,
    telegram_icons: _d
  }, N = ({
    children: t,
        ...
        children: t.map((s, a) => {
          ...
          return n === fe ? e.jsx(N, {
            ...
            style: {
              ...
              transform: `translate(${D(-80,-170)*(a%2===1?1:-1)}px, ${D(-100,100)}px)`
            },
            children: ""
          }, a) : e.jsx(Pn, {
            fontSize: i,
  ...
  }, () => !1), xd = "_layout_1nbfl_1", yd = "_button_1nbfl_14", hi = {
    layout: xd,
    button: yd
  }, vd = () => {
    const t = Z();
  ...
  }, wd = "_layout_gx8in_1", jd = "_container_gx8in_5", bd = "_item_gx8in_11", Nd = "_active_gx8in_20", Id = "_image_container_gx8in_24", Cd = "_image_gx8in_24", Pd = "_item_text_container_gx8in_34", Sd = "_item_text_gx8in_34", lt = {
    layout: wd,
    container: jd,
    item: bd,
    active: Nd,
  ...
  }, Wn = Q("user/getUserPixels", async ({
    offset: t,
    limit: n
  }) => (await W.getUserPixels({
    offset: t,
    limit: n
  })).data), Zn = Q("user/getPixelsForSaleTotal", async () => (await W.getUserPixelsCount()).data), Kn = Q("user/getUserPixelsSold", async ({
    offset: t,
    limit: n
  }, s) => (await W.getUserPixelsSold({
    offset: t,
    limit: n
  })).data), $n = Q("user/getUser", async (t, {
    rejectWithValue: n
  }) => {
    try {
  ...
  }, Ud = t => t.user.userPic, Oe = t => t.user.user, Od = _o.reducer, Et = {
    getPixelsForSale: Wn,
    ...
    return c(Oe), m.useEffect(() => {
      ...
      children: e.jsx("div", {
        ...
        children: n.map(i => {
          ...
          return e.jsxs("div", {
            className: U(lt.item, o ? lt.active : ""),
            onPointerUp: () => {
              t(jn(i.currency_id))
            },
            children: [e.jsx("div", {
    ...
    children: [e.jsx("div", {
      ...
      children: e.jsxs("button", {
        className: dn.button,
        onPointerUp: () => {
          ne("https://t.me/notpixel_channel")
        },
        children: [e.jsx("img", {
          alt: "tg_logo",
          src: Tn
    ...
    logo_container: du
  }, Au = "_layout_1cvcu_1", mu = "_container_1cvcu_10", pu = "_bubble_1cvcu_16", hu = "_move_1cvcu_1", ra = {
    layout: Au,
    container: mu,
    bubble: pu,
    move: hu
        ...
        children: n.map((s, a) => {
          ...
          return e.jsx("div", {
            ...
            style: {
              ...
              height: i,
              animationDelay: `-${a*300}ms`,
              transform: `translate3d(${D(-200,500)}px, ${D(-200,200)}px, ${D(0,33)}px)`,
              background: t()
            }
          }, a)
        })
  ...
  }, () => !1), _u = "_container_1aw3i_1", fu = "_logo_1aw3i_9", xu = "_animate_1aw3i_1", yu = "_center_1aw3i_18", vu = "_glow_1aw3i_28", Ln = {
    container: _u,
    logo: fu,
    animate: xu,
    center: yu,
    ...
    children: [e.jsx(gu, {
      color: () => `hsl(${D(0,360)} , 1000%, 50%)`
    }), e.jsx(wu, {})]
  }), bu = "_container_13oyr_1", Nu = "_button_13oyr_11", Iu = "_info_13oyr_32", gt = {
    container: bu,
    button: Nu,
    info: Iu
  };
...
const es = Q("mining/info", async () => (await qs.info()).data),
  ts = Q("mining/claim", async () => (await qs.claim()).data),
  ns = Q("mining/checkTask", async ({
    key: t
  }) => (await qs.checkTask({
    key: t
  })).data),
  ss = Q("mining/checkBoost", async ({
    key: t
  }) => (await qs.checkBoost({
    key: t
  })).data),
  ...
  Io = m.memo(({
    ...
    const [s, a] = m.useState(Vu()), [i, o] = m.useState(!1);
    return m.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  yA = "_row_reward_completed_bt2qf_158",
  vA = "_priceless_bt2qf_165",
  ...
  HA = () => {
    ...
    return m.useEffect(() => {
      var h;
      !o || d !== p.fulfilled || r && (i || (h = r == null ? void 0 : r.connectItems) != null && h.tonProof && !("error" in r.connectItems.tonProof) && W.checkTonProof(r.connectItems.tonProof.proof, r.account).then(_ => {
  ...
  XA = () => {
    ...
    return !t || !t.isPremium ? null : e.jsx(Y, {
      action: () => {
        ne("https://t.me/boost/notpixel_channel")
      },
      boost: n,
  ...
  WA = "_pixel_image_popup_265n2_1",
  ZA = "_pixel_image_text_container_265n2_8",
  KA = "_pixel_image_265n2_1",
  $A = "_pixel_copy_button_265n2_25",
  em = "_gray_265n2_35",
  dt = {
    pixel_image_popup: WA,
    pixel_image_text_container: ZA,
    pixel_image: KA,
    pixel_copy_button: $A,
    gray: em
  },
...
const vi = () => {
  ...
  dm = () => {
    ...
    }, []), !lm || h || s !== "mobile" || o === !1 ? null : e.jsxs(Y, {
      enableCheck: !1,
      action: () => {
        d === 0 && n.show().then(I => {
          t(Mt(j)), t(O({
  ...
  hm = () => {
    ...
    return t !== "en" ? null : e.jsx(Y, {
      action: () => {
        ne(`https://t.me/community_bot/join?startapp=id_${n}`)
      },
      boost: r,
      reward: d,
      children: e.jsxs("div", {
  ...
  xm = () => {
    ...
    return c(s => s.user.country), !fm && !n && !_t.isDev, null
  },
  ...
  Nm = () => {
    const t = y.frogApp,
      ...
      s = 512,
      a = Bn();
    return !bm && !n ? null : e.jsx(Y, {
      boost: t,
      action: () => {
        ne("https://t.me/frogfarmbot/frogfarm?startapp=291096007"), a("task_frogApp")
      },
      reward: s,
      children: e.jsxs("div", {
        className: A.content,
  ...
  Sm = () => {
    const t = y.tonPoker,
      ...
      i = 512,
      o = Bn();
    return !Pm && !n ? null : e.jsx(Y, {
      boost: t,
      action: () => {
        ne("https://t.me/tonpoker/lobby?startapp=eyJ0eXBlIjoibG9iYnkiLCJjaWQiOiJOb3RQaXhlbCIsImFmcCI6IlkyTmhOek14T1RGak1XTTFNR1prWXpOaFlXTmlOek5rTlRabU9UazFObVkifQ"), o("task_poker")
      },
      reward: i,
      children: e.jsxs("div", {
        className: A.content,
  ...
  km = () => {
    const t = y.solitaireGame,
      ...
      s = 512,
      a = Bn();
    return !Em && !n ? null : e.jsx(Y, {
      boost: t,
      action: () => {
        ne("https://t.me/MySolitaireGameBot/play?startapp=NotPixel"), a("task_solitaire")
      },
      reward: s,
      children: e.jsxs("div", {
        className: A.content,
  ...
  Um = () => {
    const t = y.tonDurakGame,
      ...
      s = 512,
      a = Bn();
    return !Mm && !n ? null : e.jsx(Y, {
      boost: t,
      action: () => {
        ne("https://t.me/TonDurakGameBot/PLAY?startapp=ee1811e8c20553f6758373a6fa8b79147e627addd678a57c94c51012872c910e"), a("task_durak")
      },
      reward: s,
      children: e.jsxs("div", {
        className: A.content,
  ...
  Qm = () => {
    ...
    return Om[r] ? e.jsx(Y, {
      action: () => {
        ne("https://t.me/community_bot/join?startapp=id_74434")
      },
      boost: s,
      reward: o,
      children: e.jsxs("div", {
  ...
  Lm = () => e.jsxs("div", {
    ...
    children: [e.jsx(dm, {}), e.jsx(Nm, {}), e.jsx(Sm, {}), e.jsx(km, {}), e.jsx(Um, {}), e.jsx(xm, {}), e.jsx(gm, {}), e.jsx(Qm, {}), e.jsx(hm, {}), e.jsx(SA, {}), e.jsx(da, {
      text: "Quick start"
    }), e.jsx(BA, {}), e.jsx(kA, {}), e.jsx(RA, {}), e.jsx(da, {
      text: "Special"
    }), e.jsx(HA, {}), e.jsx(Am, {}), e.jsx(pm, {}), e.jsx(am, {}), e.jsx(YA, {}), e.jsx(JA, {}), e.jsx(XA, {}), e.jsx(NA, {}), e.jsx(MA, {}), e.jsx(UA, {}), e.jsx(OA, {}), e.jsx(zA, {}), e.jsx(vm, {}), e.jsx(da, {
      text: "Browser"
    }), e.jsx(zm, {}), e.jsx(IA, {}), e.jsx(CA, {}), e.jsx(GA, {}), e.jsx(qA, {}), e.jsx(FA, {}), e.jsx("div", {
      style: {
        height: 30
      }
    })]
    ...
    return m.useEffect(() => {
      function a(i) {
        i.ctrlKey && i.altKey && i.keyCode === 67 && (async () => {
          try {
            await nn(window.Telegram.WebApp.initData), await t(O({
              id: performance.now(),
              text: "Copied!"
            }))
          } catch {
  ...
  np = "_pixelPriceValue_7jsmf_83",
  sp = "_pixelPriceDescription_7jsmf_91",
  ap = "_pixelState_7jsmf_95",
  ip = "_pixelDate_7jsmf_100",
  op = "_paginationContainer_7jsmf_107",
  rp = "_loadMoreButton_7jsmf_114",
  cp = "_noPixelsContainer_7jsmf_136",
  lp = "_noPixelsText_7jsmf_143",
  dp = "_pixelsForSaleCountText_7jsmf_149",
  up = "_skeleton_container_7jsmf_153",
  Ap = "_skeleton_header_7jsmf_157",
  mp = "_skeleton_row_7jsmf_166",
  ae = {
    container: qm,
    row: Xm,
    cell1: Vm,
    ...
    pixelCoords: tp,
    pixelPriceValue: np,
    pixelPriceDescription: sp,
    pixelState: ap,
    pixelDate: ip,
    paginationContainer: op,
    loadMoreButton: rp,
    noPixelsContainer: cp,
    noPixelsText: lp,
    pixelsForSaleCountText: dp,
    skeleton_container: up,
    skeleton_header: Ap,
    skeleton_row: mp
  },
  Ya = Bs.getSelectors(t => t.user.pixelsForSale);
Es.getSelectors(t => t.user.pixelsSold);
const Bo = ks.getSelectors(t => t.daily.list);
Xa.getSelectors(t => t.reward.list);
const Eo = xn.getSelectors(t => t.tournament.approvedTemplatesList),
  pp = () => {
    const t = c(s => s.user.pixelsForSaleFetchStatus);
    return c(Ya.selectTotal) === 0 && t === p.fulfilled ? e.jsx("div", {
      className: ae.noPixelsContainer,
      children: e.jsx("span", {
        className: ae.noPixelsText,
  ...
  _p = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
  Qe = t => {
    const n = new Date().getFullYear(),
      ...
      r = t.getHours(),
      l = t.getMinutes();
    return `${o<10?0:""}${o} ${[_p[i]]} ${a} at ${r<10?0:""}${r}:${l<10?0:""}${l}`
  },
  fp = ({
    date: t
  }) => e.jsx("div", {
    className: ae.pixelDate,
    children: Qe(new Date(t))
  }),
  xp = ({
    coords: t
  }) => e.jsxs("div", {
    className: ae.pixelCoords,
    children: [t.x, ", ", t.y]
  }),
  yp = ({
    color: t
  }) => e.jsx("div", {
    className: ae.pixelColor,
    style: {
      backgroundColor: t
    }
  }),
...
const Pa = Q("canvas/getPixelInfo", async ({
    id: t
  }) => (Jt !== null && (Jt.abort(), Jt = null), Jt = new AbortController, (await W.getPixelInfo({
    id: t,
    signal: Jt.signal
  })).data)),
  is = Q("canvas/getPrices", async () => (await W.getPrices()).data),
  os = Q("canvas/getPriceMask", async ({
    price: t
  }) => {
  ...
  jp = () => qa() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  bp = {
    coords: null,
    animations: jp(),
    stats: null,
...
let Xp = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [kp, Dp, Rp, Mp, Up, Op, Qp, Fp, zp, Lp, Hp, Gp, qp], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
  ...
  boom({
    ...
    a.loop = !1, a.animationSpeed = .17, a.zIndex = 2, a.x = n, a.y = s, a.scale.set(D(1, 2) === 1 ? 1 : -1, 1), a.anchor.set(.48, .55), this.pixiViewport.addChild(a), a.play(), a.onComplete = () => {
      this.pixiViewport.removeChild(a)
    }
  }
};
const Vp = "_order_panel_dvy5p_1",
  Yp = "_content_dvy5p_13",
  Jp = "_fast_mode_blocker_dvy5p_26",
  Wp = "_info_dvy5p_39",
  Zp = "_active_color_dvy5p_48",
  Kp = "_pixel_info_container_dvy5p_58",
  $p = "_pixel_info_color_dvy5p_66",
  eh = "_pixel_info_text_dvy5p_72",
  th = "_info_button_dvy5p_78",
  nh = "_info_button_active_dvy5p_95",
  sh = "_price_value_dvy5p_99",
  ah = "_pixel_locked_text_dvy5p_105",
  ih = "_pixel_locked_text_painted_dvy5p_116",
  oh = "_pixel_locked_animation_dvy5p_138",
  rh = "_button_dvy5p_144",
  ch = "_button_text_dvy5p_168",
  lh = "_flash_mode_button_text_dvy5p_181",
  dh = "_not_pixel_icon_dvy5p_192",
  uh = "_tg_logo_dvy5p_196",
  Ah = "_image_dvy5p_201",
  mh = "_inner_wrapper_button_dvy5p_206",
  re = {
    order_panel: Vp,
    content: Yp,
    ...
    info: Wp,
    active_color: Zp,
    pixel_info_container: Kp,
    pixel_info_color: $p,
    pixel_info_text: eh,
    info_button: th,
    info_button_active: nh,
    price_value: sh,
    pixel_locked_text: ah,
...
const sn = Oo,
  ...
  Fo = t => t ? t.friends >= Uc.friendsForTemplateCreation || t.isContractor : !1,
  Be = {
    create: "create",
    main: "main",
    result: "result"
...
const rs = Q("tournament/getPeriods", async () => (await zo.getPeriods()).data),
  cs = Q("tournament/getResults", async () => (await zo.getResults()).data),
  ls = Q("tournament/getMyTemplate", async ({
    id: t
  }) => (await Pe.getTournamentTemplateById({
    id: t
  })).data),
  ds = Q("tournament/getSelectedTemplate", async () => (await Pe.getSelectedTemplate()).data),
  us = Q("tournament/getApprovedTemplatesList", async ({
    offset: t,
    limit: n
  ...
  As = Q("tournament/getRandomTemplatesList", async () => (await Pe.getRandomTemplates()).data),
  ms = Q("tournament/selectTemplate", async ({
    id: t
  ...
  }),
  {
    ...
    setShowRoundRewardsPopup: Go,
    changeTemplateCoordsIfNeeded: qo,
    setMyTournamentTemplate: ER,
    clearApprovedTemplateList: Xo,
    showTournamentTemplateInfoPopup: Ka,
    closeTournamentTemplateInfoPopup: ma,
    setSelectedTemplate: Vo
  } = Lo.actions,
  Me = {
    getMyTemplate: ls,
...
const Sh = (t, n) => {
    ...
    Ia() && (s = {
    ...
    }), st = new rc(za.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), st.on("connected", function(a) {
      ...
      o.src = URL.createObjectURL(i), o.onload = () => {
        v.mainImage.loadFromCentrifuge(o).then(() => {
          ...
          }), v.mainImage.selectedPixel.draw(l), tt.dispatch(kt(l)))
        })
      }
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          ...
          if (r.type === sa.pixanos && tt.dispatch(Dh(l)), l.user.userId === n || !Nn) return;
      ...
      cc(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === Ch[1] && tt.getState().daily.list.entities[d.good_id]) {
  ...
  }),
  {
    ...
    setShowIntro: DR,
    setShowBetaTestIntro: RR,
    addFlyingReward: Mh,
    removeFlyingReward: Uh,
    showInviteFrensPopup: MR,
    hideInviteFrensPopup: pa,
    showNoChargesPopup: UR,
    hideNoChargesPopup: ha,
    setLastShowChargesPopupTs: OR,
    setShowMiningDetailsPopup: Ko,
    setShowBoostDetailsPopup: $a,
    setActiveBoostDetails: Oh,
    addItemToUserAndSquadPopupStack: kn,
    removeItemFromUserAndSquadPopupStack: $o,
...
const Tg = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(Ls(10)), t(ot(1)), t(rt()), t(Zo()), !1;
  if (s === a) return !1;
  ...
  try {
    (await t(Gs.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === p.fulfilled && (t(Eu(a)), t(Hs({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: Tt
} = sr.actions, ar = t => t.layout.isShowSideMenu, kg = sr.reducer;
let Gt = null,
  qt = null;
class ir {
...
const ps = Q("ratings/personal", async ({
    league: t
  }) => (await ir.personal({
    league: t
  })).data),
  hs = Q("ratings/squad", async ({
    league: t
  }) => (await ir.squad({
    league: t
  })).data),
...
wt.startListening({
  ...
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Ed(t.payload.totalUserPixels)), n.dispatch(xo(t.payload.userBalance))), n.dispatch(Wc(t.payload.goods))
  }
});
wt.startListening({
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === me.energyLimit) {
        ...
        n.dispatch(Tu(s.mining.maxCharges + d)), n.dispatch(bo(d))
      }
...
lr.startListening({
  ...
  effect: (t, n) => {
    n.dispatch(rr(t.payload.data.league))
  }
});
const Rn = tn();
Rn.startListening({
...
const Fg = ur.reducer,
  ...
  zg = "/assets/halloween2-l9FmXxVI.png",
  Lg = Q("template/subscribe", async ({
    id: t
  }) => (await Pe.subscribeToTemplate({
    id: t
  })).data),
  fs = Q("template/getTemplateList", async ({
    offset: t,
    limit: n
  ...
  Hg = Q("template/getAvailableSizes", async ({
    userId: t
  }) => (await Pe.getAvailableSizes({
    userId: t
  })).data),
  xs = Q("template/getReferredTemplate", async () => (await Pe.getReferredTemplate()).data),
  Ea = Q("template/getMyTemplate", async ({
    id: t
  }) => (await Pe.getTemplateById({
    id: t
  })).data),
  ys = Q("template/getWorldTemplate", async () => ({
    x: (T.width - 256) / 2,
    y: (T.height - 256) / 2,
    imageSize: 256,
    url: zg,
  ...
  {
    setActiveTemplate: QR,
    setActiveTemplateTab: Ni,
    hideTemplates: mr,
    setTemplateOpacity: qg,
    setReferredTemplate: Xg,
    setMyTemplate: Vg,
    setTemplateListOffset: FR,
    clearTemplatesListData: Yg,
    setShowTemplateDetailsPopup: pr,
  ...
  vs = Q("daily/getList", async () => (await W.getDailyList()).data),
  ws = Q("daily/getFirstDaily", async () => (await W.getFirstDaily()).data),
  hr = pe({
    name: "daily",
    initialState: Wg,
    reducers: {
  ...
  Zg = t => {
    ...
    return Bo.selectById(t, n)
  },
  {
    setSelectedDaily: Kg,
    updateOneDaily: zR,
    setShowHowDailyWorksPopup: gr
  } = hr.actions,
  $g = hr.reducer,
  e_ = {
    getList: vs,
  ...
  js = Q("reward/getList", async ({
    userId: t
  }) => (await W.getRewards({
    userId: t
  })).data),
  _a = Q("reward/getById", async ({
    rewardId: t
...
rn.startListening({
  matcher: he(Me.getSelectedTemplate.fulfilled, Vo),
  effect: (t, n) => {
    const s = n.getState();
...
const Mn = $r({
    ...
    devTools: !1,
    middleware: t => [Rn.middleware, lr.middleware, Js.middleware, wt.middleware, dr.middleware, rn.middleware, ...t()]
  }),
  bs = [],
  l_ = async ({
    dispatch: t,
    ...
    await t(Mh({
      ...
      id: it(s),
      color: St(a)
    }), v.mainImage.updateTexture(), await t(hh(a)), await t(Cp(s)), await t(Du());
    try {
      ...
      d && d.balance && (t(xo(d.balance)), d.reward_user && d.reward_user.reward_id && (v.mainImage.reward.add(s), t(n_({
    ...
    n(Vs()), t && t.push("/energy-over"), n(kt(s)), v.mainImage.selectedPixel.draw(s)
  }, fr = async ({
    history: t,
    charges: n,
    dispatch: s,
...
let F_ = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [y_, v_, w_, j_, b_, N_, I_, C_, P_, S_, T_, B_, E_, k_, D_, R_, M_, U_, O_, Q_], this.textureArray = [];
...
function ef() {
  v = new $_({
    readyCallback: t => {
      Sh(t.getState().user.user.websocketToken, t.getState().user.user.id)
    }
  })
}
const tf = m.memo(() => (m.useEffect(() => {
  ...
  sf = ({
    ...
    children: [e.jsxs(ko, {
      ...
      children: e.jsx("div", {
        className: `${ae.icon_arrow} telegram_icons`,
        children: ""
      })
    })]
  }),
  af = () => c(Ya.selectAll).map(n => e.jsx(sf, {
    item: n
  }, it({
    x: n.x,
    y: n.y
  ...
  of = () => {
    ...
    return n + s >= a ? null : e.jsx("button", {
      className: `${ae.row} ${ae.loadMoreButton}`,
      onPointerUp: () => {
        t(fo({
          offset: n + s
        }))
  ...
  rf = () => e.jsxs("div", {
    className: ae.skeleton_container,
    children: [e.jsx("div", {
      className: `${ae.header} ${ae.skeleton_header}`
    }), e.jsx("div", {
      className: ae.data,
      children: e.jsx("div", {
        className: `${ae.skeleton_row}`
      })
    })]
  }),
  cf = () => {
    const t = c(Ya.selectTotal);
    return c(s => s.user.pixelsForSaleFetchStatus) === p.pending && t === 0 ? e.jsx(rf, {}) : t !== 0 ? e.jsxs(gp, {
      children: [e.jsx(af, {}), e.jsx(of, {})]
    }) : null
  },
  lf = () => {
    const t = g();
    return Gm(), m.useEffect(() => () => {
      t(Dd()), t(fo({
        offset: 0
      })), t(kd({
        status: p.idle
  ...
  kf = "_description_1_1e12r_19",
  Df = "_description_2_1e12r_27",
  Rf = "_description_container_1e12r_35",
  Mf = "_image_container_1e12r_47",
  Uf = "_image_1e12r_47",
  Of = "_buttons_container_1e12r_59",
  Qf = "_button_1e12r_59",
  ...
  ce = {
    ...
    description_1: kf,
    description_2: Df,
    description_container: Rf,
    image_container: Mf,
    image: Uf,
    buttons_container: Of,
    button: Qf,
    cancel_button: Ff,
    loading: zf
  },
  ...
  qf = () => {
    ...
    return e.jsxs(Ut, {
      show: n,
      setShow: a,
      children: [s === me.paintReward && e.jsx(Lf, {}), s === me.reChargeSpeed && e.jsx(Hf, {}), s === me.energyLimit && e.jsx(Gf, {})]
    })
  },
  Xf = () => e.jsxs("div", {
    className: Ns.layout,
    children: [e.jsxs(pf, {
      title: "Boosters",
      children: [e.jsx(Pf, {}), e.jsx(Sf, {}), e.jsx(Tf, {})]
    }), e.jsx(qf, {}), e.jsx("div", {
      style: {
        height: "20px"
      }
  ...
  Vf = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(Hm, {}), t === "tasks" && e.jsx(Lm, {}), t === "pixels" && e.jsx(lf, {}), t === "boosts" && e.jsx(Xf, {})]
    })
  },
  Yf = () => {
    const t = g(),
  ...
  Jf = () => e.jsxs(te.Fragment, {
    children: [e.jsx(Yf, {}), e.jsx(Vf, {})]
  }),
  Wf = "_more_details_6gp7h_1",
  Zf = {
    more_details: Wf
  },
  cn = ({
  ...
  Kf = "_container_11l5m_1",
  $f = "_divider_11l5m_23",
  ex = "_row_11l5m_28",
  tx = "_row_title_11l5m_40",
  nx = "_row_title_main_11l5m_44",
  sx = "_row_hint_11l5m_49",
  ax = "_row_value_11l5m_55",
  ix = "_row_value_main_11l5m_59",
  ox = "_mining_percent_11l5m_64",
  ...
  Xx = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(qx, {}), n.map((i, o) => e.jsx(Gx, {
        item: i,
        index: o
      }, o))]
    })
  ...
  $x = () => {
    ...
    return c(s => s.ratings.status) !== p.fulfilled ? null : t.map((s, a) => e.jsx(Kx, {
      item: s,
      index: a
    }, a))
  },
  ey = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(Wx, {}), e.jsx(Zx, {}), e.jsx($x, {})]
    })
  },
  ty = () => e.jsx(te.Fragment, {
  ...
  iy = () => (c(t => t.ratings.league), c(yo), c(er), e.jsx("div", {
    className: sy.container,
    children: e.jsx(ay, {})
  })),
  oy = "_container_d5ybi_1",
  ry = {
    container: oy
  },
  cy = () => {
  ...
  ly = "/assets/icon_squad-_NF17RUb.gif",
  dy = "/assets/icon_squad_secret-B-fF264Z.gif",
  uy = () => {
  ...
  Ay = () => {
    ...
    return e.jsxs(le, {
      children: [e.jsx(uy, {}), e.jsx(Hx, {
        selectedSection: t,
        setSelectedSection: n
      }), e.jsx(Jx, {}), e.jsx(Qx, {
        isPlayers: t === "Painters"
      }), e.jsxs(Yx, {
        children: [t === "Painters" && e.jsx(iy, {}), t === "Squads" && e.jsx(cy, {}), t === "Squads" && e.jsx(ey, {}), t === "Painters" && e.jsx(Xx, {}), s !== p.fulfilled && e.jsx(ty, {})]
      })]
    })
  },
  my = ({
  ...
  _y = "_expandable_panel_1v9vd_1",
  fy = "_divider_1v9vd_16",
  xy = "_divider_spacer_1v9vd_24",
  yy = "_divider_pointer_1v9vd_28",
  vn = {
  ...
  jy = "_container_1vu8i_1",
  by = "_owner_1vu8i_10",
  Ny = "_id_1vu8i_14",
  Iy = "_date_1vu8i_19",
  Cy = "_avatar_container_1vu8i_24",
  Py = "_avatar_1vu8i_24",
  Sy = "_squad_avatar_container_1vu8i_36",
  Ty = "_text_container_1vu8i_48",
  By = "_dot_1vu8i_54",
  Ey = "_user_name_1vu8i_59",
  ...
  Un = ({
    ...
    return n > 0 && (i = Sn(i, n)), e.jsx("span", {
      className: go.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ne(`https://t.me/${pi(t)}`) : Rt(`https://t.me/${pi(t)}`)
      },
      children: i
    })
  },
  ...
  Ly = () => e.jsxs("div", {
    ...
    children: [e.jsx(zy, {}), e.jsx(Uy, {}), e.jsx(Fy, {}), e.jsx(Oy, {}), e.jsx(Qy, {})]
  }),
  Hy = "_category_text_epppt_1",
  Gy = "_latest_used_container_epppt_8",
  qy = "_color_line_epppt_15",
  Xy = "_color_item_epppt_22",
  Vy = "_pipette_container_epppt_30",
  Yy = "_child_scale_epppt_48",
  Nr = {
    category_text: Hy,
    latest_used_container: Gy,
    color_line: qy,
    color_item: Xy,
  ...
  Wy = ({
    ...
    className: Nr.color_line,
    children: t.map((n, s) => e.jsx(Jy, {
      color: n
    }, `${n}_${s}`))
  }),
  Zy = "_unlock_button_fc8qr_1",
  Ky = "_stars_text_fc8qr_13",
  Pi = {
    unlock_button: Zy,
    stars_text: Ky
  },
  ...
  nv = ({
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(tv, {
        ...
        children: [e.jsx(vy, {
          active: s
        }), s === 1 && e.jsx(ev, {}), s === 2 && e.jsx(Ly, {})]
      })]
    })
  },
  sv = () => c(Fe) ? null : e.jsxs("button", {
    className: re.button,
    onPointerUp: () => {
      ne("https://t.me/notpixel")
    },
    children: [e.jsx("img", {
      alt: "tg_logo",
  ...
  cv = () => c(n => n.canvas.coords) === null ? null : e.jsx(te.Fragment, {
    children: e.jsx(rv, {})
  }),
  lv = "_layout_14eqc_1",
  ...
  fv = () => e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [e.jsx(hv, {}), e.jsx(_v, {})]
    })
  }),
  xv = () => null,
  yv = "_layout_14a3l_1",
  vv = "_container_14a3l_11",
  wv = "_image_14a3l_26",
  jv = "_text_14a3l_31",
  bv = "_gold_14a3l_37",
  ...
  Uv = ({
    ...
    return m.useEffect(() => {
      ...
      children: [Mv[t.repaintRewardType], " ", e.jsx("img", {
        alt: "img",
        className: Rs.image,
        src: li
      })]
  ...
  Lv = "_layout_1v16g_1",
  Hv = "_container_1v16g_5",
  Gv = "_close_button_1v16g_14",
  qv = "_title_container_1v16g_22",
  Xv = "_image_container_1v16g_28",
  Vv = "_image_1v16g_28",
  Yv = "_first_image_1v16g_45",
  Jv = "_second_image_1v16g_50",
  Wv = "_text_container_1v16g_55",
  Zv = "_button_container_1v16g_60",
  Kv = "_button_1v16g_60",
  Se = {
    layout: Lv,
    container: Hv,
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsxs("button", {
              className: Se.button,
              onPointerUp: () => {
                s !== null && ne(`https://t.me/${Bt}?startapp=${btoa(`id=${s.id}`)}`)
              },
  ...
  sw = "_layout_srn55_1",
  aw = "_container_srn55_12",
  iw = "_buttons_container_srn55_18",
  ya = {
    layout: sw,
    container: aw,
    buttons_container: iw
  },
  ow = "_container_srbwq_1",
  rw = {
    container: ow
  },
  cw = ({
  ...
  dw = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(cw, {
        ...
        max: Ei,
        onChange: o => {
          n(qg(o)), v.mainImage.worldTemplate.setOpacity(Number(o[0])), v.mainImage.tournamentTemplates.setOpacity(Number(o[0]))
        },
        renderTrack: ({
          props: o,
          children: r
  ...
  uw = () => c(n => n.tournament.activeTournamentTemplate) === null ? null : e.jsx("div", {
    className: rw.container,
    children: e.jsx(dw, {})
  }),
  Aw = "_button_14giw_2",
  mw = "_image_14giw_22",
  pw = "_enabled_14giw_29",
  hw = "_animation_14giw_33",
  gw = "_scaleInfinity_14giw_1",
  _w = "_gray_14giw_38",
  fw = "_indicator_14giw_42",
  pt = {
    button: Aw,
    image: mw,
    enabled: pw,
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(xw, {}), e.jsx(yw, {}), e.jsx(uw, {})]
        })
      })
    })
  }),
  ...
  Cw = () => c(n => n.canvas.coords) === null ? null : e.jsx("div", {
    className: ki.layout,
    children: e.jsxs("div", {
      className: ki.container + " " + C.container__bottom,
      children: [e.jsx(x_, {}), e.jsx(g_, {}), e.jsx(H_, {}), e.jsx(Bg, {}), e.jsx(bw, {}), e.jsx(Nw, {}), e.jsx(Iw, {})]
    })
  }),
  Pw = "_layout_swx97_1",
  Sw = {
  ...
  Tw = () => e.jsxs("div", {
    className: Sw.layout,
    children: [e.jsx(Cw, {}), e.jsx(cv, {})]
  }),
  Bw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(Sv, {}), e.jsx(Av, {}), e.jsx(vw, {}), e.jsx(fv, {}), e.jsx(Tw, {}), e.jsx(zv, {}), e.jsx(Ov, {}), e.jsx(nw, {}), e.jsx(Tv, {}), e.jsx(xv, {})]
  }),
  Ew = "_page_title_13ybj_1",
  kw = "_container_13ybj_9",
  Dw = "_item_13ybj_13",
  Rw = "_active_13ybj_18",
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx(Qt, {
            ...
            className: E.button,
            onPointerUp: d => {
              d.stopPropagation(), ne(`https://t.me/share/url?url=${a}`)
            },
            children: "Share"
          })]
        })]
  ...
  E1 = ({
    ...
    const I = async () => {
      try {
        const f = a.prices[0],
          b = await W.startShopTransaction({
            buyerWallet: l,
            currencyId: 2,
            daily: !0,
            quantity: f.quantity,
    ...
    if (r) {
      ...
      return t && (b = `Claim in ${dd(t)}`), h && (b = "Pending transaction..."), e.jsxs("div", {
        className: R.content,
        children: [e.jsx("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("div", {
            ...
            children: n.map((o, r) => {
              ...
              let j = k1;
              return r >= 8 && r <= 15 && (j = D1), r >= 16 && r <= 23 && (j = R1), r >= 24 && r <= 31 && (j = M1), e.jsxs("div", {
                className: u.join(" "),
                onPointerUp: () => {
                  t(O({
                    id: performance.now(),
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx("div", {
        ...
        children: o.map(r => {
          ...
          const l = [se.template_size_item];
          return t === r && l.push(se.template_size_item_active), e.jsx("div", {
            className: l.join(" "),
            onPointerUp: () => {
              i >= Ms[r] || a.isContractor ? n(r) : s(O({
                id: performance.now(),
    ...
    return m.useEffect(() => (t(Dt.getList({
      ...
      children: [e.jsx("div", {
        ...
        children: a.map(o => {
          ...
          let r = !1;
          return i !== null && Number(i.id) === Number(o.templateId) && (r = !0), e.jsx(Cr, {
            item: o,
            current: r
          }, o.templateId)
        })
  ...
  W0 = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === "my" && e.jsx(H0, {}), t === "catalog" && e.jsx(J0, {})]
    })
  },
  Z0 = () => {
    const t = g(),
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Dt.subscribe({
              ...
              t(Xg(h)), v.mainImage.worldTemplate.deleteTemplate(o.id), v.mainImage.worldTemplate.add(h), t(mr())
            } else await t(O({
              id: performance.now(),
  ...
  uI = ({
    ...
    className: U(Nt.container, t ? "" : Nt.not_completed),
    children: [e.jsx("div", {
  ...
  Ma = ({
    ...
    return e.jsxs("div", {
      className: U(L.container, !t && L.page),
  ...
  SI = () => {
    const t = g(),
      n = c(Oe);
    return m.useEffect(() => (n && n.id && t(r_.getListByUserId({
      userId: n.id
    })), () => {
      t(a_())
    }), [n]), e.jsx(le, {
  ...
  kr = ({
    ...
    return n ? s !== null && s.squad.id !== null && s.squad.id === t.squad.id ? e.jsxs("div", {
      ...
      onPointerUp: () => {
        ne(`https://t.me/${Bt}?startapp=${btoa(`id=${t.squad.id}`)}`)
      },
      children: [e.jsx("span", {
        className: B.gray,
        children: "Your Squad."
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Pe.uploadTemplate({
              ...
              const j = await i(Dt.getTemplateById({
                  id: l.id
                })),
                I = {
                  ...j.payload,
              ...
              i(Vg(I)), i(mr()), await v.mainImage.worldTemplate.add(I), i(O({
                id: performance.now(),
  ...
  pC = ({
    ...
    className: se.template_coords,
    children: [e.jsx("div", {
      className: se.template_coordinates_title,
      children: "Input template coordinates:"
    }), e.jsxs("div", {
      className: se.template_coords_container,
      children: [e.jsxs("div", {
        className: se.coords_item,
        children: [e.jsx("span", {
          children: "x:"
        }), e.jsx("input", {
          type: "text",
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const j = async () => {
          ...
          AC(we), f.putImageData(we, 0, 0), a(we), o(I.toDataURL())
        };
        setTimeout(() => {
          j().then(() => {
            _(!1)
      ...
      children: [n && e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("img", {
            ...
            className: U(ee.image_status, ee.image_status_review),
            children: "On review"
          }), s === Vt.rejected && e.jsx("div", {
            className: U(ee.image_status, ee.image_status_rejected),
            children: "Rejected"
          }), s === Vt.approved && e.jsx("div", {
            className: U(ee.image_status, ee.image_status_approved),
            children: "Approved"
          })]
        })
      }), e.jsx("div", {
    ...
    return m.useEffect(() => {
      if (s !== null) {
        ...
        const f = async () => {
          ...
          BC(ln), H.putImageData(ln, 0, 0), o(ln), l(b.toDataURL())
        };
        setTimeout(() => {
          f().then(() => {
            I(!1)
  ...
  yP = "_template_item_rejected_1c93x_43",
  ...
  CP = () => {
    const t = g(),
      ...
      a = c(Eo.selectAll);
    return m.useEffect(() => (t(Me.getApprovedList({
      offset: n,
      limit: s
    })), () => {
      t(Xo())
  ...
  TP = () => {
    ...
    return m.useEffect(() => (t(Me.getRandomList()), () => {
      t(Xo())
    }), []), e.jsxs("div", {
      className: We.layout,
      children: [e.jsxs("div", {
        className: We.container,
        children: [e.jsx(SP, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(di, {
          item: i
        }, i.id))]
      }), e.jsx(PP, {})]
    })
  ...
  YP = "_round_status_fail_la5q2_60",
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          className: U(F.round_status_success, F.success),
          children: I
        }), !_ && e.jsx("div", {
          className: U(F.round_status_fail, F.fail),
          children: f
        })]
      }), e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsxs("div", {
            className: U(F.round_line),
            children: [e.jsx("div", {
              className: U(F.gray),
              children: "Template rank:"
            }), e.jsxs("div", {
              className: U(u ? F.success : F.fail),
              children: ["👑 ", l]
            })]
          }), e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: U(o ? F.success : F.fail),
              children: t.rank
            })]
          }), e.jsxs("div", {
            className: F.round_line,
  ...
  lS = () => {
    ...
    return t ? e.jsxs(te.Fragment, {
      ...
      }), t.map(s => n && n === s.round_id ? null : e.jsx(Ur, {
        result: s
      }, s.round_id))]
    }) : null
  },
  ...
  uS = () => {
    ...
    return t ? null : e.jsxs("div", {
      className: U(F.round_container, F.not_active_round_instruction),
      children: [e.jsxs("span", {
        className: F.round_title_text,
  ...
  mS = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === Be.create && e.jsx(uP, {}), t === Be.main && e.jsx(QP, {}), t === Be.result && e.jsx(AS, {})]
    })
  },
  pS = () => e.jsxs(te.Fragment, {
    children: [e.jsx(vh, {}), e.jsx(mS, {})]
  }),
      ...
      onPointerUp: async () => {
        try {
          ...
          (await a(Me.selectTemplate({
            id: t.id
          }))).meta.requestStatus === p.fulfilled && a(Vo(t))
        } catch (r) {
        ...
        children: t.map((n, s) => {
          ...
          return e.jsx(WS, {
            ...
            style: {
              ...
              transform: `translate(${D(-80,-170)*(s%2===1?1:-1)}px, ${D(-100,100)}px)`
            }
          }, s)
        })
      })
  ...
  k2 = "_wrong_helper_text_qn09x_124",
  ...
  H2 = () => {
    ...
    return m.useEffect(() => {
      ...
      (async () => {
        const H = await W.getSecretStats();
...
const bT = () => {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Qt, {
            ...
            className: k.button,
            onPointerUp: l => {
              l.stopPropagation(), ne(`https://t.me/share/url?url=${i}`), t(pa())
            },
            children: "Share"
          })]
        })]
  ...
  AB = "_crypto_button_container_19qal_118",
  mB = "_error_19qal_132",
  ...
  yB = "_tokens_container_19qal_192",
  ...
  EB = ({
    ...
    const H = async X => {
      ...
      const we = new na.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        ...
        qr = Ve.Address.parse(f),
        Xr = Ve.Address.parse(Na),
        Vr = Ve.beginCell().storeUint(0, 32).storeStringTail(X.txMemCode).endCell();
      let ea = Ve.toNano(X.strAmount);
      Number(i) === 4 && (ea = ea / 1000n);
      const Yr = Ve.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(ea).storeAddress(Xr).storeAddress(qr).storeBit(0).storeCoins(Ve.toNano("0.01")).storeBit(1).storeRef(Vr).endCell(),
        Jr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
      ...
      await h.sendTransaction(Jr), n(!0), u(!0), l(p.fulfilled)
    };
  ...
  UB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(SB, {}), e.jsx(MB, {}), e.jsx(Io, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: J.error,
...
async function hE() {
  w.enable(w.BLEND), w.blendFunc(w.SRC_ALPHA, w.ONE_MINUS_SRC_ALPHA), w.clearColor(0, 0, 0, 0), w.viewport(0, 0, w.canvas.width, w.canvas.height), Ie = await gE(w), w.useProgram(Ie)
}
...
async function _E(t) {
  fE(), vE(t), Lr(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function vE(t) {
  ...
  Is = l * l, nt(w, Ie, "u_AnimationDuration", zr), nt(w, Ie, "u_ParticleSize", AE), nt(w, Ie, "u_ViewportWidth", n), nt(w, Ie, "u_ViewportHeight", s), nt(w, Ie, "u_TextureWidth", a), nt(w, Ie, "u_TextureHeight", i), nt(w, Ie, "u_TextureLeft", o), nt(w, Ie, "u_TextureTop", r);
...
function wE(t) {
  ...
  nt(w, Ie, "u_ElapsedTime", s), w.drawArrays(w.POINTS, 0, Is), Lr()
}
...
const jE = () => {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                ...
                t.push("/"), n(Rh()), v.mainImage.pixanosRepaint(a.info.seed, T.width, a.info.percentage, a.info.color), (l = (r = window.Telegram.WebApp) == null ? void 0 : r.HapticFeedback) == null || l.notificationOccurred("error")
              },
              children: "Whoosh!"
            })
          })]
  ...
  FE = ({
    ...
    const n = t ? "Squad" : "My Squad",
      s = bt(t);
    return e.jsxs("div", {
      className: U(B.container, !t && B.page),
      children: [t && e.jsx(Sr, {}), e.jsx("div", {
        children: e.jsx("span", {
          className: B.title,
          children: n
    ...
    return e.jsx(qe, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === He.userFromPixelInfo && e.jsx(Ma, {
          ...
          isPopupContent: s
        }), n.dataSource === He.squadFromData && e.jsx(FE, {})]
      })
    })
  },
  LE = "_overlay_1vl8z_1",
  ...
  ek = "_menu_list_text_1vl8z_109",
  tk = "_menu_list_new_item_1vl8z_113",
  nk = "_button_wrapper_1vl8z_136",
  sk = "_button_content_1vl8z_145",
  ak = "_footer_1vl8z_152",
  ik = "_avatar_1vl8z_158",
  ok = "_ratings_image_container_1vl8z_165",
  rk = "_ratings_image_1vl8z_165",
  V = {
    overlay: LE,
    top_container: HE,
    bottom_container: GE,
    ...
    menu_list_li: $E,
    menu_list_text: ek,
    menu_list_new_item: tk,
    button_wrapper: nk,
    button_content: sk,
    footer: ak,
    avatar: ik,
    ratings_image_container: ok,
    ratings_image: rk
  },
  qi = [.215, .61, .355, 1],
  ck = {
  ...
  _k = "_layout_eiymv_1",
  fk = "_container_eiymv_7",
  Yi = {
    layout: _k,
    container: fk
  },
  xk = () => localStorage.getItem("canvasFps") ? [Number(localStorage.getItem("canvasFps"))] : [60],
  yk = () => {
    const [t, n] = te.useState(xk());
    return m.useEffect(() => {
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(wn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(bk, {}), e.jsx(yk, {}), e.jsxs("div", {
...
m.memo(({
  ...
  const [s, a] = m.useState(kk()), [i, o] = m.useState(!1);
  return m.useEffect(() => {
    t && setTimeout(() => {
      o(!0), setTimeout(() => {
        n(!1), o(!1)
...
const Dk = "_container_gb8eq_1",
  Rk = "_header_gb8eq_11",
  Mk = "_title_gb8eq_17",
  Uk = "_close_container_gb8eq_23",
  Ok = "_close_gb8eq_23",
  Qk = "_body_gb8eq_47",
  Fk = "_content_gb8eq_59",
  zk = "_time_left_container_gb8eq_65",
  Lk = "_timer_gb8eq_69",
  Hk = "_image_container_gb8eq_73",
  Gk = "_image_gb8eq_73",
  qk = "_glow_container_gb8eq_91",
  Xk = "_glow_gb8eq_91",
  Vk = "_rotate_gb8eq_1",
  Yk = "_glow_reverse_gb8eq_107",
  Jk = "_description_container_gb8eq_113",
  Wk = "_bold_gb8eq_123",
  Zk = "_gray_gb8eq_128",
  Kk = "_center_gb8eq_132",
  $k = "_gold_gb8eq_136",
  eD = "_button_gb8eq_144",
  ge = {
    container: Dk,
    header: Rk,
    title: Mk,
  ...
  tD = "/assets/cup_glad-DGT2PBmm.png",
  nD = () => {
    const t = Z(),
      n = c(Oe),
      [s, a] = m.useState(!1),
      i = "showCreateTournamentTemplatePopup";
    return m.useEffect(() => (qa() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(qe, {
      show: s,
      children: e.jsx("div", {
  ...
  sD = "_layout_xga4i_1",
  aD = "_container_xga4i_14",
  iD = "_header_xga4i_20",
  oD = "_close_xga4i_25",
  rD = "_body_xga4i_38",
  cD = "_image_container_xga4i_42",
  lD = "_image_xga4i_42",
  dD = "_glow_xga4i_55",
  uD = "_forward_xga4i_62",
  AD = "_rotate_xga4i_1",
  mD = "_reverse_xga4i_66",
  pD = "_text_container_xga4i_70",
  hD = "_title_xga4i_78",
  gD = "_description_xga4i_82",
  _D = "_footer_xga4i_86",
  fD = "_button_xga4i_90",
  _e = {
    layout: sD,
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(jD, {}), e.jsx("img", {
                alt: "glow",
                src: Da,
                className: U(_e.glow, _e.forward)
              }), e.jsx("img", {
                alt: "glow",
                src: Da,
                className: U(_e.glow, _e.reverse)
              }), e.jsx("img", {
                alt: "img",
                src: n ? n.image_url : "",
                className: _e.image
...
const ND = "_layout_15tw0_1",
  ID = "_container_15tw0_7",
  CD = "_close_button_15tw0_16",
  PD = "_title_container_15tw0_24",
  SD = "_image_container_15tw0_31",
  TD = "_image_15tw0_31",
  BD = "_text_container_15tw0_50",
  ED = "_button_container_15tw0_56",
  et = {
    layout: ND,
    container: ID,
    close_button: CD,
  ...
  DD = () => e.jsxs("div", {
    className: fn.layout,
    children: [e.jsx(CT, {}), e.jsx(jT, {}), e.jsx(tf, {}), e.jsx(q2, {}), e.jsx(bT, {}), e.jsx(NE, {}), e.jsx(QE, {}), e.jsx(zE, {}), e.jsx(ZT, {}), e.jsx(bE, {}), e.jsx(nD, {}), e.jsx(bD, {}), e.jsx(kD, {}), e.jsx(HB, {}), e.jsx(jE, {}), e.jsx(TE, {}), e.jsx(Ik, {})]
  }),
  RD = () => {
    const t = g(),
  ...
  OD = "_layout_ieygs_1",
  QD = "_container_ieygs_8",
  FD = "_logo_container_ieygs_17",
  zD = "_logo_ieygs_17",
  LD = "_animate_ieygs_1",
  HD = "_center_ieygs_37",
  GD = "_title_ieygs_51",
  qD = "_description_ieygs_58",
  XD = "_button_container_ieygs_63",
  VD = "_button_ieygs_63",
  YD = "_b_ieygs_63",
  It = {
    layout: OD,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("button", {
            className: It.button,
            onPointerUp: () => {
              t ? ne("https://t.me/notpixel_channel") : Rt("https://t.me/notpixel_channel")
            },
            children: "Not Pixel Channel"
          })
        })]
  ...
  KD = () => {
    ...
    m.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(gh(s)), t(Ja(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(Su(s))
      })
    }, [t])
  ...
  $D = () => {
    const t = g(),
      ...
      s = async () => {
        ...
        if (!Fo(u)) return Promise.resolve();
        try {
          t(Me.getMyTemplate({
            id: u.id
          }))
  ...
  i4 = () => {
    ...
    return m.useEffect(() => {
      function a() {
        console.log("is fullscreen: ", this.isFullscreen), t(Ul(this.isFullscreen))
      }
  ...
  o4 = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Mc) && UD(), KD(), $D(), e4(), a || o ? e.jsx(JD, {}) : i ? e.jsx(ZD, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
Qc(Mn);
Ph(Mn);
const A4 = Kr.createRoot(document.getElementById("root"));
A4.render(e.jsx(te.StrictMode, {
  children: e.jsx(nc, {
    store: Mn,
    children: e.jsx(uc, {
      children: e.jsx(ic, {
