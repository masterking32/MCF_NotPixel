...
const ec = {
  ...
  Cn = H("shop/getProducts", async () => (await W.getProducts()).data),
  ...
  Hc = "_header_1mii1_1",
  Gc = "_header_bottom_container_1mii1_14",
  Vc = "_header_bottom_1mii1_14",
  Jc = "_header_placeholder_1mii1_39",
  Yc = "_header_content_1mii1_45",
  Xc = "_league_1mii1_56",
  Wc = "_bronze_1mii1_66",
  Kc = "_silver_1mii1_67",
  Zc = "_gold_1mii1_68",
  $c = "_platinum_1mii1_69",
  el = "_diamond_1mii1_70",
  tl = "_logo_link_1mii1_72",
  nl = "_logo_1mii1_72",
  Pe = {
    header: Hc,
  ...
  }, Ri = t => new Promise(n => setTimeout(n, t)), ol = t => {
  ...
  }, oa = t => !0, ul = "_layout_13e1w_1", ml = "_container_13e1w_10", Al = "_star_13e1w_14", pl = "_move_13e1w_1", vn = {
    layout: ul,
    container: ml,
    star: Al,
    move: pl
  }, hl = "_link_1fn8i_1", gl = "_telegram_icons_1fn8i_13", Fi = {
    link: hl,
    telegram_icons: gl
  }, b = ({
    children: t,
  ...
  }, Tn = Dl, kl = () => window.location.hostname.split(".").length === 3, Ml = () => !1, Oi = () => window.location.hostname.includes("dev"), Rl = () => Oi() ? Tn.VITE_ADSGRAM_BLOCK_ID : kl() ? "4853" : "4995", ft = {
    isDev: Ml(),
    devServer: Oi(),
  ...
  }, Ll = "_text_layout_1xggq_1", ql = "_text_1xggq_1", Hl = "_button_layout_1xggq_14", Gl = "_button_layout_placeholder_1xggq_26", Vl = "_button_1xggq_14", Gt = {
    text_layout: Ll,
    text: ql,
    button_layout: Hl,
  ...
  }), ed = "_pixels_amount_ngjsa_1", td = "_general_info_container_ngjsa_6", nd = "_coin_amount_text_ngjsa_12", sd = "_description_container_ngjsa_16", ad = "_description_ngjsa_16", wn = {
    pixels_amount: ed,
  ...
  }, () => !1), md = "_container_1aw3i_1", Ad = "_logo_1aw3i_9", pd = "_animate_1aw3i_1", hd = "_center_1aw3i_18", gd = "_glow_1aw3i_28", jn = {
    container: md,
    logo: Ad,
    animate: pd,
    center: hd,
...
const En = H("mining/info", async () => (await js.info()).data),
  ...
  Un = H("user/getPixelsForSaleTotal", async () => (await W.getUserPixelsCount()).data),
  ...
  }),
  {
    ...
    setPixelsSoldOffset: gD,
    setPixelsSoldTotal: _D,
  ...
  Pa = cs.getSelectors(t => t.user.pixelsForSale);
...
const la = H("canvas/getPixelInfo", async ({
  ...
  zn = H("canvas/getPrices", async () => (await W.getPrices()).data),
...
const qA = (t, n) => {
    ...
    oa() && (s = {
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          r.user === n || !rn || (r.type === Fa.bomb && y.mainImage.bomb.boomWithDebounce(ca(r.pixel)), r.type === Fa.pumpkin && y.mainImage.pumpkin.boomWithDebounce(ca(r.pixel)))
        });
        return
      }
  ...
  }),
  {
    ...
    hidePixanosEvent: XA,
    setShowIntro: PD,
    setShowBetaTestIntro: ID,
    addFlyingReward: WA,
    removeFlyingReward: KA,
    showInviteFrensPopup: CD,
    hideInviteFrensPopup: Ws,
    showNoChargesPopup: SD,
    hideNoChargesPopup: Ks,
    setLastShowChargesPopupTs: TD,
...
const Lp = async ({
  ...
  try {
    (await t(vs.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === A.fulfilled && (t(Id(a)), t(ys({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: _t
} = ho.actions, go = t => t.layout.isShowSideMenu, Gp = ho.reducer;
let It = null,
  Ct = null;
class _o {
...
mt.startListening({
  ...
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(kd(t.payload.totalUserPixels)), n.dispatch(Vi(t.payload.userBalance))), n.dispatch(tc(t.payload.goods))
  }
});
mt.startListening({
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === de.energyLimit) {
        ...
        n.dispatch(Nd(s.mining.maxCharges + d)), n.dispatch(qi(d))
      }
...
const $p = "/assets/halloween2-l9FmXxVI.png",
  ...
  Wn = H("daily/getList", async () => (await W.getDailyList()).data),
  Kn = H("daily/getFirstDaily", async () => (await W.getFirstDaily()).data),
  Co = me({
    name: "daily",
    initialState: oh,
    reducers: {
  ...
  }),
  {
    ...
    setCreatedTemplate: DD,
    setMyTournamentTemplate: kD,
  ...
  xn = ur({
    ...
    devTools: !1,
    middleware: t => [fn.middleware, vo.middleware, Cs.middleware, mt.middleware, wo.middleware, ...t()]
  }),
  ns = [],
  Ph = async ({
    dispatch: t,
...
const _g = u.memo(() => (u.useEffect(() => {
  ...
  vf = () => (c(t => t.ratings.league), c(Ji), c(mo), e.jsx("div", {
  ...
  Ky = () => e.jsxs("div", {
    className: Wy.layout,
    children: [e.jsx(Yy, {}), e.jsx(bx, {})]
  }),
  Zy = () => e.jsxs(e.Fragment, {
    children: [e.jsx(Fx, {}), e.jsx(Cx, {}), e.jsx(qy, {}), e.jsx(kx, {}), e.jsx(Ky, {}), e.jsx(Gx, {}), e.jsx(oy, {}), e.jsx(Ox, {}), e.jsx(Mx, {})]
  }),
...
const SC = () => {
  ...
  z2 = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(D2, {}), e.jsx(Q2, {}), e.jsx(Xi, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: X.error,
...
function pS() {
  ...
  as = r * r, Xe(v, we, "u_AnimationDuration", $o), Xe(v, we, "u_ParticleSize", iS), Xe(v, we, "u_ViewportWidth", t), Xe(v, we, "u_ViewportHeight", n), Xe(v, we, "u_TextureWidth", s), Xe(v, we, "u_TextureHeight", a), Xe(v, we, "u_TextureLeft", i), Xe(v, we, "u_TextureTop", o);
...
function hS(t) {
  ...
  Xe(v, we, "u_ElapsedTime", s), v.drawArrays(v.POINTS, 0, as), er()
}
...
const gS = () => {
  ...
  MS = "_overlay_1c8me_1",
  RS = "_top_container_1c8me_10",
  US = "_bottom_container_1c8me_15",
  FS = "_side_menu_1c8me_20",
  OS = "_menu_safe_area_inset_1c8me_36",
  QS = "_menu_header_1c8me_40",
  zS = "_close_button_1c8me_53",
  LS = "_menu_list_1c8me_58",
  qS = "_icon_1c8me_79",
  HS = "_icon_not_pixel_1c8me_87",
  GS = "_menu_list_li_1c8me_97",
  VS = "_menu_list_text_1c8me_103",
  JS = "_menu_list_new_item_1c8me_107",
  YS = "_button_wrapper_1c8me_130",
  XS = "_button_content_1c8me_139",
  WS = "_footer_1c8me_146",
  KS = "_avatar_1c8me_152",
  ZS = "_ratings_image_container_1c8me_159",
  $S = "_ratings_image_1c8me_159",
  q = {
    overlay: MS,
    top_container: RS,
    bottom_container: US,
    side_menu: FS,
    menu_safe_area_inset: OS,
    menu_header: QS,
    close_button: zS,
    menu_list: LS,
    icon: qS,
  ...
  uT = () => localStorage.getItem("canvasFps") ? [Number(localStorage.getItem("canvasFps"))] : [60],
  mT = () => {
    const [t, n] = ie.useState(uT());
    return u.useEffect(() => {
  ...
  hT = "_header_n1egb_11",
  gT = "_title_n1egb_24",
  _T = "_close_container_n1egb_30",
  fT = "_close_n1egb_30",
  xT = "_body_n1egb_54",
  yT = "_content_n1egb_65",
  vT = "_time_left_container_n1egb_71",
  wT = "_timer_n1egb_75",
  jT = "_image_container_n1egb_79",
  bT = "_image_n1egb_79",
  NT = "_description_container_n1egb_89",
  PT = "_bold_n1egb_98",
  IT = "_gray_n1egb_103",
  CT = "_center_n1egb_107",
  ST = "_footer_n1egb_111",
  TT = "_button_n1egb_117",
  ET = "_image_container_charges_n1egb_149",
  BT = "_image_charges_n1egb_153",
  xe = {
    container: pT,
    header: hT,
    title: gT,
...
const kT = "_layout_1at34_1",
  MT = "_container_1at34_10",
  RT = "_item_1at34_14",
  sa = {
    layout: kT,
    container: MT,
  ...
  zT = u.memo(({
    ...
    const [s, a] = u.useState(QT()), [i, o] = u.useState(!1);
    return u.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  qT = "_container_q0ezh_1",
  HT = "_header_q0ezh_11",
  GT = "_title_q0ezh_17",
  VT = "_close_container_q0ezh_23",
  JT = "_close_q0ezh_23",
  YT = "_body_q0ezh_47",
  XT = "_content_q0ezh_59",
  WT = "_time_left_container_q0ezh_65",
  KT = "_timer_q0ezh_69",
  ZT = "_image_container_q0ezh_73",
  $T = "_image_q0ezh_73",
  eE = "_glow_q0ezh_91",
  tE = "_rotate_q0ezh_1",
  nE = "_glow_reverse_q0ezh_100",
  sE = "_description_container_q0ezh_110",
  aE = "_bold_q0ezh_119",
  iE = "_gray_q0ezh_124",
  oE = "_center_q0ezh_128",
  rE = "_button_q0ezh_132",
  ve = {
    container: qT,
    header: HT,
    title: GT,
  ...
  cE = () => {
    ...
    return u.useEffect(() => (Ea(s) && Mi() && (localStorage.getItem(o) || i(!0)), () => {}), [s]), e.jsx(Fe, {
      show: a,
      children: e.jsx("div", {
  ...
  hE = "_image_xga4i_42",
  gE = "_glow_xga4i_55",
  _E = "_forward_xga4i_62",
  fE = "_rotate_xga4i_1",
  xE = "_reverse_xga4i_66",
  yE = "_text_container_xga4i_70",
  vE = "_title_xga4i_78",
  wE = "_description_xga4i_82",
  jE = "_footer_xga4i_86",
  bE = "_button_xga4i_90",
  _e = {
    layout: lE,
...
const EE = () => e.jsxs("div", {
    className: $t.layout,
    children: [e.jsx(BC, {}), e.jsx(CC, {}), e.jsx(_g, {}), e.jsx(WI, {}), e.jsx(SC, {}), e.jsx(fS, {}), e.jsx(BS, {}), e.jsx(kS, {}), e.jsx(n2, {}), e.jsx(_S, {}), e.jsx(LT, {}), e.jsx(cE, {}), e.jsx(TE, {}), e.jsx(H2, {}), e.jsx(gS, {}), e.jsx(jS, {}), e.jsx(AT, {})]
  }),
  BE = () => {
    const t = g(),
  ...
  ME = "_layout_ieygs_1",
  RE = "_container_ieygs_8",
  UE = "_logo_container_ieygs_17",
  FE = "_logo_ieygs_17",
  OE = "_animate_ieygs_1",
  QE = "_center_ieygs_37",
  zE = "_title_ieygs_51",
  LE = "_description_ieygs_58",
  qE = "_button_container_ieygs_63",
  HE = "_button_ieygs_63",
  GE = "_b_ieygs_63",
  ht = {
    layout: ME,
  ...
  JE = "/assets/loading-D8SQALTR.gif",
  YE = () => e.jsxs("div", {
  ...
  sB = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Vr) && kE(), XE(), WE(), KE(), a || o ? e.jsx(VE, {}) : i ? e.jsx(YE, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
Xr(xn);
LA(xn);
const lB = dr.createRoot(document.getElementById("root"));
lB.render(e.jsx(ie.StrictMode, {
  children: e.jsx(pr, {
    store: xn,
    children: e.jsx(vr, {
      children: e.jsx(gr, {
