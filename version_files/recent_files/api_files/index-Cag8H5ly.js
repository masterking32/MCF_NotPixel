...
const Hc = {
  ...
  }),
  {
    ...
    setLimitedGoods: J4,
    clearLimitedGoods: Y4,
    showLimitedGoodsPopup: Xc,
    hideLimitedGoodsPopup: W4
  } = $i.actions,
  eo = t => t.shop.crypto,
  Vc = $i.reducer,
  Ls = {
  ...
  sn = async t => {
  ...
  }, () => !1), pd = "_layout_1nbfl_1", hd = "_button_1nbfl_14", ui = {
    layout: pd,
    button: hd
  }, gd = () => {
    const t = K();
  ...
  }, _d = "_layout_gx8in_1", fd = "_container_gx8in_5", xd = "_item_gx8in_11", vd = "_active_gx8in_20", yd = "_image_container_gx8in_24", wd = "_image_gx8in_24", jd = "_item_text_container_gx8in_34", bd = "_item_text_gx8in_34", ct = {
    layout: _d,
    container: fd,
    item: xd,
    active: vd,
    ...
    setPixelsSoldOffset: K4,
    setPixelsSoldTotal: Z4,
    setPixelsSoldFetchStatus: $4,
    removePixelsSold: e3,
    addPixelCoins: Mt,
  ...
  }, Ed = t => t.user.userPic, Te = t => t.user.user, Dd = po.reducer, Dt = {
    getPixelsForSale: Jn,
...
const Zn = F("mining/info", async () => (await qs.info()).data),
  ...
  nt = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='white'/%3e%3c/svg%3e",
...
const _i = () => {
  ...
  wA = () => e.jsxs("div", {
    ...
    children: [e.jsx(iA, {}), e.jsx(yA, {}), e.jsx(hA, {}), e.jsx(mA, {}), e.jsx(uA, {}), e.jsx(bm, {}), e.jsx(ca, {
      text: "Quick start"
    }), e.jsx(Im, {}), e.jsx(Cm, {}), e.jsx(Tm, {}), e.jsx(ca, {
      text: "Special"
    }), e.jsx(Om, {}), e.jsx(rA, {}), e.jsx(lA, {}), e.jsx($m, {}), e.jsx(Hm, {}), e.jsx(Lm, {}), e.jsx(vm, {}), e.jsx(Bm, {}), e.jsx(Em, {}), e.jsx(Dm, {}), e.jsx(Mm, {}), e.jsx(_A, {}), e.jsx(ca, {
      text: "Browser"
  ...
  Ga = Ss.getSelectors(t => t.user.pixelsForSale);
...
const Ia = F("canvas/getPixelInfo", async ({
  ...
  sp = () => La() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  ap = {
    coords: null,
    animations: sp(),
    stats: null,
...
const eh = (t, n) => {
  ...
  }),
  {
    ...
    setShowIntro: l3,
    setShowBetaTestIntro: d3,
    addFlyingReward: rh,
    removeFlyingReward: ch,
    showInviteFrensPopup: u3,
    hideInviteFrensPopup: ua,
    showNoChargesPopup: m3,
    hideNoChargesPopup: ma,
    setLastShowChargesPopupTs: A3,
...
jt.startListening({
  matcher: xe(ye.checkTask.fulfilled),
  effect: (t, n) => {
...
jt.startListening({
  matcher: xe(ye.checkBoost.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s];
    let i = "Not enough PX",
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === pe.energyLimit) {
        ...
        n.dispatch(Nu(s.mining.maxCharges + d)), n.dispatch(yo(d))
      }
...
jt.startListening({
  matcher: xe(ye.checkTask.rejected),
  effect: (t, n) => {
    n.dispatch(O({
      id: performance.now(),
      text: "Check failed",
...
jt.startListening({
  matcher: xe(ye.checkBoost.rejected),
  effect: (t, n) => {
    n.dispatch(O({
      id: performance.now(),
      text: "Not enough PX",
...
const Vs = tn();
Vs.startListening({
  matcher: xe(Hs.getPriceMask.pending, Dt.getPixelsForSale.pending, Dt.getPixelsSold.pending, Ya.get.pending),
  effect: (t, n) => {
    n.dispatch(st({
      command: Me.start
    }))
...
Vs.startListening({
  matcher: xe(Hs.getPriceMask.fulfilled, Dt.getPixelsForSale.fulfilled, Dt.getPixelsSold.fulfilled, Ya.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(st({
      command: Me.finish
    }))
...
class Be {
  ...
  static async getTemplateById({
    ...
    return mn !== null && (mn.abort(), mn = null), mn = new AbortController, T.get(`/image/template/${n}`, {
      signal: mn.signal
    })
  }
...
const mg = "/assets/halloween2-l9FmXxVI.png",
  ...
  ds = F("template/getReferredTemplate", async () => (await Be.getReferredTemplate()).data),
  ...
  {
    setActiveTemplate: p3,
    setActiveTemplateTab: yi,
    hideTemplates: er,
    setTemplateOpacity: gg,
    setReferredTemplate: _g,
    setMyTemplate: fg,
    setTemplateListOffset: h3,
  ...
  Sg = () => {
    const t = g(),
      ...
      o = i && i.approved;
    return e.jsxs(rn, {
      children: [a && o && e.jsx(Ue, {
        active: n === De.create,
        setActive: () => t(xn(De.create)),
        children: "My template"
      }), e.jsx(Ue, {
        active: n === De.main,
        setActive: () => t(xn(De.main)),
        children: "Tournament"
      }), e.jsx(Ue, {
        active: n === De.result,
        setActive: () => t(xn(De.result)),
        children: "My results"
      })]
    })
  };
...
const ps = F("tournament/getPeriods", async () => (await ir.getPeriods()).data),
  ...
  _s = F("tournament/getSelectedTemplate", async () => (await Be.getSelectedTemplate()).data),
  ...
  xs = F("tournament/getRandomTemplatesList", async () => (await Be.getRandomTemplates()).data),
  vs = F("tournament/selectTemplate", async ({
    id: t
...
const kn = Yr({
  ...
  zg = async ({
    ...
    try {
      ...
      console.log(r, r.response.data.code === 16), r.response.data.code === 16 && t(ye.info())
    }
  }, Lg = ({
    history: t,
    dispatch: n,
    ...
    n(Gs()), t && t.push("/energy-over"), n(kt(s)), v.mainImage.selectedPixel.draw(s)
  }, Ar = async ({
    history: t,
    charges: n,
    dispatch: s,
...
const k_ = m.memo(() => (m.useEffect(() => {
  ...
  U_ = () => c(Ga.selectAll).map(n => e.jsx(M_, {
    item: n
  }, at({
    x: n.x,
    y: n.y
  ...
  rf = () => {
    const {
      t
    } = Oe(), n = pe.paintReward, s = c(u => u.main.settings.UpgradeRepaint), a = c(u => u.mining.boosts[n]), {
      repaintReward: i
  ...
  cf = () => {
    const {
      t
    } = Oe(), n = pe.reChargeSpeed, s = c(u => u.main.settings.UpgradeChargeRestoration), a = c(u => u.mining.boosts[n]), {
      restorationSpeed: i
    } = c(on), o = a >= i, r = Math.min(i, a + 1), l = Math.min(i, a), d = s == null ? void 0 : s.levels[r];
    return e.jsxs($a, {
      boost: n,
  ...
  lf = () => {
    const {
      t
    } = Oe(), n = pe.energyLimit, s = c(u => u.main.settings.UpgradeChargeCount), a = c(u => u.mining.boosts[n]), {
      chargesCount: i
    } = c(on), o = a >= i, r = Math.min(i, a + 1), l = Math.min(i, a), d = s == null ? void 0 : s.levels[r];
    return e.jsxs($a, {
      boost: n,
  ...
  yf = () => {
    const {
      t
    } = Oe(), n = pe.paintReward, s = c(d => d.main.settings.UpgradeRepaint), a = c(d => d.mining.boosts[n]), {
      repaintReward: i
  ...
  wf = () => {
    const {
      t
    } = Oe(), n = pe.reChargeSpeed, s = c(d => d.main.settings.UpgradeChargeRestoration), a = c(d => d.mining.boosts[n]), {
      restorationSpeed: i
    } = c(on), o = Math.min(i, a + 1), r = (s == null ? void 0 : s.levels[a]) || {
      ChargeBoost: 6e5
    }, l = s == null ? void 0 : s.levels[o];
  ...
  jf = () => {
    const {
      t
    } = Oe(), n = pe.energyLimit, s = c(d => d.main.settings.UpgradeChargeCount), a = c(d => d.mining.boosts[n]), {
      chargesCount: i
  ...
  Rn = ({
    ...
    return n > 0 && (i = Cn(i, n)), e.jsx("span", {
      className: Ao.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ue(`https://t.me/${di(t)}`) : nn(`https://t.me/${di(t)}`)
      },
      children: i
    })
  },
  ...
  Zy = () => {
    ...
    return r && o.push(ht.enabled), e.jsx("button", {
      ...
      onPointerUp: () => {
        if (!i) {
          t(xn(De.create)), n.push("/tournament");
          return
        }
        r ? t(Ka()) : (v.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
  ...
  $y = () => {
    ...
    return i && o.push(ht.enabled), s || o.push(ht.animation), e.jsxs("button", {
      ...
      onPointerUp: l => {
        if (!s || !r) {
          t(xn(De.main)), n.push("/tournament");
          return
        }
        i ? t(Ka()) : (v.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
  ...
  Hj = "/assets/sitting_chars_animation_outl-BdmQzfhn.gif",
  Gj = "_link_a4r15_1",
  Xj = {
    link: Gj
  },
  ...
  A1 = "_container_11l5m_1",
  p1 = "_divider_11l5m_23",
  h1 = "_row_11l5m_28",
  g1 = "_row_title_11l5m_40",
  _1 = "_row_title_main_11l5m_44",
  f1 = "_row_hint_11l5m_49",
  x1 = "_row_value_11l5m_55",
  v1 = "_row_value_main_11l5m_59",
  y1 = "_mining_percent_11l5m_64",
  w1 = "_active_row_11l5m_74",
  j1 = "_button_11l5m_85",
  Bi = {
    container: A1,
    divider: p1,
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Rt.subscribe({
              ...
              t(_g(h)), v.mainImage.worldTemplate.deleteTemplate(o.id), v.mainImage.worldTemplate.add(h), t(er())
            } else await t(O({
              id: performance.now(),
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Be.uploadTemplate({
              ...
              i(fg(N)), i(er()), await v.mainImage.worldTemplate.add(N), i(O({
                id: performance.now(),
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const b = async () => {
          ...
          LI(we), f.putImageData(we, 0, 0), a(we), o(N.toDataURL())
        };
        setTimeout(() => {
          b().then(() => {
            _(!1)
    ...
    return m.useEffect(() => {
      if (t !== null) {
        ...
        const f = async () => {
          ...
          rP(ln), q.putImageData(ln, 0, 0), a(ln), o(j.toDataURL())
        };
        setTimeout(() => {
          f().then(() => {
            _(!1)
  ...
  VP = "_template_item_container_1c93x_1",
  JP = "_template_item_inner_1c93x_12",
  YP = "_template_item_picked_1c93x_28",
  WP = "_template_item_rejected_1c93x_43",
  KP = "_template_item_shadow_1c93x_58",
  ZP = "_template_rank_1c93x_70",
  $P = "_template_recolors_1c93x_90",
  eC = "_template_recolors_pixel_1c93x_105",
  tC = "_template_image_1c93x_112",
  Ze = {
    template_item_container: VP,
    template_item_inner: JP,
    template_item_picked: YP,
    template_item_rejected: WP,
    template_item_shadow: KP,
    template_rank: ZP,
    template_recolors: $P,
    template_recolors_pixel: eC,
    template_image: tC
  },
  oi = ({
    item: t,
    ...
    return m.useEffect(() => {
      ...
      className: Ze.template_item_container,
      style: {
        ...a
      },
      onPointerUp: async () => {
      ...
      children: [e.jsx("div", {
        className: Ze.template_item_inner,
        children: e.jsx("img", {
          alt: "image",
          className: Ze.template_image,
          src: t.url
        })
      }), r && t.approved !== !1 && e.jsx("div", {
        className: Ze.template_item_picked,
        children: "Picked"
      }), t.approved === !1 && e.jsx("div", {
        className: Ze.template_item_rejected,
        children: "Rejected"
      }), n && e.jsx("div", {
        className: Ze.template_rank,
        children: n
      }), s !== void 0 && s !== 0 && e.jsx("div", {
        className: Ze.template_item_shadow
      }), s !== void 0 && s !== 0 && e.jsxs("div", {
        className: Ze.template_recolors,
        children: [e.jsx("div", {
          className: Ze.template_recolors_pixel
        }), $t(s)]
      })]
    })
  },
  ...
  oC = () => {
    ...
    return m.useEffect(() => (t(Se.getRandomList()), () => {
      ...
      children: [e.jsxs("div", {
        className: Ye.container,
        children: [e.jsx(iC, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(oi, {
          item: i
        }, i.id))]
      }), e.jsx(aC, {})]
    })
  ...
  hC = () => {
    ...
    return e.jsxs("div", {
      children: [e.jsx(pC, {}), t && n === A.fulfilled && e.jsx(sC, {}), !t && n === A.fulfilled && e.jsx(oC, {})]
    })
  },
  gC = "_soon_la5q2_1",
  _C = "_active_round_instruction_la5q2_11",
  fC = "_not_active_round_instruction_la5q2_19",
  xC = "_round_container_la5q2_25",
  vC = "_round_title_la5q2_33",
  yC = "_round_title_text_la5q2_38",
  wC = "_round_indicator_la5q2_43",
  jC = "_round_status_success_la5q2_49",
  bC = "_round_status_fail_la5q2_60",
  NC = "_success_la5q2_71",
  IC = "_fail_la5q2_75",
  PC = "_gray_la5q2_79",
  CC = "_round_main_info_la5q2_83",
  SC = "_round_image_container_la5q2_89",
  TC = "_round_image_la5q2_89",
  BC = "_round_lines_container_la5q2_103",
  EC = "_round_line_la5q2_103",
  DC = "_divider_la5q2_117",
  kC = "_pixels_number_la5q2_124",
  RC = "_pixel_la5q2_124",
  MC = "_past_rounds_la5q2_136",
  UC = "_past_rounds_divider_la5q2_145",
  Q = {
    soon: gC,
    active_round_instruction: _C,
    not_active_round_instruction: fC,
    round_container: xC,
    round_title: vC,
    round_title_text: yC,
    round_indicator: wC,
  ...
  LC = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(QC, {}), e.jsx(zC, {}), e.jsx(OC, {}), e.jsx(FC, {})]
    })
  },
  qC = () => {
  ...
  sS = "_close_button_17ca7_20",
  aS = "_title_container_17ca7_28",
  iS = "_title_17ca7_28",
  oS = "_image_container_17ca7_39",
  rS = "_image_17ca7_39",
  cS = "_image_placeholder_17ca7_53",
  lS = "_info_container_17ca7_60",
  dS = "_info_row_17ca7_66",
  uS = "_info_title_17ca7_71",
  mS = "_info_value_blue_17ca7_75",
  AS = "_info_value_white_17ca7_80",
  pS = "_buttons_container_17ca7_84",
  hS = "_button_17ca7_84",
  gS = "_not_button_17ca7_100",
  _S = "_button_copy_17ca7_111",
  Z = {
    layout: tS,
    container: nS,
    close_button: sS,
  ...
  xS = () => {
    ...
    return c(Ne), !a || !s ? null : Ke.createPortal(e.jsx(He, {
      onPointerUp: () => t(pa()),
      show: s,
      children: e.jsx("div", {
        className: Z.layout,
  ...
  vS = "_layout_20dlh_1",
  yS = "_container_20dlh_10",
  wS = "_star_20dlh_14",
  jS = "_star_animation_20dlh_21",
  bS = "_move_20dlh_1",
  Ms = {
    layout: vS,
    container: yS,
  ...
  NS = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  IS = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  CS = "_container_tuzgg_1",
  SS = "_column_tuzgg_9",
  TS = "_column_rev_tuzgg_17",
  BS = "_title_tuzgg_26",
  ES = "_table_container_tuzgg_32",
  DS = "_table_row_tuzgg_38",
  kS = "_button_tuzgg_45",
  RS = "_value_tuzgg_52",
  MS = "_notpixel_icon_tuzgg_58",
  US = "_active_row_tuzgg_74",
  OS = "_row_title_tuzgg_74",
  be = {
    container: CS,
    column: SS,
    column_rev: TS,
  ...
  XS = "_container_qn09x_1",
  VS = "_image_container_qn09x_9",
  JS = "_image_qn09x_9",
  YS = "_title_container_qn09x_18",
  WS = "_text_container_qn09x_27",
  KS = "_title_qn09x_18",
  ZS = "_gray_qn09x_39",
  $S = "_bold_qn09x_43",
  e2 = "_input_qn09x_47",
  t2 = "_catalog_container_qn09x_71",
  n2 = "_catalog_title_qn09x_76",
  s2 = "_catalog_items_container_qn09x_81",
  a2 = "_catalog_item_qn09x_81",
  i2 = "_catalog_item_image_container_qn09x_100",
  o2 = "_catalog_item_image_qn09x_100",
  r2 = "_button_container_qn09x_109",
  c2 = "_button_qn09x_109",
  l2 = "_wrong_helper_text_qn09x_124",
  d2 = "_wrong_button_qn09x_129",
  u2 = "_wrong_button_text2_qn09x_142",
  S = {
    container: XS,
    image_container: VS,
    image: JS,
  ...
  w2 = "_layout_1djp8_1",
  j2 = "_loading_container_1djp8_8",
  b2 = "_image_container_1djp8_20",
  N2 = "_image_1djp8_20",
  I2 = "_text_1djp8_29",
  _n = {
    layout: w2,
    loading_container: j2,
    image_container: b2,
    image: N2,
    text: I2
  },
  P2 = "_buttons_container_rjvnl_1",
  C2 = "_group_rjvnl_8",
  S2 = "_left_rjvnl_15",
  T2 = "_middle_rjvnl_21",
  B2 = "_right_rjvnl_29",
  ...
  ki = ee.memo(() => e.jsxs("div", {
    className: ve.buttons_container,
    children: [e.jsxs("div", {
      className: `${ve.group} ${ve.left}`,
      children: [e.jsx(K2, {}), e.jsx(W2, {})]
    }), e.jsx("div", {
      className: `${ve.group} ${ve.middle}`,
      children: e.jsx(V2, {})
    }), e.jsxs("div", {
      className: `${ve.group} ${ve.right}`,
      children: [e.jsx(Z2, {}), e.jsx(X2, {}), e.jsx(Y2, {})]
    })]
  })),
  Ri = {
    bronze: Re.bronze,
...
const eT = () => {
  ...
  iT = "_header_11ui8_13",
  oT = "_close_container_11ui8_23",
  rT = "_close_11ui8_23",
  cT = "_title_11ui8_48",
  lT = "_frens_count_11ui8_53",
  dT = "_body_11ui8_58",
  uT = "_content_11ui8_68",
  mT = "_image_container_11ui8_75",
  AT = "_image_11ui8_75",
  pT = "_image_container_charges_11ui8_84",
  hT = "_image_charges_11ui8_89",
  gT = "_description_container_11ui8_94",
  _T = "_bold_11ui8_102",
  fT = "_gray_11ui8_107",
  xT = "_center_11ui8_111",
  vT = "_benefits_container_11ui8_115",
  yT = "_benefits_item_11ui8_123",
  wT = "_benefits_icon_container_11ui8_128",
  jT = "_icon_invite_11ui8_132",
  bT = "_footer_11ui8_136",
  NT = "_button_11ui8_141",
  D = {
    container: aT,
    header: iT,
    close_container: oT,
  ...
  CT = "_container_19qal_1",
  ST = "_header_19qal_9",
  TT = "_close_19qal_19",
  BT = "_title_19qal_31",
  ET = "_body_19qal_36",
  DT = "_image_container_19qal_49",
  kT = "_image_19qal_49",
  RT = "_content_container_19qal_60",
  MT = "_description_container_19qal_68",
  UT = "_description_item_19qal_75",
  OT = "_amount_selector_container_19qal_82",
  FT = "_amount_selector_button_19qal_88",
  QT = "_amount_selector_count_19qal_101",
  zT = "_button_container_19qal_112",
  LT = "_crypto_button_container_19qal_118",
  qT = "_error_19qal_132",
  HT = "_not_available_19qal_139",
  GT = "_button_19qal_112",
  XT = "_star_color_19qal_165",
  VT = "_tokens_selector_19qal_171",
  JT = "_tokens_title_19qal_176",
  YT = "_connect_wallet_text_title_19qal_183",
  WT = "_tokens_container_19qal_192",
  KT = "_token_item_19qal_199",
  ZT = "_token_image_container_19qal_210",
  $T = "_token_image_19qal_210",
  eB = "_sale_box_19qal_220",
  tB = "_sale_text_19qal_232",
  Y = {
    container: CT,
    header: ST,
    close: TT,
    ...
    image_container: DT,
    image: kT,
    content_container: RT,
    description_container: MT,
    description_item: UT,
    amount_selector_container: OT,
    amount_selector_button: FT,
    amount_selector_count: QT,
    button_container: zT,
    crypto_button_container: LT,
    error: qT,
    not_available: HT,
    button: GT,
    star_color: XT,
  ...
  rB = ({
    ...
    if (o) return e.jsxs(ee.Fragment, {
      children: ["Buy for ", e.jsx(oB, {}), Math.round(o * (r ? s : 1) * 100) / 100, e.jsx("div", {
  ...
  cB = ({
    ...
    const q = async V => {
      ...
      const we = new ea.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        ...
        Hr = Xe.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(Xe.toNano(V.strAmount)).storeAddress(Lr).storeAddress(zr).storeBit(0).storeCoins(Xe.toNano("0.01")).storeBit(1).storeRef(qr).endCell(),
        Gr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
  ...
  AB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(iB, {}), e.jsx(mB, {}), e.jsx(jo, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: Y.error,
  ...
  hB = "_container_1rmx4_1",
  gB = "_max_value_1rmx4_9",
  Oi = {
    container: hB,
    max_value: gB
  },
...
const _B = () => {
  ...
  fB = () => e.jsxs("div", {
    ...
    children: [e.jsx(sB, {}), e.jsxs("div", {
      className: Y.content_container,
      children: [e.jsx(aB, {}), e.jsx(pB, {}), e.jsx(_B, {})]
    }), e.jsx(AB, {})]
  }),
  xB = () => {
    ...
    return Ke.createPortal(e.jsx(He, {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx(nB, {}), e.jsx(fB, {})]
      })
    }), document.body)
  },
  vB = "_layout_9sf1k_1",
  yB = "_container_9sf1k_13",
  wB = "_header_9sf1k_20",
  jB = "_title_9sf1k_30",
  bB = "_body_9sf1k_35",
  NB = "_image_container_9sf1k_47",
  IB = "_image_9sf1k_47",
  PB = "_shake_9sf1k_1",
  CB = "_description_container_9sf1k_60",
  SB = "_buyer_info_9sf1k_70",
  TB = "_avatar_9sf1k_78",
  BB = "_name_9sf1k_84",
  EB = "_squad_info_9sf1k_88",
  DB = "_squad_avatar_9sf1k_94",
  kB = "_text_container_9sf1k_100",
  RB = "_text_9sf1k_100",
  MB = "_thanos_snap_container_9sf1k_110",
  UB = "_thanos_snap_text_9sf1k_119",
  OB = "_button_container_9sf1k_126",
...
async function GB() {
  w.enable(w.BLEND), w.blendFunc(w.SRC_ALPHA, w.ONE_MINUS_SRC_ALPHA), w.clearColor(0, 0, 0, 0), w.viewport(0, 0, w.canvas.width, w.canvas.height), Pe = await XB(w), w.useProgram(Pe)
}
async function XB(t, n, s) {
  const a = QB,
    i = zB,
...
async function VB(t) {
  JB(), KB(t), Or(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function KB(t) {
  ...
  bs = l * l, et(w, Pe, "u_AnimationDuration", Ur), et(w, Pe, "u_ParticleSize", LB), et(w, Pe, "u_ViewportWidth", n), et(w, Pe, "u_ViewportHeight", s), et(w, Pe, "u_TextureWidth", a), et(w, Pe, "u_TextureHeight", i), et(w, Pe, "u_TextureLeft", o), et(w, Pe, "u_TextureTop", r);
...
function ZB(t) {
  ...
  et(w, Pe, "u_ElapsedTime", s), w.drawArrays(w.POINTS, 0, bs), Or()
}
...
const $B = () => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                var r, l;
                v.viewport.viewport.fit(), v.viewport.viewport.moveCenter(v.viewport.viewport.worldWidth / 2, v.viewport.viewport.worldHeight / 2), n(vi(!0)), setTimeout(() => {
                  n(vi(!1))
                }, 7e3);
                try {
                  await qB(i ? 0 : Sc)
  ...
  lE = "_image_container_1nuac_30",
  dE = "_image_1nuac_30",
  uE = "_text_container_1nuac_42",
  mE = "_title_1nuac_49",
  AE = "_button_container_1nuac_55",
  pE = "_button_1nuac_55",
  ut = {
    layout: rE,
    container: cE,
    ...
    return e.jsx(He, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === Le.userFromPixelInfo && e.jsx(ka, {
          ...
          isPopupContent: s
        }), n.dataSource === Le.squadFromData && e.jsx(gE, {})]
      })
    })
  },
  fE = "_overlay_1vl8z_1",
  ...
  yE = "_side_menu_1vl8z_20",
  wE = "_menu_safe_area_inset_1vl8z_36",
  jE = "_menu_header_1vl8z_40",
  bE = "_close_button_1vl8z_53",
  NE = "_menu_list_1vl8z_58",
  IE = "_icon_1vl8z_79",
  PE = "_icon_not_pixel_1vl8z_87",
  CE = "_gold_pixel_1vl8z_97",
  SE = "_menu_list_li_1vl8z_103",
  TE = "_menu_list_text_1vl8z_109",
  BE = "_menu_list_new_item_1vl8z_113",
  EE = "_button_wrapper_1vl8z_136",
  DE = "_button_content_1vl8z_145",
  kE = "_footer_1vl8z_152",
  RE = "_avatar_1vl8z_158",
  ME = "_ratings_image_container_1vl8z_165",
  UE = "_ratings_image_1vl8z_165",
  J = {
    overlay: fE,
    top_container: xE,
    bottom_container: vE,
    side_menu: yE,
    menu_safe_area_inset: wE,
    menu_header: jE,
    close_button: bE,
    menu_list: NE,
    icon: IE,
    ...
    menu_list_li: SE,
    menu_list_text: TE,
    menu_list_new_item: BE,
    button_wrapper: EE,
    button_content: DE,
    footer: kE,
    avatar: RE,
    ratings_image_container: ME,
    ratings_image: UE
  },
  zi = [.215, .61, .355, 1],
  OE = {
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(yn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(eD, {}), e.jsx(WE, {}), e.jsxs("div", {
...
m.memo(({
  ...
  const [s, a] = m.useState(lD()), [i, o] = m.useState(!1);
  return m.useEffect(() => {
    t && setTimeout(() => {
      o(!0), setTimeout(() => {
        n(!1), o(!1)
...
const dD = "_container_gb8eq_1",
  uD = "_header_gb8eq_11",
  mD = "_title_gb8eq_17",
  AD = "_close_container_gb8eq_23",
  pD = "_close_gb8eq_23",
  hD = "_body_gb8eq_47",
  gD = "_content_gb8eq_59",
  _D = "_time_left_container_gb8eq_65",
  fD = "_timer_gb8eq_69",
  xD = "_image_container_gb8eq_73",
  vD = "_image_gb8eq_73",
  yD = "_glow_container_gb8eq_91",
  wD = "_glow_gb8eq_91",
  jD = "_rotate_gb8eq_1",
  bD = "_glow_reverse_gb8eq_107",
  ND = "_description_container_gb8eq_113",
  ID = "_bold_gb8eq_123",
  PD = "_gray_gb8eq_128",
  CD = "_center_gb8eq_132",
  SD = "_gold_gb8eq_136",
  TD = "_button_gb8eq_144",
  ge = {
    container: dD,
    header: uD,
    title: mD,
  ...
  BD = "/assets/cup_glad-DGT2PBmm.png",
  ED = () => {
    const t = K(),
      n = c(Te),
      [s, a] = m.useState(!1),
  ...
  MD = "_close_xga4i_25",
  UD = "_body_xga4i_38",
  OD = "_image_container_xga4i_42",
  FD = "_image_xga4i_42",
  QD = "_glow_xga4i_55",
  zD = "_forward_xga4i_62",
  LD = "_rotate_xga4i_1",
  qD = "_reverse_xga4i_66",
  HD = "_text_container_xga4i_70",
  GD = "_title_xga4i_78",
  XD = "_description_xga4i_82",
  VD = "_footer_xga4i_86",
  JD = "_button_xga4i_90",
  _e = {
    layout: DD,
...
const tk = "_layout_15tw0_1",
  ...
  dk = () => e.jsxs("div", {
    className: _n.layout,
    children: [e.jsx(sT, {}), e.jsx($2, {}), e.jsx(k_, {}), e.jsx(y2, {}), e.jsx(eT, {}), e.jsx(tE, {}), e.jsx(hE, {}), e.jsx(_E, {}), e.jsx(PT, {}), e.jsx(eE, {}), e.jsx(ED, {}), e.jsx(ek, {}), e.jsx(lk, {}), e.jsx(xB, {}), e.jsx($B, {}), e.jsx(oE, {}), e.jsx(nD, {})]
  }),
  uk = () => {
    const t = g(),
  ...
  pk = "_layout_ieygs_1",
  hk = "_container_ieygs_8",
  gk = "_logo_container_ieygs_17",
  _k = "_logo_ieygs_17",
  fk = "_animate_ieygs_1",
  xk = "_center_ieygs_37",
  vk = "_title_ieygs_51",
  yk = "_description_ieygs_58",
  wk = "_button_container_ieygs_63",
  jk = "_button_ieygs_63",
  bk = "_b_ieygs_63",
  Pt = {
    layout: pk,
  ...
  Ik = "/assets/loading-D8SQALTR.gif",
  Pk = () => e.jsxs("div", {
  ...
  Ck = () => {
    ...
    m.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(Wp(s)), t(Xa(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(bu(s))
      })
    }, [t])
  ...
  Tk = () => {
    const t = K();
    m.useEffect(() => {
      La() ? localStorage.getItem("skipIntro") || (t.push("/welcome"), localStorage.setItem("skipIntro", "true")) : an.get("skipIntro", (n, s) => {
  ...
  Mk = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Ec) && Ak(), Ck(), Sk(), Tk(), a || o ? e.jsx(Nk, {}) : i ? e.jsx(Pk, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
Rc(kn);
$p(kn);
const Lk = Jr.createRoot(document.getElementById("root"));
Lk.render(e.jsx(ee.StrictMode, {
  children: e.jsx(Zr, {
    store: kn,
    children: e.jsx(rc, {
      children: e.jsx(tc, {
