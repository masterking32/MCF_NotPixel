...
const j = () => {
  ...
  ee = (n, e, t) => {
    ...
    let r = e[e.length - 1],
      ...
      o = I(n, a, Object);
    for (; o.obj === void 0 && a.length;) r = `${a[a.length-1]}.${r}`, a = a.slice(0, a.length - 1), o = I(n, a, Object), o && o.obj && typeof o.obj[`${o.k}.${r}`] < "u" && (o.obj = void 0);
    o.obj[`${o.k}.${r}`] = t
  },
  pe = (n, e, t, s) => {
    const {
  ...
  le = (n, e, t) => {
    for (const s in e) s !== "__proto__" && s !== "constructor" && (s in n ? typeof n[s] == "string" || n[s] instanceof String || typeof e[s] == "string" || e[s] instanceof String ? t && (n[s] = e[s]) : le(n[s], e[s], t) : n[s] = e[s]);
    return n
  },
  R = n => n.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&");
var ye = {
...
const xe = n => typeof n == "string" ? n.replace(/[&<>"'\/]/g, e => ye[e]) : n;
class be {
  constructor(e) {
...
const Se = [" ", ",", "?", "!", ";"],
  ...
  Le = (n, e, t) => {
    ...
    const i = Oe.getRegExp(`(${s.map(a=>a==="?"?"\\?":a).join("|")})`);
    let r = !i.test(n);
    if (!r) {
      const a = n.indexOf(t);
...
class te extends J {
  ...
  addResource(e, t, s, i) {
    ...
    let o = [e, t];
    s && (o = o.concat(a ? s.split(a) : s)), e.indexOf(".") > -1 && (o = e.split("."), i = t, t = o[1]), this.addNamespaces(t), ee(this.data, o, i), r.silent || this.emit("added", e, t, s, i)
  }
  addResources(e, t, s) {
    let i = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {
      silent: !1
  ...
  addResourceBundle(e, t, s, i, r) {
    ...
    let l = M(this.data, o) || {};
    a.skipCopy || (s = JSON.parse(JSON.stringify(s))), i ? le(l, s, r) : l = {
      ...l,
      ...s
    }, ee(this.data, o, l), a.silent || this.emit("added", e, t, s)
  }
...
class z extends J {
  ...
  extractFromKey(e, t) {
    ...
    const a = s && e.indexOf(s) > -1,
      o = !this.options.userDefinedKeySeparator && !t.keySeparator && !this.options.userDefinedNsSeparator && !t.nsSeparator && !Le(e, s, i);
    if (a && !o) {
  ...
  translate(e, t, s) {
    ...
    if (x && u && (typeof u != "string" && typeof u != "boolean" && typeof u != "number") && p.indexOf(m) < 0 && !(typeof O == "string" && Array.isArray(u))) {
    ...
    } else if (x && typeof O == "string" && Array.isArray(u)) u = u.join(O), u && (u = this.extendTranslation(u, e, t, s));
    else {
      let y = !1,
        L = !1;
      const w = t.count !== void 0 && typeof t.count != "string",
        ...
        Y = w && !t.ordinal && t.count === 0 && this.pluralResolver.shouldUseIntlApi(),
        $ = Y && t[`defaultValue${this.options.pluralSeparator}zero`] || t[`defaultValue${V}`] || t[`defaultValue${fe}`] || t.defaultValue;
      !this.isValidLookup(u) && b && (y = !0, u = $), this.isValidLookup(u) || (L = !0, u = a);
      const he = (t.missingKeyNoValueFallbackToKey || this.options.missingKeyNoValueFallbackToKey) && L ? void 0 : u,
      ...
      if (L || y || k) {
        ...
        if (this.options.saveMissingTo === "fallback" && T && T[0])
          for (let v = 0; v < T.length; v++) E.push(T[v]);
        ...
        const G = (v, N, F) => {
          const Z = b && F !== u ? F : he;
          this.options.missingKeyHandler ? this.options.missingKeyHandler(v, l, N, Z, k, t) : this.backendConnector && this.backendConnector.saveMissing && this.backendConnector.saveMissing(v, l, N, Z, k, t), this.emit("missingKey", v, l, N, u)
        };
        this.options.saveMissing && (this.options.saveMissingPlurals && w ? E.forEach(v => {
          const N = this.pluralResolver.getSuffixes(v, t);
          Y && t[`defaultValue${this.options.pluralSeparator}zero`] && N.indexOf(`${this.options.pluralSeparator}zero`) < 0 && N.push(`${this.options.pluralSeparator}zero`), N.forEach(F => {
            G([v], a + F, t[`defaultValue${F}`] || $)
          })
        }) : G(E, a, $))
      }
  ...
  extendTranslation(e, t, s, i, r) {
    ...
    return e != null && l && l.length && s.applyPostProcessor !== !1 && (e = ue.handle(l, e, t, this.options && this.options.postProcessPassResolved ? {
      i18nResolved: {
        ...i,
      ...
      g.forEach(p => {
        this.isValidLookup(s) || (o = p, !se[`${m[0]}-${p}`] && this.utils && this.utils.hasLoadedNamespace && !this.utils.hasLoadedNamespace(o) && (se[`${m[0]}-${p}`] = !0, this.logger.warn(`key "${i}" for languages "${m.join(", ")}" won't get resolved as namespace "${o}" was not yet loaded`, "This means something IS WRONG in your setup. You access the t function before i18next.init / i18next.loadNamespace / i18next.changeLanguage was done. Wait for the callback or Promise to resolve before accessing it!!!")), m.forEach(O => {
          ...
          if (this.i18nFormat && this.i18nFormat.addLookupKeys) this.i18nFormat.addLookupKeys(x, h, O, p, t);
            ...
            if (u && (x.push(h + y), t.ordinal && y.indexOf(w) === 0 && x.push(h + y.replace(w, this.options.pluralSeparator)), c && x.push(h + L)), d) {
              const b = `${h}${this.options.contextSeparator}${t.context}`;
              x.push(b), u && (x.push(b + y), t.ordinal && y.indexOf(w) === 0 && x.push(b + y.replace(w, this.options.pluralSeparator)), c && x.push(b + L))
            }
          }
          let D;
          for (; D = x.pop();) this.isValidLookup(s) || (r = D, s = this.getResource(O, p, D, t))
        }))
      })
    }), {
      res: s,
...
class ie {
  ...
  formatLanguageCode(e) {
    if (typeof e == "string" && e.indexOf("-") > -1) {
      ...
      let s = e.split("-");
      return this.options.lowerCaseLng ? s = s.map(i => i.toLowerCase()) : s.length === 2 ? (s[0] = s[0].toLowerCase(), s[1] = s[1].toUpperCase(), t.indexOf(s[1].toLowerCase()) > -1 && (s[1] = B(s[1].toLowerCase()))) : s.length === 3 && (s[0] = s[0].toLowerCase(), s[1].length === 2 && (s[1] = s[1].toUpperCase()), s[0] !== "sgn" && s[2].length === 2 && (s[2] = s[2].toUpperCase()), t.indexOf(s[1].toLowerCase()) > -1 && (s[1] = B(s[1].toLowerCase())), t.indexOf(s[2].toLowerCase()) > -1 && (s[2] = B(s[2].toLowerCase()))), s.join("-")
    }
  ...
  getBestMatchFromCodes(e) {
    ...
    return e.forEach(s => {
      ...
      t = this.options.supportedLngs.find(r => {
        if (r === i) return r;
        if (!(r.indexOf("-") < 0 && i.indexOf("-") < 0) && (r.indexOf("-") > 0 && i.indexOf("-") < 0 && r.substring(0, r.indexOf("-")) === i || r.indexOf(i) === 0 && i.length > 1)) return r
      })
...
class Pe {
  ...
  getSuffixes(e) {
    let t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    const s = this.getRule(e, t);
    return s ? this.shouldUseIntlApi() ? s.resolvedOptions().pluralCategories.sort((i, r) => ne[i] - ne[r]).map(i => `${this.options.prepend}${t.ordinal?`ordinal${this.options.prepend}`:""}${i}`) : s.numbers.map(i => this.getSuffix(e, i, t)) : []
  }
  getSuffix(e, t) {
    let s = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
...
const re = function(n, e, t) {
    let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : ".",
      ...
      r = me(n, e, t);
    return !r && i && typeof t == "string" && (r = Q(n, t, s), r === void 0 && (r = Q(e, t, s))), r
  },
  W = n => n.replace(/\$/g, "$$$$");
class $e {
  constructor() {
  ...
  interpolate(e, t, s, i) {
    ...
    const l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {},
      f = c => {
        if (c.indexOf(this.formatSeparator) < 0) {
          const O = re(t, l, c, this.options.keySeparator, this.options.ignoreJSONStructure);
        ...
        return this.format(re(t, l, m, this.options.keySeparator, this.options.ignoreJSONStructure), p, s, {
          ...i,
          ...t,
          interpolationkey: m
        })
    ...
    return [{
      ...
      for (o = 0; r = c.regex.exec(e);) {
        ...
        if (e = e.replace(r[0], m), g ? (c.regex.lastIndex += a.length, c.regex.lastIndex -= r[0].length) : c.regex.lastIndex = 0, o++, o >= this.maxReplaces) break
      }
    }), e
  }
  nest(e, t) {
    ...
    for (; i = this.nestingRegexp.exec(e);) {
      ...
      if (r = t(o.call(this, i[1].trim(), a), a), r && i[0] === e && typeof r != "string") return r;
      typeof r != "string" && (r = X(r)), r || (this.logger.warn(`missed to resolve ${i[1]} for nesting ${e}`), r = ""), f && (r = l.reduce((h, g) => this.format(h, g, s.lng, {
        ...s,
...
class je extends J {
  ...
  loaded(e, t, s) {
    ...
    this.queue.forEach(l => {
      pe(l.loaded, [r], a), Fe(l, e), t && l.errors.push(t), l.pendingCount === 0 && !l.done && (Object.keys(l.loaded).forEach(f => {
        o[f] || (o[f] = {});
        const h = l.loaded[f];
...
const ae = () => ({
  ...
  oe = n => (typeof n.ns == "string" && (n.ns = [n.ns]), typeof n.fallbackLng == "string" && (n.fallbackLng = [n.fallbackLng]), typeof n.fallbackNS == "string" && (n.fallbackNS = [n.fallbackNS]), n.supportedLngs && n.supportedLngs.indexOf("cimode") < 0 && (n.supportedLngs = n.supportedLngs.concat(["cimode"])), n),
  K = () => {},
  Ie = n => {
...
class A extends J {
  ...
  init() {
    ...
    if (!this.options.isClone) {
      ...
      u.logger = C, u.resourceStore = this.store, u.languageUtils = g, u.pluralResolver = new Pe(g, {
        ...
        for (var d = arguments.length, m = new Array(d > 1 ? d - 1 : 0), p = 1; p < d; p++) m[p - 1] = arguments[p];
        e.emit(c, ...m)
  ...
  reloadResources(e, t, s) {
    const i = j();
    return typeof e == "function" && (s = e, e = void 0), typeof t == "function" && (s = t, t = void 0), e || (e = this.languages), t || (t = this.options.ns), s || (s = K), this.services.backendConnector.reload(e, t, r => {
      i.resolve(), s(r)
    }), i
  }
  use(e) {
  ...
  getFixedT(e, t, s) {
    ...
    const r = function(a, o) {
      ...
      let c;
      return l.keyPrefix && Array.isArray(a) ? c = a.map(d => `${l.keyPrefix}${u}${d}`) : c = l.keyPrefix ? `${l.keyPrefix}${u}${a}` : a, i.t(c, l)
    };
  ...
  cloneInstance() {
    ...
    }, s && (r.store = new te(this.store.data, i), r.services.resourceStore = r.store), r.translator = new z(r.services, i), r.translator.on("*", function(o) {
      for (var l = arguments.length, f = new Array(l > 1 ? l - 1 : 0), h = 1; h < l; h++) f[h - 1] = arguments[h];
      r.emit(o, ...f)
