...
const Bn = L("mining/info", async () => (await Is.info()).data),
  ...
  Qm = () => e.jsxs("div", {
    ...
    children: [e.jsx(Cm, {}), e.jsx(Um, {}), e.jsx(Om, {}), e.jsx(Fm, {}), e.jsx(Ju, {}), e.jsx(Ks, {
      text: "Quick start"
      ...
      Pr(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === pp[1] && vt.getState().daily.list.entities[d.good_id]) {
...
const Yg = u.memo(() => (u.useEffect(() => {
  ...
  M_ = () => {
    ...
    return e.jsxs(hn, {
      show: n,
      setShow: a,
      children: [s === ue.paintReward && e.jsx(D_, {}), s === ue.reChargeSpeed && e.jsx(k_, {}), s === ue.energyLimit && e.jsx(R_, {})]
    })
  },
  U_ = () => e.jsxs("div", {
    className: os.layout,
    ...
    return u.useEffect(() => {}, []), u.useEffect(() => {
      if (t !== null) {
        ...
        const P = async () => {
          ...
          BN(We), f.putImageData(We, 0, 0), a(We), o(b.toDataURL())
        };
        setTimeout(() => {
          P().then(() => {
            h(!1)
  ...
  wP = () => !Ye.devServer && !Ye.isDev ? e.jsxs("div", {
    className: G.soon,
    children: ["Something will happen here,", e.jsx("br", {}), " but not now."]
  }) : e.jsxs("div", {
    children: [e.jsx("div", {
  ...
  jP = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === qe.create && e.jsx(SI, {}), t === qe.main && e.jsx($I, {}), t === qe.result && e.jsx(wP, {})]
    })
  },
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            onPointerUp: async () => {
              ...
              t.push("/"), n(vp()), v.mainImage.pixanosRepaint(a.info.seed, E.width, a.info.percentage, a.info.color), (r = (o = window.Telegram.WebApp) == null ? void 0 : o.HapticFeedback) == null || r.notificationOccurred("error")
            },
            children: "Whoosh!"
          })]
        })]
