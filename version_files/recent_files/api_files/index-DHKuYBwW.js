...
var Wr = (t, n, s) => n in t ? Jr(t, n, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: s
}) : t[n] = s;
var Qn = (t, n, s) => Wr(t, typeof n != "symbol" ? n + "" : n, s);
import {
  j as e,
  r as A,
  R as te
...
const Ac = "_stars_img_container_1wci0_1",
  mc = "_stars_img_1wci0_1",
  pc = "_scalebubble_1wci0_1",
  hc = "_squads_img_1wci0_17",
  gc = "_title_container_1wci0_22",
  _c = "_description_container_1wci0_28",
  fc = "_description_1wci0_28",
  xc = "_info_layout_1wci0_42",
  yc = "_info_container_1wci0_52",
  vc = "_info_row_1wci0_59",
  wc = "_info_row_content_1wci0_65",
  jc = "_info_row_sale_1wci0_84",
  bc = "_not_active_1wci0_100",
  Nc = "_selected_1wci0_105",
  Ic = "_row_icon_container_1wci0_110",
  Cc = "_row_icon_1wci0_110",
  Pc = "_row_title_1wci0_133",
  ...
  kc = ["/transaction/user/start", "/repaint/finish", "/transaction/user/complete", "/stars/shop/process", "/mining/status/claim", "/mining/claim", "/mining/status/error", "/repaint/complete", "/stars/shop/reject", "/squads/list/get", "/squads/list/update"],
  Ze = {
    my: "my",
    referred: "referred",
    world: "world"
  ...
  Uc = "https://image.notpx.app/api/v2/image";
let Ki;
const Oc = t => {
    Ki = t
  },
...
const Yc = {
  ...
  }),
  {
    ...
    addAvailable: Jt,
    subAvailable: Hs,
    setSelectedCurrency: jn,
    setLimitedGoods: hR,
    clearLimitedGoods: gR,
    showLimitedGoodsPopup: Wc,
    hideLimitedGoodsPopup: _R
  } = so.actions,
  Ha = t => t.shop.crypto,
  Zc = so.reducer,
  Gs = {
  ...
  _l = (t, n) => n < 5 ? Qt[1] : n < 10 ? Qt[5] : n < 100 ? Qt[10] : n < 500 ? Qt[100] : n < 1e3 ? Qt[500] : Qt[1e3],
  Ft = {
    1: $c,
    5: el,
    10: tl,
  ...
  fl = (t, n) => n < 5 ? Ft[1] : n < 10 ? Ft[5] : n < 100 ? Ft[10] : n < 500 ? Ft[100] : n < 1e3 ? Ft[500] : Ft[1e3],
  xl = () => zs,
  yl = () => ao,
  vl = () => io,
  zt = {
  ...
  wl = (t, n) => n < 5 ? zt[1] : n < 10 ? zt[5] : n < 100 ? zt[10] : n < 500 ? zt[100] : n < 1e3 ? zt[500] : zt[1e3],
  ui = {
    9: eo,
    10: to,
    11: no
  ...
  Jn = Pl,
  Sl = () => window.location.hostname.split(".").length === 3,
  Tl = () => !1,
  uo = () => window.location.hostname.includes("dev"),
  Bl = () => uo() ? Jn.VITE_ADSGRAM_BLOCK_ID : Sl() ? "4853" : "4995",
  _t = {
    isDev: Tl(),
    devServer: uo(),
  ...
  El = () => window.Telegram.WebApp.isVersionAtLeast(8) ? window.Telegram.WebApp.safeAreaInset : {
    top: 0,
    bottom: 0,
    left: 0,
    right: 0
  },
  Dl = () => window.Telegram.WebApp.isVersionAtLeast(8) ? window.Telegram.WebApp.contentSafeAreaInset : {
    top: 0,
    bottom: 0,
    left: 0,
    right: 0
  ...
  Hl = "_header_btihg_1",
  Gl = "_header_bottom_container_btihg_14",
  ql = "_header_bottom_btihg_14",
  Xl = "_header_placeholder_btihg_39",
  Vl = "_header_content_btihg_45",
  Yl = "_league_btihg_56",
  Jl = "_bronze_btihg_66",
  Wl = "_silver_btihg_67",
  Zl = "_gold_btihg_68",
  Kl = "_platinum_btihg_69",
  $l = "_diamond_btihg_70",
  ed = "_logo_link_btihg_72",
  td = "_logo_btihg_72",
  De = {
    header: Hl,
    header_bottom_container: Gl,
    header_bottom: ql,
    header_placeholder: Xl,
    header_content: Vl,
    league: Yl,
    bronze: Jl,
    silver: Wl,
  ...
  od = t => `${t.includes("@")?"":"@"}${t}`,
  pi = t => t.replace("@", ""),
  Sn = (t, n = 18, s = !0) => t.slice(0, n) + (t.length > n && s ? "..." : ""),
  tn = t => {
  ...
  nn = async t => {
  ...
  }, ho = t => new Promise(n => setTimeout(n, t)), rd = t => {
    ...
    try {
      ...
      return rd(n.coords) || (n.coords = !1), n.showTemplate && (n.coords = !1), n
    } catch {
      return {
        coords: !1,
        squad: !1,
  ...
  }, Ia = t => !0, ud = "_layout_13e1w_1", Ad = "_container_13e1w_10", md = "_star_13e1w_14", pd = "_move_13e1w_1", Fn = {
    layout: ud,
    container: Ad,
    star: md,
    move: pd
  }, hd = "_link_1fn8i_1", gd = "_telegram_icons_1fn8i_13", go = {
    link: hd,
    telegram_icons: gd
  }, N = ({
    children: t,
  ...
  }, () => !1), fd = "_layout_1nbfl_1", xd = "_button_1nbfl_14", hi = {
    layout: fd,
    button: xd
  }, yd = () => {
    const t = W();
  ...
  }, vd = "_layout_gx8in_1", wd = "_container_gx8in_5", jd = "_item_gx8in_11", bd = "_active_gx8in_20", Nd = "_image_container_gx8in_24", Id = "_image_gx8in_24", Cd = "_item_text_container_gx8in_34", Pd = "_item_text_gx8in_34", lt = {
    layout: vd,
    container: wd,
    item: jd,
    active: bd,
    ...
    setPixelsForSaleTotal: Bd,
    setPixelsForSaleFetchStatus: Ed,
    removePixelsForSale: Dd,
    setPixelsSoldOffset: fR,
    setPixelsSoldTotal: xR,
  ...
  }, Md = t => t.user.userPic, Oe = t => t.user.user, Ud = _o.reducer, Et = {
    getPixelsForSale: Wn,
  ...
  }, Qd = "/assets/icon_coin-COCalNMQ.gif", Fd = "/assets/icon_stars-BmDiRMAW.gif", zd = {
    items: []
  }, vo = pe({
    name: "toast",
    initialState: zd,
  ...
  }), au = "_pixels_amount_ngjsa_1", iu = "_general_info_container_ngjsa_6", ou = "_coin_amount_text_ngjsa_12", ru = "_description_container_ngjsa_16", cu = "_description_ngjsa_16", zn = {
    pixels_amount: au,
    general_info_container: iu,
    coin_amount_text: ou,
    description_container: ru,
    description: cu
  }, lu = "_logo_container_1i5of_1", du = {
    logo_container: lu
  }, uu = "_layout_1cvcu_1", Au = "_container_1cvcu_10", mu = "_bubble_1cvcu_16", pu = "_move_1cvcu_1", ra = {
    layout: uu,
    container: Au,
    bubble: mu,
    move: pu
  ...
  }, () => !1), gu = "_container_1aw3i_1", _u = "_logo_1aw3i_9", fu = "_animate_1aw3i_1", xu = "_center_1aw3i_18", yu = "_glow_1aw3i_28", Ln = {
    container: gu,
    logo: _u,
    animate: fu,
    center: xu,
  ...
  }), ju = "_container_13oyr_1", bu = "_button_13oyr_11", Nu = "_info_13oyr_32", gt = {
    container: ju,
    button: bu,
    info: Nu
  };
...
const es = O("mining/info", async () => (await qs.info()).data),
  ...
  Io = A.memo(({
    ...
    const [s, a] = A.useState(Xu()), [i, o] = A.useState(!1);
    return A.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  Zu = () => c(n => n.mining.infoStatus) !== p.fulfilled ? e.jsx(Wu, {}) : e.jsx(Ju, {}),
  Ku = () => {
  ...
  $u = "_info_layout_bt2qf_1",
  eA = "_info_container_bt2qf_10",
  tA = "_category_container_bt2qf_16",
  nA = "_category_title_bt2qf_22",
  sA = "_row_container_bt2qf_27",
  aA = "_info_row_bt2qf_35",
  iA = "_info_row_pending_bt2qf_59",
  oA = "_loading_bt2qf_1",
  rA = "_content_bt2qf_74",
  cA = "_image_container_bt2qf_83",
  lA = "_image_bt2qf_83",
  dA = "_row_main_information_bt2qf_103",
  uA = "_row_title_bt2qf_114",
  AA = "_row_icon_container_bt2qf_120",
  mA = "_row_icon_bt2qf_120",
  pA = "_row_main_value_bt2qf_130",
  hA = "_row_prompt_bt2qf_137",
  gA = "_not_pixel_icon_bt2qf_142",
  _A = "_row_image_bt2qf_147",
  fA = "_row_reward_count_bt2qf_153",
  xA = "_row_reward_completed_bt2qf_158",
  yA = "_priceless_bt2qf_165",
  vA = "_completed_tasks_container_bt2qf_169",
  wA = "_completed_task_item_bt2qf_176",
  m = {
    info_layout: $u,
    info_container: eA,
    category_container: tA,
    category_title: nA,
    row_container: sA,
    info_row: aA,
    info_row_pending: iA,
    ...
    row_image: _A,
    row_reward_count: fA,
    row_reward_completed: xA,
    priceless: yA,
    completed_tasks_container: vA,
    completed_task_item: wA
  },
  Z = ({
    children: t,
    boost: n,
  ...
  CA = "data:image/png;base64,",
  Je = ({
    num: t
  ...
  BA = "data:image/png;base64,",
  EA = () => {
    const t = W(),
      n = y.invite3frens;
  ...
  DA = "data:image/png;base64,",
  kA = () => {
    const t = y.joinSquad;
...
const vi = () => {
  ...
  Qm = () => e.jsxs("div", {
    ...
    children: [e.jsx(lm, {}), e.jsx(bm, {}), e.jsx(Pm, {}), e.jsx(Em, {}), e.jsx(Mm, {}), e.jsx(fm, {}), e.jsx(hm, {}), e.jsx(Om, {}), e.jsx(pm, {}), e.jsx(PA, {}), e.jsx(da, {
      text: "Quick start"
    }), e.jsx(TA, {}), e.jsx(EA, {}), e.jsx(kA, {}), e.jsx(da, {
      text: "Special"
    }), e.jsx(LA, {}), e.jsx(um, {}), e.jsx(mm, {}), e.jsx(sm, {}), e.jsx(YA, {}), e.jsx(XA, {}), e.jsx(bA, {}), e.jsx(RA, {}), e.jsx(MA, {}), e.jsx(UA, {}), e.jsx(FA, {}), e.jsx(ym, {}), e.jsx(da, {
      text: "Browser"
    }), e.jsx(NA, {}), e.jsx(IA, {}), e.jsx(HA, {}), e.jsx(GA, {}), e.jsx(QA, {}), e.jsx("div", {
      style: {
        height: 30
      }
    })]
...
const Bo = xn.getSelectors(t => t.tournament.approvedTemplatesList),
  up = () => {
...
const Pa = O("canvas/getPixelInfo", async ({
  ...
  yp = () => qa() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  vp = {
    coords: null,
    animations: yp(),
    stats: null,
  ...
  Ro = pe({
    ...
    reducers: {
      ...
      addPaintCoords: (t, n) => {
        ft(n.payload) && (t.stats = it(n.payload) ^ 3201282)
      }
    },
    extraReducers: t => {
...
const sn = Uo,
  ...
  Re = ({
    ...
    className: `${Sa.item} ${t?Sa.active:""}`,
    onPointerUp: () => {
      n()
    },
    children: s
  }),
  Qo = t => t ? t.friends >= Mc.friendsForTemplateCreation || t.isContractor : !1,
  Be = {
    create: "create",
    main: "main",
    result: "result"
  ...
  fh = () => {
    ...
    return e.jsxs(an, {
      children: [a && i && e.jsx(Re, {
        active: n === Be.create,
        setActive: () => t(yn(Be.create)),
        children: "My template"
      }), e.jsx(Re, {
        active: n === Be.main,
        setActive: () => t(yn(Be.main)),
        children: "Tournament"
      }), e.jsx(Re, {
        active: n === Be.result,
        setActive: () => t(yn(Be.result)),
        children: "My results"
      })]
    })
  };
...
const rs = O("tournament/getPeriods", async () => (await Fo.getPeriods()).data),
  cs = O("tournament/getResults", async () => (await Fo.getResults()).data),
  ls = O("tournament/getMyTemplate", async ({
    id: t
  }) => (await Pe.getTournamentTemplateById({
    id: t
  })).data),
  ds = O("tournament/getSelectedTemplate", async () => (await Pe.getSelectedTemplate()).data),
  us = O("tournament/getApprovedTemplatesList", async ({
    offset: t,
    limit: n
  ...
  As = O("tournament/getRandomTemplatesList", async () => (await Pe.getRandomTemplates()).data),
  ms = O("tournament/selectTemplate", async ({
    id: t
  ...
  xh = {
    ...
    approvedTemplatesList: xn.getInitialState(),
  ...
  zo = pe({
    ...
    reducers: {
      ...
      clearApprovedTemplateList: t => {
        t.approvedTemplatesList = xn.getInitialState(), t.approvedTemplatesListOffset = 0
      },
    ...
    extraReducers: t => {
      t.addCase(ls.pending, n => {}).addCase(ls.fulfilled, (n, s) => {
        ...
        s.payload && s.payload.list && (xn.addMany(n.approvedTemplatesList, s.payload.list.map(a => ({
          ...a,
          url: `${a.url}${An}`
        ...
        s.payload && s.payload.list && xn.setAll(n.approvedTemplatesList, s.payload.list.map(a => ({
          ...a,
          url: `${a.url}${An}`
  ...
  }),
  {
    ...
    setActiveTournamentTemplate: Wa,
    hideTournamentTemplates: Za,
    setShowTournamentDetailsPopup: Lo,
    setShowRoundRewardsPopup: Ho,
    changeTemplateCoordsIfNeeded: Go,
    setMyTournamentTemplate: SR,
    clearApprovedTemplateList: qo,
    showTournamentTemplateInfoPopup: Ka,
    closeTournamentTemplateInfoPopup: ma,
    setSelectedTemplate: Xo
  } = zo.actions,
  Me = {
    getMyTemplate: ls,
...
const Ih = (t, n) => {
    ...
    Ia() && (s = {
    ...
    }), st = new oc(za.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), st.on("connected", function(a) {
      ...
      o.src = URL.createObjectURL(i), o.onload = () => {
        v.mainImage.loadFromCentrifuge(o).then(() => {
          const l = tt.getState().main.startParams.coords;
          ...
          }), v.mainImage.selectedPixel.draw(l), tt.dispatch(Dt(l)))
        })
      }
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          ...
          if (r.type === sa.pixanos && tt.dispatch(Bh(l)), l.user.userId === n || !Nn) return;
          const u = tt.getState().canvas.animations;
          if (r.type === sa.bomb) {
      ...
      rc(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === bh[1] && tt.getState().daily.list.entities[d.good_id]) {
              const u = tt.getState().daily.list.entities[d.good_id],
                h = u.name,
  ...
  Ph = {
    ...
    lastShowChargesPopupTs: Date.now() - Dc,
  ...
  }),
  {
    ...
    disableFastType: Ut,
    enableFastEnergy: Th,
    disableFastEnergy: Wo,
    showPixanosEvent: Bh,
    hidePixanosEvent: Eh,
    setPixanosProcessing: bi,
    setShowIntro: BR,
    setShowBetaTestIntro: ER,
    addFlyingReward: Dh,
    removeFlyingReward: kh,
    showInviteFrensPopup: DR,
    hideInviteFrensPopup: pa,
    showNoChargesPopup: kR,
    hideNoChargesPopup: ha,
    setLastShowChargesPopupTs: RR,
    setShowMiningDetailsPopup: Zo,
    setShowBoostDetailsPopup: $a,
...
const Cg = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(Ls(10)), t(ot(1)), t(rt()), t(Wo()), !1;
  if (s === a) return !1;
  if (ga) return p.pending;
  ga = !0, t(at({
    command: ke.start
  }));
  try {
    (await t(Gs.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === p.fulfilled && (t(Bu(a)), t(Hs({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: Tt
} = nr.actions, sr = t => t.layout.isShowSideMenu, Tg = nr.reducer;
let Ht = null,
  Gt = null;
class ar {
...
const ps = O("ratings/personal", async ({
    league: t
  }) => (await ar.personal({
    league: t
  })).data),
  hs = O("ratings/squad", async ({
    league: t
  }) => (await ar.squad({
    league: t
  })).data),
...
const ti = {
  ...
  wt = en();
wt.startListening({
  matcher: he(ye.info.fulfilled),
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Bd(t.payload.totalUserPixels)), n.dispatch(xo(t.payload.userBalance))), n.dispatch(Jc(t.payload.goods))
  }
});
wt.startListening({
  matcher: he(ye.checkTask.fulfilled),
  effect: (t, n) => {
...
wt.startListening({
  matcher: he(ye.checkBoost.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s];
    let i = "Not enough PX",
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === me.energyLimit) {
        ...
        n.dispatch(Su(s.mining.maxCharges + d)), n.dispatch(bo(d))
      }
...
wt.startListening({
  matcher: he(ye.checkTask.rejected),
  effect: (t, n) => {
    n.dispatch(U({
      id: performance.now(),
      text: "Check failed",
...
wt.startListening({
  matcher: he(ye.checkBoost.rejected),
  effect: (t, n) => {
    n.dispatch(U({
      id: performance.now(),
      text: "Not enough PX",
...
const Js = en();
Js.startListening({
  matcher: he(Xs.getPriceMask.pending, Et.getPixelsForSale.pending, Et.getPixelsSold.pending, ti.get.pending),
  effect: (t, n) => {
    n.dispatch(at({
      command: ke.start
    }))
...
Js.startListening({
  matcher: he(Xs.getPriceMask.fulfilled, Et.getPixelsForSale.fulfilled, Et.getPixelsSold.fulfilled, ti.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(at({
      command: ke.finish
    }))
...
cr.startListening({
  ...
  effect: (t, n) => {
    n.dispatch(or(t.payload.data.league))
  }
});
const Rn = en();
Rn.startListening({
...
const lr = en();
lr.startListening({
  matcher: he(ei.squad.fulfilled),
  effect: (t, n) => {
    n.dispatch(Rd(t.payload.mySquad))
  }
});
const Mg = {
    info: null,
...
const Ug = dr.reducer,
  ...
  Qg = O("template/subscribe", async ({
    id: t
  }) => (await Pe.subscribeToTemplate({
    id: t
  })).data),
  fs = O("template/getTemplateList", async ({
    offset: t,
    limit: n
  ...
  Fg = O("template/getAvailableSizes", async ({
    userId: t
  }) => (await Pe.getAvailableSizes({
    userId: t
  })).data),
  xs = O("template/getReferredTemplate", async () => (await Pe.getReferredTemplate()).data),
  Ea = O("template/getMyTemplate", async ({
    id: t
  }) => (await Pe.getTemplateById({
    id: t
  })).data),
  ys = O("template/getWorldTemplate", async () => ({
    x: (T.width - 256) / 2,
    y: (T.height - 256) / 2,
    imageSize: 256,
    url: Og,
  ...
  ur = pe({
    ...
    extraReducers: t => {
      ...
      }).addCase(xs.rejected, (n, s) => {}).addCase(Ea.pending, n => {}).addCase(Ea.fulfilled, (n, s) => {}).addCase(ys.pending, (n, s) => {}).addCase(ys.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: Ze.world
        };
        n.worldTemplate = a, v.mainImage.worldTemplate.add(a)
      }).addCase(ys.rejected, (n, s) => {}).addCase(fs.pending, n => {
  ...
  vs = O("daily/getList", async () => (await J.getDailyList()).data),
  ws = O("daily/getFirstDaily", async () => (await J.getFirstDaily()).data),
  pr = pe({
    name: "daily",
    initialState: Vg,
    reducers: {
  ...
  rn = en();
rn.startListening({
  matcher: he(Me.getMyTemplate.fulfilled),
  effect: (t, n) => {
    const s = n.getState();
...
rn.startListening({
  matcher: he(Me.getSelectedTemplate.fulfilled, Xo),
  effect: (t, n) => {
    const s = n.getState();
...
rn.startListening({
  matcher: he(Go),
  effect: t => {
    v.mainImage.tournamentTemplates.changeTemplateCoords(t.payload)
  }
});
const Mn = Kr({
    reducer: {
    ...
    devTools: !1,
    middleware: t => [Rn.middleware, cr.middleware, Js.middleware, wt.middleware, lr.middleware, rn.middleware, ...t()]
  }),
  bs = [],
  o_ = async ({
    dispatch: t,
    ...
    await t(Dh({
      ...
      id: it(s),
      color: St(a)
    }), v.mainImage.updateTexture(), await t(Ah(a)), await t(bp(s)), await t(Du());
    try {
      ...
      d && d.balance && (t(xo(d.balance)), d.reward_user && d.reward_user.reward_id && (v.mainImage.reward.add(s), t($g({
    ...
    return i === "paintcan" && l.push(C.fast_mode_button_enabled), s ? e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "paintcan") {
          t(Ut());
          return
        }!a || a === 0 ? (t(ot(n)), t(rt())) : t(Ys("paintcan"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: C.button_image,
...
let U_ = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [__, f_, x_, y_, v_, w_, j_, b_, N_, I_, C_, P_, S_, T_, B_, E_, D_, k_, R_, M_], this.textureArray = [];
    ...
    return i === "pumpkin" && l.push(C.fast_mode_button_enabled), !s || !a || a === 0 ? null : e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "pumpkin") {
          t(Ut());
          return
        }!a || a === 0 ? (t(ot(n)), t(rt())) : t(Ys("pumpkin"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: C.button_image,
...
class G_ {
  ...
  async loadAllChunks() {
    const n = await this.loadImage(Uc),
...
const K_ = A.memo(() => (A.useEffect(() => {
  ...
  tf = () => c(Ya.selectAll).map(n => e.jsx(ef, {
    item: n
  }, it({
    x: n.x,
    y: n.y
  ...
  Lf = () => {
    ...
    return e.jsxs(Mt, {
      show: n,
      setShow: a,
      children: [s === me.paintReward && e.jsx(Qf, {}), s === me.reChargeSpeed && e.jsx(Ff, {}), s === me.energyLimit && e.jsx(zf, {})]
    })
  },
  Hf = () => e.jsxs("div", {
    className: Ns.layout,
  ...
  Gf = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(Fm, {}), t === "tasks" && e.jsx(Qm, {}), t === "pixels" && e.jsx(of, {}), t === "boosts" && e.jsx(Hf, {})]
    })
  },
  qf = () => {
    const t = g(),
  ...
  Zx = () => {
    ...
    return A.useEffect(() => {
      ...
      children: [e.jsx(Vx, {}), e.jsx(Yx, {}), e.jsx(Wx, {})]
    })
  },
  Kx = () => e.jsx(te.Fragment, {
  ...
  ny = () => (c(t => t.ratings.league), c(yo), c($o), e.jsx("div", {
    className: ey.container,
    children: e.jsx(ty, {})
  })),
  sy = "_container_d5ybi_1",
  ay = {
    container: sy
  },
  iy = () => {
  ...
  oy = "/assets/icon_squad-_NF17RUb.gif",
  ry = "/assets/icon_squad_secret-B-fF264Z.gif",
  cy = () => {
  ...
  ly = () => {
    ...
    return e.jsxs(le, {
      children: [e.jsx(cy, {}), e.jsx(Fx, {
        selectedSection: t,
        setSelectedSection: n
      }), e.jsx(Xx, {}), e.jsx(Mx, {
        isPlayers: t === "Painters"
      }), e.jsxs(qx, {
        children: [t === "Painters" && e.jsx(ny, {}), t === "Squads" && e.jsx(iy, {}), t === "Squads" && e.jsx(Zx, {}), t === "Painters" && e.jsx(Hx, {}), s !== p.fulfilled && e.jsx(Kx, {})]
      })]
    })
  },
  dy = ({
  ...
  py = "_expandable_panel_1v9vd_1",
  hy = "_divider_1v9vd_16",
  gy = "_divider_spacer_1v9vd_24",
  _y = "_divider_pointer_1v9vd_28",
  vn = {
  ...
  yy = "_container_1vu8i_1",
  vy = "_owner_1vu8i_10",
  wy = "_id_1vu8i_14",
  jy = "_date_1vu8i_19",
  by = "_avatar_container_1vu8i_24",
  Ny = "_avatar_1vu8i_24",
  Iy = "_squad_avatar_container_1vu8i_36",
  Cy = "_text_container_1vu8i_48",
  Py = "_dot_1vu8i_54",
  Sy = "_user_name_1vu8i_59",
  Ty = "_squad_name_1vu8i_64",
  de = {
    container: yy,
    owner: vy,
    id: wy,
    ...
    avatar_container: by,
    avatar: Ny,
    squad_avatar_container: Iy,
    text_container: Cy,
    dot: Py,
    user_name: Sy,
    squad_name: Ty
  },
  By = "_skeleton_k7kmi_1",
  Ey = "_loading_k7kmi_1",
  Dy = {
    skeleton: By,
    loading: Ey
  ...
  Un = ({
    ...
    let i = od(s === null ? t : s);
    return n > 0 && (i = Sn(i, n)), e.jsx("span", {
      className: go.link,
      onPointerUp: o => {
  ...
  Ry = () => {
    ...
    const i = Sn(t.owner.firstName || "No name");
    return (() => {
  ...
  Qy = () => e.jsxs("div", {
    ...
    children: [e.jsx(Oy, {}), e.jsx(ky, {}), e.jsx(Uy, {}), e.jsx(Ry, {}), e.jsx(My, {})]
  }),
  Fy = "_category_text_epppt_1",
  zy = "_latest_used_container_epppt_8",
  Ly = "_color_line_epppt_15",
  Hy = "_color_item_epppt_22",
  Gy = "_pipette_container_epppt_30",
  qy = "_child_scale_epppt_48",
  br = {
    category_text: Fy,
    latest_used_container: zy,
    color_line: Ly,
    color_item: Hy,
  ...
  $y = ({
    ...
    return A.useEffect(() => {
      ...
      children: [e.jsx(Ky, {
        ...
        children: [e.jsx(fy, {
          active: s
        }), s === 1 && e.jsx(Zy, {}), s === 2 && e.jsx(Qy, {})]
      })]
    })
  },
  ev = () => c(Fe) ? null : e.jsxs("button", {
    className: re.button,
    onPointerUp: () => {
  ...
  iv = () => c(n => n.canvas.coords) === null ? null : e.jsx(te.Fragment, {
    children: e.jsx(av, {})
  }),
  ov = "_layout_14eqc_1",
  rv = "_container_14eqc_9",
  cv = "_button_14eqc_13",
  xa = {
    layout: ov,
    container: rv,
  ...
  gv = () => null,
  _v = "_layout_14a3l_1",
  fv = "_container_14a3l_11",
  xv = "_image_14a3l_26",
  yv = "_text_14a3l_31",
  vv = "_gold_14a3l_37",
  wv = "_winning_14a3l_44",
  jv = "_loosing_14a3l_48",
  Ce = {
    layout: _v,
    container: fv,
    image: xv,
  ...
  Mv = "_panel_1urz2_1",
  Uv = "_content_1urz2_16",
  Si = {
    panel: Mv,
    content: Uv
  },
  Ov = () => c(n => n.canvas.coords) !== null ? null : e.jsx("div", {
    className: Si.panel,
    children: e.jsx("div", {
  ...
  Qv = "_layout_1v16g_1",
  Fv = "_container_1v16g_5",
  zv = "_close_button_1v16g_14",
  Lv = "_title_container_1v16g_22",
  Hv = "_image_container_1v16g_28",
  Gv = "_image_1v16g_28",
  qv = "_first_image_1v16g_45",
  Xv = "_second_image_1v16g_50",
  Vv = "_text_container_1v16g_55",
  ...
  ew = "_layout_srn55_1",
  tw = "_container_srn55_12",
  nw = "_buttons_container_srn55_18",
  ya = {
    layout: ew,
    container: tw,
    buttons_container: nw
  },
  sw = "_container_srbwq_1",
  aw = {
    container: sw
  },
  iw = ({
  ...
  rw = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(iw, {
        ...
        max: Ei,
        onChange: o => {
          n(Lg(o)), v.mainImage.worldTemplate.setOpacity(Number(o[0])), v.mainImage.tournamentTemplates.setOpacity(Number(o[0]))
        },
        renderTrack: ({
          props: o,
          children: r
  ...
  cw = () => c(n => n.tournament.activeTournamentTemplate) === null ? null : e.jsx("div", {
    className: aw.container,
    children: e.jsx(rw, {})
  }),
  lw = "_button_14giw_2",
  dw = "_image_14giw_22",
  uw = "_enabled_14giw_29",
  Aw = "_animation_14giw_33",
  mw = "_scaleInfinity_14giw_1",
  pw = "_gray_14giw_38",
  hw = "_indicator_14giw_42",
  pt = {
    button: lw,
    image: dw,
    enabled: uw,
  ...
  gw = () => {
    ...
    return r && o.push(pt.enabled), e.jsx("button", {
      ...
      onPointerUp: () => {
        if (!i) {
          t(yn(Be.create)), n.push("/tournament");
          return
        }
        r ? t(Za()) : (v.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
  ...
  _w = () => {
    ...
    return c(d => d.tournament.selectedTemplateStatus) === p.pending ? null : (i && o.push(pt.enabled), s || o.push(pt.animation), e.jsxs("button", {
      ...
      onPointerUp: d => {
        if (!s || !r) {
          t(yn(Be.main)), n.push("/tournament");
          return
        }
        i ? t(Za()) : (v.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(gw, {}), e.jsx(_w, {}), e.jsx(cw, {})]
        })
      })
    })
  }),
  xw = "_layout_1a5xo_1",
  yw = "_container_1a5xo_5",
  Di = {
    layout: xw,
    container: yw
  },
  ...
  bw = () => c(n => n.canvas.coords) === null ? null : e.jsx("div", {
    className: Di.layout,
    children: e.jsxs("div", {
      className: Di.container + " " + C.container__bottom,
      children: [e.jsx(g_, {}), e.jsx(m_, {}), e.jsx(F_, {}), e.jsx(Pg, {}), e.jsx(vw, {}), e.jsx(ww, {}), e.jsx(jw, {})]
    })
  }),
  Nw = "_layout_swx97_1",
  Iw = {
  ...
  Cw = () => e.jsxs("div", {
    className: Iw.layout,
    children: [e.jsx(bw, {}), e.jsx(iv, {})]
  }),
  Pw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(Iv, {}), e.jsx(lv, {}), e.jsx(fw, {}), e.jsx(hv, {}), e.jsx(Cw, {}), e.jsx(Ov, {}), e.jsx(Rv, {}), e.jsx($v, {}), e.jsx(Cv, {}), e.jsx(gv, {})]
  }),
  Sw = "_page_title_13ybj_1",
  Tw = "_container_13ybj_9",
  Bw = "_item_13ybj_13",
  Ew = "_active_13ybj_18",
  Dw = "_info_container_13ybj_34",
  kw = "_dot_13ybj_40",
  Rw = "_title_text_13ybj_46",
  Mw = "_capitalize_13ybj_50",
  Uw = "_hint_text_13ybj_54",
  Ow = "_date_text_13ybj_61",
  Qw = "_value_container_13ybj_66",
  ...
  ej = ({
    ...
    item: t
  }) : t.action === "get boost" ? e.jsx(Vw, {
    item: t
  }) : t.action === "league transfer" ? e.jsx(Yw, {
    item: t
  }) : t.action === "referral" ? e.jsx(Jw, {
    item: t
    ...
    item: t
  }) : t.action === "referrer reward" ? e.jsx($w, {
    item: t
  ...
  sj = "_text_layout_1xggq_1",
  aj = "_text_1xggq_1",
  ij = "_button_layout_1xggq_14",
  oj = "_button_layout_placeholder_1xggq_26",
  rj = "_button_1xggq_14",
  pn = {
    text_layout: sj,
    text: aj,
  ...
  lj = "_text_layout_1h04i_1",
  dj = "_text_1h04i_1",
  uj = "_button_layout_1h04i_14",
  Aj = "_button_layout_placeholder_1h04i_26",
  mj = "_button_1h04i_14",
  hn = {
    text_layout: lj,
    text: dj,
  ...
  hj = "_layout_1drph_1",
  gj = "_container_1drph_11",
  _j = "_bold_1drph_22",
  fj = "_info_container_1drph_26",
  xj = "_title_1drph_33",
  yj = "_description_1drph_38",
  vj = "_image_container_1drph_43",
  wj = "_image_1drph_43",
  jj = "_extra_info_container_1drph_53",
  bj = "_npx_tokens_1drph_77",
  ...
  Qj = "_button_layout_placeholder_q4wab_27",
  Fj = "_button_q4wab_15",
  ki = {
    text_layout: Mj,
    text: Uj,
  ...
  Lj = "_close_container_1mu9y_1",
  Hj = "_title_container_1mu9y_12",
  Gj = "_title_1mu9y_12",
  qj = "_frens_count_1mu9y_21",
  Xj = "_content_1mu9y_25",
  Vj = "_image_container_1mu9y_32",
  Yj = "_image_1mu9y_32",
  Jj = "_description_container_1mu9y_41",
  Wj = "_white_1mu9y_50",
  Zj = "_gray_1mu9y_54",
  Kj = "_purple_1mu9y_58",
  $j = "_bold_1mu9y_64",
  ...
  sb = "_benefits_item_1mu9y_92",
  ab = "_divider_1mu9y_98",
  ib = "_buttons_container_1mu9y_105",
  ob = "_button_copy_1mu9y_112",
  rb = "_button_1mu9y_105",
  cb = "_share_container_1mu9y_137",
  lb = "_share_row_1mu9y_143",
  ...
  ub = "/assets/sitting_chars_animation_outl-BdmQzfhn.gif",
  Ab = "_link_a4r15_1",
  mb = {
    link: Ab
  },
  ...
  hb = "_container_10f8u_1",
  gb = "_text_container_10f8u_9",
  _b = "_text_block_10f8u_16",
  fb = "_gray_10f8u_24",
  xb = "_total_10f8u_28",
  yb = "_bold_10f8u_33",
  vb = "_indicator_10f8u_37",
  wb = "_button_container_10f8u_46",
  jb = "_button_10f8u_46",
  Xe = {
    container: hb,
    text_container: gb,
  ...
  Eb = "_main_info_container_1gqs9_2",
  Db = "_image_container_1gqs9_11",
  kb = "_image_1gqs9_11",
  Rb = "_title_1gqs9_21",
  Mb = "_variants_container_1gqs9_25",
  Ub = "_variant_item_1gqs9_33",
  Ob = "_variant_left_container_1gqs9_39",
  Qb = "_variant_middle_container_1gqs9_45",
  Fb = "_dot_1gqs9_53",
  zb = "_variant_right_container_1gqs9_59",
  Lb = "_button_container_1gqs9_66",
  Hb = "_button_1gqs9_66",
  Gb = "_bold_1gqs9_96",
  qb = "_gray_1gqs9_100",
  Xb = "_blue_1gqs9_104",
  Vb = "_text_1gqs9_109",
  G = {
    main_info_container: Eb,
    image_container: Db,
    image: kb,
    title: Rb,
    variants_container: Mb,
    variant_item: Ub,
    variant_left_container: Ob,
    variant_middle_container: Qb,
    dot: Fb,
  ...
  t1 = "_small_title_5xtkt_23",
  n1 = "_content_5xtkt_32",
  s1 = "_image_container_5xtkt_40",
  a1 = "_image_placeholder_5xtkt_46",
  i1 = "_image_5xtkt_40",
  o1 = "_how_container_5xtkt_58",
  r1 = "_description_container_5xtkt_63",
  c1 = "_white_5xtkt_72",
  l1 = "_gray_5xtkt_76",
  d1 = "_bold_5xtkt_80",
  u1 = "_center_5xtkt_84",
  A1 = "_claim_button_container_5xtkt_88",
  m1 = "_claim_button_5xtkt_88",
  p1 = "_no_button_5xtkt_107",
  h1 = "_info_layout_5xtkt_119",
  g1 = "_rewards_layout_5xtkt_131",
  _1 = "_rewards_grid_container_5xtkt_137",
  f1 = "_reward_item_5xtkt_143",
  x1 = "_reward_item_completed_5xtkt_153",
  ...
  b1 = "_reward_item_amount_active_5xtkt_201",
  N1 = "_reward_item_amount_premium_5xtkt_205",
  I1 = "_reward_item_title_5xtkt_210",
  C1 = "_reward_item_title_premium_5xtkt_216",
  P1 = "_reward_item_image_5xtkt_183",
  R = {
    close_container: Zb,
    title_container: Kb,
    title: $b,
    ...
    content: n1,
    image_container: s1,
    image_placeholder: a1,
    image: i1,
    how_container: o1,
    description_container: r1,
    white: c1,
    gray: l1,
    bold: d1,
    center: u1,
    claim_button_container: A1,
    claim_button: m1,
    no_button: p1,
    info_layout: h1,
    rewards_layout: g1,
    rewards_grid_container: _1,
    reward_item: f1,
    reward_item_completed: x1,
    reward_item_content_container: y1,
    reward_item_active: v1,
    reward_item_image_container: w1,
    reward_item_amount: j1,
    reward_item_amount_active: b1,
    reward_item_amount_premium: N1,
    reward_item_title: I1,
    reward_item_title_premium: C1,
    reward_item_image: P1
  },
  S1 = ({
    secondsLeft: t
  }) => {
    ...
    if (r) {
      ...
      return t && (b = `Claim in ${ld(t)}`), h && (b = "Pending transaction..."), e.jsxs("div", {
        className: R.content,
        children: [e.jsx("div", {
          ...
          children: e.jsx(cn, {
            onPointerUp: H => {
              H.stopPropagation(), n(hr(!0))
            },
            children: "How it works"
          })
        }), e.jsxs("div", {
          className: R.claim_button_container,
          children: [j !== fe && e.jsx("button", {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("div", {
            ...
            children: n.map((o, r) => {
              ...
              let j = T1;
              return r >= 8 && r <= 15 && (j = B1), r >= 16 && r <= 23 && (j = E1), r >= 24 && r <= 31 && (j = D1), e.jsxs("div", {
                className: u.join(" "),
                onPointerUp: () => {
                  t(U({
                    id: performance.now(),
  ...
  Y1 = "_general_info_container_fv8d9_1",
  J1 = "_img_container_fv8d9_7",
  W1 = "_image_fv8d9_13",
  Z1 = "_title_fv8d9_19",
  K1 = "_description_container_fv8d9_25",
  $1 = "_description_fv8d9_25",
  qt = {
    general_info_container: Y1,
    img_container: J1,
    image: W1,
    title: Z1,
  ...
  n0 = "_no_template_container_uihlo_1",
  s0 = "_no_template_button_uihlo_10",
  a0 = "_template_container_uihlo_28",
  i0 = "_template_info_container_uihlo_35",
  o0 = "_template_info_uihlo_35",
  r0 = "_buttons_container_uihlo_44",
  c0 = "_button_copy_uihlo_53",
  l0 = "_button_uihlo_44",
  d0 = "_create_new_template_uihlo_72",
  Ye = {
    no_template_container: n0,
    no_template_button: s0,
    template_container: a0,
    template_info_container: i0,
    template_info: o0,
    buttons_container: r0,
    button_copy: c0,
    button: l0,
    create_new_template: d0
  },
  u0 = "_instruction_container_14ts7_1",
  A0 = "_img_container_14ts7_9",
  m0 = "_image_14ts7_15",
  p0 = "_instruction_text_14ts7_21",
  h0 = "_preview_container_14ts7_26",
  g0 = "_preview_image_container_14ts7_32",
  _0 = "_preview_image_14ts7_32",
  f0 = "_preview_image_loader_14ts7_45",
  x0 = "_template_size_14ts7_60",
  ...
  b0 = "_template_coords_14ts7_92",
  N0 = "_template_coordinates_title_14ts7_102",
  I0 = "_template_coords_container_14ts7_107",
  C0 = "_coords_item_14ts7_114",
  P0 = "_coords_input_14ts7_120",
  S0 = "_file_button_container_14ts7_129",
  T0 = "_file_button_14ts7_129",
  ne = {
    ...
    template_coords: b0,
    template_coordinates_title: N0,
    template_coords_container: I0,
    coords_item: C0,
    coords_input: P0,
    file_button_container: S0,
    file_button: T0
  },
  Ms = {
    16: 512,
  ...
  D0 = "_template_item_container_srp11_1",
  k0 = "_template_item_inner_srp11_9",
  R0 = "_template_image_srp11_17",
  M0 = "_template_image_info_layout_srp11_24",
  U0 = "_template_image_info_container_srp11_34",
  _n = {
    template_item_container: D0,
    template_item_inner: k0,
    template_image: R0,
    template_image_info_layout: M0,
    template_image_info_container: U0
  },
  Ir = ({
    item: t,
    style: n = {}
    ...
    return e.jsx("div", {
      ...
      onPointerUp: async () => {
        t.templateId && t.templateId !== 0 && s(Da({
          show: !0,
  ...
  F0 = () => e.jsxs("div", {
    children: [e.jsx(E0, {}), e.jsx(Q0, {})]
  }),
  z0 = "_layout_94gj5_1",
  L0 = "_container_94gj5_5",
  H0 = "_button_container_94gj5_11",
  G0 = "_button_94gj5_11",
  Us = {
    layout: z0,
    container: L0,
    ...
    return A.useEffect(() => (t(kt.getList({
      ...
      children: [e.jsx("div", {
        ...
        children: a.map(o => {
          ...
          let r = !1;
          return i !== null && Number(i.id) === Number(o.templateId) && (r = !0), e.jsx(Ir, {
            item: o,
            current: r
          }, o.templateId)
        })
  ...
  V0 = () => {
    ...
    return e.jsxs("div", {
      className: t0.info_layout,
      children: [t === "my" && e.jsx(F0, {}), t === "catalog" && e.jsx(X0, {})]
    })
  },
  Y0 = () => {
    const t = g(),
  ...
  J0 = () => e.jsxs(te.Fragment, {
    children: [e.jsx(Y0, {}), e.jsx(V0, {})]
  }),
  Ks = "/assets/paintings_anim2-nk1iBB8J.gif",
  W0 = "_container_1h1qc_1",
  Z0 = "_divider_1h1qc_19",
  K0 = "_row_1h1qc_24",
  $0 = "_row_title_1h1qc_36",
  eN = "_row_title_main_1h1qc_40",
  tN = "_row_hint_1h1qc_45",
  nN = "_row_value_1h1qc_51",
  sN = "_row_value_main_1h1qc_55",
  aN = "_mining_percent_1h1qc_60",
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(kt.subscribe({
              ...
              t(Hg(h)), v.mainImage.worldTemplate.deleteTemplate(o.id), v.mainImage.worldTemplate.add(h), t(Ar())
            } else await t(U({
              id: performance.now(),
  ...
  PN = "_container_s1r1v_1",
  SN = "_page_s1r1v_13",
  TN = "_id_s1r1v_17",
  BN = "_title_s1r1v_22",
  EN = "_avatar_container_s1r1v_28",
  DN = "_avatar_s1r1v_28",
  kN = "_squad_avatar_container_s1r1v_40",
  RN = "_text_container_s1r1v_52",
  MN = "_dot_s1r1v_58",
  UN = "_user_name_s1r1v_63",
  ON = "_squad_name_s1r1v_69",
  QN = "_divider_s1r1v_75",
  FN = "_tabs_content_s1r1v_81",
  zN = "_content_info_s1r1v_85",
  LN = "_content_info_item_s1r1v_92",
  HN = "_content_info_item_title_s1r1v_96",
  GN = "_content_info_item_value_s1r1v_100",
  qN = "_no_content_s1r1v_106",
  XN = "_achievements_container_s1r1v_115",
  L = {
    container: PN,
    page: SN,
    id: TN,
  ...
  YN = ({
    ...
    const i = Sn(n.firstName || "No name");
    return e.jsx("div", {
      className: L.text_container,
      children: e.jsx("span", {
        className: L.user_name,
  ...
  zI = "_red_12mk9_91",
  LI = "_divider_12mk9_95",
  HI = "_tabs_content_12mk9_101",
  GI = "_content_info_12mk9_105",
  qI = "_content_info_item_12mk9_112",
  XI = "_content_info_item_title_12mk9_116",
  VI = "_content_info_item_value_12mk9_120",
  YI = "_content_top_12mk9_127",
  JI = "_content_top_item_12mk9_140",
  ...
  B = {
    ...
    content_info_item_title: XI,
    content_info_item_value: VI,
    content_top: YI,
    content_top_item: JI,
  ...
  Tr = ({
    ...
    const a = (() => {
      var i;
      return Sn(((i = t == null ? void 0 : t.squad) == null ? void 0 : i.name) || "No name")
    })();
    return e.jsx("div", {
      className: B.text_container,
      children: e.jsx("span", {
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Pe.uploadTemplate({
              ...
              i(Gg(I)), i(Ar()), await v.mainImage.worldTemplate.add(I), i(U({
                id: performance.now(),
    ...
    return A.useEffect(() => {}, []), A.useEffect(() => {
      if (t !== null) {
        ...
        const j = async () => {
          ...
          lC(we), f.putImageData(we, 0, 0), a(we), o(I.toDataURL())
        };
        setTimeout(() => {
          j().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(AC, {}), i !== null && e.jsx(cC, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(B0, {
  ...
  pC = "_general_info_container_1u2nd_1",
  hC = "_img_container_1u2nd_7",
  gC = "_image_1u2nd_17",
  _C = "_image_cup_1u2nd_23",
  fC = "_image_glow_container_1u2nd_29",
  xC = "_image_glow_1u2nd_29",
  yC = "_rotate_1u2nd_1",
  vC = "_image_glow_reverse_1u2nd_48",
  wC = "_title_1u2nd_53",
  jC = "_description_container_1u2nd_60",
  bC = "_description_1u2nd_60",
  NC = "_gold_1u2nd_73",
  ze = {
    general_info_container: pC,
    img_container: hC,
    image: gC,
    image_cup: _C,
    image_glow_container: fC,
    image_glow: xC,
    rotate: yC,
    image_glow_reverse: vC,
    title: wC,
    description_container: jC,
    description: bC,
    gold: NC
  },
  IC = "_info_layout_1p9dg_1",
  CC = {
    info_layout: IC
  },
  PC = t => {
  ...
  SC = "_instruction_container_17lvx_1",
  TC = "_img_container_17lvx_9",
  BC = "_img_inner_container_17lvx_16",
  EC = "_image_17lvx_22",
  DC = "_image_status_17lvx_30",
  kC = "_image_status_rejected_17lvx_45",
  RC = "_image_status_review_17lvx_49",
  MC = "_image_status_approved_17lvx_53",
  UC = "_copy_button_container_17lvx_57",
  OC = "_button_copy_17lvx_65",
  QC = "_gray_17lvx_71",
  FC = "_preview_container_17lvx_75",
  zC = "_preview_image_container_17lvx_81",
  LC = "_preview_image_17lvx_81",
  HC = "_preview_image_loader_17lvx_94",
  GC = "_template_size_17lvx_109",
  qC = "_template_title_17lvx_117",
  XC = "_template_size_container_17lvx_122",
  VC = "_template_size_item_17lvx_128",
  YC = "_template_size_item_active_17lvx_136",
  JC = "_template_coords_17lvx_141",
  WC = "_template_coordinates_title_17lvx_151",
  ZC = "_template_coords_container_17lvx_156",
  KC = "_coords_item_17lvx_163",
  $C = "_coords_input_17lvx_169",
  eP = "_file_button_container_17lvx_178",
  tP = "_file_button_17lvx_178",
  ee = {
    instruction_container: SC,
    img_container: TC,
    img_inner_container: BC,
    image: EC,
    image_status: DC,
    image_status_rejected: kC,
    image_status_review: RC,
    image_status_approved: MC,
    copy_button_container: UC,
    button_copy: OC,
    gray: QC,
    preview_container: FC,
    preview_image_container: zC,
    preview_image: LC,
    preview_image_loader: HC,
    template_size: GC,
    template_title: qC,
    template_size_container: XC,
    template_size_item: VC,
    template_size_item_active: YC,
    template_coords: JC,
    template_coordinates_title: WC,
    ...
    return A.useEffect(() => {
      if (s !== null) {
        ...
        const f = async () => {
          ...
          const ln = H.getImageData(0, 0, d, d);
          PC(ln), H.putImageData(ln, 0, 0), o(ln), l(b.toDataURL())
        };
        setTimeout(() => {
          f().then(() => {
            I(!1)
      ...
      children: [r === null && e.jsx(nP, {}), r !== null && e.jsx(sP, {
        loading: j,
        dataUrl: r,
        templateSize: d
      }), r !== null && e.jsx(aP, {
  ...
  lP = "_layout_1c7e5_1",
  dP = "_container_1c7e5_5",
  uP = "_button_container_1c7e5_11",
  AP = "_button_1c7e5_11",
  ...
  pP = "_template_item_container_1c93x_1",
  hP = "_template_item_inner_1c93x_12",
  gP = "_template_item_picked_1c93x_28",
  _P = "_template_item_rejected_1c93x_43",
  fP = "_template_item_shadow_1c93x_58",
  xP = "_template_rank_1c93x_70",
  yP = "_template_recolors_1c93x_90",
  vP = "_template_recolors_pixel_1c93x_105",
  wP = "_template_image_1c93x_112",
  $e = {
    template_item_container: pP,
    template_item_inner: hP,
    template_item_picked: gP,
    template_item_rejected: _P,
    template_item_shadow: fP,
    template_rank: xP,
    template_recolors: yP,
    template_recolors_pixel: vP,
    template_image: wP
  },
  di = ({
    item: t,
  ...
  CP = () => {
    ...
    return A.useEffect(() => (t(Me.getRandomList()), () => {
      ...
      children: [e.jsxs("div", {
        className: We.container,
        children: [e.jsx(IP, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(di, {
          item: i
        }, i.id))]
      }), e.jsx(NP, {})]
    })
  },
  PP = "_round_info_container_1d52c_1",
  SP = "_title_1d52c_7",
  TP = "_description_1d52c_12",
  BP = "_round_status_container_1d52c_17",
  ut = {
    round_info_container: PP,
    title: SP,
    description: TP,
    round_status_container: BP
  },
  EP = "_round_indicator_mgwmo_1",
  DP = "_round_indicator_wait_mgwmo_37",
  kr = {
    round_indicator: EP,
    round_indicator_wait: DP
  },
  kP = () => e.jsx("div", {
    className: kr.round_indicator_wait
  }),
  Rr = () => e.jsx("div", {
    className: kr.round_indicator
  }),
  RP = () => {
    const t = c(ve),
      n = c(En);
  ...
  MP = () => {
    ...
    return e.jsxs("div", {
      children: [e.jsx(RP, {}), t && n === p.fulfilled && e.jsx(bP, {}), !t && n === p.fulfilled && e.jsx(CP, {})]
    })
  },
  UP = "_soon_la5q2_1",
  OP = "_active_round_instruction_la5q2_11",
  QP = "_not_active_round_instruction_la5q2_19",
  FP = "_round_container_la5q2_25",
  zP = "_round_title_la5q2_33",
  LP = "_round_title_text_la5q2_38",
  HP = "_round_indicator_la5q2_43",
  GP = "_round_status_success_la5q2_49",
  qP = "_round_status_fail_la5q2_60",
  XP = "_success_la5q2_71",
  VP = "_fail_la5q2_75",
  YP = "_gray_la5q2_79",
  JP = "_round_main_info_la5q2_83",
  WP = "_round_image_container_la5q2_89",
  ZP = "_round_image_la5q2_89",
  KP = "_round_lines_container_la5q2_103",
  $P = "_round_line_la5q2_103",
  eS = "_divider_la5q2_117",
  tS = "_pixels_number_la5q2_124",
  nS = "_pixel_la5q2_124",
  sS = "_past_rounds_la5q2_136",
  aS = "_past_rounds_divider_la5q2_145",
  Q = {
    soon: UP,
    active_round_instruction: OP,
    not_active_round_instruction: QP,
    round_container: FP,
    round_title: zP,
    round_title_text: LP,
    round_indicator: HP,
    ...
    round_image: ZP,
    round_lines_container: KP,
    round_line: $P,
    divider: eS,
    pixels_number: tS,
    pixel: nS,
    past_rounds: sS,
    past_rounds_divider: aS
  },
  Mr = ({
    result: t
  }) => {
  ...
  oS = () => {
    ...
    return t ? e.jsxs(te.Fragment, {
      ...
      }), t.map(s => n && n === s.round_id ? null : e.jsx(Mr, {
        result: s
      }, s.round_id))]
    }) : null
  },
  ...
  wS = "_layout_17ca7_1",
  jS = "_container_17ca7_6",
  bS = "_close_button_17ca7_20",
  NS = "_title_container_17ca7_28",
  IS = "_title_17ca7_28",
  CS = "_image_container_17ca7_39",
  PS = "_image_17ca7_39",
  SS = "_image_placeholder_17ca7_53",
  TS = "_info_container_17ca7_60",
  BS = "_info_row_17ca7_66",
  ES = "_info_title_17ca7_71",
  DS = "_info_value_blue_17ca7_75",
  kS = "_info_value_white_17ca7_80",
  RS = "_buttons_container_17ca7_84",
  MS = "_button_17ca7_84",
  US = "_not_button_17ca7_100",
  OS = "_button_copy_17ca7_111",
  $ = {
    layout: wS,
    container: jS,
    close_button: bS,
    ...
    image_container: CS,
    image: PS,
    image_placeholder: SS,
    info_container: TS,
    info_row: BS,
    info_title: ES,
    info_value_blue: DS,
    info_value_white: kS,
    buttons_container: RS,
    button: MS,
    not_button: US,
    button_copy: OS
  },
      ...
      onPointerUp: async () => {
        try {
          ...
          (await a(Me.selectTemplate({
            id: t.id
          }))).meta.requestStatus === p.fulfilled && a(Xo(t))
        } catch (r) {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              className: $.info_row,
              onPointerUp: () => {
                n.push("/"), t(ma()), v.viewport.viewport.animate({
                  scale: 4,
                  time: 400,
                  position: {
                    x: a.x + a.imageSize / 2,
  ...
  zS = "_layout_20dlh_1",
  LS = "_container_20dlh_10",
  HS = "_star_20dlh_14",
  GS = "_star_animation_20dlh_21",
  qS = "_move_20dlh_1",
  Os = {
    layout: zS,
    container: LS,
  ...
  XS = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  VS = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  JS = "_container_tuzgg_1",
  WS = "_column_tuzgg_9",
  ZS = "_column_rev_tuzgg_17",
  KS = "_title_tuzgg_26",
  $S = "_table_container_tuzgg_32",
  e2 = "_table_row_tuzgg_38",
  t2 = "_button_tuzgg_45",
  n2 = "_value_tuzgg_52",
  s2 = "_notpixel_icon_tuzgg_58",
  a2 = "_active_row_tuzgg_74",
  i2 = "_row_title_tuzgg_74",
  be = {
    container: JS,
    column: WS,
    column_rev: ZS,
  ...
  m2 = "_container_qn09x_1",
  p2 = "_image_container_qn09x_9",
  h2 = "_image_qn09x_9",
  g2 = "_title_container_qn09x_18",
  _2 = "_text_container_qn09x_27",
  f2 = "_title_qn09x_18",
  x2 = "_gray_qn09x_39",
  y2 = "_bold_qn09x_43",
  v2 = "_input_qn09x_47",
  w2 = "_catalog_container_qn09x_71",
  j2 = "_catalog_title_qn09x_76",
  b2 = "_catalog_items_container_qn09x_81",
  N2 = "_catalog_item_qn09x_81",
  I2 = "_catalog_item_image_container_qn09x_100",
  C2 = "_catalog_item_image_qn09x_100",
  P2 = "_button_container_qn09x_109",
  S2 = "_button_qn09x_109",
  T2 = "_wrong_helper_text_qn09x_124",
  B2 = "_wrong_button_qn09x_129",
  E2 = "_wrong_button_text2_qn09x_142",
  S = {
    container: m2,
    image_container: p2,
    image: h2,
    ...
    bold: y2,
    input: v2,
    catalog_container: w2,
    catalog_title: j2,
    catalog_items_container: b2,
    catalog_item: N2,
    catalog_item_image_container: I2,
    catalog_item_image: C2,
    button_container: P2,
    button: S2,
    wrong_helper_text: T2,
    wrong_button: B2,
    wrong_button_text2: E2
  },
  D2 = "/assets/box_1-CzUKXu07.gif",
  k2 = "/assets/box_2-wR9cQS7q.gif",
  R2 = "/assets/box_3-g_PL1kKM.gif",
  M2 = "/assets/dogs-D0jtZggB.gif",
  U2 = "/assets/secret_word-BTKB1fAO.gif",
  O2 = "/assets/cube_youtube_2-BqessN1a.gif",
  Q2 = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif",
  Gn = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
  ...
  H2 = "_layout_1djp8_1",
  G2 = "_loading_container_1djp8_8",
  q2 = "_image_container_1djp8_20",
  X2 = "_image_1djp8_20",
  V2 = "_text_1djp8_29",
  fn = {
    layout: H2,
    loading_container: G2,
    image_container: q2,
    image: X2,
    text: V2
  },
  Y2 = "_buttons_container_rjvnl_1",
  J2 = "_group_rjvnl_8",
  W2 = "_left_rjvnl_15",
  Z2 = "_middle_rjvnl_21",
  K2 = "_right_rjvnl_29",
  $2 = "_number_rjvnl_36",
  eT = "_button_rjvnl_1",
  tT = "_ratings_button_rjvnl_55",
  nT = "_stars_button_rjvnl_62",
  sT = "_shop_button_rjvnl_70",
  aT = "_burger_button_rjvnl_79",
  iT = "_relative_button_rjvnl_89",
  oT = "_telegram_button_rjvnl_116",
  rT = "_button_img_rjvnl_124",
  cT = "_avatar_img_rjvnl_129",
  lT = "_open_menu_button_rjvnl_134",
  dT = "_open_menu_button_image_rjvnl_144",
  uT = "_my_pixels_amount_rjvnl_149",
  ...
  xe = {
    ...
    avatar_img: cT,
    open_menu_button: lT,
    open_menu_button_image: dT,
    my_pixels_amount: uT,
    header_content: AT
  },
  mT = () => c(Fe) ? null : e.jsxs("button", {
  ...
  Oi = te.memo(() => e.jsxs("div", {
    ...
    children: [e.jsxs("div", {
      ...
      children: [e.jsx(fT, {}), e.jsx(_T, {})]
    }), e.jsx("div", {
      className: `${xe.group} ${xe.middle}`,
      children: e.jsx(pT, {})
    }), e.jsxs("div", {
      className: `${xe.group} ${xe.right}`,
      children: [e.jsx(xT, {}), e.jsx(mT, {}), e.jsx(gT, {})]
    })]
  })),
  Qi = {
    bronze: De.bronze,
...
const vT = () => {
  ...
  IT = "_header_11ui8_13",
  CT = "_close_container_11ui8_23",
  PT = "_close_11ui8_23",
  ST = "_title_11ui8_48",
  TT = "_frens_count_11ui8_53",
  BT = "_body_11ui8_58",
  ET = "_content_11ui8_68",
  DT = "_image_container_11ui8_75",
  kT = "_image_11ui8_75",
  RT = "_image_container_charges_11ui8_84",
  MT = "_image_charges_11ui8_89",
  UT = "_description_container_11ui8_94",
  OT = "_bold_11ui8_102",
  QT = "_gray_11ui8_107",
  FT = "_center_11ui8_111",
  zT = "_benefits_container_11ui8_115",
  LT = "_benefits_item_11ui8_123",
  HT = "_benefits_icon_container_11ui8_128",
  GT = "_icon_invite_11ui8_132",
  qT = "_footer_11ui8_136",
  XT = "_button_11ui8_141",
  D = {
    container: NT,
    header: IT,
    close_container: CT,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: D.button,
            onPointerUp: l => {
              l.stopPropagation(), ae(`https://t.me/share/url?url=${i}`), t(pa())
            },
            children: "Share"
          })]
        })]
  ...
  JT = "_container_19qal_1",
  WT = "_header_19qal_9",
  ZT = "_close_19qal_19",
  KT = "_title_19qal_31",
  $T = "_body_19qal_36",
  eB = "_image_container_19qal_49",
  tB = "_image_19qal_49",
  nB = "_content_container_19qal_60",
  sB = "_description_container_19qal_68",
  aB = "_description_item_19qal_75",
  iB = "_amount_selector_container_19qal_82",
  oB = "_amount_selector_button_19qal_88",
  rB = "_amount_selector_count_19qal_101",
  cB = "_button_container_19qal_112",
  lB = "_crypto_button_container_19qal_118",
  dB = "_error_19qal_132",
  uB = "_not_available_19qal_139",
  AB = "_button_19qal_112",
  mB = "_star_color_19qal_165",
  pB = "_tokens_selector_19qal_171",
  hB = "_tokens_title_19qal_176",
  gB = "_connect_wallet_text_title_19qal_183",
  _B = "_tokens_container_19qal_192",
  fB = "_token_item_19qal_199",
  xB = "_token_image_container_19qal_210",
  yB = "_token_image_19qal_210",
  vB = "_sale_box_19qal_220",
  wB = "_sale_text_19qal_232",
  Y = {
    container: JT,
    header: WT,
    close: ZT,
    ...
    image_container: eB,
    image: tB,
    content_container: nB,
    description_container: sB,
    description_item: aB,
    amount_selector_container: iB,
    amount_selector_button: oB,
    amount_selector_count: rB,
    button_container: cB,
    crypto_button_container: lB,
    error: dB,
    not_available: uB,
    button: AB,
    star_color: mB,
    tokens_selector: pB,
    tokens_title: hB,
    connect_wallet_text_title: gB,
    tokens_container: _B,
    token_item: fB,
    token_image_container: xB,
    token_image: yB,
    sale_box: vB,
    sale_text: wB
  },
  ...
  PB = ({
    ...
    if (o) return e.jsxs(te.Fragment, {
      children: ["Buy for ", e.jsx(CB, {}), Math.round(o * (r ? s : 1) * 100) / 100, e.jsx("div", {
  ...
  SB = ({
    ...
    const H = async X => {
      ...
      const we = new na.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        ln = await new na.token.jetton.JettonMinter(we, {
          address: Ct[i]
        }).getJettonWalletAddress(new na.utils.Address(f)),
        Gr = Ve.Address.parse(f),
        qr = Ve.Address.parse(Na),
        Xr = Ve.beginCell().storeUint(0, 32).storeStringTail(X.txMemCode).endCell();
      let ea = Ve.toNano(X.strAmount);
      Number(i) === 4 && (ea = ea / 1000n);
      const Vr = Ve.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(ea).storeAddress(qr).storeAddress(Gr).storeBit(0).storeCoins(Ve.toNano("0.01")).storeBit(1).storeRef(Xr).endCell(),
        Yr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
  ...
  TB = () => {
    const [t, n] = Cn(), s = Qs(), a = c(i => i.shop.selectedCurrency);
  ...
  kB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(IB, {}), e.jsx(DB, {}), e.jsx(Io, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: Y.error,
  ...
  MB = "_container_1rmx4_1",
  UB = "_max_value_1rmx4_9",
  Li = {
    container: MB,
    max_value: UB
  },
...
const OB = () => {
  ...
  QB = () => e.jsxs("div", {
    ...
    children: [e.jsx(bB, {}), e.jsxs("div", {
      className: Y.content_container,
      children: [e.jsx(NB, {}), e.jsx(RB, {}), e.jsx(OB, {})]
    }), e.jsx(kB, {})]
  }),
  FB = () => {
    ...
    return Ke.createPortal(e.jsx(qe, {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx(jB, {}), e.jsx(QB, {})]
      })
    }), document.body)
  },
  zB = "_layout_9sf1k_1",
  LB = "_container_9sf1k_13",
  HB = "_header_9sf1k_20",
  GB = "_title_9sf1k_30",
  qB = "_body_9sf1k_35",
  XB = "_image_container_9sf1k_47",
  VB = "_image_9sf1k_47",
  YB = "_shake_9sf1k_1",
  JB = "_description_container_9sf1k_60",
  WB = "_buyer_info_9sf1k_70",
  ZB = "_avatar_9sf1k_78",
  KB = "_name_9sf1k_84",
  $B = "_squad_info_9sf1k_88",
  eE = "_squad_avatar_9sf1k_94",
  tE = "_text_container_9sf1k_100",
  nE = "_text_9sf1k_100",
  sE = "_thanos_snap_container_9sf1k_110",
  aE = "_thanos_snap_text_9sf1k_119",
  iE = "_button_container_9sf1k_126",
  oE = "_button_9sf1k_126",
  ue = {
    layout: zB,
    container: LB,
    header: HB,
...
async function AE() {
  w.enable(w.BLEND), w.blendFunc(w.SRC_ALPHA, w.ONE_MINUS_SRC_ALPHA), w.clearColor(0, 0, 0, 0), w.viewport(0, 0, w.canvas.width, w.canvas.height), Ie = await mE(w), w.useProgram(Ie)
}
...
async function pE(t) {
  hE(), fE(t), zr(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function fE(t) {
  ...
  Is = l * l, nt(w, Ie, "u_AnimationDuration", Fr), nt(w, Ie, "u_ParticleSize", lE), nt(w, Ie, "u_ViewportWidth", n), nt(w, Ie, "u_ViewportHeight", s), nt(w, Ie, "u_TextureWidth", a), nt(w, Ie, "u_TextureHeight", i), nt(w, Ie, "u_TextureLeft", o), nt(w, Ie, "u_TextureTop", r);
...
function xE(t) {
  ...
  nt(w, Ie, "u_ElapsedTime", s), w.drawArrays(w.POINTS, 0, Is), zr()
}
...
const yE = () => {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                ...
                t.push("/"), n(Eh()), v.mainImage.pixanosRepaint(a.info.seed, T.width, a.info.percentage, a.info.color), (l = (r = window.Telegram.WebApp) == null ? void 0 : r.HapticFeedback) == null || l.notificationOccurred("error")
              },
              children: "Whoosh!"
            })
          })]
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: D.button,
            onPointerUp: l => {
              l.stopPropagation(), window.Telegram.WebApp.openLink(`https://t.me/share/url?url=${i}`), n(ha())
            },
            children: "Share"
          })]
        })]
  ...
  TE = "_image_container_1nuac_30",
  BE = "_image_1nuac_30",
  EE = "_text_container_1nuac_42",
  DE = "_title_1nuac_49",
  kE = "_button_container_1nuac_55",
  RE = "_button_1nuac_55",
  At = {
    layout: PE,
    container: SE,
    ...
    return e.jsx(qe, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === He.userFromPixelInfo && e.jsx(Ma, {
          ...
          isPopupContent: s
        }), n.dataSource === He.squadFromData && e.jsx(UE, {})]
      })
    })
  },
  QE = "_overlay_1vl8z_1",
  FE = "_top_container_1vl8z_10",
  zE = "_bottom_container_1vl8z_15",
  LE = "_side_menu_1vl8z_20",
  HE = "_menu_safe_area_inset_1vl8z_36",
  GE = "_menu_header_1vl8z_40",
  qE = "_close_button_1vl8z_53",
  XE = "_menu_list_1vl8z_58",
  VE = "_icon_1vl8z_79",
  YE = "_icon_not_pixel_1vl8z_87",
  JE = "_gold_pixel_1vl8z_97",
  WE = "_menu_list_li_1vl8z_103",
  ZE = "_menu_list_text_1vl8z_109",
  KE = "_menu_list_new_item_1vl8z_113",
  $E = "_button_wrapper_1vl8z_136",
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(wn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(vD, {}), e.jsx(_D, {}), e.jsxs("div", {
...
A.memo(({
  ...
  const [s, a] = A.useState(TD()), [i, o] = A.useState(!1);
  return A.useEffect(() => {
    t && setTimeout(() => {
      o(!0), setTimeout(() => {
        n(!1), o(!1)
...
const BD = "_container_gb8eq_1",
  ED = "_header_gb8eq_11",
  DD = "_title_gb8eq_17",
  kD = "_close_container_gb8eq_23",
  RD = "_close_gb8eq_23",
  MD = "_body_gb8eq_47",
  UD = "_content_gb8eq_59",
  OD = "_time_left_container_gb8eq_65",
  QD = "_timer_gb8eq_69",
  FD = "_image_container_gb8eq_73",
  zD = "_image_gb8eq_73",
  LD = "_glow_container_gb8eq_91",
  HD = "_glow_gb8eq_91",
  GD = "_rotate_gb8eq_1",
  qD = "_glow_reverse_gb8eq_107",
  XD = "_description_container_gb8eq_113",
  VD = "_bold_gb8eq_123",
  YD = "_gray_gb8eq_128",
  JD = "_center_gb8eq_132",
  WD = "_gold_gb8eq_136",
  ...
  ek = "_layout_xga4i_1",
  tk = "_container_xga4i_14",
  nk = "_header_xga4i_20",
  sk = "_close_xga4i_25",
  ak = "_body_xga4i_38",
  ik = "_image_container_xga4i_42",
  ok = "_image_xga4i_42",
  rk = "_glow_xga4i_55",
  ck = "_forward_xga4i_62",
  lk = "_rotate_xga4i_1",
  dk = "_reverse_xga4i_66",
  uk = "_text_container_xga4i_70",
  Ak = "_title_xga4i_78",
  mk = "_description_xga4i_82",
  pk = "_footer_xga4i_86",
  hk = "_button_xga4i_90",
  _e = {
    layout: ek,
...
const wk = "_layout_15tw0_1",
  jk = "_container_15tw0_7",
  bk = "_close_button_15tw0_16",
  Nk = "_title_container_15tw0_24",
  Ik = "_image_container_15tw0_31",
  Ck = "_image_15tw0_31",
  Pk = "_text_container_15tw0_50",
  Sk = "_button_container_15tw0_56",
  et = {
    layout: wk,
    container: jk,
    close_button: bk,
  ...
  Bk = () => e.jsxs("div", {
    className: fn.layout,
    children: [e.jsx(bT, {}), e.jsx(yT, {}), e.jsx(K_, {}), e.jsx(L2, {}), e.jsx(vT, {}), e.jsx(wE, {}), e.jsx(ME, {}), e.jsx(OE, {}), e.jsx(YT, {}), e.jsx(vE, {}), e.jsx($D, {}), e.jsx(vk, {}), e.jsx(Tk, {}), e.jsx(FB, {}), e.jsx(yE, {}), e.jsx(CE, {}), e.jsx(jD, {})]
  }),
  Ek = () => {
    const t = g(),
  ...
  Rk = "_layout_ieygs_1",
  Mk = "_container_ieygs_8",
  Uk = "_logo_container_ieygs_17",
  Ok = "_logo_ieygs_17",
  Qk = "_animate_ieygs_1",
  Fk = "_center_ieygs_37",
  zk = "_title_ieygs_51",
  Lk = "_description_ieygs_58",
  Hk = "_button_container_ieygs_63",
  Gk = "_button_ieygs_63",
  qk = "_b_ieygs_63",
  It = {
    layout: Rk,
  ...
  Vk = "/assets/loading-D8SQALTR.gif",
  Yk = () => e.jsxs("div", {
    className: fn.loading_container,
    children: [e.jsx("div", {
      className: fn.image_container,
      children: e.jsx("img", {
        alt: "img",
        src: Vk,
        className: fn.image
  ...
  Jk = () => {
    ...
    A.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(mh(s)), t(Ja(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(Pu(s))
      })
    }, [t])
  ...
  Wk = () => {
    const t = g(),
      ...
      s = async () => {
        ...
        if (!Qo(u)) return Promise.resolve();
        try {
          t(Me.getMyTemplate({
            id: u.id
          }))
  ...
  s4 = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Rc) && kk(), Jk(), Wk(), Zk(), a || o ? e.jsx(Xk, {}) : i ? e.jsx(Yk, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
Oc(Mn);
Nh(Mn);
const l4 = Zr.createRoot(document.getElementById("root"));
l4.render(e.jsx(te.StrictMode, {
  children: e.jsx(tc, {
    store: Mn,
    children: e.jsx(dc, {
      children: e.jsx(ac, {
