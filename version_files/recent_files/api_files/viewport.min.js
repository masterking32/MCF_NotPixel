...
this.PIXI = this.PIXI || {},
  function(t, e) {
    "object" == typeof exports && "undefined" != typeof module ? e(exports, require("@pixi/math"), require("@pixi/display"), require("@pixi/ticker")) : "function" == typeof define && define.amd ? define(["exports", "@pixi/math", "@pixi/display", "@pixi/ticker"], e) : e((t = "undefined" != typeof globalThis ? globalThis : t || self).pixi_viewport = {}, t.PIXI, t.PIXI, t.PIXI)
    ...
    function p(t, e) {
      return t ? "function" == typeof t ? t : "string" == typeof t ? a[t] : void 0 : a[e]
    }
    const l = {
      removeOnInterrupt: !1,
      ease: "linear",
    ...
    class c extends n {
      ...
      constructor(t, e = {}) {
        super(t), c.prototype.__init.call(this), c.prototype.__init2.call(this), c.prototype.__init3.call(this), c.prototype.__init4.call(this), c.prototype.__init5.call(this), c.prototype.__init6.call(this), c.prototype.__init7.call(this), this.options = Object.assign({}, l, e), this.options.ease = p(this.options.ease), this.setupPosition(), this.setupZoom(), this.time = 0
      }
      setupPosition() {
      ...
      update(t) {
        ...
        if (this.time >= this.options.time) {
          ...
          this.complete(), t === this.parent.width && e === this.parent.height || this.parent.emit("zoomed", {
          ...
          if (null !== this.width) {
            const e = this.startWidth,
              i = this.deltaWidth;
            this.parent.fitWidth(e + i * t, this.keepCenter, null === this.height)
          }
          if (null !== this.height) {
            const e = this.startHeight,
              i = this.deltaHeight;
            this.parent.fitHeight(e + i * t, this.keepCenter, null === this.width)
          }
          if (null === this.width ? this.parent.scale.x = this.parent.scale.y : null === this.height && (this.parent.scale.y = this.parent.scale.x), !this.keepCenter) {
            ...
            this.parent.moveCenter(i + n * t, s + h * t), this.parent.emit("moved", {
              viewport: this.parent,
              original: o,
              type: "animate"
            })
    ...
    function d(t) {
      ...
      for (; s < t.length;) {
        const n = t[s],
          h = t[s + 1];
        if (s += 2, ("optionalAccess" === n || "optionalCall" === n) && null == i) return;
        "access" === n || "optionalAccess" === n ? (e = i, i = h(i)) : "call" !== n && "optionalCall" !== n || (i = h((...t) => i.call(e, ...t)), e = void 0)
      }
      return i
    }
    const u = {
    ...
    class m extends n {
      constructor(t, e = {}) {
        super(t), this.options = Object.assign({}, u, e), this.ease = p(this.options.ease, "easeInOutSine"), this.options.sides ? "all" === this.options.sides ? this.top = this.bottom = this.left = this.right = !0 : "horizontal" === this.options.sides ? (this.right = this.left = !0, this.top = this.bottom = !1) : "vertical" === this.options.sides ? (this.left = this.right = !1, this.top = this.bottom = !0) : (this.top = -1 !== this.options.sides.indexOf("top"), this.bottom = -1 !== this.options.sides.indexOf("bottom"), this.left = -1 !== this.options.sides.indexOf("left"), this.right = -1 !== this.options.sides.indexOf("right")) : this.left = this.top = this.right = this.bottom = !1;
        const i = this.options.underflow.toLowerCase();
        "center" === i ? (this.underflowX = 0, this.underflowY = 0) : (this.underflowX = -1 !== i.indexOf("left") ? -1 : -1 !== i.indexOf("right") ? 1 : 0, this.underflowY = -1 !== i.indexOf("top") ? -1 : -1 !== i.indexOf("bottom") ? 1 : 0), this.reset()
      }
      isActive() {
      ...
      bounce() {
        ...
        e && (e.x || e.y) && (e.x && e.percentChangeX === d([e, "access", t => t.options, "optionalAccess", t => t.friction]) || e.y && e.percentChangeY === d([e, "access", t => t.options, "optionalAccess", t => t.friction])) && (((t = this.oob()).left && this.left || t.right && this.right) && (e.percentChangeX = this.options.friction), (t.top && this.top || t.bottom && this.bottom) && (e.percentChangeY = this.options.friction));
        const i = this.parent.plugins.get("drag", !0) || {},
          s = this.parent.plugins.get("pinch", !0) || {};
        if (e = e || {}, !(d([i, "optionalAccess", t => t.active]) || d([s, "optionalAccess", t => t.active]) || this.toX && this.toY || e.x && e.y)) {
    ...
    class f extends n {
      ...
      clamp() {
        if (!this.paused)
          ...
          if ("number" == typeof this.options.minScale) t.x = this.options.minScale, t.y = this.options.minScale;
          else if (null !== this.options.minScale) {
            const e = this.options.minScale;
            t.x = void 0 === e.x ? null : e.x, t.y = void 0 === e.y ? null : e.y
          }
          if ("number" == typeof this.options.maxScale) e.x = this.options.maxScale, e.y = this.options.maxScale;
          else if (null !== this.options.maxScale) {
            const t = this.options.maxScale;
            e.x = void 0 === t.x ? null : t.x, e.y = void 0 === t.y ? null : t.y
          }
          let i = this.parent.scale.x,
            s = this.parent.scale.y;
          null !== t.x && i < t.x && (i = t.x), null !== e.x && i > e.x && (i = e.x), null !== t.y && s < t.y && (s = t.y), null !== e.y && s > e.y && (s = e.y), i === this.parent.scale.x && s === this.parent.scale.y || (this.parent.scale.set(i, s), this.parent.emit("zoomed", {
            viewport: this.parent,
            type: "clamp-zoom"
          }))
        }
    ...
    class W extends n {
      constructor(t, e = {}) {
        super(t), this.options = Object.assign({}, x, e), this.saved = [], this.timeSinceRelease = 0, this.reset(), this.parent.on("moved", t => this.moved(t))
      }
      down() {
      ...
      update(t) {
        ...
        if (this.x) {
          const e = this.percentChangeX,
            n = Math.log(e);
          this.parent.x += this.x * v / n * (Math.pow(e, s / v) - Math.pow(e, i / v)), this.x *= Math.pow(this.percentChangeX, t / v)
        }
        if (this.y) {
          const e = this.percentChangeY,
            n = Math.log(e);
          this.parent.y += this.y * v / n * (Math.pow(e, s / v) - Math.pow(e, i / v)), this.y *= Math.pow(this.percentChangeY, t / v)
        }
    ...
    class H extends n {
      ...
      addWindowEventHandler(t, e) {
        window.addEventListener(t, e), this.windowEventHandlers.push({
          event: t,
          handler: e
        })
      }
      ...
      parseUnderflow() {
        const t = this.options.underflow.toLowerCase();
        "center" === t ? (this.underflowX = 0, this.underflowY = 0) : (t.includes("left") ? this.underflowX = -1 : t.includes("right") ? this.underflowX = 1 : this.underflowX = 0, t.includes("top") ? this.underflowY = -1 : t.includes("bottom") ? this.underflowY = 1 : this.underflowY = 0)
      }
      checkButtons(t) {
      ...
      down(t) {
        return !(this.paused || !this.options.pressDrag) && (this.checkButtons(t) && this.checkKeyPress(t) ? (this.last = {
          x: t.data.global.x,
          y: t.data.global.y
        }, this.current = t.data.pointerId, !0) : (this.last = null, !1))
      }
      get active() {
        return this.moved
      }
      ...
      wheel(t) {
        ...
        if (this.options.wheel) {
          ...
          if (!e || !e.options.wheelZoom && !t.ctrlKey) {
            ...
            return this.xDirection && (this.parent.x += s * e * this.options.wheelScroll * this.reverse), this.yDirection && (this.parent.y += n * e * this.options.wheelScroll * this.reverse), this.options.clampWheel && this.clamp(), this.parent.emit("wheel-scroll", this.parent), this.parent.emit("moved", {
              viewport: this.parent,
              type: "wheel"
    ...
    class S extends n {
      constructor(t, e, i = {}) {
        super(t), this.target = e, this.options = Object.assign({}, M, i), this.velocity = {
          x: 0,
          y: 0
        }
      }
        ...
        if (n || h)
          if (this.options.speed)
            if (this.options.acceleration) {
              ...
              if (o) {
                const r = (Math.pow(this.velocity.x, 2) + Math.pow(this.velocity.y, 2)) / (2 * this.options.acceleration);
                this.velocity = o > r ? {
                  x: Math.min(this.velocity.x + (this.options.acceleration, this.options.speed)),
                  y: Math.min(this.velocity.y + (this.options.acceleration, this.options.speed))
                } : {
                ...
                this.parent.moveCenter(l, c), this.parent.emit("moved", {
                  viewport: this.parent,
                  type: "follow"
                })
              }
    ...
    class C extends n {
      constructor(t, e = {}) {
        super(t), this.options = Object.assign({}, P, e), this.reverse = this.options.reverse ? 1 : -1, this.radiusSquared = "number" == typeof this.options.radius ? Math.pow(this.options.radius, 2) : null, this.resize()
      }
      resize() {
        const t = this.options.distance;
        null !== t ? (this.left = t, this.top = t, this.right = this.parent.screenWidth - t, this.bottom = this.parent.screenHeight - t) : this.options.radius || (this.left = this.options.left, this.top = this.options.top, this.right = null === this.options.right ? null : this.parent.screenWidth - this.options.right, this.bottom = null === this.options.bottom ? null : this.parent.screenHeight - this.options.bottom)
      }
      down() {
      ...
      move(t) {
        if (this.paused) return !1;
        if ("mouse" !== t.data.pointerType && 1 !== t.data.identifier || !this.options.allowButtons && 0 !== t.data.buttons) return !1;
        ...
        } else null !== this.left && e < this.left ? this.horizontal = Number(this.reverse) * this.options.speed * .06 : null !== this.right && e > this.right ? this.horizontal = -1 * this.reverse * this.options.speed * .06 : (this.decelerateHorizontal(), this.horizontal = 0), null !== this.top && i < this.top ? this.vertical = Number(this.reverse) * this.options.speed * .06 : null !== this.bottom && i > this.bottom ? this.vertical = -1 * this.reverse * this.options.speed * .06 : (this.decelerateVertical(), this.vertical = 0);
        return !1
      }
    ...
    class O extends n {
      ...
      constructor(t, e = {}) {
        super(t), O.prototype.__init.call(this), O.prototype.__init2.call(this), O.prototype.__init3.call(this), this.options = Object.assign({}, I, e)
      }
      down() {
      ...
      move(t) {
        ...
        if (s.length >= 2) {
          ...
          if (n.id === t.data.pointerId ? n.last = {
            ...
            const s = (1 - o / (i = 0 === i ? i = 1e-10 : i)) * this.options.percent * (this.isAxisX() ? this.parent.scale.x : this.parent.scale.y);
            this.isAxisX() && (this.parent.scale.x += s), this.isAxisY() && (this.parent.scale.y += s), this.parent.emit("zoomed", {
              viewport: this.parent,
              type: "pinch",
              center: e
            });
    ...
    class z extends n {
      constructor(t, e, i, s = {}) {
        super(t), this.options = Object.assign({}, k, s), this.ease = p(s.ease, "easeInOutSine"), this.x = e, this.y = i, this.options.forceStart && this.snapStart()
      }
      snapStart() {
    ...
    class A extends n {
      constructor(t, e = {}) {
        super(t), this.options = Object.assign({}, Y, e), this.keyIsPressed = !1, this.options.keyToPress && this.handleKeyPresses(this.options.keyToPress)
      }
      handleKeyPresses(t) {
      ...
      update() {
        if (this.smoothing) {
          const t = this.smoothingCenter,
            e = this.smoothing;
          let i;
          this.options.center || (i = this.parent.toLocal(t)), this.isAxisX() && (this.parent.scale.x += e.x), this.isAxisY() && (this.parent.scale.y += e.y), this.parent.emit("zoomed", {
            viewport: this.parent,
            type: "wheel"
          });
          const s = this.parent.plugins.get("clamp-zoom", !0);
      ...
      pinch(t) {
        ...
        let n;
        this.options.center || (n = this.parent.toLocal(e)), this.isAxisX() && (this.parent.scale.x *= s), this.isAxisY() && (this.parent.scale.y *= s), this.parent.emit("zoomed", {
          viewport: this.parent,
          type: "wheel"
        });
      ...
      wheel(t) {
        ...
        if (t.ctrlKey && this.options.trackpadPinch) this.pinch(t);
          ...
          const e = this.parent.input.getPointerPosition(t),
            i = (this.options.reverse ? -1 : 1) * -t.deltaY * (t.deltaMode ? this.options.lineHeight : 1) / 500,
            s = Math.pow(2, (1 + this.options.percent) * i);
          if (this.options.smooth) {
            ...
            let t;
            this.options.center || (t = this.parent.toLocal(e)), this.isAxisX() && (this.parent.scale.x *= s), this.isAxisY() && (this.parent.scale.y *= s), this.parent.emit("zoomed", {
              viewport: this.parent,
              type: "wheel"
            });
    ...
    class D {
      ...
      getPointerPosition(t) {
        const i = new e.Point;
        if (this.viewport.options.interaction) this.viewport.options.interaction.mapPositionToPoint(i, t.clientX, t.clientY);
      ...
      handleWheel(t) {
        if (this.viewport.pause || !this.viewport.worldVisible) return;
        if (this.viewport.options.interaction && this.viewport.options.interaction.interactionDOMElement !== t.target) return;
    ...
    const L = ["drag", "pinch", "wheel", "follow", "mouse-edges", "decelerate", "animate", "bounce", "snap-zoom", "clamp-zoom", "snap", "clamp"];
    class E {
      constructor(t) {
      ...
      add(t, e, i = L.length) {
        ...
        const n = L.indexOf(t); - 1 !== n && L.splice(n, 1), L.splice(i, 0, t), this.sort()
      }
      get(t, e) {
        return e && T([this, "access", t => t.plugins, "access", e => e[t], "optionalAccess", t => t.paused]) ? null : this.plugins[t]
      }
      update(t) {
      ...
      remove(t) {
        this.plugins[t] && (T([this, "access", t => t.plugins, "access", e => e[t], "optionalAccess", t => t.destroy, "call", t => t()]), delete this.plugins[t], this.viewport.emit(`${t}-remove`), this.sort())
      }
      pause(t) {
        T([this, "access", t => t.plugins, "access", e => e[t], "optionalAccess", t => t.pause, "call", t => t()])
      }
      resume(t) {
        T([this, "access", t => t.plugins, "access", e => e[t], "optionalAccess", t => t.resume, "call", t => t()])
      }
      sort() {
        this.list = [];
    ...
    class B extends i.Container {
      ...
      constructor(t = {}) {
        super(), B.prototype.__init.call(this), this.options = Object.assign({}, {
          divWheel: document.body
        }, V, t), this.screenWidth = this.options.screenWidth, this.screenHeight = this.options.screenHeight, this._worldWidth = this.options.worldWidth, this._worldHeight = this.options.worldHeight, this.forceHitArea = this.options.forceHitArea, this.threshold = this.options.threshold, this.options.divWheel = this.options.divWheel || document.body, this.options.disableOnContextMenu && this.options.divWheel.addEventListener("contextmenu", this._disableOnContextMenu), this.options.noTicker || (this.tickerFunction = (() => this.update(this.options.ticker.elapsedMS)), this.options.ticker.add(this.tickerFunction)), this.input = new D(this), this.plugins = new E(this)
      }
      destroy(t) {
      ...
      moveCenter(...t) {
        let e, i;
        "number" == typeof t[0] ? (e = t[0], i = t[1]) : (e = t[0].x, i = t[0].y);
      ...
      moveCorner(...t) {
        let e, i;
        return 1 === t.length ? (e = -t[0].x * this.scale.x, i = -t[0].y * this.scale.y) : (e = -t[0] * this.scale.x, i = -t[1] * this.scale.y), e === this.x && i === this.y || (this.position.set(e, i), this.plugins.reset(), this.dirty = !0), this
      }
    ...
    t.Animate = c, t.Bounce = m, t.Clamp = w, t.ClampZoom = f, t.Decelerate = W, t.Drag = H, t.Follow = S, t.InputManager = D, t.MouseEdges = C, t.Pinch = O, t.Plugin = n, t.PluginManager = E, t.Snap = z, t.SnapZoom = X, t.Viewport = B, t.Wheel = A, Object.defineProperty(t, "__esModule", {
      value: !0
    })
  }), "undefined" != typeof pixi_viewport && Object.assign(this.PIXI, pixi_viewport);