...
function y(e) {
  ...
  return r === "[object RegExp]" || r === "[object Date]" || g(e)
}
var m = typeof Symbol == "function" && Symbol.for,
  O = m ? Symbol.for("react.element") : 60103;
...
function u(e, r) {
  return r.clone !== !1 && r.isMergeableObject(e) ? a(j(e), e, r) : e
}
...
function d(e, r, n) {
  ...
  return n.isMergeableObject(e) && f(e).forEach(function(t) {
    ...
    E(e, t) || (l(e, t) && n.isMergeableObject(r[t]) ? c[t] = p(t, n)(e[t], r[t], n) : c[t] = u(r[t], n))
  }), c
}

function a(e, r, n) {
  n = n || {}, n.arrayMerge = n.arrayMerge || M, n.isMergeableObject = n.isMergeableObject || o, n.cloneUnlessOtherwiseSpecified = u;
  var c = Array.isArray(r),
    t = Array.isArray(e),
    i = c === t;
  return i ? c ? n.arrayMerge(e, r, n) : d(e, r, n) : u(r, n)
}
a.all = function(r, n) {
