...
const lc = {
  ...
  Tn = z("shop/getProducts", async () => (await X.getProducts()).data),
  ...
  zt = async t => {
  ...
  }, Gi = t => new Promise(n => setTimeout(n, t)), yl = t => {
  ...
  }, ma = t => !0, Nl = "_layout_13e1w_1", Il = "_container_13e1w_10", Pl = "_star_13e1w_14", Cl = "_move_13e1w_1", jn = {
    layout: Nl,
    container: Il,
    star: Pl,
    move: Cl
  }, Sl = "_link_1fn8i_1", Tl = "_telegram_icons_1fn8i_13", Hi = {
    link: Sl,
    telegram_icons: Tl
  }, N = ({
    children: t,
  ...
  }, () => !1), Bl = "_layout_1nbfl_1", Dl = "_button_1nbfl_14", Xa = {
    layout: Bl,
    button: Dl
  }, kl = () => {
    const t = K();
  ...
  }, Rl = "_layout_fzjo7_1", Ml = "_container_fzjo7_5", Ul = "_item_fzjo7_11", Fl = "_active_fzjo7_20", Ol = "_image_container_fzjo7_24", Ql = "_image_fzjo7_24", zl = "_item_text_container_fzjo7_34", Ll = "_item_text_fzjo7_34", at = {
    layout: Rl,
    container: Ml,
    item: Ul,
    active: Fl,
    ...
    let a = "sale";
    return t.id === 7 && (a = "event"), s.map(i => e.jsx(Qi, {
      amount: i,
      item: t,
      active: n,
      type: a
    }, i))
  }, Hl = "/assets/icon_coin-COCalNMQ.gif", Jl = "/assets/icon_stars-BmDiRMAW.gif", Vl = {
    items: []
  }, Ji = Ae({
    name: "toast",
    initialState: Vl,
        ...
        children: [e.jsx(ql, {}), e.jsx("div", {
          ...
          children: t.map(i => {
            if (n.hasOwnProperty(i)) {
              const o = n[i];
              let r = !((i === 4 || i === 5) && s[i] > 0);
              if (i === 1 || i === 2 || i === 6 || i === 7) return e.jsx(Gl, {
                item: o,
                active: r
              }, i);
              {
  ...
  }), dd = "_pixels_amount_ngjsa_1", ud = "_general_info_container_ngjsa_6", md = "_coin_amount_text_ngjsa_12", Ad = "_description_container_ngjsa_16", pd = "_description_ngjsa_16", bn = {
    pixels_amount: dd,
    general_info_container: ud,
    coin_amount_text: md,
    description_container: Ad,
    description: pd
  }, hd = "_logo_container_1i5of_1", gd = {
    logo_container: hd
  }, _d = "_layout_1cvcu_1", fd = "_container_1cvcu_10", xd = "_bubble_1cvcu_16", yd = "_move_1cvcu_1", Ys = {
    layout: _d,
    container: fd,
    bubble: xd,
    move: yd
  ...
  }, () => !1), wd = "_container_1aw3i_1", jd = "_logo_1aw3i_9", bd = "_animate_1aw3i_1", Nd = "_center_1aw3i_18", Id = "_glow_1aw3i_28", Nn = {
    container: wd,
    logo: jd,
    animate: bd,
    center: Nd,
  ...
  }), Sd = "_container_13oyr_1", Td = "_button_13oyr_11", Ed = "_info_13oyr_32", dt = {
    container: Sd,
    button: Td,
    info: Ed
  };
...
const Dn = z("mining/info", async () => (await Is.info()).data),
  ...
  On = z("user/getPixelsForSaleTotal", async () => (await X.getUserPixelsCount()).data),
  ...
  }),
  {
    ...
    setPixelsForSaleTotal: Gd,
    setPixelsForSaleFetchStatus: Hd,
    removePixelsForSale: Jd,
    setPixelsSoldOffset: ck,
    setPixelsSoldTotal: lk,
    setPixelsSoldFetchStatus: dk,
    removePixelsSold: uk,
    addPixelCoins: jt,
    subtractPixelCoins: Vd,
    setPixelCoins: Zi,
    updateUserSquad: Yd
  } = Wi.actions,
  $i = t => {
  ...
  to = u.memo(({
    ...
    const [s, a] = u.useState(lu()), [i, o] = u.useState(!1);
    return u.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  gn = ({
    ...
    }, [t]), a ? Ve.createPortal(e.jsxs(ae.Fragment, {
  ...
  Im = () => e.jsxs("div", {
    ...
    children: [e.jsx(Nm, {}), e.jsx(bm, {}), e.jsx(Hu, {}), e.jsx(Ws, {
      text: "Quick start"
    }), e.jsx(Vu, {}), e.jsx(Xu, {}), e.jsx(Ku, {}), e.jsx(Ws, {
      text: "Special"
    }), e.jsx(ym, {}), e.jsx(wm, {}), e.jsx(fm, {}), e.jsx(lm, {}), e.jsx(rm, {}), e.jsx(zu, {}), e.jsx(Zu, {}), e.jsx($u, {}), e.jsx(em, {}), e.jsx(sm, {}), e.jsx(Ws, {
      text: "Browser"
  ...
  Mm = "_data_7jsmf_57",
  Um = "_title_7jsmf_63",
  Fm = "_pixelColor_7jsmf_68",
  Om = "_pixelCoords_7jsmf_77",
  Qm = "_pixelPriceValue_7jsmf_83",
  zm = "_pixelPriceDescription_7jsmf_91",
  Lm = "_pixelState_7jsmf_95",
  qm = "_pixelDate_7jsmf_100",
  Gm = "_paginationContainer_7jsmf_107",
  Hm = "_loadMoreButton_7jsmf_114",
  Jm = "_noPixelsContainer_7jsmf_136",
  Vm = "_noPixelsText_7jsmf_143",
  Ym = "_pixelsForSaleCountText_7jsmf_149",
  Xm = "_skeleton_container_7jsmf_153",
  Wm = "_skeleton_header_7jsmf_157",
  ...
  $ = {
    ...
    pixelState: Lm,
    pixelDate: qm,
    paginationContainer: Gm,
    loadMoreButton: Hm,
    noPixelsContainer: Jm,
    noPixelsText: Vm,
    pixelsForSaleCountText: Ym,
...
const Zm = tn.getSelectors(t => t.tournament.approvedTemplatesList),
  $m = () => {
  ...
  tA = t => e.jsxs("div", {
    className: $.container,
    children: [e.jsx(eA, {}), e.jsx("div", {
      className: $.data,
      children: t.children
    })]
  }),
  nA = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
  Ee = t => {
    const n = new Date().getFullYear(),
      ...
      r = t.getHours(),
      l = t.getMinutes();
    return `${o<10?0:""}${o} ${[nA[i]]} ${a} at ${r<10?0:""}${r}:${l<10?0:""}${l}`
  },
  sA = ({
    date: t
  }) => e.jsx("div", {
...
const ha = z("canvas/getPixelInfo", async ({
  ...
  qn = z("canvas/getPrices", async () => (await X.getPrices()).data),
...
let CA = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [hA, gA, _A, fA, xA, yA, vA, wA, jA, bA, NA, IA, PA], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
...
const SA = "_order_panel_1ley0_1",
  TA = "_content_1ley0_12",
  EA = "_fast_mode_blocker_1ley0_25",
  BA = "_info_1ley0_38",
  DA = "_active_color_1ley0_47",
  kA = "_pixel_info_container_1ley0_57",
  RA = "_pixel_info_color_1ley0_65",
  MA = "_pixel_info_text_1ley0_71",
  UA = "_info_button_1ley0_77",
  FA = "_info_button_active_1ley0_94",
  OA = "_price_value_1ley0_98",
  QA = "_pixel_locked_text_1ley0_104",
  zA = "_pixel_locked_text_painted_1ley0_115",
  LA = "_pixel_locked_animation_1ley0_137",
  qA = "_button_1ley0_143",
  GA = "_button_text_1ley0_167",
  HA = "_flash_mode_button_text_1ley0_180",
  JA = "_not_pixel_icon_1ley0_191",
  VA = "_tg_logo_1ley0_195",
  YA = "_image_1ley0_200",
  XA = "_inner_wrapper_button_1ley0_205",
  ne = {
    order_panel: SA,
    content: TA,
    ...
    pixel_info_text: MA,
    info_button: UA,
    info_button_active: FA,
    price_value: OA,
    pixel_locked_text: QA,
    pixel_locked_text_painted: zA,
    pixel_locked_animation: LA,
    button: qA,
    button_text: GA,
    flash_mode_button_text: HA,
    not_pixel_icon: JA,
    tg_logo: VA,
    image: YA,
    inner_wrapper_button: XA
  },
...
const np = (t, n) => {
    ...
    ma() && (s = {
    ...
    }), lt = new Ir(Ca.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), lt.on("connected", function(a) {
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          r.user === n || !ln || (r.type === Ga.bomb && v.mainImage.bomb.boomWithDebounce(pa(r.pixel)), r.type === Ga.pumpkin && v.mainImage.pumpkin.boomWithDebounce(pa(r.pixel)))
        });
        return
      }
      ...
      Pr(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === ep[1] && kt.getState().daily.list.entities[d.good_id]) {
...
const th = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(js(10)), t(nt(1)), t(st()), t(ho()), !1;
  if (s === a) return !1;
  ...
  try {
    (await t(Ns.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === A.fulfilled && (t(Ud(a)), t(bs({
      product: 1,
      amount: 1
...
ht.startListening({
  ...
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Gd(t.payload.totalUserPixels)), n.dispatch(Zi(t.payload.userBalance))), n.dispatch(dc(t.payload.goods))
  }
});
ht.startListening({
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === me.energyLimit) {
        ...
        n.dispatch(Rd(s.mining.maxCharges + d)), n.dispatch(Xi(d))
      }
...
class De {
  ...
  static async getTemplateById({
    ...
    return Yt !== null && (Yt.abort(), Yt = null), Yt = new AbortController, S.get(`/image/template/${n}`, {
      signal: Yt.signal
    })
  }
...
const mh = "/assets/halloween2-l9FmXxVI.png",
  ...
  Zn = z("daily/getList", async () => (await X.getDailyList()).data),
  $n = z("daily/getFirstDaily", async () => (await X.getFirstDaily()).data),
  Do = Ae({
    name: "daily",
    initialState: yh,
    reducers: {
  ...
  Lh = async ({
    ...
    await t(lp({
      ...
      id: tt(s),
      color: Mt(a)
    }), v.mainImage.updateTexture(), await t(KA(a)), await t(lA(s)), await t(Od());
...
function Dg() {
  v = new Bg({
    readyCallback: t => {
      np(t.getState().user.user.websocketToken, t.getState().user.user.id)
    }
  })
}
const kg = u.memo(() => (u.useEffect(() => {
  ...
  Qg = () => {
    ...
    return c(s => s.user.pixelsForSaleFetchStatus) === A.pending && t === 0 ? e.jsx(Og, {}) : t !== 0 ? e.jsxs(tA, {
      children: [e.jsx(Ug, {}), e.jsx(Fg, {})]
    }) : null
  },
  zg = () => {
    const t = g();
    return Cm(), u.useEffect(() => () => {
      t(Jd()), t(Ki({
        offset: 0
      })), t(Hd({
        status: A.idle
  ...
  N_ = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(Pm, {}), t === "tasks" && e.jsx(Im, {}), t === "pixels" && e.jsx(zg, {}), t === "boosts" && e.jsx(b_, {})]
    })
  },
  I_ = () => {
    const t = g(),
  ...
  Ff = () => (c(t => t.ratings.league), c($i), c(fo), e.jsx("div", {
  ...
  ks = ({
    ...
    return n > 0 && (i = An(i, n)), e.jsx("span", {
      className: Hi.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? le(`https://t.me/${Ya(t)}`) : Qt(`https://t.me/${Ya(t)}`)
      },
      children: i
    })
  },
  ...
  jb = ({
    ...
    if (r) {
      ...
      return t && (j = `Claim in ${wl(t)}`), h && (j = "Pending transaction..."), e.jsxs("div", {
        className: U.content,
        children: [e.jsx("div", {
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Je.subscribe({
              ...
              t(_h(h)), v.mainImage.worldTemplate.deleteTemplate(o.id), v.mainImage.worldTemplate.add(h), t(yn())
            } else await t(J({
              id: performance.now(),
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await De.uploadTemplate({
              ...
              i(Eo(k)), i(yn()), await v.mainImage.worldTemplate.add(k), i(J({
                id: performance.now(),
    ...
    return u.useEffect(() => {}, []), u.useEffect(() => {
      if (t !== null) {
        ...
        const M = async () => {
          ...
          xN(We), _.putImageData(We, 0, 0), a(We), o(k.toDataURL())
        };
        setTimeout(() => {
          M().then(() => {
            f(!1)
    ...
    return u.useEffect(() => {
      if (t !== null) {
        ...
        const M = async () => {
          ...
          k.width = r, k.height = r, _.drawImage(t, ge, Oe, E, w);
          const We = _.getImageData(0, 0, r, r);
          FN(We), _.putImageData(We, 0, 0), a(We), o(k.toDataURL())
        };
        setTimeout(() => {
          M().then(() => {
            f(!1)
  ...
  dP = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === qe.create && e.jsx(gI, {}), t === qe.main && e.jsx(QI, {}), t === qe.result && e.jsx(lP, {})]
    })
  },
...
const l2 = () => {
  ...
  gS = ({
    ...
    const j = async w => {
      ...
      await f.sendTransaction(gr), n(!0), h(!0), d(A.fulfilled)
    };
    return e.jsx("button", {
      className: Y.button,
      onPointerUp: async w => {
  ...
  vS = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(AS, {}), e.jsx(yS, {}), e.jsx(to, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: Y.error,
  ...
  NS = "_layout_j8oqn_1",
  IS = "_container_j8oqn_13",
  PS = "_header_j8oqn_19",
  CS = "_title_j8oqn_29",
  SS = "_body_j8oqn_34",
  TS = "_image_container_j8oqn_46",
  ES = "_image_j8oqn_46",
  BS = "_description_container_j8oqn_57",
  DS = "_text_j8oqn_66",
  kS = "_button_container_j8oqn_70",
  RS = "_button_j8oqn_70",
  ze = {
    layout: NS,
    container: IS,
...
async function zS() {
  y.enable(y.BLEND), y.blendFunc(y.SRC_ALPHA, y.ONE_MINUS_SRC_ALPHA), y.clearColor(0, 0, 0, 0), y.viewport(0, 0, y.canvas.width, y.canvas.height), we = await LS(y), y.useProgram(we)
}
...
function VS() {
  ...
  cs = r * r, Ze(y, we, "u_AnimationDuration", cr), Ze(y, we, "u_ParticleSize", FS), Ze(y, we, "u_ViewportWidth", t), Ze(y, we, "u_ViewportHeight", n), Ze(y, we, "u_TextureWidth", s), Ze(y, we, "u_TextureHeight", a), Ze(y, we, "u_TextureLeft", i), Ze(y, we, "u_TextureTop", o);
...
function YS(t) {
  ...
  Ze(y, we, "u_ElapsedTime", s), y.drawArrays(y.POINTS, 0, cs), lr()
}
...
const XS = () => {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            onPointerUp: () => {
              var a, i;
              v.viewport.viewport.fit(), v.viewport.viewport.moveCenter(v.viewport.viewport.worldWidth / 2, v.viewport.viewport.worldHeight / 2), OS(), t.push("/"), n(cp()), (i = (a = window.Telegram.WebApp) == null ? void 0 : a.HapticFeedback) == null || i.notificationOccurred("error")
            },
            children: "Whoosh!"
          })]
        })]
  ...
  sT = "_layout_1nuac_1",
  aT = "_container_1nuac_19",
  iT = "_image_container_1nuac_30",
  oT = "_image_1nuac_30",
    ...
    return e.jsx(ke, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === Ue.userFromPixelInfo && e.jsx(ba, {
          ...
          isPopupContent: s
        }), n.dataSource === Ue.squadFromData && e.jsx(mT, {})]
      })
    })
  },
  pT = "_overlay_1vl8z_1",
  hT = "_top_container_1vl8z_10",
  gT = "_bottom_container_1vl8z_15",
  _T = "_side_menu_1vl8z_20",
  fT = "_menu_safe_area_inset_1vl8z_36",
  xT = "_menu_header_1vl8z_40",
  yT = "_close_button_1vl8z_53",
  vT = "_menu_list_1vl8z_58",
  wT = "_icon_1vl8z_79",
  jT = "_icon_not_pixel_1vl8z_87",
  bT = "_gold_pixel_1vl8z_97",
  NT = "_menu_list_li_1vl8z_103",
  IT = "_menu_list_text_1vl8z_109",
  PT = "_menu_list_new_item_1vl8z_113",
  CT = "_button_wrapper_1vl8z_136",
  ST = "_button_content_1vl8z_145",
  TT = "_footer_1vl8z_152",
  ET = "_avatar_1vl8z_158",
  BT = "_ratings_image_container_1vl8z_165",
  DT = "_ratings_image_1vl8z_165",
  H = {
    overlay: pT,
    top_container: hT,
    bottom_container: gT,
    side_menu: _T,
    menu_safe_area_inset: fT,
    menu_header: xT,
    close_button: yT,
    menu_list: vT,
    icon: wT,
  ...
  YT = "_container_n1egb_1",
  XT = "_header_n1egb_11",
  WT = "_title_n1egb_24",
  KT = "_close_container_n1egb_30",
  ZT = "_close_n1egb_30",
  $T = "_body_n1egb_54",
  eE = "_content_n1egb_65",
  tE = "_time_left_container_n1egb_71",
  nE = "_timer_n1egb_75",
  sE = "_image_container_n1egb_79",
  aE = "_image_n1egb_79",
  iE = "_description_container_n1egb_89",
  oE = "_bold_n1egb_98",
  rE = "_gray_n1egb_103",
  cE = "_center_n1egb_107",
  lE = "_footer_n1egb_111",
  dE = "_button_n1egb_117",
  uE = "_image_container_charges_n1egb_149",
  mE = "_image_charges_n1egb_153",
  xe = {
    container: YT,
    header: XT,
    title: WT,
...
const pE = "_layout_1at34_1",
  hE = "_container_1at34_10",
  gE = "_item_1at34_14",
  la = {
    layout: pE,
    container: hE,
  ...
  jE = "_container_gb8eq_1",
  bE = "_header_gb8eq_11",
  NE = "_title_gb8eq_17",
  IE = "_close_container_gb8eq_23",
  PE = "_close_gb8eq_23",
  CE = "_body_gb8eq_47",
  SE = "_content_gb8eq_59",
  TE = "_time_left_container_gb8eq_65",
  EE = "_timer_gb8eq_69",
  BE = "_image_container_gb8eq_73",
  DE = "_image_gb8eq_73",
  kE = "_glow_container_gb8eq_91",
  RE = "_glow_gb8eq_91",
  ME = "_rotate_gb8eq_1",
  UE = "_glow_reverse_gb8eq_107",
  FE = "_description_container_gb8eq_113",
  OE = "_bold_gb8eq_123",
  QE = "_gray_gb8eq_128",
  zE = "_center_gb8eq_132",
  LE = "_gold_gb8eq_136",
  qE = "_button_gb8eq_144",
  _e = {
    container: jE,
    header: bE,
    title: NE,
  ...
  GE = "/assets/cup_glad-DGT2PBmm.png",
  HE = () => {
    const t = K(),
      n = c(Xe),
      [s, a] = u.useState(!1),
      i = "showCreateTournamentTemplatePopup";
    return u.useEffect(() => (qi() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(ke, {
      show: s,
      children: e.jsx("div", {
  ...
  XE = "_close_xga4i_25",
  WE = "_body_xga4i_38",
  KE = "_image_container_xga4i_42",
  ZE = "_image_xga4i_42",
  $E = "_glow_xga4i_55",
  eB = "_forward_xga4i_62",
  tB = "_rotate_xga4i_1",
  nB = "_reverse_xga4i_66",
  sB = "_text_container_xga4i_70",
  aB = "_title_xga4i_78",
  iB = "_description_xga4i_82",
  oB = "_footer_xga4i_86",
  rB = "_button_xga4i_90",
  fe = {
    layout: JE,
...
const pB = "_layout_1tvc9_1",
  hB = "_container_1tvc9_5",
  gB = "_close_button_1tvc9_14",
  _B = "_title_container_1tvc9_22",
  fB = "_image_container_1tvc9_28",
  xB = "_image_1tvc9_28",
  yB = "_text_container_1tvc9_47",
  vB = "_button_container_1tvc9_52",
  Ke = {
    layout: pB,
    container: hB,
    close_button: gB,
  ...
  jB = () => e.jsxs("div", {
    className: en.layout,
    children: [e.jsx(m2, {}), e.jsx(c2, {}), e.jsx(kg, {}), e.jsx(TC, {}), e.jsx(l2, {}), e.jsx(KS, {}), e.jsx(uT, {}), e.jsx(AT, {}), e.jsx(M2, {}), e.jsx(WS, {}), e.jsx(wE, {}), e.jsx(HE, {}), e.jsx(AB, {}), e.jsx(wB, {}), e.jsx(bS, {}), e.jsx(XS, {}), e.jsx(nT, {}), e.jsx(VT, {})]
  }),
  bB = () => {
    const t = g(),
    ...
    return u.useEffect(() => {
      const s = setInterval(() => {
        Date.now() - n > 18e5 && (t(ip()), clearInterval(s))
      }, 100);
      return () => {
        clearInterval(s)
      }
  ...
  zB = () => {
    ...
    u.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(ZA(s)), t(Da(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(kd(s))
      })
    }, [t])
      ...
      s = async () => {
        ...
        try {
          ...
          if (f.payload && f.payload.id !== 0) {
            ...
            t(Eo(M)), await v.mainImage.worldTemplate.add(M)
          }
        } catch (f) {
          console.error("Ошибка получения подключенного трафарета:", f)
        }
      }, r = async h => {
        if (!ko(h)) return Promise.resolve();
        try {
          t(Bs.getMyTemplate({
            id: h.id
          }))
  ...
  qB = () => {
    const t = K();
    u.useEffect(() => {
      qi() ? localStorage.getItem("skipIntro") || (t.push("/welcome"), localStorage.setItem("skipIntro", "true")) : Lt.get("skipIntro", (n, s) => {
  ...
  YB = () => {
    ...
    return u.useEffect(() => {
      function a() {
        console.log("is fullscreen: ", this.isFullscreen), t(Xc(this.isFullscreen))
      }
  ...
  XB = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(tc) && IB(), zB(), LB(), qB(), a || o ? e.jsx(FB, {}) : i ? e.jsx(QB, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
ac(vn);
tp(vn);
const tD = xr.createRoot(document.getElementById("root"));
