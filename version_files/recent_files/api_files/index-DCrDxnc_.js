...
var hr = (t, n, s) => n in t ? pr(t, n, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: s
}) : t[n] = s;
var Us = (t, n, s) => hr(t, typeof n != "symbol" ? n + "" : n, s);
import {
  j as e,
  r as u,
  R as ie
...
const Sr = "_stars_img_container_1wci0_1",
  Tr = "_stars_img_1wci0_1",
  Er = "_scalebubble_1wci0_1",
  Br = "_squads_img_1wci0_17",
  Dr = "_title_container_1wci0_22",
  kr = "_description_container_1wci0_28",
  Rr = "_description_1wci0_28",
  Mr = "_info_layout_1wci0_42",
  Ur = "_info_container_1wci0_52",
  Fr = "_info_row_1wci0_59",
  Or = "_info_row_content_1wci0_65",
  Qr = "_info_row_sale_1wci0_84",
  zr = "_not_active_1wci0_100",
  qr = "_selected_1wci0_105",
  Lr = "_row_icon_container_1wci0_110",
  Hr = "_row_icon_1wci0_110",
  Gr = "_row_title_1wci0_133",
  Jr = "_row_amount_1wci0_143",
  Vr = "_row_price_container_1wci0_156",
  ...
  Wr = ["/transaction/user/start", "/repaint/finish", "/transaction/user/complete", "/stars/shop/process", "/mining/status/claim", "/mining/claim", "/mining/status/error", "/repaint/complete", "/stars/shop/reject", "/squads/list/get", "/squads/list/update"],
  pe = {
    my: "my",
    referred: "referred",
    world: "world"
...
const nc = "/assets/icon_stars_new-Dk8ap_HZ.png",
...
const oc = {
  ...
  Tn = Q("shop/getProducts", async () => (await Y.getProducts()).data),
  ...
  }),
  {
    ...
    setLimitedGoods: cc,
    clearLimitedGoods: Qs,
    showLimitedGoodsPopup: Ei,
    hideLimitedGoodsPopup: zs
  } = Ti.actions,
  lc = Ti.reducer,
  Ns = {
    getProducts: Tn,
  ...
  Bn = Fc,
  Oc = () => window.location.hostname.split(".").length === 3,
  Qc = () => !1,
  Oi = () => window.location.hostname.includes("dev"),
  zc = () => Oi() ? Bn.VITE_ADSGRAM_BLOCK_ID : Oc() ? "4853" : "4995",
  ut = {
    isDev: Qc(),
    devServer: Oi(),
  ...
  Xc = t => t.device.contentSafeAreaInset,
  ...
  el = "_header_btihg_1",
  tl = "_header_bottom_container_btihg_14",
  nl = "_header_bottom_btihg_14",
  sl = "_header_placeholder_btihg_39",
  al = "_header_content_btihg_45",
  il = "_league_btihg_56",
  ol = "_bronze_btihg_66",
  rl = "_silver_btihg_67",
  cl = "_gold_btihg_68",
  ll = "_platinum_btihg_69",
  dl = "_diamond_btihg_70",
  ul = "_logo_link_btihg_72",
  ml = "_logo_btihg_72",
  Ne = {
    header: el,
    header_bottom_container: tl,
    header_bottom: nl,
    header_placeholder: sl,
    header_content: al,
    league: il,
    bronze: ol,
    silver: rl,
  ...
  Qt = async t => {
  ...
  }, qi = t => new Promise(n => setTimeout(n, t)), gl = t => {
    ...
    try {
      ...
      return gl(n.coords) || (n.coords = !1), n.showTemplate && (n.coords = !1), n
    } catch {
      return {
        coords: !1,
        squad: !1,
  ...
  }, ma = t => !0, yl = "_layout_13e1w_1", wl = "_container_13e1w_10", jl = "_star_13e1w_14", bl = "_move_13e1w_1", jn = {
    layout: yl,
    container: wl,
    star: jl,
    move: bl
  }, Nl = "_link_1fn8i_1", Pl = "_telegram_icons_1fn8i_13", Li = {
    link: Nl,
    telegram_icons: Pl
  }, b = ({
    children: t,
  ...
  }, () => !1), Il = "_layout_1nbfl_1", Sl = "_button_1nbfl_14", Xa = {
    layout: Il,
    button: Sl
  }, Tl = () => {
    const t = K();
  ...
  }, El = "_layout_fzjo7_1", Bl = "_container_fzjo7_5", Dl = "_item_fzjo7_11", kl = "_active_fzjo7_20", Rl = "_image_container_fzjo7_24", Ml = "_image_fzjo7_24", Ul = "_item_text_container_fzjo7_34", Fl = "_item_text_fzjo7_34", at = {
    layout: El,
    container: Bl,
    item: Dl,
    active: kl,
    ...
    return u.useEffect(() => {
      ...
      children: e.jsx("div", {
        ...
        children: n.map(i => {
          ...
          return e.jsxs("div", {
            className: G(at.item, o ? at.active : ""),
            onPointerUp: () => {
              t(on(i.currency_id))
            },
            children: [e.jsx("div", {
  ...
  }, zl = "/assets/icon_coin-COCalNMQ.gif", ql = "/assets/icon_stars-BmDiRMAW.gif", Ll = {
    items: []
  }, Hi = me({
    name: "toast",
    initialState: Ll,
    ...
    return u.useEffect(() => {}, []), e.jsxs(oe, {
      children: [e.jsxs("div", {
        ...
        children: [e.jsx(Ol, {}), e.jsx("div", {
          className: de.info_container,
          children: t.map(i => {
            if (n.hasOwnProperty(i)) {
              const o = n[i];
              let r = !((i === 4 || i === 5) && s[i] > 0);
              if (i === 1 || i === 2 || i === 6 || i === 7) return e.jsx(Ql, {
                item: o,
                active: r
              }, i);
              {
  ...
  }), od = "_pixels_amount_ngjsa_1", rd = "_general_info_container_ngjsa_6", cd = "_coin_amount_text_ngjsa_12", ld = "_description_container_ngjsa_16", dd = "_description_ngjsa_16", bn = {
    pixels_amount: od,
    general_info_container: rd,
    coin_amount_text: cd,
    description_container: ld,
    description: dd
  }, ud = "_logo_container_1i5of_1", md = {
    logo_container: ud
  }, Ad = "_layout_1cvcu_1", pd = "_container_1cvcu_10", hd = "_bubble_1cvcu_16", gd = "_move_1cvcu_1", Xs = {
    layout: Ad,
    container: pd,
    bubble: hd,
    move: gd
  ...
  }, () => !1), fd = "_container_1aw3i_1", xd = "_logo_1aw3i_9", vd = "_animate_1aw3i_1", yd = "_center_1aw3i_18", wd = "_glow_1aw3i_28", Nn = {
    container: fd,
    logo: xd,
    animate: vd,
    center: yd,
    ...
    className: md.logo_container,
    children: [e.jsx(_d, {
      color: () => `hsl(${z(0,360)} , 1000%, 50%)`
    }), e.jsx(jd, {})]
  }), Nd = "_container_13oyr_1", Pd = "_button_13oyr_11", Cd = "_info_13oyr_32", dt = {
    container: Nd,
    button: Pd,
    info: Cd
  };
...
const Dn = Q("mining/info", async () => (await Ps.info()).data),
  kn = Q("mining/claim", async () => (await Ps.claim()).data),
  ...
  On = Q("user/getPixelsForSaleTotal", async () => (await Y.getUserPixelsCount()).data),
  ...
  }),
  {
    ...
    removePixelsForSale: qd,
    setPixelsSoldOffset: YD,
    setPixelsSoldTotal: WD,
    setPixelsSoldFetchStatus: KD,
    removePixelsSold: ZD,
    addPixelCoins: jt,
  ...
  Xd = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='%238794a1'/%3e%3c/svg%3e",
  Yd = {
    white: Vd,
    gray: Xd
  },
  ...
  du = () => c(n => n.mining.infoStatus) !== A.fulfilled ? e.jsx(lu, {}) : e.jsx(cu, {}),
  uu = () => {
  ...
  mu = "_info_layout_bt2qf_1",
  Au = "_info_container_bt2qf_10",
  pu = "_category_container_bt2qf_16",
  hu = "_category_title_bt2qf_22",
  gu = "_row_container_bt2qf_27",
  _u = "_info_row_bt2qf_35",
  fu = "_info_row_pending_bt2qf_59",
  xu = "_loading_bt2qf_1",
  vu = "_content_bt2qf_74",
  yu = "_image_container_bt2qf_83",
  wu = "_image_bt2qf_83",
  ju = "_row_main_information_bt2qf_103",
  bu = "_row_title_bt2qf_114",
  Nu = "_row_icon_container_bt2qf_120",
  Pu = "_row_icon_bt2qf_120",
  Cu = "_row_main_value_bt2qf_130",
  Iu = "_row_prompt_bt2qf_137",
  Su = "_not_pixel_icon_bt2qf_142",
  Tu = "_row_image_bt2qf_147",
  Eu = "_row_reward_count_bt2qf_153",
  Bu = "_row_reward_completed_bt2qf_158",
  Du = "_priceless_bt2qf_165",
  ku = "_completed_tasks_container_bt2qf_169",
  Ru = "_completed_task_item_bt2qf_176",
  p = {
    info_layout: mu,
    info_container: Au,
    category_container: pu,
    category_title: hu,
    row_container: gu,
    info_row: _u,
    info_row_pending: fu,
    ...
    image_container: yu,
    image: wu,
    row_main_information: ju,
    row_title: bu,
    row_icon_container: Nu,
    row_icon: Pu,
    row_main_value: Cu,
    row_prompt: Iu,
    not_pixel_icon: Su,
    row_image: Tu,
    row_reward_count: Eu,
    row_reward_completed: Bu,
    priceless: Du,
    completed_tasks_container: ku,
    completed_task_item: Ru
  },
  le = ({
    children: t,
    boost: n,
  ...
  Qu = "data:image/png;base64,",
  Ge = ({
    num: t
  ...
  Hu = "data:image/png;base64,",
  Gu = () => {
    const t = K(),
      n = N.invite3frens;
  ...
  Ju = "data:image/png;base64,",
  Vu = () => {
    const t = N.joinSquad;
  ...
  rm = "_pixel_copy_button_265n2_25",
  cm = "_gray_265n2_35",
  it = {
    pixel_image_popup: am,
    pixel_image_text_container: im,
    pixel_image: om,
    pixel_copy_button: rm,
    gray: cm
  },
  ...
  xm = () => e.jsxs("div", {
    ...
    children: [e.jsx(fm, {}), e.jsx(zu, {}), e.jsx(Ws, {
      text: "Quick start"
    }), e.jsx(Lu, {}), e.jsx(Gu, {}), e.jsx(Vu, {}), e.jsx(Ws, {
      text: "Special"
    }), e.jsx(pm, {}), e.jsx(gm, {}), e.jsx(mm, {}), e.jsx(sm, {}), e.jsx(tm, {}), e.jsx(Uu, {}), e.jsx(Xu, {}), e.jsx(Yu, {}), e.jsx(Wu, {}), e.jsx(Ku, {}), e.jsx(Ws, {
      text: "Browser"
    }), e.jsx(Fu, {}), e.jsx(Ou, {}), e.jsx(Zu, {}), e.jsx($u, {}), e.jsx("div", {
      style: {
        height: 30
      }
    })]
  ...
  ym = () => {
    ...
    return u.useEffect(() => {
      t(yt.getPixelsForSale({
        offset: n,
        limit: s
      }))
    }, [n, s, t]), null
  },
  wm = "_container_7jsmf_1",
  jm = "_row_7jsmf_6",
  bm = "_cell1_7jsmf_26",
  Nm = "_cell2_7jsmf_30",
  Pm = "_cell3_7jsmf_36",
  Cm = "_icon_arrow_7jsmf_40",
  Im = "_header_7jsmf_47",
  Sm = "_data_7jsmf_57",
  Tm = "_title_7jsmf_63",
  Em = "_pixelColor_7jsmf_68",
  Bm = "_pixelCoords_7jsmf_77",
  Dm = "_pixelPriceValue_7jsmf_83",
  km = "_pixelPriceDescription_7jsmf_91",
  Rm = "_pixelState_7jsmf_95",
  Mm = "_pixelDate_7jsmf_100",
  Um = "_paginationContainer_7jsmf_107",
  Fm = "_loadMoreButton_7jsmf_114",
  Om = "_noPixelsContainer_7jsmf_136",
  Qm = "_noPixelsText_7jsmf_143",
  zm = "_pixelsForSaleCountText_7jsmf_149",
  qm = "_skeleton_container_7jsmf_153",
  Lm = "_skeleton_header_7jsmf_157",
  Hm = "_skeleton_row_7jsmf_166",
  $ = {
    container: wm,
    row: jm,
    cell1: bm,
    ...
    loadMoreButton: Fm,
    noPixelsContainer: Om,
    noPixelsText: Qm,
    pixelsForSaleCountText: zm,
    skeleton_container: qm,
    skeleton_header: Lm,
    skeleton_row: Hm
  },
...
const Gm = en.getSelectors(t => t.tournament.approvedTemplatesList),
  Jm = () => {
...
let Dt = null;
const ha = Q("canvas/getPixelInfo", async ({
    id: t
  }) => (Dt !== null && (Dt.abort(), Dt = null), Dt = new AbortController, (await Y.getPixelInfo({
    id: t,
    signal: Dt.signal
  })).data)),
  ...
  oo = me({
    ...
    extraReducers: t => {
      ...
      }).addCase(Ln.rejected, n => {}).addCase(Hn.pending, n => {
...
let yA = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [cA, lA, dA, uA, mA, AA, pA, hA, gA, _A, fA, xA, vA], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
...
const wA = "_order_panel_1ley0_1",
  jA = "_content_1ley0_12",
  bA = "_fast_mode_blocker_1ley0_25",
  NA = "_info_1ley0_38",
  PA = "_active_color_1ley0_47",
  CA = "_pixel_info_container_1ley0_57",
  IA = "_pixel_info_color_1ley0_65",
  SA = "_pixel_info_text_1ley0_71",
  TA = "_info_button_1ley0_77",
  EA = "_info_button_active_1ley0_94",
  BA = "_price_value_1ley0_98",
  DA = "_pixel_locked_text_1ley0_104",
  kA = "_pixel_locked_text_painted_1ley0_115",
  RA = "_pixel_locked_animation_1ley0_137",
  MA = "_button_1ley0_143",
  UA = "_button_text_1ley0_167",
  FA = "_flash_mode_button_text_1ley0_180",
  OA = "_not_pixel_icon_1ley0_191",
  QA = "_tg_logo_1ley0_195",
  zA = "_image_1ley0_200",
  qA = "_inner_wrapper_button_1ley0_205",
  ne = {
    order_panel: wA,
    content: jA,
    fast_mode_blocker: bA,
    info: NA,
    active_color: PA,
    pixel_info_container: CA,
    pixel_info_color: IA,
    pixel_info_text: SA,
    info_button: TA,
    info_button_active: EA,
    price_value: BA,
    pixel_locked_text: DA,
    pixel_locked_text_painted: kA,
    pixel_locked_animation: RA,
    button: MA,
    button_text: UA,
    flash_mode_button_text: FA,
    not_pixel_icon: OA,
    tg_logo: QA,
    image: zA,
    inner_wrapper_button: qA
  },
  $a = window.Telegram.WebApp.CloudStorage;
let co = class {
  static warn() {
...
const YA = (t, n) => {
    ...
    ma() && (s = {
    ...
    }), lt = new jr(Ia.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), lt.on("connected", function(a) {
      ...
      o.src = URL.createObjectURL(i), o.onload = () => {
        y.mainImage.loadFromCentrifuge(o).then(() => {
          ...
          }), y.mainImage.selectedPixel.draw(l), kt.dispatch(wt(l)))
        })
      }
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          r.user === n || !cn || (r.type === Ha.bomb && y.mainImage.bomb.boomWithDebounce(pa(r.pixel)), r.type === Ha.pumpkin && y.mainImage.pumpkin.boomWithDebounce(pa(r.pixel)))
        });
        return
      }
      ...
      br(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === VA[1] && kt.getState().daily.list.entities[d.good_id]) {
  ...
  cp = "_layout_oxfjd_1",
  lp = "_container_oxfjd_7",
  dp = "_placeholder_oxfjd_20",
  up = "_progress_oxfjd_24",
  mp = "_counter_oxfjd_32",
  ...
  fp = () => {
    ...
    return u.useEffect(() => {
      ...
      children: [e.jsx(pp, {}), e.jsx(_p, {
        progress: d
      })]
    })
  },
  xp = "_layout_j77dp_1",
  vp = "_container_j77dp_21",
  yp = "_buttons_container_j77dp_27",
  wp = "_button_j77dp_27",
  jp = "_shop_button_j77dp_44",
  bp = "_container__bottom_j77dp_49",
  Np = "_fast_type_button_j77dp_49",
  Pp = "_disabled_button_cover_j77dp_61",
  Cp = "_fast_mode_button_enabled_j77dp_72",
  Ip = "_available_j77dp_82",
  Sp = "_limited_good_timer_j77dp_99",
  Tp = "_disabled_available_cover_j77dp_120",
  Ep = "_button_image_j77dp_130",
  S = {
    layout: xp,
    container: vp,
    ...
    button: wp,
    shop_button: jp,
    container__bottom: bp,
    fast_type_button: Np,
    disabled_button_cover: Pp,
    fast_mode_button_enabled: Cp,
    available: Ip,
    limited_good_timer: Sp,
...
const Xp = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(js(10)), t(nt(1)), t(st()), t(Ao()), !1;
  if (s === a) return !1;
  if (ta) return A.pending;
  ta = !0, t($e({
    command: Pe.start
  }));
  try {
    (await t(Ns.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === A.fulfilled && (t(Dd(a)), t(bs({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: vt
} = xo.actions, vo = t => t.layout.isShowSideMenu, Kp = xo.reducer;
let It = null,
  St = null;
class yo {
...
ht.startListening({
  ...
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Qd(t.payload.totalUserPixels)), n.dispatch(Wi(t.payload.userBalance))), n.dispatch(rc(t.payload.goods))
  }
});
ht.startListening({
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === ue.energyLimit) {
        ...
        n.dispatch(Ed(s.mining.maxCharges + d)), n.dispatch(Vi(d))
      }
...
const Ts = un();
Ts.startListening({
  matcher: Ie(Cs.getPriceMask.pending, yt.getPixelsForSale.pending, yt.getPixelsSold.pending, Ma.get.pending),
  effect: (t, n) => {
    n.dispatch($e({
      command: Pe.start
    }))
...
Ts.startListening({
  matcher: Ie(Cs.getPriceMask.fulfilled, yt.getPixelsForSale.fulfilled, yt.getPixelsSold.fulfilled, Ma.get.fulfilled),
  effect: (t, n) => {
    n.dispatch($e({
      command: Pe.finish
    }))
...
Ts.startListening({
  matcher: Ie(Cs.getPriceMask.rejected),
  effect: (t, n) => {
...
const No = un();
No.startListening({
  matcher: Ie(yt.getUser.fulfilled),
  effect: (t, n) => {
...
const Po = un();
Po.startListening({
  matcher: Ie(Ra.squad.fulfilled),
  effect: (t, n) => {
    n.dispatch(Hd(t.payload.mySquad))
  }
});
const sh = {
    info: null,
...
class De {
  ...
  static async getRandomTemplates() {
    return C.get("/tournament/template/randomList?limit=16")
  }
...
const ih = "/assets/halloween2-l9FmXxVI.png",
  oh = Q("template/subscribe", async ({
    id: t
  ...
  Io = me({
    ...
    extraReducers: t => {
      ...
      }).addCase(Wn.rejected, (n, s) => {}).addCase(fa.pending, n => {}).addCase(fa.fulfilled, (n, s) => {}).addCase(Kn.pending, (n, s) => {}).addCase(Kn.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: pe.world
        };
        n.worldTemplate = a, y.mainImage.worldTemplate.add(a)
      }).addCase(Kn.rejected, (n, s) => {}).addCase(Yn.pending, n => {
  ...
  }),
  {
    ...
    hideTemplates: vn,
    setTemplateOpacity: lh,
    setReferredTemplate: dh,
    setMyTemplate: So,
    setTemplateListOffset: dk,
    clearTemplatesListData: uh,
  ...
  Zn = Q("daily/getList", async () => (await Y.getDailyList()).data),
  $n = Q("daily/getFirstDaily", async () => (await Y.getFirstDaily()).data),
  Eo = me({
    name: "daily",
    initialState: Ah,
    reducers: {
  ...
  Bo = t => t ? t.friends >= ec.friendsForTemplateCreation || t.isContractor : !1,
  Le = {
    create: "create",
    main: "main",
    result: "result"
  ...
  yh = () => {
    const t = g(),
      ...
      o = i && i.approved;
    return e.jsxs(Lt, {
      children: [a && o && e.jsx(Ce, {
        active: n === Le.create,
        setActive: () => t(na(Le.create)),
        children: "My template"
      }), e.jsx(Ce, {
        active: n === Le.main,
        setActive: () => t(na(Le.main)),
        children: "Tournament"
      }), e.jsx(Ce, {
        active: n === Le.result,
        setActive: () => t(na(Le.result)),
        children: "My results"
      })]
    })
  },
  ...
  }),
  {
    ...
    setMyTournamentTemplate: mk,
    clearApprovedTemplateList: bh,
    showTournamentTemplateInfoPopup: Ro,
    closeTournamentTemplateInfoPopup: ti,
    setSelectedTemplate: Nh
  } = Do.actions,
  Bs = {
    getMyTemplate: es,
  ...
  yn = _r({
    ...
    devTools: !1,
    middleware: t => [xn.middleware, No.middleware, Ts.middleware, ht.middleware, Po.middleware, ...t()]
  }),
  os = [],
  Rh = async ({
    dispatch: t,
    ...
    await t(np({
      ...
      id: et(s),
      color: Mt(a)
    }), y.mainImage.updateTexture(), await t(HA(a)), await t(nA(s)), await t(Rd());
    ...
    try {
      const r = await o;
      r.status === 200 && (r.data.reward_user && r.data.reward_user.reward_id && (y.mainImage.reward.add(s), t(Ih({
    ...
    n(Is()), t && t.push("/energy-over"), n(wt(s)), y.mainImage.selectedPixel.draw(s)
  }, Uo = async ({
    history: t,
    charges: n,
    dispatch: s,
...
const Qh = ({
  ...
  zh = async ({
    ...
    if (!a && i && (a = i.shop.available[2]), !a || a === 0) {
      n(js(10)), n(nt(2)), n(st()), n(bt());
      return
    }
    y.mainImage.bomb.boom(t), n(Ns.useProduct({
      pixelId: et(t),
      productId: 2
    })), n(jt(s * Qh(t))), n(bs({
      product: 2,
    ...
    return i === "paintcan" && l.push(S.fast_mode_button_enabled), s ? e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "paintcan") {
          t(bt());
          return
        }!a || a === 0 ? (t(nt(n)), t(st())) : t(Ss("paintcan"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: S.button_image,
...
let Ag = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [Jh, Vh, Xh, Yh, Wh, Kh, Zh, $h, eg, tg, ng, sg, ag, ig, og, rg, cg, lg, dg, ug], this.textureArray = [];
...
const pg = ({
  ...
  hg = async ({
    ...
    y.mainImage.pumpkin.boom(t), n(Ns.useProduct({
      pixelId: et(t),
      productId: 7
    })), n(jt(s * pg(t))), n(bs({
      product: 7,
    ...
    return i === "pumpkin" && l.push(S.fast_mode_button_enabled), !s || !a || a === 0 ? null : e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "pumpkin") {
          t(bt());
          return
        }!a || a === 0 ? (t(nt(n)), t(st())) : t(Ss("pumpkin"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: S.button_image,
...
const Cg = u.memo(() => (u.useEffect(() => {
  ...
  Tg = () => c(Ba.selectAll).map(n => e.jsx(Sg, {
    item: n
  }, et({
    x: n.x,
    y: n.y
  ...
  Dg = () => {
    ...
    return c(s => s.user.pixelsForSaleFetchStatus) === A.pending && t === 0 ? e.jsx(Bg, {}) : t !== 0 ? e.jsxs(Xm, {
  ...
  g_ = () => {
    ...
    return e.jsxs(gn, {
      show: n,
      setShow: a,
      children: [s === ue.paintReward && e.jsx(A_, {}), s === ue.reChargeSpeed && e.jsx(p_, {}), s === ue.energyLimit && e.jsx(h_, {})]
    })
  },
  __ = () => e.jsxs("div", {
    className: rs.layout,
  ...
  f_ = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(vm, {}), t === "tasks" && e.jsx(xm, {}), t === "pixels" && e.jsx(kg, {}), t === "boosts" && e.jsx(__, {})]
    })
  },
  x_ = () => {
    const t = g(),
  ...
  Ef = () => (c(t => t.ratings.league), c(Ki), c(go), e.jsx("div", {
  ...
  ks = ({
    ...
    return n > 0 && (i = An(i, n)), e.jsx("span", {
      className: Li.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ce(`https://t.me/${Va(t)}`) : Ot(`https://t.me/${Va(t)}`)
      },
      children: i
    })
  },
  ...
  Nx = () => e.jsxs("div", {
    className: ai.unlock_button,
    children: [e.jsx("span", {
      children: "Unlock all colors for"
    }), e.jsxs("span", {
      className: ai.stars_text,
  ...
  ev = ({
    ...
    return u.useEffect(() => {
      ...
      children: ["+", t.isExtraReward ? Kr + s : 0, " ", e.jsx(W, {})]
    })
  },
  tv = () => {
  ...
  av = "_close_button_1v16g_14",
  iv = "_title_container_1v16g_22",
  ov = "_image_container_1v16g_28",
  rv = "_image_1v16g_28",
  cv = "_first_image_1v16g_45",
  lv = "_second_image_1v16g_50",
  dv = "_text_container_1v16g_55",
  ...
  bv = () => {
    ...
    return s && a.push(Me.enabled), n === null ? null : e.jsx("button", {
      className: a.join(" "),
      onPointerUp: () => {
        s ? t(vn()) : (y.viewport.viewport.animate({
          scale: 2,
          time: 400,
          position: {
            x: n.x + n.imageSize / 2,
  ...
  Iv = ({
    ...
    return e.jsx("div", {
      ...
      children: e.jsx(Zt.Range, {
        ...
        max: ci,
        onChange: a => {
          n(lh(a)), y.mainImage.worldTemplate.setOpacity(Number(a[0]))
        },
        renderTrack: ({
          props: a,
          children: i
  ...
  Sv = () => c(n => n.template.active) === null ? null : e.jsx("div", {
  ...
  Tv = () => {
    ...
    return a && i.push(Me.enabled), e.jsxs("button", {
      ...
      onPointerUp: () => {
        ...
        a ? t(vn()) : (y.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
  ...
  Ev = "_instruction_container_14ts7_1",
  Bv = "_img_container_14ts7_9",
  Dv = "_image_14ts7_15",
  kv = "_instruction_text_14ts7_21",
  Rv = "_preview_container_14ts7_26",
  Mv = "_preview_image_container_14ts7_32",
  Uv = "_preview_image_14ts7_32",
  Fv = "_preview_image_loader_14ts7_45",
  Ov = "_template_size_14ts7_60",
  Qv = "_template_title_14ts7_68",
  zv = "_template_size_container_14ts7_73",
  qv = "_template_size_item_14ts7_79",
  Lv = "_template_size_item_active_14ts7_87",
  Hv = "_template_coords_14ts7_92",
  Gv = "_template_coordinates_title_14ts7_102",
  Jv = "_template_coords_container_14ts7_107",
  Vv = "_coords_item_14ts7_114",
  Xv = "_coords_input_14ts7_120",
  Yv = "_file_button_container_14ts7_129",
  Wv = "_file_button_14ts7_129",
  Z = {
    instruction_container: Ev,
    img_container: Bv,
    image: Dv,
    instruction_text: kv,
    ...
    template_size: Ov,
    template_title: Qv,
    template_size_container: zv,
    template_size_item: qv,
    template_size_item_active: Lv,
    template_coords: Hv,
    template_coordinates_title: Gv,
    template_coords_container: Jv,
    coords_item: Vv,
    coords_input: Xv,
    file_button_container: Yv,
    file_button: Wv
  },
  ln = {
    16: 512,
  ...
  Zv = () => {
    ...
    return i && o.push(Me.enabled), n && n.friends >= ln[16] || n.isContractor ? e.jsxs("button", {
      ...
      onPointerUp: () => {
        ...
        i ? t(vn()) : (y.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: a.x + a.imageSize / 2,
  ...
  $v = "_button_5u70q_2",
  ey = "_image_5u70q_22",
  ty = "_enabled_5u70q_29",
  ny = "_gray_5u70q_33",
  sy = "_indicator_5u70q_37",
  ra = {
    button: $v,
    image: ey,
    enabled: ty,
  ...
  Go = "/assets/gold_pixel-CRD2C_ap.gif",
  ay = () => {
    const t = K(),
      n = [ra.button];
    return e.jsxs("button", {
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(ay, {}), e.jsx(bv, {}), e.jsx(Tv, {}), e.jsx(Zv, {}), e.jsx(Sv, {})]
        })
      })
    })
  }),
  oy = "_layout_1a5xo_1",
  ry = "_container_1a5xo_5",
  li = {
    layout: oy,
    container: ry
  },
  ...
  dy = () => c(n => n.canvas.coords) === null ? null : e.jsx("div", {
    className: li.layout,
    children: e.jsxs("div", {
      className: li.container + " " + S.container__bottom,
      children: [e.jsx(Gh, {}), e.jsx(qh, {}), e.jsx(gg, {}), e.jsx(Yp, {}), e.jsx(cy, {}), e.jsx(ly, {})]
    })
  }),
  uy = "_layout_11ck4_1",
  my = {
  ...
  Ay = () => e.jsxs("div", {
    className: my.layout,
    children: [e.jsx(dy, {}), e.jsx(kx, {})]
  }),
  py = () => e.jsxs(e.Fragment, {
    children: [e.jsx(Xx, {}), e.jsx(Fx, {}), e.jsx(iy, {}), e.jsx(Hx, {}), e.jsx(Ay, {}), e.jsx(tv, {}), e.jsx(gv, {}), e.jsx(Yx, {}), e.jsx(Gx, {})]
  }),
  hy = "_page_title_13ybj_1",
  gy = "_container_13ybj_9",
  _y = "_item_13ybj_13",
  fy = "_active_13ybj_18",
  xy = "_info_container_13ybj_34",
  vy = "_dot_13ybj_40",
  yy = "_title_text_13ybj_46",
  wy = "_capitalize_13ybj_50",
  jy = "_hint_text_13ybj_54",
  by = "_date_text_13ybj_61",
  Ny = "_value_container_13ybj_66",
  Py = "_value_text_13ybj_74",
  Cy = "_positive_color_13ybj_78",
  Iy = "_negative_color_13ybj_85",
  Sy = "_last_text_13ybj_92",
  x = {
    page_title: hy,
    container: gy,
    item: _y,
  ...
  Qy = ({
    item: t
  }) => t.action === "buy pixel" ? e.jsx(Ty, {
    item: t
  }) : t.action === "sell pixel" ? e.jsx(Ey, {
    item: t
  }) : t.action === "claim" ? e.jsx(By, {
    item: t
  }) : t.action === "get boost" ? e.jsx(Dy, {
    item: t
  }) : t.action === "league transfer" ? e.jsx(ky, {
    item: t
  }) : t.action === "referral" ? e.jsx(Ry, {
    item: t
  }) : t.action === "special" ? e.jsx(My, {
    item: t
  }) : t.action === "purchase" ? e.jsx(Uy, {
    item: t
  }) : t.action === "complete task" ? e.jsx(Fy, {
    item: t
  }) : t.action === "referrer reward" ? e.jsx(Oy, {
    item: t
  ...
  Ly = "_text_layout_1xggq_1",
  Hy = "_text_1xggq_1",
  Gy = "_button_layout_1xggq_14",
  Jy = "_button_layout_placeholder_1xggq_26",
  Vy = "_button_1xggq_14",
  Xt = {
    text_layout: Ly,
    text: Hy,
    button_layout: Gy,
    button_layout_placeholder: Jy,
    button: Vy
  },
  Xy = () => e.jsxs(oe, {
    children: [e.jsx("div", {
  ...
  Yy = "_text_layout_1h04i_1",
  Wy = "_text_1h04i_1",
  Ky = "_button_layout_1h04i_14",
  Zy = "_button_layout_placeholder_1h04i_26",
  $y = "_button_1h04i_14",
  Yt = {
    text_layout: Yy,
    text: Wy,
  ...
  tw = "_layout_1drph_1",
  nw = "_container_1drph_11",
  sw = "_bold_1drph_22",
  aw = "_info_container_1drph_26",
  iw = "_title_1drph_33",
  ow = "_description_1drph_38",
  rw = "_image_container_1drph_43",
  cw = "_image_1drph_43",
  lw = "_extra_info_container_1drph_53",
  dw = "_npx_tokens_1drph_77",
  uw = "_button_container_1drph_81",
  mw = "_button_1drph_81",
  ye = {
    layout: tw,
    container: nw,
  ...
  jw = "_text_q4wab_1",
  bw = "_button_layout_q4wab_15",
  Nw = "_button_layout_placeholder_q4wab_27",
  Pw = "_button_q4wab_15",
  di = {
    text_layout: ww,
    text: jw,
  ...
  Iw = "_close_container_1pvsg_1",
  Sw = "_title_container_1pvsg_12",
  Tw = "_title_1pvsg_12",
  Ew = "_frens_count_1pvsg_21",
  Bw = "_content_1pvsg_25",
  Dw = "_image_container_1pvsg_32",
  kw = "_image_1pvsg_32",
  Rw = "_description_container_1pvsg_41",
  Mw = "_white_1pvsg_50",
  Uw = "_gray_1pvsg_54",
  Fw = "_purple_1pvsg_58",
  Ow = "_bold_1pvsg_64",
  Qw = "_center_1pvsg_68",
  zw = "_info_layout_1pvsg_72",
  qw = "_benefits_container_1pvsg_84",
  Lw = "_benefits_item_1pvsg_92",
  Hw = "_divider_1pvsg_98",
  Gw = "_buttons_container_1pvsg_105",
  Jw = "_button_copy_1pvsg_112",
  Vw = "_button_1pvsg_105",
  k = {
    close_container: Iw,
    title_container: Sw,
    title: Tw,
    ...
    center: Qw,
    info_layout: zw,
    benefits_container: qw,
    benefits_item: Lw,
    divider: Hw,
    buttons_container: Gw,
    button_copy: Jw,
    button: Vw
  },
  Xw = "/assets/sitting_chars_shadow-DfXpFWWw.gif",
  Yw = "_link_a4r15_1",
  Ww = {
    link: Yw
  },
  ...
  $w = "_text_container_10f8u_9",
  ej = "_text_block_10f8u_16",
  tj = "_gray_10f8u_24",
  nj = "_total_10f8u_28",
  sj = "_bold_10f8u_33",
  aj = "_indicator_10f8u_37",
  ij = "_button_container_10f8u_46",
  oj = "_button_10f8u_46",
  Qe = {
    container: Zw,
    text_container: $w,
  ...
  rj = "_layout_1ulm2_1",
  cj = "_container_1ulm2_11",
  lj = "_stars_1ulm2_17",
  dj = "_animStar_1ulm2_1",
  Pn = {
    layout: rj,
    container: cj,
    stars: lj,
  ...
  hj = "_main_info_container_1gqs9_2",
  gj = "_image_container_1gqs9_11",
  _j = "_image_1gqs9_11",
  fj = "_title_1gqs9_21",
  xj = "_variants_container_1gqs9_25",
  vj = "_variant_item_1gqs9_33",
  yj = "_variant_left_container_1gqs9_39",
  wj = "_variant_middle_container_1gqs9_45",
  jj = "_dot_1gqs9_53",
  bj = "_variant_right_container_1gqs9_59",
  Nj = "_button_container_1gqs9_66",
  Pj = "_button_1gqs9_66",
  Cj = "_bold_1gqs9_96",
  Ij = "_gray_1gqs9_100",
  Sj = "_blue_1gqs9_104",
  Tj = "_text_1gqs9_109",
  q = {
    main_info_container: hj,
    image_container: gj,
    image: _j,
    title: fj,
    variants_container: xj,
    variant_item: vj,
    variant_left_container: yj,
    variant_middle_container: wj,
    dot: jj,
    variant_right_container: bj,
    button_container: Nj,
    button: Pj,
    bold: Cj,
    gray: Ij,
  ...
  Jo = "/assets/button_dog_200x200-DtCBiZdv.gif",
  Ej = t => {
    const n = t / 1e3,
      s = Math.floor(n / 60),
      a = n % 60;
  ...
  kj = "_close_container_dwly3_1",
  Rj = "_title_container_dwly3_12",
  Mj = "_title_dwly3_12",
  Uj = "_small_title_container_dwly3_23",
  Fj = "_small_title_dwly3_23",
  Oj = "_content_dwly3_32",
  Qj = "_image_container_dwly3_40",
  zj = "_image_placeholder_dwly3_46",
  qj = "_image_dwly3_40",
  Lj = "_description_container_dwly3_58",
  Hj = "_white_dwly3_67",
  Gj = "_gray_dwly3_71",
  Jj = "_bold_dwly3_75",
  Vj = "_center_dwly3_79",
  Xj = "_claim_button_container_dwly3_83",
  Yj = "_claim_button_dwly3_83",
  Wj = "_no_button_dwly3_102",
  Kj = "_info_layout_dwly3_114",
  Zj = "_rewards_layout_dwly3_126",
  $j = "_rewards_grid_container_dwly3_132",
  eb = "_reward_item_dwly3_138",
  tb = "_reward_item_completed_dwly3_148",
  nb = "_reward_item_content_container_dwly3_161",
  sb = "_reward_item_active_dwly3_174",
  ab = "_reward_item_image_container_dwly3_178",
  ib = "_reward_item_amount_dwly3_182",
  ob = "_reward_item_amount_active_dwly3_196",
  rb = "_reward_item_amount_premium_dwly3_200",
  cb = "_reward_item_title_dwly3_205",
  lb = "_reward_item_title_premium_dwly3_211",
  db = "_reward_item_image_dwly3_178",
  U = {
    close_container: kj,
    title_container: Rj,
    title: Mj,
    small_title_container: Uj,
    small_title: Fj,
    content: Oj,
    image_container: Qj,
    image_placeholder: zj,
    image: qj,
    description_container: Lj,
    white: Hj,
    gray: Gj,
    bold: Jj,
    center: Vj,
    claim_button_container: Xj,
    claim_button: Yj,
    no_button: Wj,
    info_layout: Kj,
    rewards_layout: Zj,
    rewards_grid_container: $j,
    reward_item: eb,
    reward_item_completed: tb,
    reward_item_content_container: nb,
    reward_item_active: sb,
    reward_item_image_container: ab,
    reward_item_amount: ib,
    reward_item_amount_active: ob,
    reward_item_amount_premium: rb,
    reward_item_title: cb,
    reward_item_title_premium: lb,
    reward_item_image: db
  },
  ub = ({
    secondsLeft: t
  }) => {
    ...
    if (r) {
      ...
      return t && (j = `Claim in ${fl(t)}`), h && (j = "Pending transaction..."), e.jsxs("div", {
        className: U.content,
        children: [e.jsx("div", {
  ...
  hb = "_img_container_fv8d9_7",
  gb = "_image_fv8d9_13",
  _b = "_title_fv8d9_19",
  fb = "_description_container_fv8d9_25",
  xb = "_description_fv8d9_25",
  Tt = {
  ...
  wb = "_no_template_container_uihlo_1",
  jb = "_no_template_button_uihlo_10",
  bb = "_template_container_uihlo_28",
  Nb = "_template_info_container_uihlo_35",
  Pb = "_template_info_uihlo_35",
  Cb = "_buttons_container_uihlo_44",
  Ib = "_button_copy_uihlo_53",
  Sb = "_button_uihlo_44",
  Tb = "_create_new_template_uihlo_72",
  He = {
    no_template_container: wb,
    no_template_button: jb,
    template_container: bb,
    template_info_container: Nb,
    template_info: Pb,
    buttons_container: Cb,
    button_copy: Ib,
    button: Sb,
    create_new_template: Tb
  },
  Eb = () => {
    const t = K(),
  ...
  Db = "_template_item_inner_srp11_9",
  kb = "_template_image_srp11_17",
  Rb = "_template_image_info_layout_srp11_24",
  Mb = "_template_image_info_container_srp11_34",
  Kt = {
    template_item_container: Bb,
    template_item_inner: Db,
    template_image: kb,
    template_image_info_layout: Rb,
    template_image_info_container: Mb
  },
  Vo = ({
    item: t,
    style: n = {}
  ...
  Ob = () => e.jsxs("div", {
    children: [e.jsx(Eb, {}), e.jsx(Fb, {})]
  }),
  Qb = "_layout_94gj5_1",
  zb = "_container_94gj5_5",
    ...
    return u.useEffect(() => (t(Je.getList({
      ...
      children: [e.jsx("div", {
        ...
        children: a.map(o => {
          ...
          let r = !1;
          return i !== null && Number(i.id) === Number(o.templateId) && (r = !0), e.jsx(Vo, {
            item: o,
            current: r
          }, o.templateId)
        })
  ...
  Jb = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === "my" && e.jsx(Ob, {}), t === "catalog" && e.jsx(Gb, {})]
    })
  },
  Vb = () => {
    const t = g(),
  ...
  Xb = () => e.jsxs(ie.Fragment, {
    children: [e.jsx(Vb, {}), e.jsx(Jb, {})]
  }),
  Rs = "/assets/paintings_anim2-nk1iBB8J.gif",
  Yb = "_container_1h1qc_1",
  Wb = "_divider_1h1qc_19",
  Kb = "_row_1h1qc_24",
  Zb = "_row_title_1h1qc_36",
  $b = "_row_title_main_1h1qc_40",
  e1 = "_row_hint_1h1qc_45",
  t1 = "_row_value_1h1qc_51",
  n1 = "_row_value_main_1h1qc_55",
  s1 = "_mining_percent_1h1qc_60",
  a1 = "_active_row_1h1qc_70",
  i1 = "_button_1h1qc_81",
  ui = {
    container: Yb,
    divider: Wb,
  ...
  r1 = "_layout_2uiqn_1",
  c1 = "_container_2uiqn_6",
  l1 = "_close_button_2uiqn_18",
  d1 = "_title_container_2uiqn_26",
  u1 = "_title_2uiqn_26",
  m1 = "_image_container_2uiqn_37",
  A1 = "_image_2uiqn_37",
  p1 = "_image_placeholder_2uiqn_51",
  h1 = "_info_container_2uiqn_58",
  g1 = "_info_row_2uiqn_64",
  _1 = "_info_title_2uiqn_69",
  f1 = "_info_value_blue_2uiqn_73",
  x1 = "_info_value_white_2uiqn_78",
  v1 = "_buttons_container_2uiqn_82",
  y1 = "_button_2uiqn_82",
  w1 = "_not_button_2uiqn_98",
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Je.subscribe({
              ...
              t(dh(h)), y.mainImage.worldTemplate.deleteTemplate(o.id), y.mainImage.worldTemplate.add(h), t(vn())
            } else await t(J({
              id: performance.now(),
  ...
  S1 = "_id_s1r1v_17",
  T1 = "_title_s1r1v_22",
  E1 = "_avatar_container_s1r1v_28",
  B1 = "_avatar_s1r1v_28",
  D1 = "_squad_avatar_container_s1r1v_40",
  k1 = "_text_container_s1r1v_52",
  R1 = "_dot_s1r1v_58",
  M1 = "_user_name_s1r1v_63",
  U1 = "_squad_name_s1r1v_69",
  F1 = "_divider_s1r1v_75",
  O1 = "_tabs_content_s1r1v_81",
  Q1 = "_content_info_s1r1v_85",
  z1 = "_content_info_item_s1r1v_92",
  q1 = "_content_info_item_title_s1r1v_96",
  L1 = "_content_info_item_value_s1r1v_100",
  H1 = "_no_content_s1r1v_106",
  G1 = "_achievements_container_s1r1v_115",
  O = {
    container: C1,
    page: I1,
    id: S1,
  ...
  e0 = "_container_os5nt_1",
  t0 = "_not_completed_os5nt_6",
  n0 = "_image_container_os5nt_10",
  s0 = "_image_os5nt_10",
  a0 = "_bold_os5nt_20",
  i0 = "_gray_os5nt_24",
  ...
  r0 = ({
    ...
    className: G(_t.container, t ? "" : _t.not_completed),
    children: [e.jsx("div", {
  ...
  v0 = ({
    ...
    children: [t === "info" && e.jsx($1, {
      isPopupContent: n
    }), t === "achievements" && e.jsx(f0, {
      isPopupContent: n
    }), t === "inventory" && e.jsx(x0, {})]
  }),
  y0 = ({
    isPopupContent: t = !0
  }) => {
  ...
  ba = ({
    ...
    return e.jsxs("div", {
      className: G(O.container, !t && O.page),
  ...
  S0 = "_id_12mk9_17",
  T0 = "_title_12mk9_22",
  E0 = "_avatar_container_12mk9_28",
  B0 = "_avatar_12mk9_28",
  D0 = "_text_container_12mk9_39",
  k0 = "_dot_12mk9_45",
  R0 = "_user_name_12mk9_50",
  M0 = "_squad_slug_12mk9_56",
  U0 = "_your_squad_button_12mk9_62",
  F0 = "_join_squad_button_12mk9_75",
  O0 = "_red_12mk9_91",
  Q0 = "_divider_12mk9_95",
  z0 = "_tabs_content_12mk9_101",
  q0 = "_content_info_12mk9_105",
  L0 = "_content_info_item_12mk9_112",
  H0 = "_content_info_item_title_12mk9_116",
  G0 = "_content_info_item_value_12mk9_120",
  J0 = "_content_top_12mk9_127",
  V0 = "_content_top_item_12mk9_140",
  X0 = "_content_top_item_image_12mk9_150",
  Y0 = "_content_top_name_12mk9_156",
  W0 = "_content_top_arrow_12mk9_162",
  K0 = "_gray_12mk9_166",
  I = {
    container: C0,
    page: I0,
    ...
    user_name: R0,
    squad_slug: M0,
    your_squad_button: U0,
    join_squad_button: F0,
    red: O0,
    divider: Q0,
    tabs_content: z0,
    content_info: q0,
    ...
    content_top: J0,
    content_top_item: V0,
    content_top_item_image: X0,
    content_top_name: Y0,
    content_top_arrow: W0,
    gray: K0
  },
  Wo = ({
    data: t,
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await De.uploadTemplate({
              ...
              i(So(D)), i(vn()), await y.mainImage.worldTemplate.add(D), i(J({
                id: performance.now(),
    ...
    return u.useEffect(() => {}, []), u.useEffect(() => {
      if (t !== null) {
        ...
        const M = async () => {
          ...
          rN(Ye), _.putImageData(Ye, 0, 0), a(Ye), o(D.toDataURL())
        };
        setTimeout(() => {
          M().then(() => {
            f(!1)
      ...
      children: [i === null && e.jsx(dN, {}), i !== null && e.jsx(oN, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(Kv, {
  ...
  mN = "_general_info_container_1u2nd_1",
  AN = "_img_container_1u2nd_7",
  pN = "_image_1u2nd_17",
  hN = "_image_cup_1u2nd_23",
  gN = "_image_glow_container_1u2nd_29",
  _N = "_image_glow_1u2nd_29",
  fN = "_rotate_1u2nd_1",
  xN = "_image_glow_reverse_1u2nd_48",
  vN = "_title_1u2nd_53",
  yN = "_description_container_1u2nd_60",
  wN = "_description_1u2nd_60",
  jN = "_gold_1u2nd_73",
  Re = {
    ...
    image_glow: _N,
    rotate: fN,
    image_glow_reverse: xN,
    title: vN,
    description_container: yN,
    description: wN,
    gold: jN
  },
  bN = "_info_layout_1p9dg_1",
  NN = {
    info_layout: bN
  },
  PN = t => {
  ...
  CN = "_instruction_container_17lvx_1",
  IN = "_img_container_17lvx_9",
  SN = "_img_inner_container_17lvx_16",
  TN = "_image_17lvx_22",
  EN = "_image_status_17lvx_30",
  BN = "_image_status_rejected_17lvx_45",
  DN = "_image_status_review_17lvx_49",
  kN = "_image_status_approved_17lvx_53",
  RN = "_copy_button_container_17lvx_57",
  MN = "_button_copy_17lvx_65",
  UN = "_gray_17lvx_71",
  FN = "_preview_container_17lvx_75",
  ON = "_preview_image_container_17lvx_81",
  QN = "_preview_image_17lvx_81",
  zN = "_preview_image_loader_17lvx_94",
  qN = "_template_size_17lvx_109",
  LN = "_template_title_17lvx_117",
  HN = "_template_size_container_17lvx_122",
  GN = "_template_size_item_17lvx_128",
  JN = "_template_size_item_active_17lvx_136",
  VN = "_template_coords_17lvx_141",
  XN = "_template_coordinates_title_17lvx_151",
  YN = "_template_coords_container_17lvx_156",
  WN = "_coords_item_17lvx_163",
  KN = "_coords_input_17lvx_169",
  ZN = "_file_button_container_17lvx_178",
  $N = "_file_button_17lvx_178",
  ae = {
    instruction_container: CN,
    img_container: IN,
    img_inner_container: SN,
    image: TN,
    image_status: EN,
    image_status_rejected: BN,
    image_status_review: DN,
    image_status_approved: kN,
    copy_button_container: RN,
    button_copy: MN,
    gray: UN,
    preview_container: FN,
    preview_image_container: ON,
    preview_image: QN,
    preview_image_loader: zN,
    template_size: qN,
    template_title: LN,
      ...
      children: [n && e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("img", {
            ...
            className: G(ae.image_status, ae.image_status_review),
            children: "On review"
          }), s === Et.rejected && e.jsx("div", {
            className: G(ae.image_status, ae.image_status_rejected),
            children: "Rejected"
          }), s === Et.approved && e.jsx("div", {
            className: G(ae.image_status, ae.image_status_approved),
            children: "Approved"
          })]
        })
      }), e.jsx("div", {
    ...
    return u.useEffect(() => {
      if (t !== null) {
        ...
        const M = async () => {
          ...
          D.width = r, D.height = r, _.drawImage(t, ge, Oe, T, w);
          const Ye = _.getImageData(0, 0, r, r);
          PN(Ye), _.putImageData(Ye, 0, 0), a(Ye), o(D.toDataURL())
        };
        setTimeout(() => {
          M().then(() => {
            f(!1)
      ...
      children: [i === null && e.jsx(eP, {}), i !== null && e.jsx(tP, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(nP, {
  ...
  dP = "_template_item_container_qlah9_1",
  uP = "_template_item_inner_qlah9_12",
  mP = "_template_item_picked_qlah9_28",
  AP = "_template_item_shadow_qlah9_43",
  pP = "_template_rank_qlah9_55",
  hP = "_template_recolors_qlah9_75",
  gP = "_template_recolors_pixel_qlah9_91",
  _P = "_template_image_qlah9_97",
  ot = {
    template_item_container: dP,
    template_item_inner: uP,
    template_item_picked: mP,
    template_item_shadow: AP,
    template_rank: pP,
    template_recolors: hP,
    template_recolors_pixel: gP,
    template_image: _P
  },
  fP = ({
    item: t,
  ...
  xP = "_round_info_container_1d52c_1",
  vP = "_title_1d52c_7",
  yP = "_description_1d52c_12",
  wP = "_round_status_container_1d52c_17",
  Cn = {
    round_info_container: xP,
    title: vP,
    description: yP,
    round_status_container: wP
  },
  jP = "_round_indicator_mgwmo_1",
  bP = "_round_indicator_wait_mgwmo_37",
  tr = {
    round_indicator: jP,
    round_indicator_wait: bP
  },
  NP = () => e.jsx("div", {
  ...
  IP = () => (c(t => t.tournament.approvedTemplatesListTotal), e.jsxs("div", {
    children: [e.jsxs("div", {
  ...
  EP = "_round_container_14n1b_18",
  BP = "_round_title_14n1b_26",
  DP = "_round_title_text_14n1b_31",
  kP = "_round_indicator_14n1b_36",
  RP = "_round_status_success_14n1b_42",
  MP = "_round_status_fail_14n1b_53",
  UP = "_success_14n1b_64",
  FP = "_fail_14n1b_68",
  OP = "_gray_14n1b_72",
  QP = "_round_main_info_14n1b_76",
  zP = "_round_image_container_14n1b_82",
  qP = "_round_image_14n1b_82",
  LP = "_round_lines_container_14n1b_93",
  HP = "_round_line_14n1b_93",
  GP = "_divider_14n1b_104",
  JP = "_pixels_number_14n1b_111",
  VP = "_pixel_14n1b_111",
  ...
  KP = () => !ut.devServer && !ut.isDev ? e.jsxs("div", {
    className: L.soon,
    children: ["Something will happen here,", e.jsx("br", {}), " but not now."]
  }) : e.jsxs("div", {
    children: [e.jsx("div", {
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          className: G(L.round_status_success, L.success),
          children: "Wining"
        }), e.jsx("div", {
          className: G(L.round_status_fail, L.fail),
          children: "😔 Lost"
        })]
      }), e.jsxs("div", {
  ...
  hC = "_layout_2uiqn_1",
  gC = "_container_2uiqn_6",
  _C = "_close_button_2uiqn_18",
  fC = "_title_container_2uiqn_26",
  xC = "_title_2uiqn_26",
  vC = "_image_container_2uiqn_37",
  yC = "_image_2uiqn_37",
  wC = "_image_placeholder_2uiqn_51",
  jC = "_info_container_2uiqn_58",
  bC = "_info_row_2uiqn_64",
  NC = "_info_title_2uiqn_69",
  PC = "_info_value_blue_2uiqn_73",
  CC = "_info_value_white_2uiqn_78",
  IC = "_buttons_container_2uiqn_82",
  SC = "_button_2uiqn_82",
  TC = "_not_button_2uiqn_98",
  EC = "_button_copy_2uiqn_109",
  V = {
    layout: hC,
    container: gC,
    close_button: _C,
    ...
    image_container: vC,
    image: yC,
    image_placeholder: wC,
    info_container: jC,
    info_row: bC,
    info_title: NC,
    info_value_blue: PC,
    info_value_white: CC,
    buttons_container: IC,
    button: SC,
    not_button: TC,
    button_copy: EC
  },
      ...
      onPointerUp: async () => {
        try {
          ...
          (await a(Bs.selectTemplate({
            id: t.id
          }))).meta.requestStatus === A.fulfilled && a(Nh(t))
        } catch (r) {
  ...
  kC = "_layout_20dlh_1",
  RC = "_container_20dlh_10",
  MC = "_star_20dlh_14",
  UC = "_star_animation_20dlh_21",
  FC = "_move_20dlh_1",
  xs = {
    layout: kC,
    container: RC,
  ...
  OC = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  QC = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  LC = "_container_2w971_1",
  HC = "_image_container_2w971_9",
  GC = "_image_2w971_9",
  JC = "_title_container_2w971_18",
  VC = "_text_container_2w971_27",
  XC = "_title_2w971_18",
  YC = "_gray_2w971_39",
  WC = "_bold_2w971_43",
  KC = "_input_2w971_47",
  ZC = "_catalog_container_2w971_71",
  $C = "_catalog_title_2w971_76",
  e2 = "_catalog_items_container_2w971_81",
  t2 = "_catalog_item_2w971_81",
  n2 = "_catalog_item_image_container_2w971_100",
  s2 = "_catalog_item_image_2w971_100",
  a2 = "_button_container_2w971_109",
  i2 = "_button_2w971_109",
  o2 = "_wrong_helper_text_2w971_124",
  r2 = "_wrong_button_2w971_129",
  c2 = "_wrong_button_text2_2w971_142",
  R = {
    container: LC,
    image_container: HC,
    image: GC,
    ...
    bold: WC,
    input: KC,
    catalog_container: ZC,
    catalog_title: $C,
    catalog_items_container: e2,
    catalog_item: t2,
    catalog_item_image_container: n2,
    catalog_item_image: s2,
    button_container: a2,
    button: i2,
    wrong_helper_text: o2,
    wrong_button: r2,
    wrong_button_text2: c2
  },
  l2 = "/assets/box_1-CzUKXu07.gif",
  d2 = "/assets/box_2-wR9cQS7q.gif",
  u2 = "/assets/box_3-g_PL1kKM.gif",
  m2 = "/assets/dogs-D0jtZggB.gif",
  A2 = "/assets/secret_word-BTKB1fAO.gif",
  In = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
    ...
    return u.useEffect(() => {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            className: G(R.catalog_title, R.bold),
          ...
          children: [!o && e.jsx("button", {
            ...
            className: G(R.gray, R.wrong_helper_text),
  ...
  C2 = "_number_rjvnl_36",
  I2 = "_button_rjvnl_1",
  S2 = "_ratings_button_rjvnl_55",
  T2 = "_stars_button_rjvnl_62",
  E2 = "_shop_button_rjvnl_70",
  B2 = "_burger_button_rjvnl_79",
  D2 = "_relative_button_rjvnl_89",
  k2 = "_telegram_button_rjvnl_116",
  R2 = "_button_img_rjvnl_124",
  M2 = "_avatar_img_rjvnl_129",
  U2 = "_open_menu_button_rjvnl_134",
  F2 = "_open_menu_button_image_rjvnl_144",
  O2 = "_my_pixels_amount_rjvnl_149",
  ...
  ve = {
    ...
    avatar_img: M2,
    open_menu_button: U2,
    open_menu_button_image: F2,
    my_pixels_amount: O2,
    header_content: Q2
  },
  z2 = () => c(Be) ? null : e.jsxs("button", {
  ...
  mi = ie.memo(() => e.jsxs("div", {
    ...
    children: [e.jsxs("div", {
      ...
      children: [e.jsx(J2, {}), e.jsx(G2, {})]
    }), e.jsx("div", {
      className: `${ve.group} ${ve.middle}`,
      children: e.jsx(q2, {})
    }), e.jsxs("div", {
      className: `${ve.group} ${ve.right}`,
      children: [e.jsx(V2, {}), e.jsx(z2, {}), e.jsx(H2, {})]
    })]
  })),
  Ai = {
    bronze: Ne.bronze,
...
const Y2 = () => {
  ...
  $2 = "_container_11ui8_1",
  eI = "_header_11ui8_13",
  tI = "_close_container_11ui8_23",
  nI = "_close_11ui8_23",
  sI = "_title_11ui8_48",
  aI = "_frens_count_11ui8_53",
  iI = "_body_11ui8_58",
  oI = "_content_11ui8_68",
  rI = "_image_container_11ui8_75",
  cI = "_image_11ui8_75",
  lI = "_image_container_charges_11ui8_84",
  dI = "_image_charges_11ui8_89",
  uI = "_description_container_11ui8_94",
  mI = "_bold_11ui8_102",
  AI = "_gray_11ui8_107",
  pI = "_center_11ui8_111",
  hI = "_benefits_container_11ui8_115",
  gI = "_benefits_item_11ui8_123",
  _I = "_benefits_icon_container_11ui8_128",
  fI = "_icon_invite_11ui8_132",
  xI = "_footer_11ui8_136",
  vI = "_button_11ui8_141",
  B = {
    container: $2,
    header: eI,
    close_container: tI,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Pt, {
            ...
            className: B.button,
            onPointerUp: l => {
              l.stopPropagation(), ce(`https://t.me/share/url?url=${i}`), t($s())
            },
            children: "Share"
          })]
        })]
  ...
  PI = "_title_13215_31",
  CI = "_body_13215_36",
  II = "_image_container_13215_49",
  SI = "_image_13215_49",
  TI = "_content_container_13215_60",
  EI = "_description_container_13215_68",
  BI = "_description_item_13215_75",
  DI = "_amount_selector_container_13215_82",
  kI = "_amount_selector_button_13215_88",
  RI = "_amount_selector_count_13215_101",
  MI = "_button_container_13215_112",
  UI = "_crypto_button_container_13215_118",
  FI = "_error_13215_132",
  OI = "_button_13215_112",
  QI = "_star_color_13215_153",
  zI = "_tokens_selector_13215_159",
  qI = "_tokens_title_13215_164",
  LI = "_connect_wallet_text_title_13215_171",
  HI = "_tokens_container_13215_180",
  GI = "_token_item_13215_187",
  JI = "_token_image_container_13215_198",
  VI = "_token_image_13215_198",
  XI = "_sale_box_13215_208",
  YI = "_sale_text_13215_220",
  X = {
    container: jI,
    header: bI,
    close: NI,
    ...
    description_item: BI,
    amount_selector_container: DI,
    amount_selector_button: kI,
    amount_selector_count: RI,
    button_container: MI,
    crypto_button_container: UI,
    error: FI,
    button: OI,
    star_color: QI,
    tokens_selector: zI,
    tokens_title: qI,
    connect_wallet_text_title: LI,
    tokens_container: HI,
    token_item: GI,
    token_image_container: JI,
    token_image: VI,
    sale_box: XI,
    sale_text: YI
  },
  ...
  $I = () => {
    const t = g(),
      n = c(i => i.shop.crypto),
      s = c(i => i.shop.selectedCurrency);
    return c(Ve) !== he ? null : e.jsxs("div", {
  ...
  tS = ({
    ...
    return t ? e.jsx(ie.Fragment, {
      ...
      children: ["Buy for", e.jsx(eS, {}), Math.round(o * (r ? s : 1) * 100) / 100, e.jsx("div", {
  ...
  nS = ({
    ...
    const j = async w => {
      ...
      const ge = new Os.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        Ye = await new Os.token.jetton.JettonMinter(ge, {
          address: $r[i]
        }).getJettonWalletAddress(new Os.utils.Address(D)),
        lr = qe.Address.parse(D),
        dr = qe.Address.parse(ua),
        ur = qe.beginCell().storeUint(0, 32).storeStringTail(w.txMemCode).endCell(),
        mr = qe.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(qe.toNano(w.strAmount)).storeAddress(dr).storeAddress(lr).storeBit(0).storeCoins(qe.toNano("0.01")).storeBit(1).storeRef(ur).endCell(),
        Ar = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
      ...
      await f.sendTransaction(Ar), n(!0), h(!0), d(A.fulfilled)
    };
    return e.jsx("button", {
      className: X.button,
      onPointerUp: async w => {
  ...
  sS = () => {
    const [t, n] = ys(), s = vs(), a = c(i => i.shop.selectedCurrency);
  ...
  rS = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx($I, {}), e.jsx(oS, {}), e.jsx($i, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: X.error,
  ...
  lS = () => e.jsxs("div", {
    ...
    children: [e.jsx(KI, {}), e.jsxs("div", {
      className: X.content_container,
      children: [e.jsx(ZI, {}), e.jsx(cS, {})]
    }), e.jsx(rS, {})]
  }),
  dS = () => {
    const t = g(),
    ...
    return tt.createPortal(e.jsx(ke, {
      ...
      children: e.jsxs("div", {
        className: X.container,
        children: [e.jsx(WI, {}), e.jsx(lS, {})]
      })
    }), document.body)
  },
  uS = "_layout_j8oqn_1",
  mS = "_container_j8oqn_13",
  AS = "_header_j8oqn_19",
  pS = "_title_j8oqn_29",
  hS = "_body_j8oqn_34",
  gS = "_image_container_j8oqn_46",
  _S = "_image_j8oqn_46",
  fS = "_description_container_j8oqn_57",
  xS = "_text_j8oqn_66",
  vS = "_button_container_j8oqn_70",
  yS = "_button_j8oqn_70",
  ze = {
    layout: uS,
    container: mS,
...
async function IS() {
  v.enable(v.BLEND), v.blendFunc(v.SRC_ALPHA, v.ONE_MINUS_SRC_ALPHA), v.clearColor(0, 0, 0, 0), v.viewport(0, 0, v.canvas.width, v.canvas.height), we = await SS(v), v.useProgram(we)
}
async function SS(t, n, s) {
  const a = jS,
    i = bS,
...
function kS() {
  ...
  cs = r * r, Ke(v, we, "u_AnimationDuration", ir), Ke(v, we, "u_ParticleSize", NS), Ke(v, we, "u_ViewportWidth", t), Ke(v, we, "u_ViewportHeight", n), Ke(v, we, "u_TextureWidth", s), Ke(v, we, "u_TextureHeight", a), Ke(v, we, "u_TextureLeft", i), Ke(v, we, "u_TextureTop", o);
...
function RS(t) {
  v.clear(v.COLOR_BUFFER_BIT), Sn == -1 && (Sn = t);
  const s = t - Sn;
  if (s > ir) {
    Sn = -1, document.getElementById("canvasSnap").remove();
    return
  }
  Ke(v, we, "u_ElapsedTime", s), v.drawArrays(v.POINTS, 0, cs), or()
}
...
const MS = () => {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            onPointerUp: () => {
              var a, i;
              y.viewport.viewport.fit(), y.viewport.viewport.moveCenter(y.viewport.viewport.worldWidth / 2, y.viewport.viewport.worldHeight / 2), PS(), t.push("/"), n(tp()), (i = (a = window.Telegram.WebApp) == null ? void 0 : a.HapticFeedback) == null || i.notificationOccurred("error")
            },
            children: "Whoosh!"
          })]
        })]
  ...
  HS = "_layout_1nuac_1",
  GS = "_container_1nuac_19",
  JS = "_image_container_1nuac_30",
  VS = "_image_1nuac_30",
  XS = "_text_container_1nuac_42",
  YS = "_title_1nuac_49",
  WS = "_button_container_1nuac_55",
  KS = "_button_1nuac_55",
  rt = {
    layout: HS,
    container: GS,
  ...
  $S = ({
    ...
    const n = t ? "Squad" : "My Squad",
      s = gt(t);
    return e.jsxs("div", {
      className: G(I.container, !t && I.page),
      children: [t && e.jsx(Yo, {}), e.jsx("div", {
        children: e.jsx("span", {
          className: I.title,
          children: n
    ...
    return e.jsx(ke, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === Ue.userFromPixelInfo && e.jsx(ba, {
          ...
          isPopupContent: s
        }), n.dataSource === Ue.squadFromData && e.jsx($S, {})]
      })
    })
  },
  tT = "_overlay_1vl8z_1",
  nT = "_top_container_1vl8z_10",
  sT = "_bottom_container_1vl8z_15",
  aT = "_side_menu_1vl8z_20",
  iT = "_menu_safe_area_inset_1vl8z_36",
  oT = "_menu_header_1vl8z_40",
  rT = "_close_button_1vl8z_53",
  cT = "_menu_list_1vl8z_58",
  lT = "_icon_1vl8z_79",
  dT = "_icon_not_pixel_1vl8z_87",
  uT = "_gold_pixel_1vl8z_97",
  mT = "_menu_list_li_1vl8z_103",
  AT = "_menu_list_text_1vl8z_109",
  pT = "_menu_list_new_item_1vl8z_113",
  hT = "_button_wrapper_1vl8z_136",
  gT = "_button_content_1vl8z_145",
  _T = "_footer_1vl8z_152",
  fT = "_avatar_1vl8z_158",
  xT = "_ratings_image_container_1vl8z_165",
  vT = "_ratings_image_1vl8z_165",
  H = {
    overlay: tT,
    top_container: nT,
    bottom_container: sT,
    side_menu: aT,
    menu_safe_area_inset: iT,
    menu_header: oT,
    close_button: rT,
    menu_list: cT,
    icon: lT,
    ...
    menu_list_li: mT,
    menu_list_text: AT,
    menu_list_new_item: pT,
    button_wrapper: hT,
    button_content: gT,
    footer: _T,
    avatar: fT,
    ratings_image_container: xT,
    ratings_image: vT
  },
  _i = [.215, .61, .355, 1],
  yT = {
  ...
  TT = "_layout_eiymv_1",
  ET = "_container_eiymv_7",
  vi = {
    layout: TT,
    container: ET
  },
  BT = () => localStorage.getItem("canvasFps") ? [Number(localStorage.getItem("canvasFps"))] : [60],
  DT = () => {
    const [t, n] = ie.useState(BT());
    return u.useEffect(() => {
  ...
  RT = "_container_n1egb_1",
  MT = "_header_n1egb_11",
  UT = "_title_n1egb_24",
  FT = "_close_container_n1egb_30",
  OT = "_close_n1egb_30",
  QT = "_body_n1egb_54",
  zT = "_content_n1egb_65",
  qT = "_time_left_container_n1egb_71",
  LT = "_timer_n1egb_75",
  HT = "_image_container_n1egb_79",
  GT = "_image_n1egb_79",
  JT = "_description_container_n1egb_89",
  VT = "_bold_n1egb_98",
  XT = "_gray_n1egb_103",
  YT = "_center_n1egb_107",
  WT = "_footer_n1egb_111",
  KT = "_button_n1egb_117",
  ZT = "_image_container_charges_n1egb_149",
  $T = "_image_charges_n1egb_153",
  xe = {
    container: RT,
    header: MT,
    title: UT,
...
const tE = "_layout_1at34_1",
  ...
  cE = u.memo(({
    ...
    const [s, a] = u.useState(rE()), [i, o] = u.useState(!1);
    return u.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  dE = "_container_gb8eq_1",
  uE = "_header_gb8eq_11",
  mE = "_title_gb8eq_17",
  AE = "_close_container_gb8eq_23",
  pE = "_close_gb8eq_23",
  hE = "_body_gb8eq_47",
  gE = "_content_gb8eq_59",
  _E = "_time_left_container_gb8eq_65",
  fE = "_timer_gb8eq_69",
  xE = "_image_container_gb8eq_73",
  vE = "_image_gb8eq_73",
  yE = "_glow_container_gb8eq_91",
  wE = "_glow_gb8eq_91",
  jE = "_rotate_gb8eq_1",
  bE = "_glow_reverse_gb8eq_107",
  NE = "_description_container_gb8eq_113",
  PE = "_bold_gb8eq_123",
  CE = "_gray_gb8eq_128",
  IE = "_center_gb8eq_132",
  SE = "_gold_gb8eq_136",
  TE = "_button_gb8eq_144",
  _e = {
    container: dE,
    header: uE,
    title: mE,
  ...
  EE = "/assets/cup_glad-DGT2PBmm.png",
  BE = () => {
    const t = K(),
      n = c(Xe),
      [s, a] = u.useState(!1),
      i = "showCreateTournamentTemplatePopup";
    return u.useEffect(() => (zi() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(ke, {
      show: s,
      children: e.jsx("div", {
  ...
  DE = "_layout_xga4i_1",
  kE = "_container_xga4i_14",
  RE = "_header_xga4i_20",
  ME = "_close_xga4i_25",
  UE = "_body_xga4i_38",
  FE = "_image_container_xga4i_42",
  OE = "_image_xga4i_42",
  QE = "_glow_xga4i_55",
  zE = "_forward_xga4i_62",
  qE = "_rotate_xga4i_1",
  LE = "_reverse_xga4i_66",
  HE = "_text_container_xga4i_70",
  GE = "_title_xga4i_78",
  JE = "_description_xga4i_82",
  VE = "_footer_xga4i_86",
  XE = "_button_xga4i_90",
  fe = {
    layout: DE,
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx($E, {}), e.jsx("img", {
                alt: "glow",
                src: ya,
                className: G(fe.glow, fe.forward)
              }), e.jsx("img", {
                alt: "glow",
                src: ya,
                className: G(fe.glow, fe.reverse)
              }), e.jsx("img", {
                alt: "img",
                src: n ? n.image_url : "",
                className: fe.image
...
const tB = "_layout_1tvc9_1",
  nB = "_container_1tvc9_5",
  sB = "_close_button_1tvc9_14",
  aB = "_title_container_1tvc9_22",
  iB = "_image_container_1tvc9_28",
  oB = "_image_1tvc9_28",
  rB = "_text_container_1tvc9_47",
  cB = "_button_container_1tvc9_52",
  We = {
    layout: tB,
    container: nB,
    close_button: sB,
  ...
  dB = () => e.jsxs("div", {
    className: $t.layout,
    children: [e.jsx(Z2, {}), e.jsx(X2, {}), e.jsx(Cg, {}), e.jsx(g2, {}), e.jsx(Y2, {}), e.jsx(FS, {}), e.jsx(ZS, {}), e.jsx(eT, {}), e.jsx(wI, {}), e.jsx(US, {}), e.jsx(lE, {}), e.jsx(BE, {}), e.jsx(eB, {}), e.jsx(lB, {}), e.jsx(dS, {}), e.jsx(MS, {}), e.jsx(LS, {}), e.jsx(kT, {})]
  }),
  uB = () => {
    const t = g(),
  ...
  pB = "_layout_ieygs_1",
  hB = "_container_ieygs_8",
  gB = "_logo_container_ieygs_17",
  _B = "_logo_ieygs_17",
  fB = "_animate_ieygs_1",
  xB = "_center_ieygs_37",
  vB = "_title_ieygs_51",
  yB = "_description_ieygs_58",
  wB = "_button_container_ieygs_63",
  jB = "_button_ieygs_63",
  bB = "_b_ieygs_63",
  ft = {
    layout: pB,
  ...
  PB = "/assets/loading-D8SQALTR.gif",
  CB = () => e.jsxs("div", {
  ...
  IB = () => {
    ...
    u.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(GA(s)), t(Da(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(Td(s))
      })
    }, [t])
  ...
  SB = () => {
    const t = g(),
      ...
      s = async () => {
        try {
          const f = (await t(yt.getUser())).payload.data;
        ...
        try {
          ...
          if (f.payload && f.payload.id !== 0) {
            ...
            t(So(M)), await y.mainImage.worldTemplate.add(M)
          }
        } catch (f) {
          console.error("Ошибка получения подключенного трафарета:", f)
        }
      }, r = async h => {
        if (!Bo(h)) return Promise.resolve();
        try {
          t(Bs.getMyTemplate({
            id: h.id
          }))
  ...
  TB = () => {
    const t = K();
    u.useEffect(() => {
      zi() ? localStorage.getItem("skipIntro") || (t.push("/welcome"), localStorage.setItem("skipIntro", "true")) : zt.get("skipIntro", (n, s) => {
  ...
  RB = () => {
    ...
    return u.useEffect(() => {
      function a() {
        console.log("is fullscreen: ", this.isFullscreen), t(Jc(this.isFullscreen))
      }
  ...
  MB = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Zr) && AB(), IB(), SB(), TB(), a || o ? e.jsx(NB, {}) : i ? e.jsx(CB, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
tc(yn);
XA(yn);
const qB = gr.createRoot(document.getElementById("root"));
qB.render(e.jsx(ie.StrictMode, {
  children: e.jsx(vr, {
    store: yn,
    children: e.jsx(Cr, {
      children: e.jsx(yr, {
