...
var zr = (t, n, s) => n in t ? Qr(t, n, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: s
}) : t[n] = s;
var Rn = (t, n, s) => zr(t, typeof n != "symbol" ? n + "" : n, s);
import {
  j as e,
  r as m,
  R as te
...
const sc = "_stars_img_container_1wci0_1",
  ac = "_stars_img_1wci0_1",
  ic = "_scalebubble_1wci0_1",
  oc = "_squads_img_1wci0_17",
  rc = "_title_container_1wci0_22",
  cc = "_description_container_1wci0_28",
  lc = "_description_1wci0_28",
  dc = "_info_layout_1wci0_42",
  uc = "_info_container_1wci0_52",
  mc = "_info_row_1wci0_59",
  Ac = "_info_row_content_1wci0_65",
  pc = "_info_row_sale_1wci0_84",
  hc = "_not_active_1wci0_100",
  gc = "_selected_1wci0_105",
  _c = "_row_icon_container_1wci0_110",
...
const Oc = {
  ...
  }),
  {
    ...
    addAvailable: Yt,
    subAvailable: Fs,
    setSelectedCurrency: yn,
    setLimitedGoods: j4,
    clearLimitedGoods: b4,
    showLimitedGoodsPopup: Qc,
    hideLimitedGoodsPopup: N4
  } = Yi.actions,
  Wi = t => t.shop.crypto,
  zc = Yi.reducer,
  Qs = {
  ...
  rl = (t, n) => n < 5 ? Ft[1] : n < 10 ? Ft[5] : n < 100 ? Ft[10] : n < 500 ? Ft[100] : n < 1e3 ? Ft[500] : Ft[1e3],
  Qt = {
    1: Lc,
    5: Hc,
    10: Gc,
  ...
  cl = (t, n) => n < 5 ? Qt[1] : n < 10 ? Qt[5] : n < 100 ? Qt[10] : n < 500 ? Qt[100] : n < 1e3 ? Qt[500] : Qt[1e3],
  ll = () => Us,
  dl = () => Ki,
  ul = () => Zi,
  zt = {
  ...
  ml = (t, n) => n < 5 ? zt[1] : n < 10 ? zt[5] : n < 100 ? zt[10] : n < 500 ? zt[100] : n < 1e3 ? zt[500] : zt[1e3],
  si = {
    9: Vi,
    10: Ji,
    11: Xi
  ...
  no = (t, n) => ea[t] ? ea[t](t, n) : ea.default(),
  pl = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  yl = () => !1,
  so = () => window.location.hostname.includes("dev"),
  vl = () => so() ? Gn.VITE_ADSGRAM_BLOCK_ID : xl() ? "4853" : "4995",
  ft = {
    isDev: yl(),
    devServer: so(),
    devUserInitData: Gn.VITE_INIT_DATA || null,
    apiBaseUrl: Gn.VITE_API_URL,
    app: {
      disableBetaError: Gn.VITE_DISABLE_BETA_ERROR,
      adsgramBlockId: vl()
    }
  },
  wl = () => window.Telegram.WebApp.isVersionAtLeast(8) ? window.Telegram.WebApp.safeAreaInset : {
    top: 0,
    bottom: 0,
    left: 0,
    right: 0
  },
  jl = () => window.Telegram.WebApp.isVersionAtLeast(8) ? window.Telegram.WebApp.contentSafeAreaInset : {
    top: 0,
    bottom: 0,
    left: 0,
    right: 0
  ...
  Pl = t => t.device.os,
  Cl = t => t.device.deviceType,
  wt = t => t.device.fullscreen,
  Sl = t => t.device.contentSafeAreaInset,
  ...
  Bl = () => {
    ...
    return e.jsx("div", {
      ...
      children: ["Star Shop"].map(a => e.jsxs("div", {
        className: `${ta.item} ${t===a?ta.active:""}`,
        onPointerUp: () => {
          n(a)
        },
  ...
  nn = async t => {
  ...
  }, io = t => new Promise(n => setTimeout(n, t)), Zl = t => {
    ...
    try {
      ...
      return Zl(n.coords) || (n.coords = !1), n.showTemplate && (n.coords = !1), n
    } catch {
      return {
        coords: !1,
        squad: !1,
  ...
  }, ya = t => !0, nd = "_layout_13e1w_1", sd = "_container_13e1w_10", ad = "_star_13e1w_14", id = "_move_13e1w_1", Mn = {
    layout: nd,
    container: sd,
    star: ad,
    move: id
  }, od = "_link_1fn8i_1", rd = "_telegram_icons_1fn8i_13", oo = {
    link: od,
    telegram_icons: rd
  }, b = ({
    children: t,
  ...
  }, () => !1), ld = "_layout_1nbfl_1", dd = "_button_1nbfl_14", oi = {
    layout: ld,
    button: dd
  }, ud = () => {
    const t = K();
  ...
  }, md = "_layout_gx8in_1", Ad = "_container_gx8in_5", pd = "_item_gx8in_11", hd = "_active_gx8in_20", gd = "_image_container_gx8in_24", _d = "_image_gx8in_24", fd = "_item_text_container_gx8in_34", xd = "_item_text_gx8in_34", ot = {
    layout: md,
    container: Ad,
    item: pd,
    active: hd,
    ...
    offset: t,
    limit: n
  })).data), Jn = O("user/getPixelsForSaleTotal", async () => (await Y.getUserPixelsCount()).data), Xn = O("user/getUserPixelsSold", async ({
    offset: t,
    limit: n
  }, s) => (await Y.getUserPixelsSold({
    offset: t,
    limit: n
  })).data), Yn = O("user/getUser", async (t, {
    rejectWithValue: n
  }) => {
    try {
    ...
    extraReducers: t => {
      t.addCase(Vn.pending, n => {
        ...
        Ps.upsertMany(n.pixelsForSale, s.payload.pixels), n.totalPrice = s.payload.totalPrice, n.pixelsForSaleTotal = s.payload.total, n.pixelsForSaleFetchStatus = A.fulfilled
    ...
    setLanguageCode: vd,
    setPixelsForSaleOffset: co,
    setPixelsForSaleTotal: wd,
    setPixelsForSaleFetchStatus: jd,
    removePixelsForSale: bd,
    setPixelsSoldOffset: I4,
    setPixelsSoldTotal: P4,
  ...
  }, Pd = t => t.user.userPic, Ie = t => t.user.user, Cd = ro.reducer, Dt = {
    getPixelsForSale: Vn,
  ...
  }, Td = "/assets/icon_coin-COCalNMQ.gif", Ed = "/assets/icon_stars-BmDiRMAW.gif", Bd = {
    items: []
  }, mo = he({
    name: "toast",
    initialState: Bd,
  ...
  }), Yd = "_pixels_amount_ngjsa_1", Wd = "_general_info_container_ngjsa_6", Kd = "_coin_amount_text_ngjsa_12", Zd = "_description_container_ngjsa_16", $d = "_description_ngjsa_16", Un = {
    pixels_amount: Yd,
    general_info_container: Wd,
    coin_amount_text: Kd,
    description_container: Zd,
    description: $d
  }, eu = "_logo_container_1i5of_1", tu = {
    logo_container: eu
  }, nu = "_layout_1cvcu_1", su = "_container_1cvcu_10", au = "_bubble_1cvcu_16", iu = "_move_1cvcu_1", na = {
    layout: nu,
    container: su,
    bubble: au,
    move: iu
  ...
  }, () => !1), ru = "_container_1aw3i_1", cu = "_logo_1aw3i_9", lu = "_animate_1aw3i_1", du = "_center_1aw3i_18", uu = "_glow_1aw3i_28", On = {
    container: ru,
    logo: cu,
    animate: lu,
    center: du,
  ...
  }), pu = "_container_13oyr_1", hu = "_button_13oyr_11", gu = "_info_13oyr_32", _t = {
    container: pu,
    button: hu,
    info: gu
  };
...
const Wn = O("mining/info", async () => (await zs.info()).data),
  Kn = O("mining/claim", async () => (await zs.claim()).data),
  Zn = O("mining/checkTask", async ({
    key: t
  }) => (await zs.checkTask({
    key: t
  })).data),
  $n = O("mining/checkBoost", async ({
    key: t
  }) => (await zs.checkBoost({
    key: t
  })).data),
  ...
  pt = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='white'/%3e%3c/svg%3e",
    ...
    return m.useEffect(() => {
      ...
      children: e.jsxs("button", {
        ...
        onPointerUp: async () => {
          var u, h;
          try {
            const _ = await a(Pe.claim()).unwrap();
  ...
  _o = m.memo(({
    ...
    const [s, a] = m.useState(Uu()), [i, o] = m.useState(!1);
    return m.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  qu = () => c(n => n.mining.infoStatus) !== A.fulfilled ? e.jsx(zu, {}) : e.jsx(Qu, {}),
  Lu = () => {
  ...
  Hu = "_info_layout_bt2qf_1",
  Gu = "_info_container_bt2qf_10",
  Vu = "_category_container_bt2qf_16",
  Ju = "_category_title_bt2qf_22",
  Xu = "_row_container_bt2qf_27",
  Yu = "_info_row_bt2qf_35",
  Wu = "_info_row_pending_bt2qf_59",
  Ku = "_loading_bt2qf_1",
  Zu = "_content_bt2qf_74",
  $u = "_image_container_bt2qf_83",
  em = "_image_bt2qf_83",
  tm = "_row_main_information_bt2qf_103",
  nm = "_row_title_bt2qf_114",
  sm = "_row_icon_container_bt2qf_120",
  am = "_row_icon_bt2qf_120",
  im = "_row_main_value_bt2qf_130",
  om = "_row_prompt_bt2qf_137",
  rm = "_not_pixel_icon_bt2qf_142",
  cm = "_row_image_bt2qf_147",
  lm = "_row_reward_count_bt2qf_153",
  dm = "_row_reward_completed_bt2qf_158",
  um = "_priceless_bt2qf_165",
  mm = "_completed_tasks_container_bt2qf_169",
  Am = "_completed_task_item_bt2qf_176",
  p = {
    info_layout: Hu,
    info_container: Gu,
    ...
    image_container: $u,
    image: em,
    row_main_information: tm,
    row_title: nm,
    row_icon_container: sm,
    row_icon: am,
    row_main_value: im,
    row_prompt: om,
    not_pixel_icon: rm,
    row_image: cm,
    row_reward_count: lm,
    row_reward_completed: dm,
    priceless: um,
    completed_tasks_container: mm,
    completed_task_item: Am
  },
  ne = ({
    children: t,
    boost: n,
  ...
  wm = "data:image/png;base64,",
  jm = () => {
    const t = K(),
      n = w.invite3frens;
  ...
  Dm = () => {
    ...
    return m.useEffect(() => {
      ...
      !o || d !== A.fulfilled || r && (i || (h = r == null ? void 0 : r.connectItems) != null && h.tonProof && !("error" in r.connectItems.tonProof) && Y.checkTonProof(r.connectItems.tonProof.proof, r.account).then(_ => {
        _.status === 200 && _.data.success ? t(Pe.checkTask({
          key: n,
          reward: l
        })) : t(z({
          id: performance.now(),
...
const mi = () => {
  ...
  eA = () => {
    ...
    }, []), !$m || h || s !== "mobile" || o === !1 ? null : e.jsxs(ne, {
      enableCheck: !1,
      action: () => {
        d === 0 && n.show().then(N => {
          t(Mt(P)), t(z({
  ...
  lA = () => {
    ...
    return c(s => s.user.country), !cA && !n && !ft.isDev, null
  },
  dA = () => {
    const s = w["taskTypeCampaign3_74388"],
      ...
      i = c(r => r.mining.tasks[s]),
      o = 1024;
    return a !== "RU" && a !== "ru" ? null : e.jsx(ne, {
      action: () => {
  ...
  _A = () => e.jsxs("div", {
    ...
    children: [e.jsx(eA, {}), e.jsx(gA, {}), e.jsx(lA, {}), e.jsx(oA, {}), e.jsx(dA, {}), e.jsx(xm, {}), e.jsx(ia, {
      text: "Quick start"
    }), e.jsx(vm, {}), e.jsx(jm, {}), e.jsx(Nm, {}), e.jsx(ia, {
      text: "Special"
    }), e.jsx(Dm, {}), e.jsx(nA, {}), e.jsx(aA, {}), e.jsx(Xm, {}), e.jsx(Fm, {}), e.jsx(Um, {}), e.jsx(hm, {}), e.jsx(Im, {}), e.jsx(Pm, {}), e.jsx(Cm, {}), e.jsx(Em, {}), e.jsx(mA, {}), e.jsx(ia, {
      text: "Browser"
    }), e.jsx(gm, {}), e.jsx(_m, {}), e.jsx(km, {}), e.jsx(Rm, {}), e.jsx(Tm, {}), e.jsx("div", {
      style: {
        height: 30
      }
    })]
    ...
    return m.useEffect(() => {
      function a(i) {
        i.ctrlKey && i.altKey && i.keyCode === 67 && (async () => {
          try {
            await nn(window.Telegram.WebApp.initData), await t(z({
              id: performance.now(),
              text: "Copied!"
            }))
          } catch {
  ...
  PA = "_data_7jsmf_57",
  CA = "_title_7jsmf_63",
  SA = "_pixelColor_7jsmf_68",
  TA = "_pixelCoords_7jsmf_77",
  EA = "_pixelPriceValue_7jsmf_83",
  BA = "_pixelPriceDescription_7jsmf_91",
  DA = "_pixelState_7jsmf_95",
  kA = "_pixelDate_7jsmf_100",
  RA = "_paginationContainer_7jsmf_107",
  MA = "_loadMoreButton_7jsmf_114",
  UA = "_noPixelsContainer_7jsmf_136",
  OA = "_noPixelsText_7jsmf_143",
  FA = "_pixelsForSaleCountText_7jsmf_149",
  QA = "_skeleton_container_7jsmf_153",
  zA = "_skeleton_header_7jsmf_157",
  qA = "_skeleton_row_7jsmf_166",
  ee = {
    container: yA,
    row: vA,
    cell1: wA,
    ...
    pixelCoords: TA,
    pixelPriceValue: EA,
    pixelPriceDescription: BA,
    pixelState: DA,
    pixelDate: kA,
    paginationContainer: RA,
    loadMoreButton: MA,
    noPixelsContainer: UA,
    noPixelsText: OA,
    pixelsForSaleCountText: FA,
    skeleton_container: QA,
    skeleton_header: zA,
    skeleton_row: qA
  },
  Qa = Ps.getSelectors(t => t.user.pixelsForSale);
Cs.getSelectors(t => t.user.pixelsSold);
const vo = Ss.getSelectors(t => t.daily.list);
Oa.getSelectors(t => t.reward.list);
const wo = gn.getSelectors(t => t.tournament.approvedTemplatesList),
  LA = () => {
  ...
  Me = t => {
    const n = new Date().getFullYear(),
      ...
      r = t.getHours(),
      l = t.getMinutes();
    return `${o<10?0:""}${o} ${[VA[i]]} ${a} at ${r<10?0:""}${r}:${l<10?0:""}${l}`
  },
  JA = ({
    date: t
  }) => e.jsx("div", {
  ...
  xt = t => !(t.x < 0 || t.y < 0 || t.x > E.width - 1 || t.y > E.height - 1),
  es = O("canvas/repaint", async ({
    pixelId: t,
    newColor: n
...
const wa = O("canvas/getPixelInfo", async ({
    id: t
  }) => (Xt !== null && (Xt.abort(), Xt = null), Xt = new AbortController, (await Y.getPixelInfo({
    id: t,
    signal: Xt.signal
  })).data)),
  ts = O("canvas/getPrices", async () => (await Y.getPrices()).data),
  ns = O("canvas/getPriceMask", async ({
    price: t
  }) => {
  ...
  ZA = () => Ua() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  $A = {
    coords: null,
    animations: ZA(),
    stats: null,
  ...
  Io = he({
    ...
    reducers: {
      ...
      addPaintCoords: (t, n) => {
        xt(n.payload) && (t.stats = nt(n.payload) ^ 3201282)
      }
    },
    extraReducers: t => {
      t.addCase(wa.pending, n => {
        ...
        n.pixelInfo = s.payload, n.getPixelInfoFetchStatus = A.fulfilled, Xt = null
      }).addCase(ts.pending, n => {}).addCase(ts.fulfilled, (n, s) => {
        n.prices = s.payload.prices
      }).addCase(ts.rejected, n => {}).addCase(ns.pending, n => {
...
let vp = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [cp, lp, dp, up, mp, Ap, pp, hp, gp, _p, fp, xp, yp], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
...
const wp = "_order_panel_dvy5p_1",
  jp = "_content_dvy5p_13",
  bp = "_fast_mode_blocker_dvy5p_26",
  Np = "_info_dvy5p_39",
  Ip = "_active_color_dvy5p_48",
  Pp = "_pixel_info_container_dvy5p_58",
  Cp = "_pixel_info_color_dvy5p_66",
  Sp = "_pixel_info_text_dvy5p_72",
  Tp = "_info_button_dvy5p_78",
  Ep = "_info_button_active_dvy5p_95",
  Bp = "_price_value_dvy5p_99",
  Dp = "_pixel_locked_text_dvy5p_105",
  kp = "_pixel_locked_text_painted_dvy5p_116",
  Rp = "_pixel_locked_animation_dvy5p_138",
  Mp = "_button_dvy5p_144",
  Up = "_button_text_dvy5p_168",
  Op = "_flash_mode_button_text_dvy5p_181",
  Fp = "_not_pixel_icon_dvy5p_192",
  Qp = "_tg_logo_dvy5p_196",
  zp = "_image_dvy5p_201",
  qp = "_inner_wrapper_button_dvy5p_206",
  oe = {
    order_panel: wp,
    content: jp,
    fast_mode_blocker: bp,
    info: Np,
    active_color: Ip,
    ...
    pixel_locked_text_painted: kp,
    pixel_locked_animation: Rp,
    button: Mp,
    button_text: Up,
...
const Yp = (t, n) => {
    ...
    ya() && (s = {
    ...
    }), At = new Kr(ka.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), At.on("connected", function(a) {
      if (console.log(`connected over ${a.transport}`), !ya()) return;
      ...
      o.src = URL.createObjectURL(i), o.onload = () => {
        y.mainImage.loadFromCentrifuge(o).then(() => {
          const l = ut.getState().main.startParams.coords;
          ...
          }), y.mainImage.selectedPixel.draw(l), ut.dispatch(kt(l)))
        })
      }
    }), At.on("disconnected", function(a) {
      console.log(`disconnected: ${a.code}, ${a.reason}`)
    }), At.on("error", function(a) {
      console.log(a)
    }), At.on("publication", function(a) {
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          const l = JSON.parse(r.data);
          if (r.type === Zs.pixanos && ut.dispatch(eh(l)), l.user.userId === n || !wn) return;
          const u = ut.getState().canvas.animations;
          if (r.type === Zs.bomb) {
            const h = Ts(l.info.pixelId);
      ...
      Zr(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === Jp[1] && ut.getState().daily.list.entities[d.good_id]) {
              const u = ut.getState().daily.list.entities[d.good_id],
                h = u.name,
  ...
  To = he({
    ...
    reducers: {
      setTimeLimit: t => {
        t.timeLimit = !0, At && At.disconnect()
      },
      updateSettings: (t, n) => {
        t.settings = {
          ...t.settings,
  ...
  }),
  {
    ...
    disableFastType: Ut,
    enableFastEnergy: $p,
    disableFastEnergy: Bo,
    showPixanosEvent: eh,
    hidePixanosEvent: th,
    setPixanosProcessing: hi,
    setShowIntro: O4,
    setShowBetaTestIntro: F4,
    addFlyingReward: nh,
    removeFlyingReward: sh,
    showInviteFrensPopup: Q4,
    hideInviteFrensPopup: ca,
    showNoChargesPopup: z4,
    hideNoChargesPopup: la,
    setLastShowChargesPopupTs: q4,
    setShowMiningDetailsPopup: Do,
    setShowBoostDetailsPopup: qa,
    setActiveBoostDetails: ah,
    addItemToUserAndSquadPopupStack: Cn,
    removeItemFromUserAndSquadPopupStack: ko,
    setShowNoFlagsPopup: ih,
    setReferrerSquadId: ba
  } = To.actions,
  oh = To.reducer,
  on = Ba(t => t.main.settings, t => {
  ...
  dh = "_placeholder_oxfjd_20",
  uh = "_progress_oxfjd_24",
  mh = "_counter_oxfjd_32",
  ...
  fh = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(ph, {}), e.jsx(_h, {
        progress: d
      })]
    })
  },
  xh = "_layout_91s2c_1",
  yh = "_container_91s2c_21",
  vh = "_buttons_container_91s2c_27",
  wh = "_button_91s2c_27",
  jh = "_shop_button_91s2c_45",
  bh = "_container__bottom_91s2c_50",
  Nh = "_fast_type_button_91s2c_50",
  Ih = "_disabled_button_cover_91s2c_62",
  Ph = "_fast_mode_button_enabled_91s2c_72",
  Ch = "_available_91s2c_82",
  Sh = "_limited_good_timer_91s2c_99",
  Th = "_disabled_available_cover_91s2c_120",
  Eh = "_button_image_91s2c_130",
  Bh = "_animation_91s2c_147",
  Dh = "_shake_91s2c_1",
  I = {
    layout: xh,
    container: yh,
    buttons_container: vh,
    button: wh,
    shop_button: jh,
    container__bottom: bh,
    fast_type_button: Nh,
    disabled_button_cover: Ih,
    fast_mode_button_enabled: Ph,
    available: Ch,
    limited_good_timer: Sh,
    disabled_available_cover: Th,
    button_image: Eh,
    animation: Bh,
    shake: Dh
  },
...
const Wh = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(Os(10)), t(st(1)), t(at()), t(Bo()), !1;
  if (s === a) return !1;
  ...
  try {
    (await t(Qs.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === A.fulfilled && (t(wu(a)), t(Fs({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: Et
} = Oo.actions, Fo = t => t.layout.isShowSideMenu, $h = Oo.reducer;
let Lt = null,
  Ht = null;
class Qo {
...
const ss = O("ratings/personal", async ({
    league: t
  }) => (await Qo.personal({
    league: t
  })).data),
  as = O("ratings/squad", async ({
    league: t
  }) => (await Qo.squad({
    league: t
  })).data),
...
const Ha = {
  ...
  jt = en();
jt.startListening({
  matcher: ye(Pe.info.fulfilled),
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(wd(t.payload.totalUserPixels)), n.dispatch(lo(t.payload.userBalance))), n.dispatch(Fc(t.payload.goods))
  }
});
jt.startListening({
  matcher: ye(Pe.checkTask.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s],
      i = t.meta.arg.reward;
    a && (s === w.pumpkin && n.dispatch(Yt({
      product: 7,
      amount: 6
    })), n.dispatch(Mt(i)));
    let o = "Check failed",
...
jt.startListening({
  matcher: ye(Pe.checkBoost.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s];
    let i = "Not enough PX",
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === pe.energyLimit) {
        ...
        n.dispatch(yu(s.mining.maxCharges + d)), n.dispatch(ho(d))
      }
...
jt.startListening({
  matcher: ye(Pe.checkTask.rejected),
  effect: (t, n) => {
    n.dispatch(z({
      id: performance.now(),
      text: "Check failed",
...
jt.startListening({
  matcher: ye(Pe.checkBoost.rejected),
  effect: (t, n) => {
    n.dispatch(z({
      id: performance.now(),
      text: "Not enough PX",
...
const Ho = en();
Ho.startListening({
  matcher: ye(Dt.getUser.fulfilled),
  effect: (t, n) => {
...
const Go = en();
Go.startListening({
  matcher: ye(La.squad.fulfilled),
  effect: (t, n) => {
    n.dispatch(Id(t.payload.mySquad))
  }
});
const ig = {
    info: null,
...
const rg = "/assets/halloween2-l9FmXxVI.png",
  cg = O("template/subscribe", async ({
    id: t
  }) => (await Oe.subscribeToTemplate({
    id: t
  })).data),
  rs = O("template/getTemplateList", async ({
    offset: t,
    limit: n
  ...
  lg = O("template/getAvailableSizes", async ({
    userId: t
  }) => (await Oe.getAvailableSizes({
    userId: t
  })).data),
  cs = O("template/getReferredTemplate", async () => (await Oe.getReferredTemplate()).data),
  Na = O("template/getMyTemplate", async ({
    id: t
  }) => (await Oe.getTemplateById({
    id: t
  })).data),
  ls = O("template/getWorldTemplate", async () => ({
    x: (E.width - 256) / 2,
    y: (E.height - 256) / 2,
    imageSize: 256,
    url: rg,
  ...
  Jo = he({
    ...
    extraReducers: t => {
      ...
      }).addCase(cs.rejected, (n, s) => {}).addCase(Na.pending, n => {}).addCase(Na.fulfilled, (n, s) => {}).addCase(ls.pending, (n, s) => {}).addCase(ls.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: We.world
        };
  ...
  {
    setActiveTemplate: L4,
    setActiveTemplateTab: gi,
    hideTemplates: Xo,
    setTemplateOpacity: ug,
    setReferredTemplate: mg,
    setMyTemplate: Ag,
  ...
  ds = O("daily/getList", async () => (await Y.getDailyList()).data),
  us = O("daily/getFirstDaily", async () => (await Y.getFirstDaily()).data),
  Wo = he({
    name: "daily",
    initialState: gg,
    reducers: {
    ...
    extraReducers: t => {
      t.addCase(ds.pending, n => {
        ...
        Ss.setAll(n.list, s.payload.dailyAvailable), n.getDailyListFetchStatus = A.fulfilled
...
const ms = O("tournament/getPeriods", async () => (await Zo.getPeriods()).data),
  As = O("tournament/getResults", async () => (await Zo.getResults()).data),
  ps = O("tournament/getMyTemplate", async ({
    id: t
  }) => (await Oe.getTournamentTemplateById({
    id: t
  })).data),
  hs = O("tournament/getSelectedTemplate", async () => (await Oe.getSelectedTemplate()).data),
  gs = O("tournament/getApprovedTemplatesList", async ({
    offset: t,
    limit: n
  ...
  _s = O("tournament/getRandomTemplatesList", async () => (await Oe.getRandomTemplates()).data),
  fs = O("tournament/selectTemplate", async ({
    id: t
  ...
  $o = he({
    ...
    extraReducers: t => {
      ...
      }).addCase(ps.rejected, (n, s) => {}).addCase(ms.pending, n => {
  ...
  }),
  {
    ...
    hideTournamentTemplates: Va,
    setShowTournamentDetailsPopup: er,
    setShowRoundRewardsPopup: tr,
    setMyTournamentTemplate: V4,
    clearApprovedTemplateList: nr,
    showTournamentTemplateInfoPopup: Ja,
...
const Bn = Lr({
    ...
    devTools: !1,
    middleware: t => [Tn.middleware, Ho.middleware, Gs.middleware, jt.middleware, Go.middleware, En.middleware, ...t()]
  }),
  ys = [],
  Mg = async ({
    dispatch: t,
    ...
    await t(nh({
      ...
      id: nt(s),
      color: Tt(a)
    }), y.mainImage.updateTexture(), await t(Hp(a)), await t(np(s)), await t(bu());
    ...
    try {
      const r = await o;
      r.status === 200 && (r.data.reward_user && r.data.reward_user.reward_id && (y.mainImage.reward.add(s), t(Sg({
        rewardId: r.data.reward_user.reward_id,
        rewardUserId: r.data.reward_user.id
      }))), t(lo(r.data.balance)))
    } catch (r) {
      console.log(r, r.response.data.code === 16), r.response.data.code === 16 && t(Pe.info())
    }
  }, Ug = ({
    history: t,
    dispatch: n,
    ...
    n(Ls()), t && t.push("/energy-over"), n(kt(s)), y.mainImage.selectedPixel.draw(s)
  }, rr = async ({
    history: t,
    charges: n,
    dispatch: s,
    ...
    if (n <= 0)
      if (d && d.main.fastEnergy) {
        if (ys.length > 0 && !(await Promise.allSettled(ys)).every(P => P.status === A.fulfilled || P.status === A.rejected)) return;
        const h = await Wh({
          dispatch: s,
          state: d
        });
    ...
    return i === "paintcan" && l.push(I.fast_mode_button_enabled), s ? e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "paintcan") {
          t(Ut());
          return
        }!a || a === 0 ? (t(st(n)), t(at())) : t(Hs("paintcan"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: I.button_image,
...
let p_ = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [Jg, Xg, Yg, Wg, Kg, Zg, $g, e_, t_, n_, s_, a_, i_, o_, r_, c_, l_, d_, u_, m_], this.textureArray = [];
    ...
    return i === "pumpkin" && l.push(I.fast_mode_button_enabled), !s || !a || a === 0 ? null : e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "pumpkin") {
          t(Ut());
          return
        }!a || a === 0 ? (t(st(n)), t(at())) : t(Hs("pumpkin"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: I.button_image,
...
class v_ {
  constructor({
    ...
    this.app = n, this.ticker = i, this.viewport = s, this.store = a, this.pixiViewport = s.viewport, this.selectedPixel = new ip({
      viewport: s
    }), this.template = new Fg({
      app: n,
      viewport: s,
      store: a
    }), this.worldTemplate = new Qg({
      app: n,
      viewport: s,
      store: a,
      mainImage: this
  ...
  async loadAllChunks() {
    const n = await this.loadImage(Cc),
  ...
  pixanosRepaint(n, s, a, i) {
    ...
    for (let _ = 0; _ < u.length; _++) {
      ...
      if (_ < 20) {
        const N = Ts(P);
        console.log(`i: ${_}, id: ${P}, x: ${N.x}, y: ${N.y}`)
      }
      this.paintPixel({
        id: P,
        color: h
...
const b_ = () => localStorage.getItem("canvasFps") ? Number(localStorage.getItem("canvasFps")) : 60;
class N_ {
  constructor({
    app: n
  }) {
    this.app = n, this.lastTime = Date.now(), this.lastRenderTime = Date.now(), this.fps = b_(), this.callbacks = [], this.render()
  }
  render(n = 0) {
    const s = Date.now(),
      a = s - this.lastTime;
...
class P_ {
  constructor({
    ...
    }), this.app.ticker.stop(), this.ticker = new N_({
      app: this.app
    }), this.viewport = new j_({
      app: this.app,
      store: Sa
    }), this.mainImage = new v_({
      app: this.app,
...
function C_() {
  y = new P_({
    readyCallback: t => {
      Yp(t.getState().user.user.websocketToken, t.getState().user.user.id)
    }
  })
}
const S_ = m.memo(() => (m.useEffect(() => {
    fi || (C_(), fi = !0)
  }, []), Ke.createPortal(e.jsx("canvas", {
    id: "canvasHolder",
    className: `${KA.main_canvas}`
  }), document.body)), () => !0),
  T_ = ({
    children: t,
    coords: n,
  ...
  B_ = () => c(Qa.selectAll).map(n => e.jsx(E_, {
    item: n
  }, nt({
    x: n.x,
    y: n.y
  ...
  R_ = () => {
    ...
    return c(s => s.user.pixelsForSaleFetchStatus) === A.pending && t === 0 ? e.jsx(k_, {}) : t !== 0 ? e.jsxs(GA, {
      children: [e.jsx(B_, {}), e.jsx(D_, {})]
    }) : null
  },
  M_ = () => {
    const t = g();
    return xA(), m.useEffect(() => () => {
      t(bd()), t(co({
        offset: 0
      })), t(jd({
        status: A.idle
      ...
      children: [e.jsx(LA, {}), e.jsx(R_, {})]
    })
  },
  U_ = "_layout_v8prs_1",
  O_ = "_group_title_container_v8prs_7",
  F_ = "_group_title_v8prs_7",
  Q_ = "_group_v8prs_7",
  vs = {
    layout: U_,
    group_title_container: O_,
    group_title: F_,
    group: Q_
  },
  z_ = ({
  ...
  q_ = "_boost_item_8sbvi_1",
  L_ = "_image_container_8sbvi_10",
  H_ = "_image_8sbvi_10",
  G_ = "_content_container_8sbvi_21",
  V_ = "_content_8sbvi_21",
  J_ = "_item_title_container_8sbvi_33",
  X_ = "_item_reward_container_8sbvi_40",
  Y_ = "_price_text_8sbvi_45",
  W_ = "_dot_8sbvi_49",
  ...
  Te = {
    ...
    image_container: L_,
    image: H_,
    content_container: G_,
    content: V_,
    item_title_container: J_,
    item_reward_container: X_,
    price_text: Y_,
    dot: W_,
    level_text: K_,
    status_container: Z_,
  ...
  af = "_container_1e12r_1",
  of = "_title_container_1e12r_8",
  rf = "_description_1_1e12r_19",
  cf = "_description_2_1e12r_27",
  lf = "_description_container_1e12r_35",
  df = "_image_container_1e12r_47",
  uf = "_image_1e12r_47",
  mf = "_buttons_container_1e12r_59",
  Af = "_button_1e12r_59",
  ...
  xf = () => {
    ...
    return e.jsxs(sn, {
      show: n,
      setShow: a,
      children: [s === pe.paintReward && e.jsx(gf, {}), s === pe.reChargeSpeed && e.jsx(_f, {}), s === pe.energyLimit && e.jsx(ff, {})]
    })
  },
  yf = () => e.jsxs("div", {
    className: vs.layout,
    children: [e.jsxs(z_, {
      title: "Boosters",
      children: [e.jsx(tf, {}), e.jsx(nf, {}), e.jsx(sf, {})]
    }), e.jsx(xf, {}), e.jsx("div", {
      style: {
        height: "20px"
      }
  ...
  vf = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(fA, {}), t === "tasks" && e.jsx(_A, {}), t === "pixels" && e.jsx(M_, {}), t === "boosts" && e.jsx(yf, {})]
    })
  },
  wf = () => {
    const t = g(),
  ...
  jf = () => e.jsxs(te.Fragment, {
    children: [e.jsx(wf, {}), e.jsx(vf, {})]
  }),
  bf = "_more_details_6gp7h_1",
  Nf = {
    more_details: bf
  },
  Dn = ({
    ...
    className: Nf.more_details,
    ...n,
    children: e.jsx("span", {
      children: t
    })
  }),
  If = "_container_1h1qc_1",
  Pf = "_divider_1h1qc_19",
  Cf = "_row_1h1qc_24",
  Sf = "_row_title_1h1qc_36",
  Tf = "_row_title_main_1h1qc_40",
  Ef = "_row_hint_1h1qc_45",
  Bf = "_row_value_1h1qc_51",
  Df = "_row_value_main_1h1qc_55",
  kf = "_mining_percent_1h1qc_60",
  ...
  Of = () => {
    ...
    return e.jsxs(le, {
      children: [e.jsx("div", {
        ...
        className: Un.general_info_container,
        children: [e.jsxs("h1", {
          className: Un.pixels_amount,
          children: [e.jsx(Lu, {}), " PX"]
        }), e.jsxs("div", {
          className: Un.description_container,
          children: [e.jsxs("span", {
            className: Un.description,
            children: [n("grayInstruction"), " ", e.jsx("br", {}), e.jsx(Dn, {
              onPointerUp: s => {
                s.stopPropagation(), t(Do(!0))
              },
  ...
  Qf = "_squads_img_zthsq_1",
  zf = "_title_container_zthsq_11",
  qf = "_description_container_zthsq_18",
  Lf = "_description_zthsq_18",
  Hf = "_info_layout_zthsq_31",
  Gf = "_info_container_zthsq_42",
  ...
  Kf = "_avatar_zthsq_87",
  Zf = "_position_zthsq_99",
  $f = "_user_squad_position_zthsq_117",
  ex = "_rating_main_info_zthsq_135",
  tx = "_rating_name_zthsq_148",
  nx = "_rating_value_zthsq_155",
  sx = "_active_league_text_zthsq_163",
  ax = "_icon_leagueflag_zthsq_167",
  ix = "_join_squad_button_zthsq_174",
  ox = "_join_squad_text_zthsq_188",
  rx = "_user_squad_container_zthsq_206",
  cx = "_squad_avatar_container_zthsq_223",
  lx = "_user_squad_info_zthsq_234",
  dx = "_user_squad_name_zthsq_242",
  ux = "_user_squad_your_squad_text_zthsq_246",
  mx = "_user_squad_users_count_zthsq_251",
  F = {
    ...
    avatar: Kf,
    position: Zf,
    user_squad_position: $f,
    rating_main_info: ex,
    rating_name: tx,
    rating_value: nx,
    active_league_text: sx,
    icon_leagueflag: ax,
    join_squad_button: ix,
    join_squad_text: ox,
    user_squad_container: rx,
    squad_avatar_container: cx,
    user_squad_info: lx,
    user_squad_name: dx,
    user_squad_your_squad_text: ux,
    user_squad_users_count: mx
  },
  Ax = ({
    isPlayers: t
  }) => {
  ...
  yx = () => {
    ...
    return m.useEffect(() => {
      ...
      t(tg())
    }, []), a !== A.fulfilled ? null : e.jsxs(te.Fragment, {
      children: [e.jsx(xx, {}), n.map((i, o) => e.jsx(fx, {
        item: i,
        index: o
      }, o))]
    })
  },
  vx = () => (m.useState("Day"), null),
  wx = ({
    children: t
  }) => e.jsx("div", {
  ...
  jx = () => {
    ...
    return e.jsx("div", {
      ...
      children: e.jsxs("span", {
        ...
        children: ["Pixel painting Leaderboard!", e.jsx("br", {}), e.jsx(Dn, {
          onPointerUp: () => {
            t.push("/stats")
          },
  ...
  Px = () => {
    ...
    return c(s => s.ratings.status) !== A.fulfilled ? null : t.map((s, a) => e.jsx(Ix, {
      item: s,
      index: a
    }, a))
  },
  Cx = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(bx, {}), e.jsx(Nx, {}), e.jsx(Px, {})]
    })
  },
  Sx = () => e.jsx(te.Fragment, {
  ...
  Dx = () => (c(t => t.ratings.league), c(uo), c(Ro), e.jsx("div", {
  ...
  Ox = "/assets/icon_squad_secret-B-fF264Z.gif",
  Fx = () => {
  ...
  Qx = () => {
    ...
    return e.jsxs(le, {
      children: [e.jsx(Fx, {}), e.jsx(_x, {
        selectedSection: t,
        setSelectedSection: n
      }), e.jsx(jx, {}), e.jsx(Ax, {
        isPlayers: t === "Painters"
      }), e.jsxs(wx, {
        children: [t === "Painters" && e.jsx(Dx, {}), t === "Squads" && e.jsx(Mx, {}), t === "Squads" && e.jsx(Cx, {}), t === "Painters" && e.jsx(yx, {}), s !== A.fulfilled && e.jsx(Sx, {})]
      })]
    })
  },
  zx = ({
  ...
  Hx = "_expandable_panel_layout_1v9vd_1",
  Gx = "_expandable_panel_1v9vd_1",
  Vx = "_divider_1v9vd_16",
  Jx = "_divider_spacer_1v9vd_24",
  Xx = "_divider_pointer_1v9vd_28",
  fn = {
    expandable_panel_layout: Hx,
    expandable_panel: Gx,
    divider: Vx,
    divider_spacer: Jx,
    divider_pointer: Xx
  ...
  Kx = "_container_1vu8i_1",
  Zx = "_owner_1vu8i_10",
  $x = "_id_1vu8i_14",
  ey = "_date_1vu8i_19",
  ty = "_avatar_container_1vu8i_24",
  ny = "_avatar_1vu8i_24",
  sy = "_squad_avatar_container_1vu8i_36",
  ay = "_text_container_1vu8i_48",
  iy = "_dot_1vu8i_54",
  oy = "_user_name_1vu8i_59",
  ry = "_squad_name_1vu8i_64",
  de = {
    container: Kx,
    owner: Zx,
    id: $x,
    ...
    avatar_container: ty,
    avatar: ny,
    squad_avatar_container: sy,
    text_container: ay,
    dot: iy,
    user_name: oy,
    squad_name: ry
  },
  cy = "_skeleton_k7kmi_1",
  ly = "_loading_k7kmi_1",
  dy = {
    skeleton: cy,
    loading: ly
  ...
  kn = ({
    ...
    return n > 0 && (i = In(i, n)), e.jsx("span", {
      className: oo.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ue(`https://t.me/${ii(t)}`) : tn(`https://t.me/${ii(t)}`)
      },
      children: i
    })
  },
  ...
  gy = () => e.jsxs("div", {
    ...
    children: [e.jsx(hy, {}), e.jsx(uy, {}), e.jsx(py, {}), e.jsx(my, {}), e.jsx(Ay, {})]
  }),
  _y = "_category_text_epppt_1",
  fy = "_latest_used_container_epppt_8",
  xy = "_color_line_epppt_15",
  yy = "_color_item_epppt_22",
  vy = "_pipette_container_epppt_30",
  wy = "_child_scale_epppt_48",
  pr = {
    category_text: _y,
    latest_used_container: fy,
    color_line: xy,
    color_item: yy,
    pipette_container: vy,
    child_scale: wy
  },
  jy = ({
    color: t
  ...
  by = ({
    ...
    children: t.map((n, s) => e.jsx(jy, {
      color: n
    }, `${n}_${s}`))
  }),
  Ny = "_unlock_button_fc8qr_1",
  ...
  My = () => c(n => n.canvas.coords) === null ? null : e.jsx(te.Fragment, {
    children: e.jsx(Ry, {})
  }),
  Uy = "_layout_14eqc_1",
  Oy = "_container_14eqc_9",
  Fy = "_button_14eqc_13",
  Aa = {
    layout: Uy,
    container: Oy,
  ...
  Vy = () => e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [e.jsx(Ly, {}), e.jsx(Gy, {})]
    })
  }),
  Jy = () => null,
  Xy = "_layout_14a3l_1",
  Yy = "_container_14a3l_11",
  Wy = "_image_14a3l_26",
  Ky = "_text_14a3l_31",
  Zy = "_gold_14a3l_37",
  $y = "_winning_14a3l_44",
  ...
  ei = "/assets/gold_pixel-CRD2C_ap.gif",
  tv = () => {
    const t = c(ir),
    ...
    return n !== A.fulfilled ? null : e.jsxs(te.Fragment, {
      children: ["  ", e.jsx(b, {
        size: 14,
  ...
  uv = ({
    ...
    return m.useEffect(() => {
      ...
      children: [dv[t.repaintRewardType], " ", e.jsx("img", {
        alt: "img",
        className: Es.image,
        src: ei
      })]
  ...
  gv = "_layout_1v16g_1",
  _v = "_container_1v16g_5",
  fv = "_close_button_1v16g_14",
  xv = "_title_container_1v16g_22",
  yv = "_image_container_1v16g_28",
  vv = "_image_1v16g_28",
  wv = "_first_image_1v16g_45",
  jv = "_second_image_1v16g_50",
  ...
  Ev = "_layout_srn55_1",
  Bv = "_container_srn55_12",
  Dv = "_buttons_container_srn55_18",
  pa = {
    layout: Ev,
    container: Bv,
    buttons_container: Dv
  },
  kv = "_container_srbwq_1",
  Rv = {
    container: kv
  },
  Mv = ({
  ...
  Ov = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(Mv, {
        ...
        max: bi,
        onChange: o => {
          n(ug(o)), y.mainImage.worldTemplate.setOpacity(Number(o[0])), y.mainImage.tournamentTemplates.setOpacity(Number(o[0]))
        },
        renderTrack: ({
          props: o,
          children: r
  ...
  Fv = () => c(n => n.tournament.activeTournamentTemplate) === null ? null : e.jsx("div", {
    className: Rv.container,
    children: e.jsx(Ov, {})
  }),
  Qv = "_button_14giw_2",
  zv = "_image_14giw_22",
  qv = "_enabled_14giw_29",
  Lv = "_animation_14giw_33",
  Hv = "_scaleInfinity_14giw_1",
  Gv = "_gray_14giw_38",
  Vv = "_indicator_14giw_42",
  ht = {
    button: Qv,
    image: zv,
    enabled: qv,
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(Jv, {}), e.jsx(Xv, {}), e.jsx(Fv, {})]
        })
      })
    })
  }),
  ...
  tw = () => c(n => n.canvas.coords) === null ? null : e.jsx("div", {
    className: Ni.layout,
    children: e.jsxs("div", {
      className: Ni.container + " " + I.container__bottom,
      children: [e.jsx(Vg, {}), e.jsx(Lg, {}), e.jsx(__, {}), e.jsx(Kh, {}), e.jsx(Zv, {}), e.jsx($v, {}), e.jsx(ew, {})]
    })
  }),
  nw = "_layout_swx97_1",
  sw = {
  ...
  aw = () => e.jsxs("div", {
    className: sw.layout,
    children: [e.jsx(tw, {}), e.jsx(My, {})]
  }),
  iw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(sv, {}), e.jsx(Qy, {}), e.jsx(Yv, {}), e.jsx(Vy, {}), e.jsx(aw, {}), e.jsx(hv, {}), e.jsx(mv, {}), e.jsx(Tv, {}), e.jsx(av, {}), e.jsx(Jy, {})]
  }),
  ...
  Qw = "_text_layout_1h04i_1",
  zw = "_text_1h04i_1",
  qw = "_button_layout_1h04i_14",
  Lw = "_button_layout_placeholder_1h04i_26",
  Hw = "_button_1h04i_14",
  mn = {
    text_layout: Qw,
    text: zw,
  ...
  Fj = "/assets/sitting_chars_shadow-DfXpFWWw.gif",
  Qj = "_link_a4r15_1",
  zj = {
    link: Qj
  },
  ...
  Lj = "_container_10f8u_1",
  Hj = "_text_container_10f8u_9",
  Gj = "_text_block_10f8u_16",
  Vj = "_gray_10f8u_24",
  Jj = "_total_10f8u_28",
  Xj = "_bold_10f8u_33",
  ...
  gr = "/assets/button_dog_200x200-DtCBiZdv.gif",
  wb = t => {
    const n = t / 1e3,
      s = Math.floor(n / 60),
      a = n % 60;
  ...
  Ub = "_bold_dwly3_75",
  Ob = "_center_dwly3_79",
  Fb = "_claim_button_container_dwly3_83",
  Qb = "_claim_button_dwly3_83",
  zb = "_no_button_dwly3_102",
  qb = "_info_layout_dwly3_114",
  Lb = "_rewards_layout_dwly3_126",
  Hb = "_rewards_grid_container_dwly3_132",
  Gb = "_reward_item_dwly3_138",
  Vb = "_reward_item_completed_dwly3_148",
  Jb = "_reward_item_content_container_dwly3_161",
  ...
  R = {
    ...
    bold: Ub,
    center: Ob,
    claim_button_container: Fb,
    claim_button: Qb,
    no_button: zb,
    info_layout: qb,
    rewards_layout: Lb,
    rewards_grid_container: Hb,
    reward_item: Gb,
    reward_item_completed: Vb,
    reward_item_content_container: Jb,
  ...
  n1 = ({
    ...
    if (r) {
      ...
      return t && (j = `Claim in ${ed(t)}`), h && (j = "Pending transaction..."), e.jsxs("div", {
        className: R.content,
        children: [e.jsx("div", {
  ...
  w1 = "_instruction_container_14ts7_1",
  j1 = "_img_container_14ts7_9",
  b1 = "_image_14ts7_15",
  N1 = "_instruction_text_14ts7_21",
  I1 = "_preview_container_14ts7_26",
  P1 = "_preview_image_container_14ts7_32",
  C1 = "_preview_image_14ts7_32",
  S1 = "_preview_image_loader_14ts7_45",
  T1 = "_template_size_14ts7_60",
  E1 = "_template_title_14ts7_68",
  B1 = "_template_size_container_14ts7_73",
  D1 = "_template_size_item_14ts7_79",
  k1 = "_template_size_item_active_14ts7_87",
  R1 = "_template_coords_14ts7_92",
  M1 = "_template_coordinates_title_14ts7_102",
  U1 = "_template_coords_container_14ts7_107",
  O1 = "_coords_item_14ts7_114",
  F1 = "_coords_input_14ts7_120",
  Q1 = "_file_button_container_14ts7_129",
  z1 = "_file_button_14ts7_129",
  $ = {
    instruction_container: w1,
    img_container: j1,
    image: b1,
    instruction_text: N1,
    preview_container: I1,
    preview_image_container: P1,
    preview_image: C1,
    preview_image_loader: S1,
    template_size: T1,
    template_title: E1,
    template_size_container: B1,
    template_size_item: D1,
    template_size_item_active: k1,
    template_coords: R1,
    template_coordinates_title: M1,
    template_coords_container: U1,
    coords_item: O1,
    coords_input: F1,
    file_button_container: Q1,
    file_button: z1
  },
  Bs = {
    16: 512,
  ...
  H1 = "_template_item_container_srp11_1",
  G1 = "_template_item_inner_srp11_9",
  V1 = "_template_image_srp11_17",
  J1 = "_template_image_info_layout_srp11_24",
  X1 = "_template_image_info_container_srp11_34",
  pn = {
    template_item_container: H1,
    template_item_inner: G1,
    template_image: V1,
    template_image_info_layout: J1,
    template_image_info_container: X1
  },
  _r = ({
    item: t,
    style: n = {}
  ...
  K1 = () => e.jsxs("div", {
    children: [e.jsx(L1, {}), e.jsx(W1, {})]
  }),
  Z1 = "_layout_94gj5_1",
  $1 = "_container_94gj5_5",
    ...
    return m.useEffect(() => (t(Rt.getList({
      ...
      children: [e.jsx("div", {
        ...
        children: a.map(o => {
          ...
          let r = !1;
          return i !== null && Number(i.id) === Number(o.templateId) && (r = !0), e.jsx(_r, {
            item: o,
            current: r
          }, o.templateId)
        })
  ...
  a0 = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === "my" && e.jsx(K1, {}), t === "catalog" && e.jsx(s0, {})]
    })
  },
  i0 = () => {
    const t = g(),
  ...
  o0 = () => e.jsxs(te.Fragment, {
    children: [e.jsx(i0, {}), e.jsx(a0, {})]
  }),
  Xs = "/assets/paintings_anim2-nk1iBB8J.gif",
  r0 = "_container_1h1qc_1",
  c0 = "_divider_1h1qc_19",
  l0 = "_row_1h1qc_24",
  d0 = "_row_title_1h1qc_36",
  u0 = "_row_title_main_1h1qc_40",
  m0 = "_row_hint_1h1qc_45",
  A0 = "_row_value_1h1qc_51",
  p0 = "_row_value_main_1h1qc_55",
  h0 = "_mining_percent_1h1qc_60",
  g0 = "_active_row_1h1qc_70",
  _0 = "_button_1h1qc_81",
  Pi = {
    container: r0,
    divider: c0,
  ...
  x0 = "_layout_2uiqn_1",
  y0 = "_container_2uiqn_6",
  v0 = "_close_button_2uiqn_18",
  w0 = "_title_container_2uiqn_26",
  j0 = "_title_2uiqn_26",
  b0 = "_image_container_2uiqn_37",
  N0 = "_image_2uiqn_37",
  I0 = "_image_placeholder_2uiqn_51",
  P0 = "_info_container_2uiqn_58",
  C0 = "_info_row_2uiqn_64",
  S0 = "_info_title_2uiqn_69",
  T0 = "_info_value_blue_2uiqn_73",
  E0 = "_info_value_white_2uiqn_78",
  B0 = "_buttons_container_2uiqn_82",
  D0 = "_button_2uiqn_82",
  k0 = "_not_button_2uiqn_98",
  R0 = "_button_copy_2uiqn_109",
  ae = {
    layout: x0,
    container: y0,
    close_button: v0,
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Rt.subscribe({
              ...
              t(mg(h)), y.mainImage.worldTemplate.deleteTemplate(o.id), y.mainImage.worldTemplate.add(h), t(Xo())
            } else await t(z({
              id: performance.now(),
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsxs("span", {
            ...
            children: ["Use templates and get more PX ", e.jsx("br", {}), e.jsx(Dn, {
              onPointerUp: n => {
  ...
  z0 = "_id_s1r1v_17",
  q0 = "_title_s1r1v_22",
  L0 = "_avatar_container_s1r1v_28",
  H0 = "_avatar_s1r1v_28",
  G0 = "_squad_avatar_container_s1r1v_40",
  V0 = "_text_container_s1r1v_52",
  J0 = "_dot_s1r1v_58",
  X0 = "_user_name_s1r1v_63",
  Y0 = "_squad_name_s1r1v_69",
  W0 = "_divider_s1r1v_75",
  K0 = "_tabs_content_s1r1v_81",
  Z0 = "_content_info_s1r1v_85",
  $0 = "_content_info_item_s1r1v_92",
  eN = "_content_info_item_title_s1r1v_96",
  tN = "_content_info_item_value_s1r1v_100",
  nN = "_no_content_s1r1v_106",
  sN = "_achievements_container_s1r1v_115",
  Q = {
    container: F0,
    page: Q0,
    id: z0,
    ...
    content_info_item_value: tN,
    no_content: nN,
    achievements_container: sN
  },
  aN = () => {
  ...
  mN = "_container_os5nt_1",
  AN = "_not_completed_os5nt_6",
  pN = "_image_container_os5nt_10",
  hN = "_image_os5nt_10",
  gN = "_bold_os5nt_20",
  _N = "_gray_os5nt_24",
  ...
  yN = "/assets/0-CBlm-5t2.gif",
  vN = "/assets/1-C1eaF-Lh.gif",
  wN = "/assets/2-Dx7l5fvD.gif",
  ...
  DN = ({
    ...
    children: [t === "info" && e.jsx(uN, {
      isPopupContent: n
    }), t === "achievements" && e.jsx(EN, {
      isPopupContent: n
    }), t === "inventory" && e.jsx(BN, {})]
  }),
  kN = ({
    isPopupContent: t = !0
  }) => {
  ...
  UN = () => {
    const t = g(),
      n = c(Ie);
    return m.useEffect(() => (n && n.id && t(kg.getListByUserId({
      userId: n.id
    })), () => {
      t(Eg())
    }), [n]), e.jsx(le, {
  ...
  QN = "_container_12mk9_1",
  zN = "_page_12mk9_13",
  qN = "_id_12mk9_17",
  LN = "_title_12mk9_22",
  HN = "_avatar_container_12mk9_28",
  GN = "_avatar_12mk9_28",
  VN = "_text_container_12mk9_39",
  JN = "_dot_12mk9_45",
  XN = "_user_name_12mk9_50",
  YN = "_squad_slug_12mk9_56",
  WN = "_your_squad_button_12mk9_62",
  KN = "_join_squad_button_12mk9_75",
  ZN = "_red_12mk9_91",
  $N = "_divider_12mk9_95",
  eI = "_tabs_content_12mk9_101",
  tI = "_content_info_12mk9_105",
  nI = "_content_info_item_12mk9_112",
  sI = "_content_info_item_title_12mk9_116",
  aI = "_content_info_item_value_12mk9_120",
  iI = "_content_top_12mk9_127",
  oI = "_content_top_item_12mk9_140",
  rI = "_content_top_item_image_12mk9_150",
  cI = "_content_top_name_12mk9_156",
  ...
  B = {
    ...
    user_name: XN,
    squad_slug: YN,
    your_squad_button: WN,
    join_squad_button: KN,
    red: ZN,
    divider: $N,
    tabs_content: eI,
    content_info: tI,
    content_info_item: nI,
    content_info_item_title: sI,
    content_info_item_value: aI,
    content_top: iI,
    content_top_item: oI,
    content_top_item_image: rI,
    content_top_name: cI,
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Oe.uploadTemplate({
              ...
              const P = await i(Rt.getTemplateById({
                  id: l.id
                })),
                N = {
                  ...P.payload,
              ...
              i(Ag(N)), i(Xo()), await y.mainImage.worldTemplate.add(N), i(z({
                id: performance.now(),
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const P = async () => {
          ...
          let V, q;
          j > 1 ? (V = r, q = r / j) : (q = r, V = r * j);
          const He = (r - V) / 2,
            W = (r - q) / 2;
          N.width = r, N.height = r, f.drawImage(t, He, W, V, q);
          const ge = f.getImageData(0, 0, r, r);
          yI(ge), f.putImageData(ge, 0, 0), a(ge), o(N.toDataURL())
        };
        setTimeout(() => {
          P().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(jI, {}), i !== null && e.jsx(xI, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(q1, {
  ...
  NI = "_general_info_container_1u2nd_1",
  II = "_img_container_1u2nd_7",
  PI = "_image_1u2nd_17",
  CI = "_image_cup_1u2nd_23",
  SI = "_image_glow_container_1u2nd_29",
  TI = "_image_glow_1u2nd_29",
  EI = "_rotate_1u2nd_1",
  BI = "_image_glow_reverse_1u2nd_48",
  DI = "_title_1u2nd_53",
  kI = "_description_container_1u2nd_60",
  RI = "_description_1u2nd_60",
  MI = "_gold_1u2nd_73",
  Qe = {
    general_info_container: NI,
    img_container: II,
    image: PI,
    image_cup: CI,
    image_glow_container: SI,
    image_glow: TI,
    rotate: EI,
    image_glow_reverse: BI,
    title: DI,
    description_container: kI,
    description: RI,
    gold: MI
  },
  UI = "_info_layout_1p9dg_1",
  OI = {
    info_layout: UI
  },
  FI = t => {
  ...
  QI = "_instruction_container_17lvx_1",
  zI = "_img_container_17lvx_9",
  qI = "_img_inner_container_17lvx_16",
  LI = "_image_17lvx_22",
  HI = "_image_status_17lvx_30",
  GI = "_image_status_rejected_17lvx_45",
  VI = "_image_status_review_17lvx_49",
  JI = "_image_status_approved_17lvx_53",
  XI = "_copy_button_container_17lvx_57",
  YI = "_button_copy_17lvx_65",
  WI = "_gray_17lvx_71",
  KI = "_preview_container_17lvx_75",
  ZI = "_preview_image_container_17lvx_81",
  $I = "_preview_image_17lvx_81",
  eP = "_preview_image_loader_17lvx_94",
  tP = "_template_size_17lvx_109",
  nP = "_template_title_17lvx_117",
  sP = "_template_size_container_17lvx_122",
  aP = "_template_size_item_17lvx_128",
  iP = "_template_size_item_active_17lvx_136",
  oP = "_template_coords_17lvx_141",
  rP = "_template_coordinates_title_17lvx_151",
  cP = "_template_coords_container_17lvx_156",
  lP = "_coords_item_17lvx_163",
  dP = "_coords_input_17lvx_169",
  uP = "_file_button_container_17lvx_178",
  mP = "_file_button_17lvx_178",
  ce = {
    instruction_container: QI,
    img_container: zI,
    img_inner_container: qI,
    image: LI,
    image_status: HI,
    image_status_rejected: GI,
    image_status_review: VI,
    image_status_approved: JI,
    copy_button_container: XI,
    button_copy: YI,
    gray: WI,
    preview_container: KI,
    preview_image_container: ZI,
    preview_image: $I,
    preview_image_loader: eP,
    template_size: tP,
    template_title: nP,
    template_size_container: sP,
    template_size_item: aP,
    template_size_item_active: iP,
    template_coords: oP,
    template_coordinates_title: rP,
    template_coords_container: cP,
    coords_item: lP,
    coords_input: dP,
    file_button_container: uP,
    file_button: mP
  },
  Vt = {
    approved: "approved",
    ...
    return m.useEffect(() => {
      if (t !== null) {
        ...
        const P = async () => {
          ...
          N.width = r, N.height = r, f.drawImage(t, He, W, V, q);
          const ge = f.getImageData(0, 0, r, r);
          FI(ge), f.putImageData(ge, 0, 0), a(ge), o(N.toDataURL())
        };
        setTimeout(() => {
          P().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(AP, {}), i !== null && e.jsx(pP, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(hP, {
  ...
  vP = "_button_1c7e5_11",
  wP = "_end_of_list_button_1c7e5_27",
  Ye = {
    layout: fP,
    container: xP,
    button_container: yP,
    button: vP,
    end_of_list_button: wP
  },
  jP = "_template_item_container_pxfff_1",
  bP = "_template_item_inner_pxfff_12",
  NP = "_template_item_picked_pxfff_28",
  IP = "_template_item_shadow_pxfff_43",
  PP = "_template_rank_pxfff_55",
  CP = "_template_recolors_pxfff_75",
  SP = "_template_recolors_pixel_pxfff_90",
  TP = "_template_image_pxfff_97",
  ct = {
    template_item_container: jP,
    template_item_inner: bP,
    template_item_picked: NP,
    template_item_shadow: IP,
    template_rank: PP,
    template_recolors: CP,
  ...
  RP = () => {
    ...
    return m.useEffect(() => (t(ke.getRandomList()), () => {
      ...
      children: [e.jsxs("div", {
        className: Ye.container,
        children: [e.jsx(kP, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(ti, {
          item: i
        }, i.id))]
      }), e.jsx(DP, {})]
    })
  },
  MP = "_round_info_container_1d52c_1",
  UP = "_title_1d52c_7",
  OP = "_description_1d52c_12",
  FP = "_round_status_container_1d52c_17",
  lt = {
    round_info_container: MP,
    title: UP,
    description: OP,
    round_status_container: FP
  },
  QP = "_round_indicator_mgwmo_1",
  zP = "_round_indicator_wait_mgwmo_37",
  Nr = {
    round_indicator: QP,
    round_indicator_wait: zP
  },
  qP = () => e.jsx("div", {
    className: Nr.round_indicator_wait
  }),
  Ir = () => e.jsx("div", {
  ...
  HP = () => {
    ...
    return e.jsxs("div", {
      children: [e.jsx(LP, {}), t && n === A.fulfilled && e.jsx(BP, {}), !t && n === A.fulfilled && e.jsx(RP, {})]
    })
  },
  GP = "_soon_la5q2_1",
  VP = "_active_round_instruction_la5q2_11",
  JP = "_not_active_round_instruction_la5q2_19",
  XP = "_round_container_la5q2_25",
  YP = "_round_title_la5q2_33",
  WP = "_round_title_text_la5q2_38",
  KP = "_round_indicator_la5q2_43",
  ZP = "_round_status_success_la5q2_49",
  $P = "_round_status_fail_la5q2_60",
  eC = "_success_la5q2_71",
  tC = "_fail_la5q2_75",
  nC = "_gray_la5q2_79",
  sC = "_round_main_info_la5q2_83",
  aC = "_round_image_container_la5q2_89",
  iC = "_round_image_la5q2_89",
  oC = "_round_lines_container_la5q2_103",
  rC = "_round_line_la5q2_103",
  cC = "_divider_la5q2_117",
  lC = "_pixels_number_la5q2_124",
  dC = "_pixel_la5q2_124",
  uC = "_past_rounds_la5q2_136",
  mC = "_past_rounds_divider_la5q2_145",
  H = {
    soon: GP,
    active_round_instruction: VP,
    not_active_round_instruction: JP,
    round_container: XP,
    round_title: YP,
    round_title_text: WP,
    round_indicator: KP,
    ...
    gray: nC,
    round_main_info: sC,
    round_image_container: aC,
    round_image: iC,
    round_lines_container: oC,
    round_line: rC,
    divider: cC,
    pixels_number: lC,
    pixel: dC,
    past_rounds: uC,
    past_rounds_divider: mC
  },
  AC = ({
    result: t
  }) => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: M(l ? H.success : H.fail),
              children: ["👑 ", r]
            })]
          }), e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: M(i ? H.success : H.fail),
              children: t.rank
            })]
          }), e.jsxs("div", {
            className: H.round_line,
  ...
  fC = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(gC, {}), e.jsx(_C, {}), e.jsx(pC, {}), e.jsx(hC, {})]
    })
  },
  xC = () => {
  ...
  EC = "_layout_17ca7_1",
  BC = "_container_17ca7_6",
  DC = "_close_button_17ca7_20",
  kC = "_title_container_17ca7_28",
  RC = "_title_17ca7_28",
  MC = "_image_container_17ca7_39",
  UC = "_image_17ca7_39",
  OC = "_image_placeholder_17ca7_53",
  FC = "_info_container_17ca7_60",
  QC = "_info_row_17ca7_66",
  zC = "_info_title_17ca7_71",
  qC = "_info_value_blue_17ca7_75",
  LC = "_info_value_white_17ca7_80",
  HC = "_buttons_container_17ca7_84",
  GC = "_button_17ca7_84",
  VC = "_not_button_17ca7_100",
  JC = "_button_copy_17ca7_111",
  Z = {
    layout: EC,
    container: BC,
    close_button: DC,
  ...
  YC = () => {
    ...
    return c(Fe), !s || !n ? null : Ke.createPortal(e.jsx(Le, {
      onPointerUp: () => t(_i()),
      show: n,
      children: e.jsx("div", {
        className: Z.layout,
  ...
  WC = "_layout_20dlh_1",
  KC = "_container_20dlh_10",
  ZC = "_star_20dlh_14",
  $C = "_star_animation_20dlh_21",
  eS = "_move_20dlh_1",
  ks = {
    layout: WC,
    container: KC,
  ...
  tS = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  nS = ({
    size: t,
    style: n = {},
    animation: s = !1
    ...
    alt: "image",
    src: tS,
    className: s ? ks.star_animation : ks.star,
    style: {
      width: t,
      height: t,
      ...n
  ...
  aS = "_container_tuzgg_1",
  iS = "_column_tuzgg_9",
  oS = "_column_rev_tuzgg_17",
  rS = "_title_tuzgg_26",
  cS = "_table_container_tuzgg_32",
  lS = "_table_row_tuzgg_38",
  dS = "_button_tuzgg_45",
  uS = "_value_tuzgg_52",
  mS = "_notpixel_icon_tuzgg_58",
  AS = "_active_row_tuzgg_74",
  pS = "_row_title_tuzgg_74",
  je = {
    container: aS,
    column: iS,
    column_rev: oS,
    ...
    return e.jsx(sn, {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("img", {
          ...
          children: hS.map((a, i) => e.jsxs("div", {
          ...
          className: je.table_container,
          children: gS.map((a, i) => e.jsxs("div", {
            className: je.table_row,
            children: [e.jsx("div", {
              children: a.name
            }), e.jsxs("div", {
  ...
  yS = () => {
    ...
    return e.jsxs("button", {
      ...
      children: [e.jsx("span", {
        ...
        className: `telegram_icons ${Ci.icon}`,
        children: ""
      })]
    })
  },
  ...
  wS = "_container_qn09x_1",
  jS = "_image_container_qn09x_9",
  bS = "_image_qn09x_9",
  NS = "_title_container_qn09x_18",
  IS = "_text_container_qn09x_27",
  PS = "_title_qn09x_18",
  CS = "_gray_qn09x_39",
  SS = "_bold_qn09x_43",
  TS = "_input_qn09x_47",
  ES = "_catalog_container_qn09x_71",
  BS = "_catalog_title_qn09x_76",
  DS = "_catalog_items_container_qn09x_81",
  kS = "_catalog_item_qn09x_81",
  RS = "_catalog_item_image_container_qn09x_100",
  MS = "_catalog_item_image_qn09x_100",
  US = "_button_container_qn09x_109",
  OS = "_button_qn09x_109",
  FS = "_wrong_helper_text_qn09x_124",
  QS = "_wrong_button_qn09x_129",
  zS = "_wrong_button_text2_qn09x_142",
  S = {
    container: wS,
    image_container: jS,
    image: bS,
    ...
    bold: SS,
    input: TS,
    catalog_container: ES,
    catalog_title: BS,
    catalog_items_container: DS,
    catalog_item: kS,
    catalog_item_image_container: RS,
    catalog_item_image: MS,
    button_container: US,
    button: OS,
    wrong_helper_text: FS,
    wrong_button: QS,
    wrong_button_text2: zS
  },
  qS = "/assets/box_1-CzUKXu07.gif",
  LS = "/assets/box_2-wR9cQS7q.gif",
  HS = "/assets/box_3-g_PL1kKM.gif",
  GS = "/assets/dogs-D0jtZggB.gif",
  VS = "/assets/secret_word-BTKB1fAO.gif",
  JS = "/assets/cube_youtube_2-BqessN1a.gif",
  XS = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif",
  Qn = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
  ...
  YS = () => {
    ...
    return m.useEffect(() => {
      ...
      (async () => {
        ...
        V.status === 200 && V.data && V.data.forEach(q => {
              ...
              try {
                ...
                if (j.status === 200) {
                  ...
                  if (V.secretWord.success) {
                    let q = "Success!";
                    V.secretWord.reward && (q += ` ${V.secretWord.reward} PX earned`), t(z({
                      id: performance.now(),
                      text: q,
                      icon: ""
                    })), t(Mt(V.secretWord.reward || 0));
                    return
                  }
                }
...
const T2 = () => {
    ...
    return m.useEffect(() => {
      const s = () => {
        WS.includes(t.pathname) ? n.push("/") : n.goBack()
      };
  ...
  U2 = "_close_11ui8_23",
  O2 = "_title_11ui8_48",
  F2 = "_frens_count_11ui8_53",
  Q2 = "_body_11ui8_58",
  z2 = "_content_11ui8_68",
  q2 = "_image_container_11ui8_75",
  L2 = "_image_11ui8_75",
  ...
  eT = "_footer_11ui8_136",
  tT = "_button_11ui8_141",
  D = {
    container: k2,
    header: R2,
    close_container: M2,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: D.button,
            onPointerUp: l => {
              l.stopPropagation(), ue(`https://t.me/share/url?url=${i}`), t(ca())
            },
            children: "Share"
          })]
        })]
  ...
  aT = "_container_19qal_1",
  iT = "_header_19qal_9",
  oT = "_close_19qal_19",
  rT = "_title_19qal_31",
  cT = "_body_19qal_36",
  lT = "_image_container_19qal_49",
  dT = "_image_19qal_49",
  uT = "_content_container_19qal_60",
  mT = "_description_container_19qal_68",
  AT = "_description_item_19qal_75",
  pT = "_amount_selector_container_19qal_82",
  hT = "_amount_selector_button_19qal_88",
  gT = "_amount_selector_count_19qal_101",
  _T = "_button_container_19qal_112",
  fT = "_crypto_button_container_19qal_118",
  xT = "_error_19qal_132",
  yT = "_not_available_19qal_139",
  vT = "_button_19qal_112",
  wT = "_star_color_19qal_165",
  jT = "_tokens_selector_19qal_171",
  bT = "_tokens_title_19qal_176",
  NT = "_connect_wallet_text_title_19qal_183",
  IT = "_tokens_container_19qal_192",
  PT = "_token_item_19qal_199",
  CT = "_token_image_container_19qal_210",
  ST = "_token_image_19qal_210",
  TT = "_sale_box_19qal_220",
  ET = "_sale_text_19qal_232",
  X = {
    container: aT,
    header: iT,
    close: oT,
    ...
    image_container: lT,
    image: dT,
    content_container: uT,
    description_container: mT,
    description_item: AT,
    amount_selector_container: pT,
    amount_selector_button: hT,
    amount_selector_count: gT,
    button_container: _T,
    crypto_button_container: fT,
    error: xT,
    not_available: yT,
    button: vT,
    star_color: wT,
    tokens_selector: jT,
    tokens_title: bT,
    connect_wallet_text_title: NT,
    tokens_container: IT,
    token_item: PT,
    token_image_container: CT,
    token_image: ST,
    sale_box: TT,
    sale_text: ET
  },
  ...
  OT = ({
    ...
    const s = g(),
      ...
      [d, u] = m.useState(!1),
      [h, _] = bn(),
      N = (He = c(W => W.shop.products[a]).prices.filter(W => W.currency_id === i)[0]) == null ? void 0 : He.price,
      f = Rs();
    ...
    const V = async W => {
      ...
      await h.sendTransaction(ni), n(!0), u(!0), l(A.fulfilled)
    }, q = async W => {
      const ge = new Ks.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        kr = await new Ks.token.jetton.JettonMinter(ge, {
          address: Ct[i]
        }).getJettonWalletAddress(new Ks.utils.Address(f)),
        Rr = Ve.Address.parse(f),
        Mr = Ve.Address.parse(xa),
        Ur = Ve.beginCell().storeUint(0, 32).storeStringTail(W.txMemCode).endCell(),
        Or = Ve.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(Ve.toNano(W.strAmount)).storeAddress(Mr).storeAddress(Rr).storeBit(0).storeCoins(Ve.toNano("0.01")).storeBit(1).storeRef(Ur).endCell(),
        Fr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
      ...
      await h.sendTransaction(Fr), n(!0), u(!0), l(A.fulfilled)
    };
      ...
      onPointerUp: async W => {
        ...
        if (r !== A.pending) {
          ...
          try {
            ...
            else if (i === 3 || i === 5 || i === 6 || i === 7 || i === 8 || i === 9) await q(ge.data);
  ...
  LT = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(RT, {}), e.jsx(qT, {}), e.jsx(_o, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: X.error,
  ...
  GT = "_container_1rmx4_1",
  VT = "_max_value_1rmx4_9",
  Di = {
    container: GT,
    max_value: VT
  },
...
const JT = () => {
    const t = g(),
      ...
      [o, r] = m.useState([s]),
      [l, d] = m.useState(zn(s).max),
      [u, h] = m.useState(zn(s).step),
      _ = l === 5e3 ? "5000" : `${l}+`,
      P = f => {
        const j = f[0];
        t(Os(ki(j, u))), r([ki(j, u)])
      },
      N = f => {
        const j = f[0];
        j === l && (d(zn(j).max), h(zn(j).step))
      };
  ...
  XT = () => e.jsxs("div", {
    ...
    children: [e.jsx(DT, {}), e.jsxs("div", {
      ...
      children: [e.jsx(kT, {}), e.jsx(HT, {}), e.jsx(JT, {})]
    }), e.jsx(LT, {})]
  }),
  YT = () => {
    ...
    return Ke.createPortal(e.jsx(Le, {
      ...
      children: e.jsxs("div", {
        className: X.container,
        children: [e.jsx(BT, {}), e.jsx(XT, {})]
      })
    }), document.body)
  },
  WT = "_layout_9sf1k_1",
  KT = "_container_9sf1k_13",
  ZT = "_header_9sf1k_20",
  $T = "_title_9sf1k_30",
  eE = "_body_9sf1k_35",
  tE = "_image_container_9sf1k_47",
  nE = "_image_9sf1k_47",
  sE = "_shake_9sf1k_1",
  aE = "_description_container_9sf1k_60",
  iE = "_buyer_info_9sf1k_70",
  oE = "_avatar_9sf1k_78",
  rE = "_name_9sf1k_84",
  cE = "_squad_info_9sf1k_88",
  lE = "_squad_avatar_9sf1k_94",
  dE = "_text_container_9sf1k_100",
  uE = "_text_9sf1k_100",
  mE = "_thanos_snap_container_9sf1k_110",
  AE = "_thanos_snap_text_9sf1k_119",
  pE = "_button_container_9sf1k_126",
...
async function vE() {
  v.enable(v.BLEND), v.blendFunc(v.SRC_ALPHA, v.ONE_MINUS_SRC_ALPHA), v.clearColor(0, 0, 0, 0), v.viewport(0, 0, v.canvas.width, v.canvas.height), be = await wE(v), v.useProgram(be)
}
async function wE(t, n, s) {
  const a = gE,
    i = _E,
    o = Ri(t, a, t.VERTEX_SHADER),
    r = Ri(t, i, t.FRAGMENT_SHADER),
    l = t.createProgram();
...
async function jE(t) {
  bE(), PE(t), Er(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function PE(t) {
  ...
  ws = l * l, $e(v, be, "u_AnimationDuration", Tr), $e(v, be, "u_ParticleSize", fE), $e(v, be, "u_ViewportWidth", n), $e(v, be, "u_ViewportHeight", s), $e(v, be, "u_TextureWidth", a), $e(v, be, "u_TextureHeight", i), $e(v, be, "u_TextureLeft", o), $e(v, be, "u_TextureTop", r);
  const d = new Array(ws);
  for (let _ = 0; _ < ws; _++) d[_] = _;
...
function CE(t) {
  ...
  $e(v, be, "u_ElapsedTime", s), v.drawArrays(v.POINTS, 0, ws), Er()
}
...
const SE = () => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                var r, l;
                y.viewport.viewport.fit(), y.viewport.viewport.moveCenter(y.viewport.viewport.worldWidth / 2, y.viewport.viewport.worldHeight / 2), n(hi(!0)), setTimeout(() => {
                  n(hi(!1))
                }, 7e3);
                try {
                  await xE(i ? 0 : jc)
                ...
                t.push("/"), n(th()), y.mainImage.pixanosRepaint(a.info.seed, E.width, a.info.percentage, a.info.color), (l = (r = window.Telegram.WebApp) == null ? void 0 : r.HapticFeedback) == null || l.notificationOccurred("error")
              },
              children: "Whoosh!"
            })
          })]
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx(Ot, {
            ...
            className: D.button,
            onPointerUp: l => {
              l.stopPropagation(), window.Telegram.WebApp.openLink(`https://t.me/share/url?url=${i}`), n(la())
            },
            children: "Share"
          })]
        })]
  ...
  QE = "_image_1nuac_30",
  zE = "_text_container_1nuac_42",
  qE = "_title_1nuac_49",
  LE = "_button_container_1nuac_55",
  HE = "_button_1nuac_55",
  dt = {
    layout: UE,
    container: OE,
    ...
    return e.jsx(Le, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === ze.userFromPixelInfo && e.jsx(Ta, {
          ...
          isPopupContent: s
        }), n.dataSource === ze.squadFromData && e.jsx(VE, {})]
      })
    })
  },
  XE = "_overlay_1vl8z_1",
  YE = "_top_container_1vl8z_10",
  WE = "_bottom_container_1vl8z_15",
  KE = "_side_menu_1vl8z_20",
  ZE = "_menu_safe_area_inset_1vl8z_36",
  $E = "_menu_header_1vl8z_40",
  eB = "_close_button_1vl8z_53",
  tB = "_menu_list_1vl8z_58",
  nB = "_icon_1vl8z_79",
  sB = "_icon_not_pixel_1vl8z_87",
  aB = "_gold_pixel_1vl8z_97",
  iB = "_menu_list_li_1vl8z_103",
  oB = "_menu_list_text_1vl8z_109",
  rB = "_menu_list_new_item_1vl8z_113",
  cB = "_button_wrapper_1vl8z_136",
  lB = "_button_content_1vl8z_145",
  dB = "_footer_1vl8z_152",
  uB = "_avatar_1vl8z_158",
  mB = "_ratings_image_container_1vl8z_165",
  AB = "_ratings_image_1vl8z_165",
  J = {
    overlay: XE,
    top_container: YE,
    bottom_container: WE,
    side_menu: KE,
    menu_safe_area_inset: ZE,
    menu_header: $E,
    close_button: eB,
    menu_list: tB,
    icon: nB,
    ...
    menu_list_li: iB,
    menu_list_text: oB,
    menu_list_new_item: rB,
    button_wrapper: cB,
    button_content: lB,
    footer: dB,
    avatar: uB,
    ratings_image_container: mB,
    ratings_image: AB
  },
  Mi = [.215, .61, .355, 1],
  pB = {
  ...
  TB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: ["Animation:", " ", n ? e.jsx("span", {
        className: ga.green,
        children: "on"
      }) : e.jsx("span", {
        className: ga.red,
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(xn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(TB, {}), e.jsx(IB, {}), e.jsxs("div", {
...
m.memo(({
  ...
  const [s, a] = m.useState(OB()), [i, o] = m.useState(!1);
  return m.useEffect(() => {
    t && setTimeout(() => {
      o(!0), setTimeout(() => {
        n(!1), o(!1)
...
const FB = "_container_gb8eq_1",
  QB = "_header_gb8eq_11",
  zB = "_title_gb8eq_17",
  qB = "_close_container_gb8eq_23",
  LB = "_close_gb8eq_23",
  HB = "_body_gb8eq_47",
  GB = "_content_gb8eq_59",
  VB = "_time_left_container_gb8eq_65",
  JB = "_timer_gb8eq_69",
  XB = "_image_container_gb8eq_73",
  YB = "_image_gb8eq_73",
  WB = "_glow_container_gb8eq_91",
  KB = "_glow_gb8eq_91",
  ZB = "_rotate_gb8eq_1",
  $B = "_glow_reverse_gb8eq_107",
  eD = "_description_container_gb8eq_113",
  tD = "_bold_gb8eq_123",
  nD = "_gray_gb8eq_128",
  sD = "_center_gb8eq_132",
  aD = "_gold_gb8eq_136",
  iD = "_button_gb8eq_144",
  _e = {
    container: FB,
    header: QB,
    title: zB,
  ...
  oD = "/assets/cup_glad-DGT2PBmm.png",
  rD = () => {
    const t = K(),
      n = c(Ie),
      [s, a] = m.useState(!1),
  ...
  uD = "_close_xga4i_25",
  mD = "_body_xga4i_38",
  AD = "_image_container_xga4i_42",
  pD = "_image_xga4i_42",
  hD = "_glow_xga4i_55",
  gD = "_forward_xga4i_62",
  _D = "_rotate_xga4i_1",
  fD = "_reverse_xga4i_66",
  xD = "_text_container_xga4i_70",
  yD = "_title_xga4i_78",
  vD = "_description_xga4i_82",
  wD = "_footer_xga4i_86",
  jD = "_button_xga4i_90",
  fe = {
    layout: cD,
...
const TD = "_layout_15tw0_1",
  ED = "_container_15tw0_7",
  BD = "_close_button_15tw0_16",
  DD = "_title_container_15tw0_24",
  kD = "_image_container_15tw0_31",
  RD = "_image_15tw0_31",
  MD = "_text_container_15tw0_50",
  UD = "_button_container_15tw0_56",
  Ze = {
    layout: TD,
    container: ED,
    close_button: BD,
  ...
  FD = () => e.jsxs("div", {
    className: hn.layout,
    children: [e.jsx(D2, {}), e.jsx(S2, {}), e.jsx(S_, {}), e.jsx(KS, {}), e.jsx(T2, {}), e.jsx(EE, {}), e.jsx(GE, {}), e.jsx(JE, {}), e.jsx(sT, {}), e.jsx(TE, {}), e.jsx(rD, {}), e.jsx(SD, {}), e.jsx(OD, {}), e.jsx(YT, {}), e.jsx(SE, {}), e.jsx(ME, {}), e.jsx(EB, {})]
  }),
  QD = () => {
    const t = g(),
    ...
    return m.useEffect(() => {
      ...
      const a = setInterval(() => {
        Date.now() - n > 30 * 60 * 1e3 && (t(Zp()), clearInterval(a))
      }, 100);
      return () => {
        clearInterval(a)
      }
  ...
  LD = "_layout_ieygs_1",
  HD = "_container_ieygs_8",
  GD = "_logo_container_ieygs_17",
  VD = "_logo_ieygs_17",
  JD = "_animate_ieygs_1",
  XD = "_center_ieygs_37",
  YD = "_title_ieygs_51",
  WD = "_description_ieygs_58",
  KD = "_button_container_ieygs_63",
  ZD = "_button_ieygs_63",
  $D = "_b_ieygs_63",
  Pt = {
    layout: LD,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("button", {
            className: Pt.button,
            onPointerUp: () => {
              t ? ue("https://t.me/notpixel_channel") : tn("https://t.me/notpixel_channel")
            },
            children: "Not Pixel Channel"
          })
        })]
  ...
  tk = "/assets/loading-D8SQALTR.gif",
  nk = () => e.jsxs("div", {
  ...
  sk = () => {
    ...
    m.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(Gp(s)), t(za(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(xu(s))
      })
    }, [t])
  ...
  ik = () => {
    const t = K();
    m.useEffect(() => {
      Ua() ? localStorage.getItem("skipIntro") || (t.push("/welcome"), localStorage.setItem("skipIntro", "true")) : an.get("skipIntro", (n, s) => {
  ...
  uk = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Ic) && qD(), sk(), ak(), ik(), a || o ? e.jsx(ek, {}) : i ? e.jsx(nk, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
Sc(Bn);
Xp(Bn);
const _k = qr.createRoot(document.getElementById("root"));
_k.render(e.jsx(te.StrictMode, {
  children: e.jsx(Vr, {
    store: Bn,
    children: e.jsx(tc, {
      children: e.jsx(Yr, {
