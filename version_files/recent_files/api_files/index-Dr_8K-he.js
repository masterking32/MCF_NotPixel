...
const Qr = "_stars_img_container_1wci0_1",
  ...
  Yr = "_info_container_1wci0_52",
  Xr = "_info_row_1wci0_59",
...
const vc = {
  ...
  kn = q("shop/getProducts", async () => (await Y.getProducts()).data),
  ...
  Gc = (t, n) => n < 5 ? Et[1] : n < 10 ? Et[5] : n < 100 ? Et[10] : n < 500 ? Et[100] : n < 1e3 ? Et[500] : Et[1e3],
  Bt = {
    1: Ic,
    5: Cc,
    10: Pc,
  ...
  Gi = (t, n) => Xs[t] ? Xs[t](t, n) : Xs.default(),
  Wc = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  Jt = async t => {
  ...
  }, ha = t => !0, Ol = "_layout_13e1w_1", Ql = "_container_13e1w_10", zl = "_star_13e1w_14", Ll = "_move_13e1w_1", In = {
    layout: Ol,
    container: Ql,
    star: zl,
    move: Ll
  }, ql = "_link_1fn8i_1", Gl = "_telegram_icons_1fn8i_13", Xi = {
    link: ql,
    telegram_icons: Gl
  }, C = ({
    children: t,
  ...
  }, () => !1), Jl = "_layout_1nbfl_1", Vl = "_button_1nbfl_14", Wa = {
    layout: Jl,
    button: Vl
  }, Yl = () => {
    const t = K();
  ...
  }, Xl = "_layout_gx8in_1", Wl = "_container_gx8in_5", Kl = "_item_gx8in_11", Zl = "_active_gx8in_20", $l = "_image_container_gx8in_24", ed = "_image_gx8in_24", td = "_item_text_container_gx8in_34", nd = "_item_text_gx8in_34", it = {
    layout: Xl,
    container: Wl,
    item: Kl,
    active: Zl,
    ...
    offset: t,
    limit: n
  })).data), Fn = q("user/getPixelsForSaleTotal", async () => (await Y.getUserPixelsCount()).data), On = q("user/getUserPixelsSold", async ({
    offset: t,
    limit: n
    ...
    setPixelsSoldOffset: Qk,
    setPixelsSoldTotal: zk,
    setPixelsSoldFetchStatus: Lk,
    removePixelsSold: qk,
    addPixelCoins: ht,
  ...
  }, dd = t => t.user.userPic, Ee = t => t.user.user, ud = Wi.reducer, Nt = {
    getPixelsForSale: Un,
    ...
    logo_container: Ud
  }, Od = "_layout_1cvcu_1", Qd = "_container_1cvcu_10", zd = "_bubble_1cvcu_16", Ld = "_move_1cvcu_1", Ks = {
    layout: Od,
    container: Qd,
    bubble: zd,
    move: Ld
  ...
  }, () => !1), Gd = "_container_1aw3i_1", Hd = "_logo_1aw3i_9", Jd = "_animate_1aw3i_1", Vd = "_center_1aw3i_18", Yd = "_glow_1aw3i_28", Pn = {
    container: Gd,
    logo: Hd,
    animate: Jd,
    center: Vd,
...
const zn = q("mining/info", async () => (await Es.info()).data),
    ...
    return u.useEffect(() => {
      ...
      children: e.jsxs("button", {
        ...
        onPointerUp: async () => {
          var m, h;
          try {
            const g = await a(je.claim()).unwrap();
  ...
  Ou = "_image_bt2qf_83",
  Qu = "_row_main_information_bt2qf_103",
  ...
  fm = () => {
    const t = f(),
      ...
      m = async () => {
        if (i || !o) return;
        r && await a.disconnect(), a.setConnectRequestParameters({
          state: "loading"
        });
    ...
    return u.useEffect(() => {
      ...
      !o || d !== p.fulfilled || r && (i || ((h = r == null ? void 0 : r.connectItems) != null && h.tonProof && !("error" in r.connectItems.tonProof) ? Y.checkTonProof(r.connectItems.tonProof.proof, r.account).then(g => {
        g.status === 200 && g.data.success ? t(je.checkTask({
          key: n,
          reward: l
        })) : (t(L({
          id: performance.now(),
          text: "Wallet disconnected. Try later, or another wallet."
        })), a.disconnect())
      }) : (t(L({
        id: performance.now(),
...
const ni = () => {
  ...
  Om = () => {
    ...
    }, []), !Fm || h || s !== "mobile" || o === !1 ? null : e.jsxs(ne, {
      enableCheck: !1,
      action: () => {
        d === 0 && n.show().then(b => {
          t(ht(I)), t(L({
  ...
  Xm = () => {
    ...
    const n = c(r => r.mining.tasks[t]),
      ...
      o = 512;
    return !s || Hm.hasOwnProperty(s) || Jm.hasOwnProperty(i) || !Ym && !n ? null : e.jsx(ne, {
      action: () => {
  ...
  tA = () => {
    ...
    return c(s => s.user.country), !eA && !n && !Oe.isDev, null
  },
  nA = () => e.jsxs("div", {
    className: A.info_container,
    children: [e.jsx(Om, {}), e.jsx(Xm, {}), e.jsx(tA, {}), e.jsx(Zm, {}), e.jsx(Km, {}), e.jsx(am, {}), e.jsx($s, {
      text: "Quick start"
    }), e.jsx(om, {}), e.jsx(cm, {}), e.jsx(dm, {}), e.jsx($s, {
      text: "Special"
    }), e.jsx(fm, {}), e.jsx(zm, {}), e.jsx(qm, {}), e.jsx(Dm, {}), e.jsx(bm, {}), e.jsx(wm, {}), e.jsx(em, {}), e.jsx(um, {}), e.jsx(mm, {}), e.jsx(Am, {}), e.jsx(gm, {}), e.jsx($s, {
      text: "Browser"
  ...
  iA = "_container_7jsmf_1",
  oA = "_row_7jsmf_6",
  rA = "_cell1_7jsmf_26",
  cA = "_cell2_7jsmf_30",
  lA = "_cell3_7jsmf_36",
  dA = "_icon_arrow_7jsmf_40",
  uA = "_header_7jsmf_47",
  mA = "_data_7jsmf_57",
  AA = "_title_7jsmf_63",
  pA = "_pixelColor_7jsmf_68",
  hA = "_pixelCoords_7jsmf_77",
  gA = "_pixelPriceValue_7jsmf_83",
  _A = "_pixelPriceDescription_7jsmf_91",
  fA = "_pixelState_7jsmf_95",
  xA = "_pixelDate_7jsmf_100",
  yA = "_paginationContainer_7jsmf_107",
  vA = "_loadMoreButton_7jsmf_114",
  wA = "_noPixelsContainer_7jsmf_136",
  jA = "_noPixelsText_7jsmf_143",
  bA = "_pixelsForSaleCountText_7jsmf_149",
  NA = "_skeleton_container_7jsmf_153",
  IA = "_skeleton_header_7jsmf_157",
  CA = "_skeleton_row_7jsmf_166",
  $ = {
    container: iA,
    row: oA,
    cell1: rA,
    ...
    pixelCoords: hA,
    pixelPriceValue: gA,
    pixelPriceDescription: _A,
    pixelState: fA,
    pixelDate: xA,
    paginationContainer: yA,
    loadMoreButton: vA,
    noPixelsContainer: wA,
    noPixelsText: jA,
    pixelsForSaleCountText: bA,
    skeleton_container: NA,
    skeleton_header: IA,
    skeleton_row: CA
  },
  ka = _s.getSelectors(t => t.user.pixelsForSale);
fs.getSelectors(t => t.user.pixelsSold);
const lo = xs.getSelectors(t => t.daily.list);
Ba.getSelectors(t => t.reward.list);
const PA = an.getSelectors(t => t.tournament.approvedTemplatesList),
  SA = () => {
...
const _a = q("canvas/getPixelInfo", async ({
  ...
  Vn = q("canvas/getPrices", async () => (await Y.getPrices()).data),
...
let ap = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [HA, JA, VA, YA, XA, WA, KA, ZA, $A, ep, tp, np, sp], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
...
const ip = "_order_panel_1ley0_1",
  op = "_content_1ley0_12",
  rp = "_fast_mode_blocker_1ley0_25",
  cp = "_info_1ley0_38",
  lp = "_active_color_1ley0_47",
  dp = "_pixel_info_container_1ley0_57",
  up = "_pixel_info_color_1ley0_65",
  mp = "_pixel_info_text_1ley0_71",
  Ap = "_info_button_1ley0_77",
  pp = "_info_button_active_1ley0_94",
  hp = "_price_value_1ley0_98",
  gp = "_pixel_locked_text_1ley0_104",
  _p = "_pixel_locked_text_painted_1ley0_115",
  fp = "_pixel_locked_animation_1ley0_137",
  xp = "_button_1ley0_143",
  yp = "_button_text_1ley0_167",
  vp = "_flash_mode_button_text_1ley0_180",
  wp = "_not_pixel_icon_1ley0_191",
  jp = "_tg_logo_1ley0_195",
  bp = "_image_1ley0_200",
  Np = "_inner_wrapper_button_1ley0_205",
  se = {
    order_panel: ip,
    content: op,
    ...
    info: cp,
    active_color: lp,
    pixel_info_container: dp,
    pixel_info_color: up,
    pixel_info_text: mp,
    info_button: Ap,
    info_button_active: pp,
    price_value: hp,
    pixel_locked_text: gp,
    pixel_locked_text_painted: _p,
...
const Bp = (t, n) => {
    ...
    ha() && (s = {
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          ...
          l.user.userId === n || !un || (r.type === Hs.bomb && w.mainImage.bomb.boomWithDebounce(ys(l.info.pixelId)), r.type === Hs.pumpkin && w.mainImage.pumpkin.boomWithDebounce(ys(l.info.pixelId)), r.type === Hs.pixanos && vt.dispatch(vo(l)))
        });
        return
      }
      ...
      Rr(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === Tp[1] && vt.getState().daily.list.entities[d.good_id]) {
  ...
  Gp = "_layout_oxfjd_1",
  Hp = "_container_oxfjd_7",
  Jp = "_placeholder_oxfjd_20",
  Vp = "_progress_oxfjd_24",
  Yp = "_counter_oxfjd_32",
  Xp = "_counter_max_text_oxfjd_45",
  kt = {
    layout: Gp,
    container: Hp,
    placeholder: Jp,
  ...
  eh = () => {
    ...
    return u.useEffect(() => {
      ...
      children: [e.jsx(Wp, {}), e.jsx($p, {
        progress: d
      })]
    })
  },
  th = "_layout_mp208_1",
  nh = "_container_mp208_21",
  sh = "_buttons_container_mp208_27",
  ah = "_button_mp208_27",
  ih = "_shop_button_mp208_44",
  oh = "_container__bottom_mp208_49",
  rh = "_fast_type_button_mp208_49",
  ch = "_disabled_button_cover_mp208_61",
  lh = "_fast_mode_button_enabled_mp208_71",
  dh = "_available_mp208_81",
  uh = "_limited_good_timer_mp208_98",
  mh = "_disabled_available_cover_mp208_119",
  Ah = "_button_image_mp208_129",
  P = {
    layout: th,
    container: nh,
    buttons_container: sh,
    button: ah,
    shop_button: ih,
    container__bottom: oh,
    fast_type_button: rh,
    disabled_button_cover: ch,
    fast_mode_button_enabled: lh,
    available: dh,
    limited_good_timer: uh,
    disabled_available_cover: mh,
    button_image: Ah
  },
  ph = "_number_179d2_1",
  hh = "_layout_179d2_6",
  gh = "_viewer_179d2_14",
  _h = "_container_179d2_18",
  fh = "_digit_179d2_25",
  xh = {
    number: ph,
    layout: hh,
...
const Th = async ({
  ...
  setShowSideMenu: bt
} = Co.actions, Po = t => t.layout.isShowSideMenu, Dh = Co.reducer;
let Rt = null,
  Mt = null;
class So {
...
const Fa = {
  ...
  gt = pn();
gt.startListening({
  matcher: Se(je.info.fulfilled),
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(id(t.payload.totalUserPixels)), n.dispatch(Zi(t.payload.userBalance))), n.dispatch(wc(t.payload.goods))
  }
});
gt.startListening({
  matcher: Se(je.checkTask.fulfilled),
  effect: (t, n) => {
...
gt.startListening({
  matcher: Se(je.checkBoost.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s];
    let i = "Not enough PX",
  ...
  effect: (t, n) => {
    ...
    if (o) {
      if (i === ue.energyLimit) {
        ...
        n.dispatch(su(s.mining.maxCharges + d)), n.dispatch(so(d))
      }
...
gt.startListening({
  matcher: Se(je.checkTask.rejected),
  effect: (t, n) => {
    n.dispatch(L({
      id: performance.now(),
      text: "Check failed",
...
gt.startListening({
  matcher: Se(je.checkBoost.rejected),
  effect: (t, n) => {
    n.dispatch(L({
      id: performance.now(),
      text: "Not enough PX",
...
const Rs = pn();
Rs.startListening({
  matcher: Se(Bs.getPriceMask.pending, Nt.getPixelsForSale.pending, Nt.getPixelsSold.pending, Fa.get.pending),
  effect: (t, n) => {
    n.dispatch(tt({
      command: Ce.start
    }))
...
Rs.startListening({
  matcher: Se(Bs.getPriceMask.fulfilled, Nt.getPixelsForSale.fulfilled, Nt.getPixelsSold.fulfilled, Fa.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(tt({
      command: Ce.finish
    }))
...
const Do = pn();
Do.startListening({
  matcher: Se(Nt.getUser.fulfilled),
  effect: (t, n) => {
...
const zh = "/assets/halloween2-l9FmXxVI.png",
  ...
  }),
  {
    ...
    setReferredTemplate: Jh,
    setMyTemplate: Uo,
    setTemplateListOffset: n4,
  ...
  ns = q("daily/getList", async () => (await Y.getDailyList()).data),
  ss = q("daily/getFirstDaily", async () => (await Y.getFirstDaily()).data),
  Oo = me({
    name: "daily",
    initialState: Xh,
    reducers: {
  ...
  Qo = t => t ? t.friends >= uc.friendsForTemplateCreation || t.isContractor : !1,
  Ge = {
    create: "create",
    main: "main",
    result: "result"
  ...
  ag = () => localStorage.getItem("selectedTemplate") ? JSON.parse(localStorage.getItem("selectedTemplate")) : null,
  ig = {
    activeTab: Ge.main,
  ...
  }),
  {
    ...
    setMyTournamentTemplate: a4,
    clearApprovedTemplateList: og,
    showTournamentTemplateInfoPopup: qo,
    closeTournamentTemplateInfoPopup: ii,
    setSelectedTemplate: rg
  } = zo.actions,
  Us = {
    getMyTemplate: as,
  ...
  _g = async ({
    ...
    await t(Fp({
      ...
      id: nt(s),
      color: jt(a)
    }), w.mainImage.updateTexture(), await t(Cp(a)), await t(OA(s)), await t(ru());
    ...
    try {
      const r = await o;
      r.status === 200 && (r.data.reward_user && r.data.reward_user.reward_id && (w.mainImage.reward.add(s), t(dg({
        rewardId: r.data.reward_user.reward_id,
        rewardUserId: r.data.reward_user.id
      }))), t(Zi(r.data.balance)))
    } catch (r) {
      console.log(r, r.response.data.code === 16), r.response.data.code === 16 && t(je.info())
    }
  }, fg = ({
    history: t,
    dispatch: n,
...
let Xg = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [Pg, Sg, Tg, Eg, Bg, Dg, kg, Rg, Mg, Ug, Fg, Og, Qg, zg, Lg, qg, Gg, Hg, Jg, Vg], this.textureArray = [];
...
class e_ {
  ...
  addBackdrop() {
    this.backdrop = new PIXI.Graphics, this.backdrop.beginFill(0, .8), this.backdrop.drawRect(0, 0, B.width, B.height), this.backdrop.endFill(), this.backdrop.zIndex = 20, this.backdrop.interactive = !0, setTimeout(() => {
      this.backdrop.on("pointerup", n => {
        ...
        s(Ag()), this.viewport.unlock(), this.destroy()
      })
  ...
  async addRewardImage(n) {
    PIXI.Loader.shared.resources.tnt || await this.loadResource("tnt", $g), this.image = new PIXI.Sprite(PIXI.Loader.shared.resources.tnt.texture), this.image.zIndex = 21, this.image.width = 1, this.image.height = 1, this.image.x = n.x, this.image.y = n.y, this.pixiViewport.addChild(this.image)
  }
...
class t_ {
  constructor({
    ...
    this.app = n, this.ticker = i, this.viewport = s, this.store = a, this.pixiViewport = s.viewport, this.selectedPixel = new LA({
      viewport: s
    }), this.template = new yg({
      app: n,
      viewport: s,
      store: a
    }), this.worldTemplate = new vg({
      app: n,
      viewport: s,
      store: a,
      mainImage: this
...
const a_ = () => localStorage.getItem("canvasFps") ? Number(localStorage.getItem("canvasFps")) : 60;
class i_ {
  constructor({
    app: n
  }) {
    this.app = n, this.lastTime = Date.now(), this.lastRenderTime = Date.now(), this.fps = a_(), this.callbacks = [], this.render()
  }
  render(n = 0) {
    const s = Date.now(),
      a = s - this.lastTime;
...
class r_ {
  constructor({
    ...
    }), this.app.ticker.stop(), this.ticker = new i_({
      app: this.app
    }), this.viewport = new s_({
      app: this.app,
      store: ba
    }), this.mainImage = new t_({
      app: this.app,
...
const l_ = u.memo(() => (u.useEffect(() => {
    oi || (c_(), oi = !0)
  }, []), Ye.createPortal(e.jsx("canvas", {
    id: "canvasHolder",
    className: `${UA.main_canvas}`
  }), document.body)), () => !0),
  d_ = ({
    children: t,
    coords: n,
  ...
  m_ = () => c(ka.selectAll).map(n => e.jsx(u_, {
    item: n
  }, nt({
    x: n.x,
    y: n.y
  ...
  h_ = () => {
    ...
    return c(s => s.user.pixelsForSaleFetchStatus) === p.pending && t === 0 ? e.jsx(p_, {}) : t !== 0 ? e.jsxs(EA, {
      children: [e.jsx(m_, {}), e.jsx(A_, {})]
    }) : null
  },
  g_ = () => {
    const t = f();
    return aA(), u.useEffect(() => () => {
      t(rd()), t(Ki({
        offset: 0
      })), t(od({
        status: p.idle
      ...
      children: [e.jsx(SA, {}), e.jsx(h_, {})]
    })
  },
  __ = "_layout_v8prs_1",
  f_ = "_group_title_container_v8prs_7",
  x_ = "_group_title_v8prs_7",
  y_ = "_group_v8prs_7",
  us = {
    layout: __,
    group_title_container: f_,
    group_title: x_,
    group: y_
  },
  v_ = ({
  ...
  w_ = "_boost_item_8sbvi_1",
  j_ = "_image_container_8sbvi_10",
  b_ = "_image_8sbvi_10",
  N_ = "_content_container_8sbvi_21",
  I_ = "_content_8sbvi_21",
  C_ = "_item_title_container_8sbvi_33",
  P_ = "_item_reward_container_8sbvi_40",
  S_ = "_price_text_8sbvi_45",
  T_ = "_dot_8sbvi_49",
  E_ = "_level_text_8sbvi_53",
  ...
  Ne = {
    ...
    image_container: j_,
    image: b_,
    content_container: N_,
    content: I_,
    item_title_container: C_,
  ...
  R_ = () => {
    const {
      t
    } = Te(), n = ue.paintReward, s = c(m => m.main.settings.UpgradeRepaint), a = c(m => m.mining.boosts[n]), {
      repaintReward: i
  ...
  M_ = () => {
    const {
      t
    } = Te(), n = ue.reChargeSpeed, s = c(m => m.main.settings.UpgradeChargeRestoration), a = c(m => m.mining.boosts[n]), {
      restorationSpeed: i
    } = c(Yt), o = a >= i, r = Math.min(i, a + 1), l = Math.min(i, a), d = s == null ? void 0 : s.levels[r];
    return e.jsxs(Qa, {
      boost: n,
  ...
  U_ = () => {
    const {
      t
    } = Te(), n = ue.energyLimit, s = c(m => m.main.settings.UpgradeChargeCount), a = c(m => m.mining.boosts[n]), {
      chargesCount: i
    } = c(Yt), o = a >= i, r = Math.min(i, a + 1), l = Math.min(i, a), d = s == null ? void 0 : s.levels[r];
    return e.jsxs(Qa, {
      boost: n,
  ...
  F_ = "_container_1e12r_1",
  O_ = "_title_container_1e12r_8",
  Q_ = "_description_1_1e12r_19",
  z_ = "_description_2_1e12r_27",
  L_ = "_description_container_1e12r_35",
  ...
  X_ = () => {
    const {
      t
    } = Te(), n = ue.paintReward, s = c(d => d.main.settings.UpgradeRepaint), a = c(d => d.mining.boosts[n]), {
      repaintReward: i
  ...
  W_ = () => {
    const {
      t
    } = Te(), n = ue.reChargeSpeed, s = c(d => d.main.settings.UpgradeChargeRestoration), a = c(d => d.mining.boosts[n]), {
      restorationSpeed: i
    } = c(Yt), o = Math.min(i, a + 1), r = (s == null ? void 0 : s.levels[a]) || {
      ChargeBoost: 6e5
    }, l = s == null ? void 0 : s.levels[o];
    return l.ChargeBoost - (r == null ? void 0 : r.ChargeBoost), e.jsxs(Ga, {
      price: l.Price,
      boost: n,
      children: [e.jsxs("div", {
        className: ae.title_container,
  ...
  K_ = () => {
    const {
      t
    } = Te(), n = ue.energyLimit, s = c(d => d.main.settings.UpgradeChargeCount), a = c(d => d.mining.boosts[n]), {
      chargesCount: i
  ...
  Z_ = () => {
    ...
    return e.jsxs(xn, {
      show: n,
      setShow: a,
      children: [s === ue.paintReward && e.jsx(X_, {}), s === ue.reChargeSpeed && e.jsx(W_, {}), s === ue.energyLimit && e.jsx(K_, {})]
    })
  },
  $_ = () => e.jsxs("div", {
    className: us.layout,
    children: [e.jsxs(v_, {
      title: "Boosters",
      children: [e.jsx(R_, {}), e.jsx(M_, {}), e.jsx(U_, {})]
    }), e.jsx(Z_, {}), e.jsx("div", {
      style: {
        height: "20px"
      }
  ...
  ef = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(sA, {}), t === "tasks" && e.jsx(nA, {}), t === "pixels" && e.jsx(g_, {}), t === "boosts" && e.jsx($_, {})]
    })
  },
  tf = () => {
    const t = f(),
  ...
  nf = () => e.jsxs(ie.Fragment, {
    children: [e.jsx(tf, {}), e.jsx(ef, {})]
  }),
  ...
  Nn = ({
    ...
    className: af.more_details,
    ...n,
    children: e.jsx("span", {
      children: t
    })
  }),
  of = "_container_1h1qc_1",
  rf = "_divider_1h1qc_19",
  cf = "_row_1h1qc_24",
  lf = "_row_title_1h1qc_36",
  df = "_row_title_main_1h1qc_40",
  uf = "_row_hint_1h1qc_45",
  mf = "_row_value_1h1qc_51",
  Af = "_row_value_main_1h1qc_55",
  pf = "_mining_percent_1h1qc_60",
  hf = "_active_row_1h1qc_70",
  gf = "_button_1h1qc_81",
  ri = {
    container: of,
    divider: rf,
  ...
  xf = "_squads_img_container_zthsq_1",
  yf = "_squads_img_zthsq_1",
  vf = "_title_container_zthsq_11",
  wf = "_description_container_zthsq_18",
  jf = "_description_zthsq_18",
  bf = "_info_layout_zthsq_31",
  Nf = "_info_container_zthsq_42",
  If = "_base_item_zthsq_49",
  Cf = "_loading_item_zthsq_60",
  Pf = "_rating_item_zthsq_69",
  Sf = "_info_row_zthsq_82",
  Tf = "_avatar_container_zthsq_87",
  Ef = "_avatar_zthsq_87",
  Bf = "_position_zthsq_99",
  Df = "_user_squad_position_zthsq_117",
  kf = "_rating_main_info_zthsq_135",
  Rf = "_rating_name_zthsq_148",
  Mf = "_rating_value_zthsq_155",
  Uf = "_active_league_text_zthsq_163",
  Ff = "_icon_leagueflag_zthsq_167",
  Of = "_join_squad_button_zthsq_174",
  Qf = "_join_squad_text_zthsq_188",
  zf = "_user_squad_container_zthsq_206",
  Lf = "_squad_avatar_container_zthsq_223",
  qf = "_user_squad_info_zthsq_234",
  Gf = "_user_squad_name_zthsq_242",
  Hf = "_user_squad_your_squad_text_zthsq_246",
  Jf = "_user_squad_users_count_zthsq_251",
  O = {
    squads_img_container: xf,
    squads_img: yf,
    title_container: vf,
    ...
    avatar: Ef,
    position: Bf,
    user_squad_position: Df,
    rating_main_info: kf,
    rating_name: Rf,
    rating_value: Mf,
    active_league_text: Uf,
    icon_leagueflag: Ff,
    join_squad_button: Of,
    join_squad_text: Qf,
  ...
  ex = () => {
    ...
    return u.useEffect(() => {
      ...
      children: [e.jsx($f, {}), n.map((i, o) => e.jsx(Zf, {
        item: i,
        index: o
      }, o))]
    })
  },
  tx = () => (u.useState("Day"), null),
  nx = ({
    children: t
  }) => e.jsx("div", {
  ...
  cx = () => {
    ...
    return u.useEffect(() => {
      ...
      children: [e.jsx(ax, {}), e.jsx(ix, {}), e.jsx(rx, {})]
    })
  },
  lx = () => e.jsx(ie.Fragment, {
  ...
  Ax = () => (c(t => t.ratings.league), c($i), c(bo), e.jsx("div", {
    className: ux.container,
    children: e.jsx(mx, {})
  })),
  ...
  _x = "/assets/icon_squad-_NF17RUb.gif",
  fx = "/assets/icon_squad_secret-B-fF264Z.gif",
  xx = () => {
  ...
  yx = () => {
    ...
    return e.jsxs(ce, {
      children: [e.jsx(xx, {}), e.jsx(Kf, {
        selectedSection: t,
        setSelectedSection: n
      }), e.jsx(sx, {}), e.jsx(Vf, {
        isPlayers: t === "Painters"
      }), e.jsxs(nx, {
        children: [t === "Painters" && e.jsx(Ax, {}), t === "Squads" && e.jsx(gx, {}), t === "Squads" && e.jsx(cx, {}), t === "Painters" && e.jsx(ex, {}), s !== p.fulfilled && e.jsx(lx, {})]
      })]
    })
  },
  vx = ({
  ...
  bx = "_expandable_panel_layout_1v9vd_1",
  Nx = "_expandable_panel_1v9vd_1",
  Ix = "_divider_1v9vd_16",
  Cx = "_divider_spacer_1v9vd_24",
  Px = "_divider_pointer_1v9vd_28",
  rn = {
    expandable_panel_layout: bx,
    expandable_panel: Nx,
    divider: Ix,
    divider_spacer: Cx,
    divider_pointer: Px
  ...
  Ex = "_container_1vu8i_1",
  Bx = "_owner_1vu8i_10",
  Dx = "_id_1vu8i_14",
  kx = "_date_1vu8i_19",
  Rx = "_avatar_container_1vu8i_24",
  Mx = "_avatar_1vu8i_24",
  Ux = "_squad_avatar_container_1vu8i_36",
  Fx = "_text_container_1vu8i_48",
  Ox = "_dot_1vu8i_54",
  Qx = "_user_name_1vu8i_59",
  ...
  Os = ({
    ...
    return n > 0 && (i = gn(i, n)), e.jsx("span", {
      className: Xi.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? de(`https://t.me/${Xa(t)}`) : Ht(`https://t.me/${Xa(t)}`)
      },
      children: i
    })
  },
  ...
  Wx = () => e.jsxs("div", {
    ...
    children: [e.jsx(Xx, {}), e.jsx(Hx, {}), e.jsx(Yx, {}), e.jsx(Jx, {}), e.jsx(Vx, {})]
  }),
  Kx = "_category_text_epppt_1",
  Zx = "_latest_used_container_epppt_8",
  $x = "_color_line_epppt_15",
  ey = "_color_item_epppt_22",
  ty = "_pipette_container_epppt_30",
  ny = "_child_scale_epppt_48",
  Zo = {
    category_text: Kx,
    latest_used_container: Zx,
    color_line: $x,
    color_item: ey,
    pipette_container: ty,
    child_scale: ny
  },
  sy = ({
    color: t
  ...
  ay = ({
    ...
    children: t.map((n, s) => e.jsx(sy, {
      color: n
    }, `${n}_${s}`))
  }),
  iy = "_unlock_button_fc8qr_1",
  ...
  dy = ({
    ...
    return u.useEffect(() => {
      ...
      children: [e.jsx(ly, {
        ...
        children: [e.jsx(Sx, {
          active: s
        }), s === 1 && e.jsx(cy, {}), s === 2 && e.jsx(Wx, {})]
      })]
    })
  },
  uy = () => c(De) ? null : e.jsxs("button", {
    className: se.button,
    onPointerUp: () => {
  ...
  gy = () => c(n => n.canvas.coords) === null ? null : e.jsx(ie.Fragment, {
    children: e.jsx(hy, {})
  }),
  _y = "_layout_14eqc_1",
  fy = "_container_14eqc_9",
  xy = "_button_14eqc_13",
  ca = {
    layout: _y,
    container: fy,
  ...
  My = ({
    ...
    return u.useEffect(() => {
      ...
      children: ["+", t.isExtraReward ? lc + s : 0, " ", e.jsx(H, {})]
    })
  },
  Uy = () => {
  ...
  Yy = "_second_image_1v16g_50",
  Xy = "_text_container_1v16g_55",
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsxs("button", {
              className: be.button,
              onPointerUp: () => {
                s !== null && de(`https://t.me/${qt}?startapp=${btoa(`id=${s.id}`)}`)
              },
  ...
  nv = "_layout_srn55_1",
  sv = "_container_srn55_12",
  av = "_buttons_container_srn55_18",
  la = {
    layout: nv,
    container: sv,
  ...
  lv = () => {
    ...
    return s && a.push(Ue.enabled), n === null ? null : e.jsx("button", {
      className: a.join(" "),
      onPointerUp: () => {
        s ? t(jn()) : (w.viewport.viewport.animate({
          scale: 2,
          time: 400,
          position: {
            x: n.x + n.imageSize / 2,
  ...
  pv = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(mv, {
        ...
        max: Ai,
        onChange: o => {
          n(Hh(o)), w.mainImage.worldTemplate.setOpacity(Number(o[0]))
        },
        renderTrack: ({
          props: o,
          children: r
  ...
  hv = () => c(n => n.template.active) === null ? null : e.jsx("div", {
  ...
  gv = () => {
    ...
    return a && i.push(Ue.enabled), e.jsxs("button", {
      ...
      onPointerUp: () => {
        ...
        a ? t(jn()) : (w.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
  ...
  jv = "_preview_image_14ts7_32",
  bv = "_preview_image_loader_14ts7_45",
  Nv = "_template_size_14ts7_60",
  Iv = "_template_title_14ts7_68",
  Cv = "_template_size_container_14ts7_73",
  ...
  Z = {
    ...
    preview_image: jv,
    preview_image_loader: bv,
    template_size: Nv,
    template_title: Iv,
    template_size_container: Cv,
  ...
  Fv = () => {
    ...
    return i && o.push(Ue.enabled), n && n.friends >= mn[16] || n.isContractor ? e.jsxs("button", {
      ...
      onPointerUp: () => {
        ...
        i ? t(jn()) : (w.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: a.x + a.imageSize / 2,
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(Gv, {}), e.jsx(lv, {}), e.jsx(gv, {}), e.jsx(Fv, {}), e.jsx(hv, {})]
        })
      })
    })
  }),
  ...
  Kv = () => c(n => n.canvas.coords) === null ? null : e.jsx("div", {
    className: pi.layout,
    children: e.jsxs("div", {
      className: pi.container + " " + P.container__bottom,
      children: [e.jsx(Cg, {}), e.jsx(bg, {}), e.jsx(Zg, {}), e.jsx(Eh, {}), e.jsx(Yv, {}), e.jsx(Xv, {}), e.jsx(Wv, {})]
    })
  }),
  Zv = "_layout_11ck4_1",
  $v = {
  ...
  ew = () => e.jsxs("div", {
    className: $v.layout,
    children: [e.jsx(Kv, {}), e.jsx(gy, {})]
  }),
  tw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(Ty, {}), e.jsx(yy, {}), e.jsx(Hv, {}), e.jsx(Iy, {}), e.jsx(ew, {}), e.jsx(Qy, {}), e.jsx(Uy, {}), e.jsx(tv, {}), e.jsx(Ey, {}), e.jsx(Cy, {})]
  }),
  nw = "_page_title_13ybj_1",
  sw = "_container_13ybj_9",
  aw = "_item_13ybj_13",
  iw = "_active_13ybj_18",
  ow = "_info_container_13ybj_34",
  rw = "_dot_13ybj_40",
  cw = "_title_text_13ybj_46",
  lw = "_capitalize_13ybj_50",
  dw = "_hint_text_13ybj_54",
  uw = "_date_text_13ybj_61",
  mw = "_value_container_13ybj_66",
  Aw = "_value_text_13ybj_74",
  pw = "_positive_color_13ybj_78",
  hw = "_negative_color_13ybj_85",
  gw = "_last_text_13ybj_92",
  x = {
    page_title: nw,
    container: sw,
    item: aw,
  ...
  bw = ({
    ...
    children: [e.jsxs("div", {
      ...
      className: x.value_container,
      children: ["-", t.details.price, " ", e.jsx(Gt, {
        fontSize: 14
      })]
    })]
  }),
  ...
  Cw = ({
    item: t
  }) => t.action === "buy pixel" ? e.jsx(_w, {
    item: t
  }) : t.action === "sell pixel" ? e.jsx(fw, {
    item: t
  }) : t.action === "claim" ? e.jsx(xw, {
    item: t
  }) : t.action === "get boost" ? e.jsx(yw, {
    item: t
  }) : t.action === "league transfer" ? e.jsx(vw, {
    item: t
  }) : t.action === "referral" ? e.jsx(ww, {
    item: t
  }) : t.action === "special" ? e.jsx(jw, {
    item: t
  }) : t.action === "purchase" ? e.jsx(bw, {
    item: t
  }) : t.action === "complete task" ? e.jsx(Nw, {
    item: t
  }) : t.action === "referrer reward" ? e.jsx(Iw, {
    item: t
  ...
  Dw = "_button_layout_placeholder_1xggq_26",
  kw = "_button_1xggq_14",
  $t = {
    text_layout: Tw,
    text: Ew,
  ...
  Mw = "_text_layout_1h04i_1",
  Uw = "_text_1h04i_1",
  Fw = "_button_layout_1h04i_14",
  Ow = "_button_layout_placeholder_1h04i_26",
  Qw = "_button_1h04i_14",
  en = {
    text_layout: Mw,
    text: Uw,
  ...
  Yw = "_image_container_1drph_43",
  Xw = "_image_1drph_43",
  Ww = "_extra_info_container_1drph_53",
  Kw = "_npx_tokens_1drph_77",
  Zw = "_button_container_1drph_81",
  $w = "_button_1drph_81",
  ve = {
    layout: Lw,
    container: qw,
    ...
    image_container: Yw,
    image: Xw,
    extra_info_container: Ww,
    npx_tokens: Kw,
    button_container: Zw,
    button: $w
  },
  ej = "/assets/intro-Brtd1phH.webp",
  tj = {
    initial: {
      scale: .97,
      opacity: 0,
  ...
  hj = "_close_container_1pvsg_1",
  gj = "_title_container_1pvsg_12",
  _j = "_title_1pvsg_12",
  fj = "_frens_count_1pvsg_21",
  xj = "_content_1pvsg_25",
  yj = "_image_container_1pvsg_32",
  vj = "_image_1pvsg_32",
  wj = "_description_container_1pvsg_41",
  jj = "_white_1pvsg_50",
  bj = "_gray_1pvsg_54",
  Nj = "_purple_1pvsg_58",
  Ij = "_bold_1pvsg_64",
  ...
  Ej = "_divider_1pvsg_98",
  Bj = "_buttons_container_1pvsg_105",
  Dj = "_button_copy_1pvsg_112",
  kj = "_button_1pvsg_105",
  M = {
    close_container: hj,
    title_container: gj,
    title: _j,
  ...
  Rj = "/assets/sitting_chars_shadow-DfXpFWWw.gif",
  Mj = "_link_a4r15_1",
  Uj = {
    link: Mj
  },
  ...
  Oj = "_container_10f8u_1",
  Qj = "_text_container_10f8u_9",
  zj = "_text_block_10f8u_16",
  Lj = "_gray_10f8u_24",
  qj = "_total_10f8u_28",
  Gj = "_bold_10f8u_33",
  Hj = "_indicator_10f8u_37",
  Jj = "_button_container_10f8u_46",
  Vj = "_button_10f8u_46",
  Le = {
    container: Oj,
    text_container: Qj,
  ...
  Yj = "_layout_1ulm2_1",
  Xj = "_container_1ulm2_11",
  Wj = "_stars_1ulm2_17",
  Kj = "_animStar_1ulm2_1",
  Sn = {
    layout: Yj,
    container: Xj,
    stars: Wj,
  ...
  vb = "_close_container_dwly3_1",
  wb = "_title_container_dwly3_12",
  jb = "_title_dwly3_12",
  bb = "_small_title_container_dwly3_23",
  Nb = "_small_title_dwly3_23",
  Ib = "_content_dwly3_32",
  Cb = "_image_container_dwly3_40",
  ...
  Db = "_bold_dwly3_75",
  kb = "_center_dwly3_79",
  Rb = "_claim_button_container_dwly3_83",
  Mb = "_claim_button_dwly3_83",
  Ub = "_no_button_dwly3_102",
  Fb = "_info_layout_dwly3_114",
  Ob = "_rewards_layout_dwly3_126",
  Qb = "_rewards_grid_container_dwly3_132",
  zb = "_reward_item_dwly3_138",
  Lb = "_reward_item_completed_dwly3_148",
  qb = "_reward_item_content_container_dwly3_161",
  Gb = "_reward_item_active_dwly3_174",
  Hb = "_reward_item_image_container_dwly3_178",
  Jb = "_reward_item_amount_dwly3_182",
  Vb = "_reward_item_amount_active_dwly3_196",
  Yb = "_reward_item_amount_premium_dwly3_200",
  Xb = "_reward_item_title_dwly3_205",
  Wb = "_reward_item_title_premium_dwly3_211",
  Kb = "_reward_item_image_dwly3_178",
  U = {
    close_container: vb,
    title_container: wb,
    title: jb,
    small_title_container: bb,
    small_title: Nb,
    content: Ib,
    image_container: Cb,
    ...
    bold: Db,
    center: kb,
    claim_button_container: Rb,
    claim_button: Mb,
    no_button: Ub,
    info_layout: Fb,
    rewards_layout: Ob,
    rewards_grid_container: Qb,
    reward_item: zb,
    reward_item_completed: Lb,
    reward_item_content_container: qb,
    reward_item_active: Gb,
    reward_item_image_container: Hb,
    reward_item_amount: Jb,
    reward_item_amount_active: Vb,
    reward_item_amount_premium: Yb,
    reward_item_title: Xb,
    reward_item_title_premium: Wb,
    reward_item_image: Kb
  },
  Zb = ({
    secondsLeft: t
  }) => {
    ...
    const b = async () => {
      try {
        const _ = a.prices[0],
          y = await Y.startShopTransaction({
            buyerWallet: l,
            currencyId: 2,
            daily: !0,
            quantity: _.quantity,
  ...
  n1 = "_img_container_fv8d9_7",
  s1 = "_image_fv8d9_13",
  a1 = "_title_fv8d9_19",
  i1 = "_description_container_fv8d9_25",
  o1 = "_description_fv8d9_25",
  Ut = {
  ...
  r1 = "_info_layout_1p9dg_1",
  c1 = {
    info_layout: r1
  },
  l1 = "_no_template_container_uihlo_1",
  d1 = "_no_template_button_uihlo_10",
  u1 = "_template_container_uihlo_28",
  m1 = "_template_info_container_uihlo_35",
  A1 = "_template_info_uihlo_35",
  p1 = "_buttons_container_uihlo_44",
  h1 = "_button_copy_uihlo_53",
  g1 = "_button_uihlo_44",
  _1 = "_create_new_template_uihlo_72",
  He = {
    no_template_container: l1,
    no_template_button: d1,
    template_container: u1,
    template_info_container: m1,
    template_info: A1,
    buttons_container: p1,
    button_copy: h1,
    button: g1,
    create_new_template: _1
  },
  f1 = () => {
    const t = K(),
  ...
  x1 = "_template_item_container_srp11_1",
  y1 = "_template_item_inner_srp11_9",
  v1 = "_template_image_srp11_17",
  w1 = "_template_image_info_layout_srp11_24",
  j1 = "_template_image_info_container_srp11_34",
  nn = {
    template_item_container: x1,
    template_item_inner: y1,
    template_image: v1,
    template_image_info_layout: w1,
    template_image_info_container: j1
  },
  nr = ({
    item: t,
    style: n = {}
  ...
  D1 = () => {
    ...
    return e.jsxs("div", {
      className: c1.info_layout,
      children: [t === "my" && e.jsx(I1, {}), t === "catalog" && e.jsx(B1, {})]
    })
  },
  k1 = () => {
    const t = f(),
  ...
  R1 = () => e.jsxs(ie.Fragment, {
    children: [e.jsx(k1, {}), e.jsx(D1, {})]
  }),
  Qs = "/assets/paintings_anim2-nk1iBB8J.gif",
  M1 = "_container_1h1qc_1",
  U1 = "_divider_1h1qc_19",
  F1 = "_row_1h1qc_24",
  O1 = "_row_title_1h1qc_36",
  Q1 = "_row_title_main_1h1qc_40",
  z1 = "_row_hint_1h1qc_45",
  L1 = "_row_value_1h1qc_51",
  q1 = "_row_value_main_1h1qc_55",
  G1 = "_mining_percent_1h1qc_60",
  ...
  Y1 = "_layout_2uiqn_1",
  X1 = "_container_2uiqn_6",
  W1 = "_close_button_2uiqn_18",
  K1 = "_title_container_2uiqn_26",
  Z1 = "_title_2uiqn_26",
  $1 = "_image_container_2uiqn_37",
  e0 = "_image_2uiqn_37",
  t0 = "_image_placeholder_2uiqn_51",
  n0 = "_info_container_2uiqn_58",
  s0 = "_info_row_2uiqn_64",
  a0 = "_info_title_2uiqn_69",
  i0 = "_info_value_blue_2uiqn_73",
  o0 = "_info_value_white_2uiqn_78",
  r0 = "_buttons_container_2uiqn_82",
  c0 = "_button_2uiqn_82",
  l0 = "_not_button_2uiqn_98",
  d0 = "_button_copy_2uiqn_109",
  te = {
    layout: Y1,
    container: X1,
    close_button: W1,
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Ve.subscribe({
              ...
              t(Jh(h)), w.mainImage.worldTemplate.deleteTemplate(o.id), w.mainImage.worldTemplate.add(h), t(jn())
            } else await t(L({
              id: performance.now(),
  ...
  p0 = "_container_s1r1v_1",
  h0 = "_page_s1r1v_13",
  g0 = "_id_s1r1v_17",
  _0 = "_title_s1r1v_22",
  f0 = "_avatar_container_s1r1v_28",
  x0 = "_avatar_s1r1v_28",
  y0 = "_squad_avatar_container_s1r1v_40",
  v0 = "_text_container_s1r1v_52",
  w0 = "_dot_s1r1v_58",
  j0 = "_user_name_s1r1v_63",
  b0 = "_squad_name_s1r1v_69",
  N0 = "_divider_s1r1v_75",
  I0 = "_tabs_content_s1r1v_81",
  C0 = "_content_info_s1r1v_85",
  P0 = "_content_info_item_s1r1v_92",
  S0 = "_content_info_item_title_s1r1v_96",
  T0 = "_content_info_item_value_s1r1v_100",
  E0 = "_no_content_s1r1v_106",
  ...
  rN = ({
    ...
    children: [t === "info" && e.jsx(Q0, {
      isPopupContent: n
    }), t === "achievements" && e.jsx(iN, {
      isPopupContent: n
    }), t === "inventory" && e.jsx(oN, {})]
  }),
  cN = ({
    isPopupContent: t = !0
  }) => {
  ...
  uN = () => {
    const t = f(),
      n = c(Ee);
    return u.useEffect(() => (n && n.id && t(hg.getListByUserId({
      userId: n.id
    })), () => {
      t(mg())
    }), [n]), e.jsx(ce, {
  ...
  mN = "_container_1bw7p_1",
  AN = {
    container: mN
  },
  pN = "_container_12mk9_1",
  hN = "_page_12mk9_13",
  gN = "_id_12mk9_17",
  _N = "_title_12mk9_22",
  fN = "_avatar_container_12mk9_28",
  xN = "_avatar_12mk9_28",
  yN = "_text_container_12mk9_39",
  vN = "_dot_12mk9_45",
  wN = "_user_name_12mk9_50",
  jN = "_squad_slug_12mk9_56",
  bN = "_your_squad_button_12mk9_62",
  NN = "_join_squad_button_12mk9_75",
  IN = "_red_12mk9_91",
  CN = "_divider_12mk9_95",
  PN = "_tabs_content_12mk9_101",
  SN = "_content_info_12mk9_105",
  TN = "_content_info_item_12mk9_112",
  EN = "_content_info_item_title_12mk9_116",
  BN = "_content_info_item_value_12mk9_120",
  DN = "_content_top_12mk9_127",
  kN = "_content_top_item_12mk9_140",
  RN = "_content_top_item_image_12mk9_150",
  MN = "_content_top_name_12mk9_156",
  ...
  D = {
    ...
    user_name: wN,
    squad_slug: jN,
    your_squad_button: bN,
    join_squad_button: NN,
    red: IN,
    divider: CN,
    tabs_content: PN,
    content_info: SN,
  ...
  cr = ({
    ...
    return n ? s !== null && s.squad.id !== null && s.squad.id === t.squad.id ? e.jsxs("div", {
      ...
      onPointerUp: () => {
        de(`https://t.me/${qt}?startapp=${btoa(`id=${t.squad.id}`)}`)
      },
      children: [e.jsx("span", {
        className: D.gray,
        children: "Your Squad."
  ...
  YN = t => {
    ...
    for (let s = 0; s < n.length; s += 4) {
      ...
      let l = At[0],
        d = 1 / 0;
      for (const h of At) {
        const g = Lt.deltaE(Lt(dn(a, i, o)), Lt(h));
        g < d && (d = g, l = h)
      }
      const m = jt(l);
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await ke.uploadTemplate({
              ...
              i(Uo(b)), i(jn()), await w.mainImage.worldTemplate.add(b), i(L({
                id: performance.now(),
    ...
    return u.useEffect(() => {}, []), u.useEffect(() => {
      if (t !== null) {
        ...
        const I = async () => {
          ...
          YN(We), _.putImageData(We, 0, 0), a(We), o(b.toDataURL())
        };
        setTimeout(() => {
          I().then(() => {
            g(!1)
      ...
      children: [i === null && e.jsx(KN, {}), i !== null && e.jsx(VN, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(Uv, {
  ...
  $N = "_general_info_container_1u2nd_1",
  eI = "_img_container_1u2nd_7",
  tI = "_image_1u2nd_17",
  nI = "_image_cup_1u2nd_23",
  sI = "_image_glow_container_1u2nd_29",
  aI = "_image_glow_1u2nd_29",
  iI = "_rotate_1u2nd_1",
  oI = "_image_glow_reverse_1u2nd_48",
  rI = "_title_1u2nd_53",
  cI = "_description_container_1u2nd_60",
  lI = "_description_1u2nd_60",
  dI = "_gold_1u2nd_73",
  Me = {
    general_info_container: $N,
    img_container: eI,
    image: tI,
    image_cup: nI,
  ...
  pI = "_instruction_container_17lvx_1",
  hI = "_img_container_17lvx_9",
  gI = "_img_inner_container_17lvx_16",
  _I = "_image_17lvx_22",
  fI = "_image_status_17lvx_30",
  xI = "_image_status_rejected_17lvx_45",
  yI = "_image_status_review_17lvx_49",
  vI = "_image_status_approved_17lvx_53",
  wI = "_copy_button_container_17lvx_57",
  jI = "_button_copy_17lvx_65",
  bI = "_gray_17lvx_71",
  NI = "_preview_container_17lvx_75",
  II = "_preview_image_container_17lvx_81",
  CI = "_preview_image_17lvx_81",
  PI = "_preview_image_loader_17lvx_94",
  SI = "_template_size_17lvx_109",
  TI = "_template_title_17lvx_117",
  EI = "_template_size_container_17lvx_122",
  BI = "_template_size_item_17lvx_128",
  DI = "_template_size_item_active_17lvx_136",
  kI = "_template_coords_17lvx_141",
  RI = "_template_coordinates_title_17lvx_151",
  MI = "_template_coords_container_17lvx_156",
  UI = "_coords_item_17lvx_163",
  FI = "_coords_input_17lvx_169",
  OI = "_file_button_container_17lvx_178",
  QI = "_file_button_17lvx_178",
  re = {
    instruction_container: pI,
    img_container: hI,
    img_inner_container: gI,
    image: _I,
    image_status: fI,
    image_status_rejected: xI,
    image_status_review: yI,
    image_status_approved: vI,
    copy_button_container: wI,
    button_copy: jI,
    gray: bI,
    preview_container: NI,
    preview_image_container: II,
    preview_image: CI,
    preview_image_loader: PI,
    template_size: SI,
    template_title: TI,
    template_size_container: EI,
    template_size_item: BI,
    template_size_item_active: DI,
    template_coords: kI,
    template_coordinates_title: RI,
    template_coords_container: MI,
    coords_item: UI,
    coords_input: FI,
    file_button_container: OI,
    file_button: QI
  },
  Ft = {
    approved: "approved",
      ...
      children: [n && e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("img", {
            ...
            className: Q(re.image_status, re.image_status_review),
            children: "On review"
          }), s === Ft.rejected && e.jsx("div", {
            className: Q(re.image_status, re.image_status_rejected),
            children: "Rejected"
          }), s === Ft.approved && e.jsx("div", {
            className: Q(re.image_status, re.image_status_approved),
            children: "Approved"
          })]
        })
      }), e.jsx("div", {
    ...
    return u.useEffect(() => {
      if (t !== null) {
        ...
        const I = async () => {
          ...
          b.width = r, b.height = r, _.drawImage(t, ge, ze, k, N);
          const We = _.getImageData(0, 0, r, r);
          AI(We), _.putImageData(We, 0, 0), a(We), o(b.toDataURL())
        };
        setTimeout(() => {
          I().then(() => {
            g(!1)
      ...
      children: [i === null && e.jsx(zI, {}), i !== null && e.jsx(LI, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(qI, {
  ...
  YI = "_button_container_1c7e5_11",
  XI = "_button_1c7e5_11",
  WI = "_end_of_list_button_1c7e5_27",
  bs = {
    layout: JI,
    container: VI,
    button_container: YI,
    button: XI,
    end_of_list_button: WI
  },
  KI = "_template_item_container_qlah9_1",
  ZI = "_template_item_inner_qlah9_12",
  $I = "_template_item_picked_qlah9_28",
  eC = "_template_item_shadow_qlah9_43",
  tC = "_template_rank_qlah9_55",
  nC = "_template_recolors_qlah9_75",
  sC = "_template_recolors_pixel_qlah9_91",
  aC = "_template_image_qlah9_97",
  rt = {
    template_item_container: KI,
    template_item_inner: ZI,
    template_item_picked: $I,
  ...
  oC = "_round_info_container_1d52c_1",
  rC = "_title_1d52c_7",
  cC = "_description_1d52c_12",
  lC = "_round_status_container_1d52c_17",
  Tn = {
    round_info_container: oC,
    title: rC,
    description: cC,
    round_status_container: lC
  },
  dC = "_round_indicator_mgwmo_1",
  ...
  hC = () => (c(t => t.tournament.approvedTemplatesListTotal), e.jsxs("div", {
    children: [e.jsxs("div", {
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx(mC, {}), " Soon"]
      })]
    }), e.jsx(pC, {})]
  })),
  gC = "_soon_14n1b_1",
  _C = "_active_round_instruction_14n1b_11",
  fC = "_round_container_14n1b_18",
  xC = "_round_title_14n1b_26",
  yC = "_round_title_text_14n1b_31",
  vC = "_round_indicator_14n1b_36",
  wC = "_round_status_success_14n1b_42",
  jC = "_round_status_fail_14n1b_53",
  bC = "_success_14n1b_64",
  NC = "_fail_14n1b_68",
  IC = "_gray_14n1b_72",
  CC = "_round_main_info_14n1b_76",
  PC = "_round_image_container_14n1b_82",
  SC = "_round_image_14n1b_82",
  TC = "_round_lines_container_14n1b_93",
  EC = "_round_line_14n1b_93",
  BC = "_divider_14n1b_104",
  DC = "_pixels_number_14n1b_111",
  kC = "_pixel_14n1b_111",
  RC = "_past_rounds_14n1b_123",
  MC = "_past_rounds_divider_14n1b_132",
  J = {
    soon: gC,
    active_round_instruction: _C,
    round_container: fC,
    round_title: xC,
    round_title_text: yC,
    round_indicator: vC,
    round_status_success: wC,
    round_status_fail: jC,
    success: bC,
    fail: NC,
    gray: IC,
    round_main_info: CC,
  ...
  FC = () => !Oe.devServer && !Oe.isDev ? e.jsxs("div", {
    className: J.soon,
    children: ["Something will happen here,", e.jsx("br", {}), " but not now."]
  }) : e.jsxs("div", {
    children: [e.jsx("div", {
      ...
      children: [e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          className: Q(J.round_status_success, J.success),
          children: "Wining"
        }), e.jsx("div", {
          className: Q(J.round_status_fail, J.fail),
          children: "😔 Lost"
        })]
      }), e.jsxs("div", {
  ...
  nP = "_layout_2uiqn_1",
  sP = "_container_2uiqn_6",
  aP = "_close_button_2uiqn_18",
  iP = "_title_container_2uiqn_26",
  oP = "_title_2uiqn_26",
  rP = "_image_container_2uiqn_37",
  cP = "_image_2uiqn_37",
  lP = "_image_placeholder_2uiqn_51",
  dP = "_info_container_2uiqn_58",
  uP = "_info_row_2uiqn_64",
  mP = "_info_title_2uiqn_69",
  AP = "_info_value_blue_2uiqn_73",
  pP = "_info_value_white_2uiqn_78",
  hP = "_buttons_container_2uiqn_82",
  gP = "_button_2uiqn_82",
  _P = "_not_button_2uiqn_98",
      ...
      onPointerUp: async () => {
        try {
          ...
          (await a(Us.selectTemplate({
            id: t.id
          }))).meta.requestStatus === p.fulfilled && a(rg(t))
        } catch (r) {
  ...
  yP = () => {
    ...
    return !s || !n ? null : Ye.createPortal(e.jsx(Re, {
      onPointerUp: () => t(ii()),
      show: n,
      children: e.jsx("div", {
        className: X.layout,
  ...
  IP = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  CP = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  TP = "_container_qn09x_1",
  EP = "_image_container_qn09x_9",
  BP = "_image_qn09x_9",
  DP = "_title_container_qn09x_18",
  kP = "_text_container_qn09x_27",
  RP = "_title_qn09x_18",
  MP = "_gray_qn09x_39",
  UP = "_bold_qn09x_43",
  FP = "_input_qn09x_47",
  OP = "_catalog_container_qn09x_71",
  QP = "_catalog_title_qn09x_76",
  zP = "_catalog_items_container_qn09x_81",
  LP = "_catalog_item_qn09x_81",
  qP = "_catalog_item_image_container_qn09x_100",
  GP = "_catalog_item_image_qn09x_100",
  HP = "_button_container_qn09x_109",
  JP = "_button_qn09x_109",
  VP = "_wrong_helper_text_qn09x_124",
  YP = "_wrong_button_qn09x_129",
  XP = "_wrong_button_text2_qn09x_142",
  T = {
    container: TP,
    image_container: EP,
    image: BP,
    ...
    bold: UP,
    input: FP,
    catalog_container: OP,
    catalog_title: QP,
    catalog_items_container: zP,
    catalog_item: LP,
    catalog_item_image_container: qP,
    catalog_item_image: GP,
    button_container: HP,
    button: JP,
    wrong_helper_text: VP,
    wrong_button: YP,
    wrong_button_text2: XP
  },
  WP = "/assets/box_1-CzUKXu07.gif",
  KP = "/assets/box_2-wR9cQS7q.gif",
  ZP = "/assets/box_3-g_PL1kKM.gif",
  $P = "/assets/dogs-D0jtZggB.gif",
  e2 = "/assets/secret_word-BTKB1fAO.gif",
  t2 = "/assets/cube_youtube_2-BqessN1a.gif",
  n2 = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif",
  En = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
  ...
  s2 = () => {
    ...
    return u.useEffect(() => {
      ...
      (async () => {
        const k = await Y.getSecretStats();
  ...
  o2 = "_layout_1djp8_1",
  r2 = "_loading_container_1djp8_8",
  c2 = "_image_container_1djp8_20",
  l2 = "_image_1djp8_20",
  d2 = "_text_1djp8_29",
  sn = {
    layout: o2,
    loading_container: r2,
    image_container: c2,
    image: l2,
    text: d2
  },
  ...
  g2 = "_number_rjvnl_36",
  _2 = "_button_rjvnl_1",
  f2 = "_ratings_button_rjvnl_55",
  x2 = "_stars_button_rjvnl_62",
  y2 = "_shop_button_rjvnl_70",
  v2 = "_burger_button_rjvnl_79",
  w2 = "_relative_button_rjvnl_89",
  j2 = "_telegram_button_rjvnl_116",
  b2 = "_button_img_rjvnl_124",
  N2 = "_avatar_img_rjvnl_129",
  I2 = "_open_menu_button_rjvnl_134",
  C2 = "_open_menu_button_image_rjvnl_144",
  ...
  ye = {
    ...
    avatar_img: N2,
    open_menu_button: I2,
    open_menu_button_image: C2,
    my_pixels_amount: P2,
    header_content: S2
  },
  T2 = () => c(De) ? null : e.jsxs("button", {
...
const F2 = () => {
    ...
    return u.useEffect(() => {
      const s = () => {
        a2.includes(t.pathname) ? n.push("/") : n.goBack()
      };
  ...
  z2 = () => {
    ...
    return u.useEffect(() => {
      ...
      return n === Ce.start && (d = requestAnimationFrame(h), t.current && (t.current.style.display = "block")), n === Ce.finish && (t.current && (t.current.style.width = "100%"), m = setTimeout(() => {
  ...
  L2 = "_container_11ui8_1",
  q2 = "_header_11ui8_13",
  G2 = "_close_container_11ui8_23",
  H2 = "_close_11ui8_23",
  J2 = "_title_11ui8_48",
  V2 = "_frens_count_11ui8_53",
  Y2 = "_body_11ui8_58",
  X2 = "_content_11ui8_68",
  W2 = "_image_container_11ui8_75",
  K2 = "_image_11ui8_75",
  Z2 = "_image_container_charges_11ui8_84",
  $2 = "_image_charges_11ui8_89",
  eS = "_description_container_11ui8_94",
  tS = "_bold_11ui8_102",
  nS = "_gray_11ui8_107",
  sS = "_center_11ui8_111",
  aS = "_benefits_container_11ui8_115",
  iS = "_benefits_item_11ui8_123",
  oS = "_benefits_icon_container_11ui8_128",
  rS = "_icon_invite_11ui8_132",
  cS = "_footer_11ui8_136",
  lS = "_button_11ui8_141",
  R = {
    container: L2,
    header: q2,
    close_container: G2,
  ...
  mS = "_container_13215_1",
  AS = "_header_13215_9",
  pS = "_close_13215_19",
  hS = "_title_13215_31",
  gS = "_body_13215_36",
  _S = "_image_container_13215_49",
  fS = "_image_13215_49",
  xS = "_content_container_13215_60",
  yS = "_description_container_13215_68",
  vS = "_description_item_13215_75",
  wS = "_amount_selector_container_13215_82",
  jS = "_amount_selector_button_13215_88",
  bS = "_amount_selector_count_13215_101",
  NS = "_button_container_13215_112",
  IS = "_crypto_button_container_13215_118",
  CS = "_error_13215_132",
  PS = "_button_13215_112",
  SS = "_star_color_13215_153",
  TS = "_tokens_selector_13215_159",
  ES = "_tokens_title_13215_164",
  BS = "_connect_wallet_text_title_13215_171",
  DS = "_tokens_container_13215_180",
  kS = "_token_item_13215_187",
  RS = "_token_image_container_13215_198",
  MS = "_token_image_13215_198",
  US = "_sale_box_13215_208",
  FS = "_sale_text_13215_220",
  W = {
    container: mS,
    header: AS,
    close: pS,
    ...
    image_container: _S,
    image: fS,
    content_container: xS,
    description_container: yS,
    description_item: vS,
    amount_selector_container: wS,
    amount_selector_button: jS,
    amount_selector_count: bS,
    button_container: NS,
    crypto_button_container: IS,
    error: CS,
    button: PS,
    star_color: SS,
    tokens_selector: TS,
  ...
  GS = ({
    ...
    return t ? e.jsx(ie.Fragment, {
      ...
      children: ["Buy for", e.jsx(qS, {}), Math.round(o * (r ? s : 1) * 100) / 100, e.jsx("div", {
  ...
  WS = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(LS, {}), e.jsx(XS, {}), e.jsx(io, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: W.error,
  ...
  ZS = "_container_1rmx4_1",
  $S = "_max_value_1rmx4_9",
  vi = {
    container: ZS,
    max_value: $S
  },
...
const eT = () => {
  ...
  tT = () => e.jsxs("div", {
    ...
    children: [e.jsx(QS, {}), e.jsxs("div", {
      ...
      children: [e.jsx(zS, {}), e.jsx(KS, {}), e.jsx(eT, {})]
    }), e.jsx(WS, {})]
  }),
  nT = () => {
    const t = c(n => n.shop.show);
    return Ye.createPortal(e.jsx(Re, {
      show: t,
      children: e.jsxs("div", {
        className: W.container,
        children: [e.jsx(OS, {}), e.jsx(tT, {})]
      })
    }), document.body)
  },
  sT = "_layout_1ohv1_1",
  aT = "_container_1ohv1_13",
  iT = "_header_1ohv1_20",
  oT = "_title_1ohv1_30",
  rT = "_body_1ohv1_35",
  cT = "_image_container_1ohv1_47",
  lT = "_image_1ohv1_47",
  dT = "_shake_1ohv1_1",
  uT = "_description_container_1ohv1_60",
  mT = "_text_1ohv1_69",
  AT = "_button_container_1ohv1_73",
  pT = "_button_1ohv1_73",
  Ke = {
    layout: sT,
    container: aT,
...
async function yT() {
  v.enable(v.BLEND), v.blendFunc(v.SRC_ALPHA, v.ONE_MINUS_SRC_ALPHA), v.clearColor(0, 0, 0, 0), v.viewport(0, 0, v.canvas.width, v.canvas.height), we = await vT(v), v.useProgram(we)
}
async function vT(t, n, s) {
  const a = hT,
    i = gT,
...
async function wT(t) {
  w.mainImage.convertSpriteToImage(n => {
    ...
    s.src = URL.createObjectURL(n), s.onload = () => {
      jT(s), IT(t), hr(), document.getElementById("canvasHolder").style.transition = "7s ease opacity", document.getElementById("canvasHolder").style.opacity = "1", setTimeout(() => {
...
function IT(t) {
  ...
  ms = l * l, $e(v, we, "u_AnimationDuration", pr), $e(v, we, "u_ParticleSize", _T), $e(v, we, "u_ViewportWidth", n), $e(v, we, "u_ViewportHeight", s), $e(v, we, "u_TextureWidth", a), $e(v, we, "u_TextureHeight", i), $e(v, we, "u_TextureLeft", o), $e(v, we, "u_TextureTop", r);
  ...
  const h = v.getAttribLocation(we, "a_ParticleIndex");
...
function CT(t) {
  ...
  $e(v, we, "u_ElapsedTime", s), v.drawArrays(v.POINTS, 0, ms), hr()
}
...
const PT = () => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            onPointerUp: async () => {
              ...
              try {
                await fT(i ? 0 : oc), document.getElementById("canvasHolder").style.opacity = "0"
              } catch (l) {
                document.getElementById("canvasHolder").style.opacity = "1", console.error(l, "cannot run pixanos")
              }
              t.push("/"), n(Up()), w.mainImage.pixanosRepaint(a.info.seed, B.width, a.info.percentage, a.info.color), (r = (o = window.Telegram.WebApp) == null ? void 0 : o.HapticFeedback) == null || r.notificationOccurred("error")
            },
            children: "Whoosh!"
          })]
        })]
  ...
  MT = "_layout_1nuac_1",
  UT = "_container_1nuac_19",
  FT = "_image_container_1nuac_30",
  OT = "_image_1nuac_30",
  QT = "_text_container_1nuac_42",
  zT = "_title_1nuac_49",
  LT = "_button_container_1nuac_55",
  qT = "_button_1nuac_55",
  ct = {
    layout: MT,
    container: UT,
    ...
    return e.jsx(Re, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === Fe.userFromPixelInfo && e.jsx(Ia, {
          ...
          isPopupContent: s
        }), n.dataSource === Fe.squadFromData && e.jsx(HT, {})]
      })
    })
  },
  VT = "_overlay_1vl8z_1",
  YT = "_top_container_1vl8z_10",
  XT = "_bottom_container_1vl8z_15",
  WT = "_side_menu_1vl8z_20",
  KT = "_menu_safe_area_inset_1vl8z_36",
  ZT = "_menu_header_1vl8z_40",
  $T = "_close_button_1vl8z_53",
  eE = "_menu_list_1vl8z_58",
  tE = "_icon_1vl8z_79",
  nE = "_icon_not_pixel_1vl8z_87",
  sE = "_gold_pixel_1vl8z_97",
  aE = "_menu_list_li_1vl8z_103",
  iE = "_menu_list_text_1vl8z_109",
  oE = "_menu_list_new_item_1vl8z_113",
  rE = "_button_wrapper_1vl8z_136",
  cE = "_button_content_1vl8z_145",
  lE = "_footer_1vl8z_152",
  dE = "_avatar_1vl8z_158",
  uE = "_ratings_image_container_1vl8z_165",
  mE = "_ratings_image_1vl8z_165",
  V = {
    overlay: VT,
    top_container: YT,
    bottom_container: XT,
    ...
    menu_list_li: aE,
    menu_list_text: iE,
    menu_list_new_item: oE,
    button_wrapper: rE,
    button_content: cE,
    footer: lE,
    avatar: dE,
    ratings_image_container: uE,
    ratings_image: mE
  },
  bi = [.215, .61, .355, 1],
  AE = {
  ...
  PE = "_header_n1egb_11",
  SE = "_title_n1egb_24",
  TE = "_close_container_n1egb_30",
  EE = "_close_n1egb_30",
  BE = "_body_n1egb_54",
  DE = "_content_n1egb_65",
  kE = "_time_left_container_n1egb_71",
  RE = "_timer_n1egb_75",
  ME = "_image_container_n1egb_79",
  UE = "_image_n1egb_79",
  FE = "_description_container_n1egb_89",
  OE = "_bold_n1egb_98",
  QE = "_gray_n1egb_103",
  zE = "_center_n1egb_107",
  LE = "_footer_n1egb_111",
  qE = "_button_n1egb_117",
  GE = "_image_container_charges_n1egb_149",
...
const VE = "_layout_1at34_1",
  YE = "_container_1at34_10",
  XE = "_item_1at34_14",
  ma = {
    layout: VE,
    container: YE,
  ...
  eB = u.memo(({
    ...
    const [s, a] = u.useState($E()), [i, o] = u.useState(!1);
    return u.useEffect(() => {
      t && setTimeout(() => {
        o(!0), setTimeout(() => {
          n(!1), o(!1)
  ...
  tB = () => {
    const t = f(),
      ...
      l = c(_ => _.mining.tasks[j.spendStars]),
      [d, m] = u.useState(!1),
      [h, g] = u.useState(null),
      [I, b] = u.useState(!1);
    return u.useEffect(() => {
      const _ = async () => {
        const y = await JE.checkOffer();
      ...
      return (n !== he || Oe.isDev) && r === p.fulfilled && !l && _(), () => {}
    }, [n, r]), u.useEffect(() => {
      let _ = null;
      if (i) {
        const y = () => {
  ...
  nB = "_container_gb8eq_1",
  sB = "_header_gb8eq_11",
  aB = "_title_gb8eq_17",
  iB = "_close_container_gb8eq_23",
  oB = "_close_gb8eq_23",
  rB = "_body_gb8eq_47",
  cB = "_content_gb8eq_59",
  lB = "_time_left_container_gb8eq_65",
  dB = "_timer_gb8eq_69",
  uB = "_image_container_gb8eq_73",
  mB = "_image_gb8eq_73",
  AB = "_glow_container_gb8eq_91",
  pB = "_glow_gb8eq_91",
  hB = "_rotate_gb8eq_1",
  gB = "_glow_reverse_gb8eq_107",
  _B = "_description_container_gb8eq_113",
  fB = "_bold_gb8eq_123",
  xB = "_gray_gb8eq_128",
  yB = "_center_gb8eq_132",
  vB = "_gold_gb8eq_136",
  wB = "_button_gb8eq_144",
  _e = {
    container: nB,
    header: sB,
    title: aB,
  ...
  jB = "/assets/cup_glad-DGT2PBmm.png",
  bB = () => {
    const t = K(),
      n = c(Ee),
      [s, a] = u.useState(!1),
      i = "showCreateTournamentTemplatePopup";
    return u.useEffect(() => (Vi() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(Re, {
      show: s,
      children: e.jsx("div", {
  ...
  NB = "_layout_xga4i_1",
  IB = "_container_xga4i_14",
  CB = "_header_xga4i_20",
  PB = "_close_xga4i_25",
  SB = "_body_xga4i_38",
  TB = "_image_container_xga4i_42",
  EB = "_image_xga4i_42",
  BB = "_glow_xga4i_55",
  DB = "_forward_xga4i_62",
  kB = "_rotate_xga4i_1",
  RB = "_reverse_xga4i_66",
  MB = "_text_container_xga4i_70",
  UB = "_title_xga4i_78",
  FB = "_description_xga4i_82",
  OB = "_footer_xga4i_86",
  QB = "_button_xga4i_90",
  fe = {
    layout: NB,
...
const VB = "_layout_1tvc9_1",
  YB = "_container_1tvc9_5",
  XB = "_close_button_1tvc9_14",
  WB = "_title_container_1tvc9_22",
  KB = "_image_container_1tvc9_28",
  ZB = "_image_1tvc9_28",
  $B = "_text_container_1tvc9_47",
  eD = "_button_container_1tvc9_52",
  Ze = {
    layout: VB,
    container: YB,
    close_button: XB,
  ...
  nD = () => e.jsxs("div", {
    className: sn.layout,
    children: [e.jsx(z2, {}), e.jsx(U2, {}), e.jsx(l_, {}), e.jsx(i2, {}), e.jsx(F2, {}), e.jsx(TT, {}), e.jsx(GT, {}), e.jsx(JT, {}), e.jsx(uS, {}), e.jsx(ST, {}), e.jsx(tB, {}), e.jsx(bB, {}), e.jsx(JB, {}), e.jsx(tD, {}), e.jsx(nT, {}), e.jsx(PT, {}), e.jsx(RT, {}), e.jsx(IE, {})]
  }),
  sD = () => {
    const t = f(),
    ...
    return u.useEffect(() => {
      const s = setInterval(() => {
        Date.now() - n > 18e5 && (t(Rp()), clearInterval(s))
      }, 100);
      return () => {
        clearInterval(s)
      }
  ...
  oD = "_layout_ieygs_1",
  rD = "_container_ieygs_8",
  cD = "_logo_container_ieygs_17",
  lD = "_logo_ieygs_17",
  dD = "_animate_ieygs_1",
  uD = "_center_ieygs_37",
  mD = "_title_ieygs_51",
  AD = "_description_ieygs_58",
  pD = "_button_container_ieygs_63",
  hD = "_button_ieygs_63",
  gD = "_b_ieygs_63",
  xt = {
    layout: oD,
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("button", {
            className: xt.button,
            onPointerUp: () => {
              t ? de("https://t.me/notpixel_channel") : Ht("https://t.me/notpixel_channel")
            },
            children: "Not Pixel Channel"
          })
        })]
  ...
  fD = "/assets/loading-D8SQALTR.gif",
  xD = () => e.jsxs("div", {
  ...
  yD = () => {
    ...
    u.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(Pp(s)), t(Ra(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(nu(s))
      })
    }, [t])
      ...
      s = async () => {
        ...
        try {
          ...
          if (g.payload && g.payload.id !== 0) {
            ...
            t(Uo(I)), await w.mainImage.worldTemplate.add(I)
          }
        } catch (g) {
          console.error("Ошибка получения подключенного трафарета:", g)
        }
  ...
  PD = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      a = s === p.rejected && !Oe.app.disableBetaError,
      i = s === p.pending || s === p.idle,
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(dc) && iD(), yD(), vD(), wD(), a || o ? e.jsx(_D, {}) : i ? e.jsx(xD, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
Ac(bn);
Ep(bn);
const kD = Nr.createRoot(document.getElementById("root"));
kD.render(e.jsx(ie.StrictMode, {
  children: e.jsx(Sr, {
    store: bn,
    children: e.jsx(Fr, {
      children: e.jsx(Br, {
