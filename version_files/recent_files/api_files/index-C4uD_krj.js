...
const tl = {
  ...
  yo = (t, n) => ma[t] ? ma[t](t, n) : ma.default(),
  Tl = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  Ol = () => wo() ? es.VITE_ADSGRAM_BLOCK_ID : Ml() ? "4853" : "4995",
  ft = {
    isDev: Ul(),
    devServer: wo(),
  ...
  Ql = () => window.Telegram.WebApp.isVersionAtLeast(8) ? window.Telegram.WebApp.safeAreaInset : {
    top: 0,
    bottom: 0,
    left: 0,
    right: 0
  },
  Fl = () => window.Telegram.WebApp.isVersionAtLeast(8) ? window.Telegram.WebApp.contentSafeAreaInset : {
    top: 0,
    bottom: 0,
    left: 0,
    right: 0
  ...
  }, bo = t => new Promise(n => setTimeout(n, t)), pd = t => {
  ...
  }, () => !1), Id = "_layout_1nbfl_1", Nd = "_button_1nbfl_14", bi = {
    layout: Id,
    button: Nd
  }, Cd = () => {
    const t = W();
  ...
  }, Pd = "_layout_gx8in_1", Sd = "_container_gx8in_5", Bd = "_item_gx8in_11", Td = "_active_gx8in_20", Ed = "_image_container_gx8in_24", Dd = "_image_gx8in_24", kd = "_item_text_container_gx8in_34", Rd = "_item_text_gx8in_34", ut = {
    layout: Pd,
    container: Sd,
    item: Bd,
    active: Td,
  ...
  }, Ld = t => t.user.userPic, Ge = t => t.user.user, Hd = No.reducer, Mt = {
    getPixelsForSale: ts,
    ...
    return c(Ge), m.useEffect(() => {
      ...
      children: e.jsx("div", {
        ...
        children: n.map(i => {
          ...
          return e.jsxs("div", {
            className: R(ut.item, o ? ut.active : ""),
            onPointerUp: () => {
              t(Sn(i.currency_id))
            },
            children: [e.jsx("div", {
              ...
              className: ut.item_text_container,
              children: e.jsx("span", {
                className: ut.item_text,
                children: i.name
              })
            })]
          }, i.currency_id)
  ...
  }, () => !1), ju = "_container_1aw3i_1", bu = "_logo_1aw3i_9", Iu = "_animate_1aw3i_1", Nu = "_center_1aw3i_18", Cu = "_glow_1aw3i_28", qn = {
    container: ju,
    logo: bu,
    animate: Iu,
    center: Nu,
  ...
  }), Bu = "_container_13oyr_1", Tu = "_button_13oyr_11", Eu = "_info_13oyr_32", _t = {
    container: Bu,
    button: Tu,
    info: Eu
  };
...
const is = z("mining/info", async () => (await $s.info()).data),
    ...
    return m.useEffect(() => {
      ...
      children: e.jsxs("button", {
        ...
        onPointerUp: async () => {
          var u, h;
          try {
            const _ = await a(je.claim()).unwrap();
  ...
  JA = () => {
    ...
    return m.useEffect(() => {
      ...
      !o || d !== p.fulfilled || r && (i || (h = r == null ? void 0 : r.connectItems) != null && h.tonProof && !("error" in r.connectItems.tonProof) && X.checkTonProof(r.connectItems.tonProof.proof, r.account).then(_ => {
        _.status === 200 && _.data.success ? t(je.checkTask({
          key: n,
          reward: l
        })) : t(q({
          id: performance.now(),
  ...
  on = ({
    ...
    }, [t]), a ? et.createPortal(e.jsxs(se.Fragment, {
...
const Bi = () => {
  ...
  xm = () => {
    ...
    return c(s => s.user.country), !_m && !n && !ft.isDev, null
  },
...
const _p = () => {
  ...
  vt = t => !(t.x < 0 || t.y < 0 || t.x > B.width - 1 || t.y > B.height - 1),
...
const Ma = z("canvas/getPixelInfo", async ({
  ...
  Np = () => $a() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  Cp = {
    coords: null,
    animations: Np(),
    stats: null,
  ...
  Lo = ge({
    ...
    reducers: {
      ...
      addPaintCoords: (t, n) => {
        vt(n.payload) && (t.stats = lt(n.payload) ^ 3201282)
      }
    },
    extraReducers: t => {
  ...
  bh = () => {
    ...
    return e.jsxs(ln, {
      children: [a && i && e.jsx(Qe, {
        active: n === Re.create,
        setActive: () => t(In(Re.create)),
        children: "My template"
      }), e.jsx(Qe, {
        active: n === Re.main,
        setActive: () => t(In(Re.main)),
        children: "Tournament"
      }), e.jsx(Qe, {
        active: n === Re.result,
        setActive: () => t(In(Re.result)),
        children: "My results"
      })]
    })
  };
...
const As = z("tournament/getPeriods", async () => (await Vo.getPeriods()).data),
  ...
  ps = z("tournament/getMyTemplate", async ({
    id: t
  }) => (await Le.getTournamentTemplateById({
    id: t
  })).data),
  hs = z("tournament/getSelectedTemplate", async () => (await Le.getSelectedTemplate()).data),
  gs = z("tournament/getApprovedTemplatesList", async ({
    offset: t,
    limit: n
  }) => (await Le.getApprovedTemplatesList({
    offset: t,
    limit: n
  })).data),
  _s = z("tournament/getRandomTemplatesList", async () => (await Le.getRandomTemplates()).data),
  xs = z("tournament/selectTemplate", async ({
    id: t
  }) => (await Le.subscribeToTournamentTemplate({
    id: t
  })).data),
  Ih = {
    activeTab: Re.main,
...
const Eh = (t, n) => {
    ...
    ka() && (s = {
    ...
    }), rt = new pc(Ja.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), rt.on("connected", function(a) {
      ...
      o.src = URL.createObjectURL(i), o.onload = () => {
        j.mainImage.loadFromCentrifuge(o).then(() => {
          ...
          }), j.mainImage.selectedPixel.draw(l), it.dispatch(Ut(l)))
        })
      }
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          ...
          if (r.type === ua.pixanos && it.dispatch(Uh(l)), l.user.userId === n || !Tn) return;
          const u = it.getState().canvas.animations;
          if (r.type === ua.bomb) {
      ...
      hc(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === Bh[1] && it.getState().daily.list.entities[d.good_id]) {
...
const kg = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(Vs(10)), t(tt(1)), t(nt()), t(sr()), !1;
  if (s === a) return !1;
...
const di = {
  ...
  Nt = nn();
Nt.startListening({
  matcher: _e(je.info.fulfilled),
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Od(t.payload.totalUserPixels)), n.dispatch(Po(t.payload.userBalance))), n.dispatch(nl(t.payload.goods))
  }
});
Nt.startListening({
  matcher: _e(je.checkTask.fulfilled),
  effect: (t, n) => {
...
Nt.startListening({
  matcher: _e(je.checkBoost.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s];
    let i = "Not enough PX",
...
Nt.startListening({
  matcher: _e(je.checkTask.rejected),
  effect: (t, n) => {
    n.dispatch(q({
      id: performance.now(),
      text: "Check failed",
...
Nt.startListening({
  matcher: _e(je.checkBoost.rejected),
  effect: (t, n) => {
    n.dispatch(q({
      id: performance.now(),
      text: "Not enough PX",
...
const sa = nn();
sa.startListening({
  matcher: _e(ea.getPriceMask.pending, Mt.getPixelsForSale.pending, Mt.getPixelsSold.pending, di.get.pending),
  effect: (t, n) => {
    n.dispatch(ct({
      command: Oe.start
    }))
...
sa.startListening({
  matcher: _e(ea.getPriceMask.fulfilled, Mt.getPixelsForSale.fulfilled, Mt.getPixelsSold.fulfilled, di.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(ct({
      command: Oe.finish
    }))
...
sa.startListening({
  matcher: _e(ea.getPriceMask.rejected),
  effect: (t, n) => {
    t.error.code !== "ERR_CANCELED" && n.dispatch(ct({
      command: Oe.finish
    }))
  }
});
const hr = nn();
hr.startListening({
  matcher: _e(Mt.getUser.fulfilled),
  effect: (t, n) => {
...
const Hg = _r.reducer,
  ...
  Yg = z("template/subscribe", async ({
    id: t
  }) => (await Le.subscribeToTemplate({
    id: t
  })).data),
  Is = z("template/getTemplateList", async ({
    offset: t,
    limit: n
  }) => (await Le.getTemplatesList({
    offset: t,
    limit: n
  })).data),
  Xg = z("template/getAvailableSizes", async ({
    userId: t
  }) => (await Le.getAvailableSizes({
    userId: t
  })).data),
  Ns = z("template/getReferredTemplate", async () => (await Le.getReferredTemplate()).data),
  Fa = z("template/getMyTemplate", async ({
    id: t
  }) => (await Le.getTemplateById({
    id: t
  })).data),
  ...
  xr = ge({
    ...
    extraReducers: t => {
      ...
      }).addCase(Ns.rejected, (n, s) => {}).addCase(Fa.pending, n => {}).addCase(Fa.fulfilled, (n, s) => {}).addCase(Cs.pending, (n, s) => {}).addCase(Cs.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: Te.world
        };
        n.worldTemplate = a, j.mainImage.worldTemplate.add(a)
      }).addCase(Cs.rejected, (n, s) => {}).addCase(Is.pending, n => {
  ...
  un = nn();
un.startListening({
  matcher: _e(Dt.getMyTemplate.fulfilled),
  effect: (t, n) => {
    const s = n.getState();
...
un.startListening({
  matcher: _e(Dt.getSelectedTemplate.fulfilled, $o),
  effect: (t, n) => {
    const s = n.getState();
...
const Gn = oc({
    ...
    devTools: !1,
    middleware: t => [Fn.middleware, hr.middleware, sa.middleware, Nt.middleware, gr.middleware, un.middleware, ...t()]
  }),
  Ts = [],
  m_ = async ({
    dispatch: t,
    ...
    try {
      const o = new TextEncoder().encode(JSON.stringify({
        ...
        r = await rt.rpc("rеpаintTournаment", o);
      Ts.push(r);
      const l = await r,
        d = JSON.parse(new TextDecoder().decode(new Uint8Array(l.data)));
      d && d.balance && (t(Po(d.balance)), d.reward_user && d.reward_user.reward_id && (j.mainImage.reward.add(s), t(o_({
        rewardId: d.reward_user.reward_id,
        rewardUserId: d.reward_user.id
      }))))
    } catch (o) {
      o.code && o.code === 5e3 && t(je.info())
    }
  }, p_ = ({
    history: t,
    dispatch: n,
    ...
    return i === "paintcan" && l.push(P.fast_mode_button_enabled), s ? e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "paintcan") {
          t(Qt());
          return
        }!a || a === 0 ? (t(tt(n)), t(nt())) : t(na("paintcan"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: P.button_image,
...
let H_ = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 7, this.images = [b_, I_, N_, C_, P_, S_, B_, T_, E_, D_, k_, R_, M_, U_, O_, Q_, F_, G_, z_, L_], this.textureArray = [];
    ...
    return i === "pumpkin" && l.push(P.fast_mode_button_enabled), !s || !a || a === 0 ? null : e.jsxs("button", {
      ...
      onPointerUp: () => {
        if (i === "pumpkin") {
          t(Qt());
          return
        }!a || a === 0 ? (t(tt(n)), t(nt())) : t(na("pumpkin"))
      },
      children: [e.jsx("img", {
        alt: "img",
        className: P.button_image,
...
class Z_ {
  constructor({
    ...
    this.app = n, this.ticker = i, this.viewport = s, this.store = a, this.pixiViewport = s.viewport, this.selectedPixel = new Dp({
      ...
      x: -1,
      y: -1
    }, this.initImage(), o(a), this.initEvents(), this.store.dispatch(ct({
      command: Oe.start
  ...
  async loadAllChunks() {
    ...
    this.updateTexture(), this.store.dispatch(ct({
      command: Oe.finish
    }))
  }
...
const ix = m.memo(() => (m.useEffect(() => {
  ...
  Tx = () => {
    const {
      t
    } = Fe(), n = he.paintReward, s = c(u => u.main.settings.UpgradeRepaint), a = c(u => u.mining.boosts[n]), {
      repaintReward: i
  ...
  Ex = () => {
    const {
      t
    } = Fe(), n = he.reChargeSpeed, s = c(u => u.main.settings.UpgradeChargeRestoration), a = c(u => u.mining.boosts[n]), {
      restorationSpeed: i
    } = c(dn), o = a >= i, r = Math.min(i, a + 1), l = Math.min(i, a), d = s == null ? void 0 : s.levels[r];
    return e.jsxs(Ai, {
      boost: n,
  ...
  Dx = () => {
    const {
      t
    } = Fe(), n = he.energyLimit, s = c(u => u.main.settings.UpgradeChargeCount), a = c(u => u.mining.boosts[n]), {
      chargesCount: i
    } = c(dn), o = a >= i, r = Math.min(i, a + 1), l = Math.min(i, a), d = s == null ? void 0 : s.levels[r];
    return e.jsxs(Ai, {
      boost: n,
  ...
  qx = () => {
    const {
      t
    } = Fe(), n = he.paintReward, s = c(d => d.main.settings.UpgradeRepaint), a = c(d => d.mining.boosts[n]), {
      repaintReward: i
  ...
  Yx = () => {
    const {
      t
    } = Fe(), n = he.reChargeSpeed, s = c(d => d.main.settings.UpgradeChargeRestoration), a = c(d => d.mining.boosts[n]), {
      restorationSpeed: i
    } = c(dn), o = Math.min(i, a + 1), r = (s == null ? void 0 : s.levels[a]) || {
      ChargeBoost: 6e5
    }, l = s == null ? void 0 : s.levels[o];
  ...
  Xx = () => {
    const {
      t
    } = Fe(), n = he.energyLimit, s = c(d => d.main.settings.UpgradeChargeCount), a = c(d => d.mining.boosts[n]), {
      chargesCount: i
  ...
  Jx = () => e.jsxs("div", {
    ...
    children: [e.jsxs(_x, {
      title: "Boosters",
      children: [e.jsx(Tx, {}), e.jsx(Ex, {}), e.jsx(Dx, {})]
    }), e.jsx(Vx, {}), e.jsx("div", {
      style: {
        height: "20px"
      }
  ...
  lv = () => (c(t => t.ratings.league), c(So), c(or), e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsx("img", {
              ...
              src: i === null || i.userPic === "" ? $e : i.userPic
            })]
          }), e.jsx("div", {
            ...
            children: e.jsxs("button", {
              className: ke.button,
              onPointerUp: () => {
                s !== null && ee(`https://t.me/${xt}?startapp=${btoa(`id=${s.id}`)}`)
              },
  ...
  ky = () => {
    ...
    return r && o.push(ht.enabled), e.jsx("button", {
      ...
      onPointerUp: () => {
        if (!i) {
          t(In(Re.create)), n.push("/tournament");
          return
        }
  ...
  Ry = () => {
    const t = g(),
      ...
      o = [ht.button],
      r = c(Ce);
    return c(d => d.tournament.selectedTemplateStatus) === p.pending ? null : (i && o.push(ht.enabled), s || o.push(ht.animation), e.jsxs("button", {
      className: o.join(" "),
      onPointerUp: d => {
        if (!s || !r) {
          t(In(Re.main)), n.push("/tournament");
          return
        }
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(Fy, {}), e.jsx(ky, {}), e.jsx(Ry, {}), e.jsx(Ny, {})]
        })
      })
    })
  }),
    ...
    return t && s === 2 && o.push(ce.info_button_active), e.jsx("div", {
      ...
      onPointerUp: r => {
        r.stopPropagation(), i(On({
          dataSource: Ve.userFromPixelInfo
        }))
      },
      children: "info"
    })
  ...
  Ky = () => {
    ...
    return m.useEffect(() => () => {
      ...
      children: [t && e.jsxs("div", {
        ...
        onPointerUp: async r => {
          var d, u;
          r.stopPropagation(), await Rn(`${jt}?startapp=x${i.x}_y${i.y}`) ? (u = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || u.notificationOccurred("success") : a(!0), n(!1), o.current = setTimeout(() => {
  ...
  mn = ({
    ...
    return n > 0 && (i = kn(i, n)), e.jsx("span", {
      className: Io.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ee(`https://t.me/${ji(t)}`) : It(`https://t.me/${ji(t)}`)
      },
      children: i
    })
  },
  ...
  Qw = ({
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(Ow, {
        ...
        children: [e.jsx(aw, {
          active: s
        }), s === 1 && e.jsx(Uw, {}), s === 2 && e.jsx(Iw, {})]
      })]
    })
  },
  Fw = () => c(He) ? null : e.jsxs("button", {
    className: ce.button,
    onPointerUp: () => {
  ...
  Xw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(Hv, {}), e.jsx(vv, {}), e.jsx(Gy, {}), e.jsx(Dv, {}), e.jsx(Yw, {}), e.jsx(ny, {}), e.jsx($v, {}), e.jsx(_y, {}), e.jsx(qv, {}), e.jsx(kv, {})]
  }),
  ...
  eb = () => e.jsxs(de, {
    children: [e.jsx("div", {
      ...
      children: e.jsxs("button", {
        className: vn.button,
        onPointerUp: () => {
          It("https://ton.org/en/open-league")
        },
    ...
    const I = async () => {
      try {
        const x = a.prices[0],
          ...
          O = Ze.beginCell().storeUint(0, 32).storeStringTail(w.data.txMemCode).endCell(),
          Q = {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("div", {
            ...
            children: n.map((r, l) => {
              ...
              let I = Z1;
              return l >= 8 && l <= 15 && (I = K1), l >= 16 && l <= 23 && (I = $1), l >= 24 && l <= 31 && (I = e0), e.jsxs("div", {
                className: h.join(" "),
                onPointerUp: () => {
                  t(q({
                    id: performance.now(),
  ...
  eI = "_template_item_container_srp11_1",
  tI = "_template_item_inner_srp11_9",
  nI = "_template_image_srp11_17",
  sI = "_template_image_info_layout_srp11_24",
  aI = "_template_image_info_container_srp11_34",
  yn = {
    template_item_container: eI,
    template_item_inner: tI,
    template_image: nI,
    template_image_info_layout: sI,
    template_image_info_container: aI
  },
  Dr = ({
    item: t,
    style: n = {}
  ...
  rI = () => e.jsxs("div", {
    children: [e.jsx($0, {}), e.jsx(oI, {})]
  }),
  cI = "_layout_94gj5_1",
  lI = "_container_94gj5_5",
  dI = "_button_container_94gj5_11",
  uI = "_button_94gj5_11",
  Hs = {
    layout: cI,
    container: lI,
    ...
    return m.useEffect(() => {
      ...
      if (n.current && a === p.fulfilled && !l) {
        const h = {
          ...
          _ = (y, I) => {
            y.forEach(x => {
              x.intersectionRatio >= 1 && (t(wt.getList({
                offset: i,
                limit: o
  ...
  pI = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === "my" && e.jsx(rI, {}), t === "catalog" && e.jsx(mI, {})]
    })
  },
  hI = () => {
    const t = g(),
  ...
  gI = () => e.jsxs(se.Fragment, {
    children: [e.jsx(hI, {}), e.jsx(pI, {})]
  }),
  oa = "/assets/paintings_anim2-nk1iBB8J.gif",
  _I = "_container_1h1qc_1",
  xI = "_divider_1h1qc_19",
  fI = "_row_1h1qc_24",
  vI = "_row_title_1h1qc_36",
  yI = "_row_title_main_1h1qc_40",
  wI = "_row_hint_1h1qc_45",
  jI = "_row_value_1h1qc_51",
  bI = "_row_value_main_1h1qc_55",
  II = "_mining_percent_1h1qc_60",
  NI = "_active_row_1h1qc_70",
  CI = "_button_1h1qc_81",
  qi = {
    container: _I,
    divider: xI,
  ...
  SI = "_layout_2uiqn_1",
  BI = "_container_2uiqn_6",
  TI = "_close_button_2uiqn_18",
  EI = "_title_container_2uiqn_26",
  DI = "_title_2uiqn_26",
  kI = "_image_container_2uiqn_37",
  RI = "_image_2uiqn_37",
  MI = "_image_placeholder_2uiqn_51",
  UI = "_info_container_2uiqn_58",
  OI = "_info_row_2uiqn_64",
  QI = "_info_title_2uiqn_69",
  FI = "_info_value_blue_2uiqn_73",
  GI = "_info_value_white_2uiqn_78",
  zI = "_buttons_container_2uiqn_82",
  LI = "_button_2uiqn_82",
  HI = "_not_button_2uiqn_98",
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(wt.subscribe({
              ...
              t(Zg(h)), j.mainImage.worldTemplate.deleteTemplate(o.id), j.mainImage.worldTemplate.add(h), t(ui())
            } else await t(q({
              id: performance.now(),
  ...
  pN = () => {
    ...
    if (r.dataSource === Ve.userFromPixelInfo) return {
      ready: s === p.fulfilled && t !== null,
      data: t == null ? void 0 : t.owner,
      item: r
    };
    if (r.dataSource === Ve.squadFromData) return {
      ready: i === p.fulfilled && o !== null,
      data: o,
      item: r
    };
    if (r.dataSource === Ve.userFromRating) {
      const l = r.index,
        d = n.length;
      return {
        ready: l < d,
  ...
  wN = "_container_os5nt_1",
  jN = "_not_completed_os5nt_6",
  bN = "_image_container_os5nt_10",
  IN = "_image_os5nt_10",
  NN = "_bold_os5nt_20",
  CN = "_gray_os5nt_24",
  ...
  LN = ({
    ...
    children: [t === "info" && e.jsx(yN, {
      isPopupContent: n
    }), t === "achievements" && e.jsx(GN, {
      isPopupContent: n
    }), t === "inventory" && e.jsx(zN, {})]
  }),
  HN = ({
    isPopupContent: t = !0
  }) => {
  ...
  VN = "_container_1bw7p_1",
  JN = {
    container: VN
  },
  WN = "_container_12mk9_1",
  ZN = "_page_12mk9_13",
  KN = "_id_12mk9_17",
  $N = "_title_12mk9_22",
  ...
  Qr = ({
    ...
    return n ? s !== null && s.squad.id !== null && s.squad.id === t.squad.id ? e.jsxs("div", {
      ...
      onPointerUp: () => {
        ee(`https://t.me/${xt}?startapp=${btoa(`id=${t.squad.id}`)}`)
      },
      children: [e.jsx("span", {
        className: T.gray,
        children: "Your Squad."
  ...
  IC = () => e.jsx("div", {
    ...
    children: bC.map((t, n) => {
      const s = t.avatar && t.avatar !== "" ? t.avatar : $e;
      return e.jsxs("div", {
      ...
      children: e.jsx("button", {
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Le.uploadTemplate({
                blob: h,
                posX: s,
                posY: a
              })).status === 200) {
              r && j.mainImage.worldTemplate.deleteTemplate(r.id);
              const y = await i(wt.getTemplateById({
                  id: l.id
                })),
                I = {
                  ...y.payload,
              ...
              i(Kg(I)), i(ui()), await j.mainImage.worldTemplate.add(I), i(q({
                id: performance.now(),
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const y = async () => {
          ...
          const Ee = (r - O) / 2,
            De = (r - Q) / 2;
          I.width = r, I.height = r, x.drawImage(t, Ee, De, O, Q);
          const V = x.getImageData(0, 0, r, r);
          BC(V), x.putImageData(V, 0, 0), a(V), o(I.toDataURL())
        };
        setTimeout(() => {
          y().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(DC, {}), i !== null && e.jsx(SC, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(K0, {
  ...
  NP = "_img_inner_container_17lvx_16",
  CP = "_image_17lvx_22",
    ...
    return m.useEffect(() => {
      if (s !== null) {
        ...
        const x = async () => {
          ...
          let Ee, De;
          Q > 1 ? (Ee = d, De = d / Q) : (De = d, Ee = d * Q);
          const V = (d - Ee) / 2,
            We = (d - De) / 2;
          w.width = d, w.height = d, O.drawImage(s, V, We, Ee, De);
  ...
  Xn = ({
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx("div", {
        ...
        className: st.template_item_picked,
        children: "Picked"
      }), t.approved === !1 && e.jsx("div", {
        className: st.template_item_rejected,
        children: "Rejected"
      }), n && e.jsx("div", {
  ...
  bS = () => (c(Ce), c(t => t.tournament.periodsStatus), e.jsxs("div", {
    children: [e.jsxs("div", {
      style: {
        borderRadius: 15,
  ...
  IS = "_soon_la5q2_1",
  NS = "_active_round_instruction_la5q2_11",
  ...
  DS = "_round_status_fail_la5q2_60",
  kS = "_success_la5q2_71",
  RS = "_fail_la5q2_75",
  MS = "_gray_la5q2_79",
  ...
  KS = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === Re.create && e.jsx(tS, {}), t === Re.main && e.jsx(bS, {}), t === Re.result && e.jsx(ZS, {})]
    })
  },
  ...
  bB = "_button_17ca7_84",
  IB = "_not_button_17ca7_100",
  NB = "_button_copy_17ca7_111",
  ne = {
    layout: dB,
    container: uB,
    close_button: AB,
  ...
  PB = () => {
    ...
    return c(Ce), !a || !s ? null : et.createPortal(e.jsx(qe, {
      onPointerUp: () => t(va()),
      show: s,
      children: e.jsx("div", {
        className: ne.layout,
  ...
  kB = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  RB = ({
    size: t,
    style: n = {},
    animation: s = !1
      ...
      children: [e.jsx($B, {}), e.jsxs("div", {
        ...
        children: [e.jsxs("div", {
          ...
          children: [e.jsx("img", {
            ...
            className: Ye.image_glow_container,
            children: e.jsx("img", {
              alt: "img",
...
const lT = () => {
  ...
  pE = () => {
    const t = g(),
      n = c(Za),
      s = c(i => i.shop.selectedCurrency);
    return c(dt) !== ye ? null : e.jsxs("div", {
  ...
  _E = ({
    ...
    const Q = async V => {
      ...
      const We = new da.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        Zr = await new da.token.jetton.JettonMinter(We, {
          address: Bt[i]
        }).getJettonWalletAddress(new da.utils.Address(w)),
        Kr = Ze.Address.parse(w),
        $r = Ze.Address.parse(Da),
        ec = Ze.beginCell().storeUint(0, 32).storeStringTail(V.txMemCode).endCell();
      let ca = Ze.toNano(V.strAmount);
      Number(i) === 4 && (ca = ca / 1000n);
      const tc = Ze.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(ca).storeAddress($r).storeAddress(Kr).storeBit(0).storeCoins(Ze.toNano("0.01")).storeBit(1).storeRef(ec).endCell(),
        nc = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
  ...
  wE = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(pE, {}), e.jsx(yE, {}), e.jsx(Ro, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: K.error,
...
const NE = () => {
  ...
  CE = () => e.jsxs("div", {
    ...
    children: [e.jsx(AE, {}), e.jsxs("div", {
      ...
      children: [e.jsx(mE, {}), e.jsx(jE, {}), e.jsx(NE, {})]
    }), e.jsx(wE, {})]
  }),
  PE = () => {
    const t = c(n => n.shop.show);
    return et.createPortal(e.jsx(qe, {
      show: t,
      children: e.jsxs("div", {
        className: K.container,
...
async function eD() {
  b.enable(b.BLEND), b.blendFunc(b.SRC_ALPHA, b.ONE_MINUS_SRC_ALPHA), b.clearColor(0, 0, 0, 0), b.viewport(0, 0, b.canvas.width, b.canvas.height), Pe = await tD(b), b.useProgram(Pe)
}
async function tD(t, n, s) {
  const a = JE,
    i = WE,
...
async function nD(t) {
  sD(), oD(t), Vr(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function oD(t) {
  ...
  Ds = l * l, ot(b, Pe, "u_AnimationDuration", Xr), ot(b, Pe, "u_ParticleSize", ZE), ot(b, Pe, "u_ViewportWidth", n), ot(b, Pe, "u_ViewportHeight", s), ot(b, Pe, "u_TextureWidth", a), ot(b, Pe, "u_TextureHeight", i), ot(b, Pe, "u_TextureLeft", o), ot(b, Pe, "u_TextureTop", r);
...
function rD(t) {
  ...
  ot(b, Pe, "u_ElapsedTime", s), b.drawArrays(b.POINTS, 0, Ds), Vr()
}
...
const cD = () => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx("img", {
                alt: "avatar",
                src: a.user.userPic && a.user.userPic !== "" ? a.user.userPic : $e,
                className: xe.avatar
              }), " ", e.jsx("span", {
                className: xe.name,
  ...
  gD = "_layout_1nuac_1",
  _D = "_container_1nuac_19",
  xD = "_image_container_1nuac_30",
  fD = "_image_1nuac_30",
  vD = "_text_container_1nuac_42",
  yD = "_title_1nuac_49",
  wD = "_button_container_1nuac_55",
  jD = "_button_1nuac_55",
  mt = {
    layout: gD,
    container: _D,
  ...
  ND = () => {
    ...
    return e.jsx(qe, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === Ve.userFromPixelInfo && e.jsx(Ha, {
          isPopupContent: s
        }), n.dataSource === Ve.userFromRating && e.jsx(Ha, {
          isPopupContent: s
        }), n.dataSource === Ve.squadFromData && e.jsx(ID, {})]
      })
    })
  },
  CD = "_overlay_1vl8z_1",
  PD = "_top_container_1vl8z_10",
  SD = "_bottom_container_1vl8z_15",
  BD = "_side_menu_1vl8z_20",
  TD = "_menu_safe_area_inset_1vl8z_36",
  ED = "_menu_header_1vl8z_40",
  DD = "_close_button_1vl8z_53",
  kD = "_menu_list_1vl8z_58",
  RD = "_icon_1vl8z_79",
  MD = "_icon_not_pixel_1vl8z_87",
  UD = "_gold_pixel_1vl8z_97",
  OD = "_menu_list_li_1vl8z_103",
  QD = "_menu_list_text_1vl8z_109",
  FD = "_menu_list_new_item_1vl8z_113",
  GD = "_button_wrapper_1vl8z_136",
  zD = "_button_content_1vl8z_145",
  LD = "_footer_1vl8z_152",
  HD = "_avatar_1vl8z_158",
  qD = "_ratings_image_container_1vl8z_165",
  YD = "_ratings_image_1vl8z_165",
  J = {
    overlay: CD,
    top_container: PD,
    bottom_container: SD,
    side_menu: BD,
    menu_safe_area_inset: TD,
    menu_header: ED,
    close_button: DD,
    menu_list: kD,
    icon: RD,
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(Pn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(lk, {}), e.jsx(ik, {}), e.jsxs("div", {
...
m.memo(({
  ...
  const [s, a] = m.useState(xk()), [i, o] = m.useState(!1);
  return m.useEffect(() => {
    t && setTimeout(() => {
      o(!0), setTimeout(() => {
        n(!1), o(!1)
...
const fk = "_container_gb8eq_1",
  vk = "_header_gb8eq_11",
  yk = "_title_gb8eq_17",
  wk = "_close_container_gb8eq_23",
  jk = "_close_gb8eq_23",
  bk = "_body_gb8eq_47",
  Ik = "_content_gb8eq_59",
  Nk = "_time_left_container_gb8eq_65",
  Ck = "_timer_gb8eq_69",
  Pk = "_image_container_gb8eq_73",
  Sk = "_image_gb8eq_73",
  Bk = "_glow_container_gb8eq_91",
  Tk = "_glow_gb8eq_91",
  Ek = "_rotate_gb8eq_1",
  Dk = "_glow_reverse_gb8eq_107",
  kk = "_description_container_gb8eq_113",
  Rk = "_bold_gb8eq_123",
  Mk = "_gray_gb8eq_128",
  Uk = "_center_gb8eq_132",
  Ok = "_gold_gb8eq_136",
  Qk = "_button_gb8eq_144",
  fe = {
    container: fk,
    header: vk,
    title: yk,
  ...
  Fk = "/assets/cup_glad-DGT2PBmm.png",
  Gk = () => {
    const t = W(),
      n = c(Ge),
      [s, a] = m.useState(!1),
      i = "showCreateTournamentTemplatePopup";
    return m.useEffect(() => ($a() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(qe, {
      show: s,
      children: e.jsx("div", {
  ...
  Zk = "_rotate_xga4i_1",
  Kk = "_reverse_xga4i_66",
  $k = "_text_container_xga4i_70",
  e4 = "_title_xga4i_78",
...
const d4 = "_layout_15tw0_1",
  ...
  x4 = () => {
    ...
    return m.useEffect(() => {
      if (t.showTemplate && t.refId && (i === p.fulfilled && a && a.id !== t.refId || i === p.rejected)) try {
        (async () => {
          const l = await Le.getTournamentTemplateById({
            id: t.refId
          });
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("img", {
              alt: "img",
              className: `${at.image} ${at.first_image}`,
              src: n ? n.url : ""
            })
          }), e.jsx("div", {
  ...
  b4 = "_image_1vlcp_40",
  I4 = "_shake_1vlcp_1",
  N4 = "_description_container_1vlcp_54",
  ...
  D4 = "_text_1vlcp_94",
  k4 = "_thanos_snap_container_1vlcp_105",
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx("img", {
                alt: "avatar",
                src: i.user.userPic && i.user.userPic !== "" ? i.user.userPic : $e,
                className: te.avatar
              }), " ", e.jsx("span", {
                className: te.name,
            ...
            children: [e.jsx("div", {
              ...
              children: s.map((r, l) => l === 0 ? null : e.jsxs("div", {
                ...
                children: [e.jsx("img", {
                  alt: "avatar",
                  src: r.user.userPic && r.user.userPic !== "" ? r.user.userPic : $e,
                  className: te.avatar
                }), " ", e.jsx("span", {
                  className: te.name,
  ...
  Y4 = () => e.jsxs("div", {
    className: jn.layout,
    children: [e.jsx(AT, {}), e.jsx(cT, {}), e.jsx(ix, {}), e.jsx(B2, {}), e.jsx(lT, {}), e.jsx(dD, {}), e.jsx(bD, {}), e.jsx(ND, {}), e.jsx(MT, {}), e.jsx(lD, {}), e.jsx(Gk, {}), e.jsx(l4, {}), e.jsx(x4, {}), e.jsx(PE, {}), e.jsx(cD, {}), e.jsx(q4, {}), e.jsx(hD, {}), e.jsx(uk, {})]
  }),
  X4 = () => {
    const t = g(),
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("button", {
            className: St.button,
            onPointerUp: () => {
              t ? ee("https://t.me/notpixel_channel") : It("https://t.me/notpixel_channel")
            },
            children: "Not Pixel Channel"
          })
        })]
...
qc(Gn);
Th(Gn);
const bR = ic.createRoot(document.getElementById("root"));
bR.render(e.jsx(se.StrictMode, {
  children: e.jsx(lc, {
    store: Gn,
    children: e.jsx(xc, {
      children: e.jsx(Ac, {
