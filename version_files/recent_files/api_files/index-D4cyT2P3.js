...
var Rn = (t, n, s) => Xr(t, typeof n != "symbol" ? n + "" : n, s);
import {
  j as e,
  r as m,
  R as te
...
const Lc = {
  ...
  }),
  {
    ...
    setLimitedGoods: G4,
    clearLimitedGoods: X4,
    showLimitedGoodsPopup: Gc,
    hideLimitedGoodsPopup: V4
  } = Ki.actions,
  Zi = t => t.shop.crypto,
  Xc = Ki.reducer,
  Qs = {
  ...
  ao = (t, n) => ea[t] ? ea[t](t, n) : ea.default(),
  xl = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  Il = () => io() ? Gn.VITE_ADSGRAM_BLOCK_ID : bl() ? "4853" : "4995",
  ft = {
    isDev: Nl(),
    devServer: io(),
  ...
  sn = async t => {
  ...
  }, va = t => !0, od = "_layout_13e1w_1", rd = "_container_13e1w_10", cd = "_star_13e1w_14", ld = "_move_13e1w_1", Mn = {
    layout: od,
    container: rd,
    star: cd,
    move: ld
  ...
  }, () => !1), Ad = "_layout_1nbfl_1", pd = "_button_1nbfl_14", ri = {
    layout: Ad,
    button: pd
  }, hd = () => {
    const t = K();
    ...
    offset: t,
    limit: n
  })).data), Vn = O("user/getPixelsForSaleTotal", async () => (await Y.getUserPixelsCount()).data), Jn = O("user/getUserPixelsSold", async ({
    offset: t,
    limit: n
    ...
    setPixelsSoldOffset: J4,
    setPixelsSoldTotal: Y4,
    setPixelsSoldFetchStatus: W4,
    removePixelsSold: K4,
    addPixelCoins: Mt,
  ...
  }, Bd = t => t.user.userPic, Ie = t => t.user.user, Ed = mo.reducer, Dt = {
    getPixelsForSale: Xn,
  ...
  }, zd = "_text_layout_1xggq_1", qd = "_text_1xggq_1", Ld = "_button_layout_1xggq_14", Hd = "_button_layout_placeholder_1xggq_26", Gd = "_button_1xggq_14", ln = {
    text_layout: zd,
    text: qd,
    button_layout: Ld,
  ...
  }), $d = "_pixels_amount_ngjsa_1", eu = "_general_info_container_ngjsa_6", tu = "_coin_amount_text_ngjsa_12", nu = "_description_container_ngjsa_16", su = "_description_ngjsa_16", Un = {
    pixels_amount: $d,
    ...
    logo_container: au
  }, ou = "_layout_1cvcu_1", ru = "_container_1cvcu_10", cu = "_bubble_1cvcu_16", lu = "_move_1cvcu_1", na = {
    layout: ou,
    container: ru,
    bubble: cu,
    move: lu
  ...
  }, () => !1), uu = "_container_1aw3i_1", mu = "_logo_1aw3i_9", Au = "_animate_1aw3i_1", pu = "_center_1aw3i_18", hu = "_glow_1aw3i_28", On = {
    container: uu,
    logo: mu,
    animate: Au,
    center: pu,
...
const Ai = () => {
  ...
  yA = () => e.jsxs("div", {
    ...
    children: [e.jsx(aA, {}), e.jsx(vA, {}), e.jsx(AA, {}), e.jsx(dA, {}), e.jsx(pA, {}), e.jsx(jm, {}), e.jsx(ia, {
      text: "Quick start"
    }), e.jsx(Nm, {}), e.jsx(Pm, {}), e.jsx(Sm, {}), e.jsx(ia, {
      text: "Special"
    }), e.jsx(Um, {}), e.jsx(oA, {}), e.jsx(cA, {}), e.jsx(Zm, {}), e.jsx(Lm, {}), e.jsx(zm, {}), e.jsx(xm, {}), e.jsx(Tm, {}), e.jsx(Bm, {}), e.jsx(Em, {}), e.jsx(Rm, {}), e.jsx(gA, {}), e.jsx(ia, {
      text: "Browser"
    ...
    return m.useEffect(() => {
      function a(i) {
        i.ctrlKey && i.altKey && i.keyCode === 67 && (async () => {
          try {
            await sn(window.Telegram.WebApp.initData), await t(z({
              id: performance.now(),
              text: "Copied!"
            }))
          } catch {
...
const No = Ss.getSelectors(t => t.daily.list);
Oa.getSelectors(t => t.reward.list);
const Io = _n.getSelectors(t => t.tournament.approvedTemplatesList),
  VA = () => {
...
const Ip = "_order_panel_dvy5p_1",
  ...
  pi = window.Telegram.WebApp.CloudStorage;
let Eo = class {
  static warn() {
    ...
    va() && (s = {
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          ...
          if (r.type === Zs.pixanos && ut.dispatch(ah(l)), l.user.userId === n || !jn) return;
      ...
      sc(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === Kp[1] && ut.getState().daily.list.entities[d.good_id]) {
...
const eg = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(Os(10)), t(st(1)), t(at()), t(Mo()), !1;
  if (s === a) return !1;
  ...
  try {
    (await t(Qs.useProduct({
      productId: 1,
      pixelId: 1
    }))).meta.requestStatus === A.fulfilled && (t(Iu(a)), t(Fs({
      product: 1,
      amount: 1
  ...
  setShowSideMenu: Bt
} = qo.actions, Lo = t => t.layout.isShowSideMenu, sg = qo.reducer;
let Ht = null,
  Gt = null;
class Ho {
...
jt.startListening({
  matcher: ve(Pe.checkTask.fulfilled),
  effect: (t, n) => {
...
jt.startListening({
  matcher: ve(Pe.checkBoost.fulfilled),
  effect: (t, n) => {
    const s = t.meta.arg.key,
      a = t.payload[s];
    let i = "Not enough PX",
...
jt.startListening({
  matcher: ve(Pe.checkTask.rejected),
  effect: (t, n) => {
    n.dispatch(z({
      id: performance.now(),
      text: "Check failed",
...
jt.startListening({
  matcher: ve(Pe.checkBoost.rejected),
  effect: (t, n) => {
    n.dispatch(z({
      id: performance.now(),
      text: "Not enough PX",
...
const Gs = tn();
Gs.startListening({
  matcher: ve(qs.getPriceMask.pending, Dt.getPixelsForSale.pending, Dt.getPixelsSold.pending, Ha.get.pending),
  effect: (t, n) => {
    n.dispatch(tt({
      command: Ee.start
    }))
...
Gs.startListening({
  matcher: ve(qs.getPriceMask.fulfilled, Dt.getPixelsForSale.fulfilled, Dt.getPixelsSold.fulfilled, Ha.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(tt({
      command: Ee.finish
    }))
  ...
  Cg = () => {
    ...
    return e.jsxs(rn, {
      children: [a && o && e.jsx(De, {
        active: n === Se.create,
        setActive: () => t(fn(Se.create)),
        children: "My template"
      }), e.jsx(De, {
        active: n === Se.main,
        setActive: () => t(fn(Se.main)),
        children: "Tournament"
      }), e.jsx(De, {
        active: n === Se.result,
        setActive: () => t(fn(Se.result)),
        children: "My results"
      })]
    })
  };
...
const ms = O("tournament/getPeriods", async () => (await sr.getPeriods()).data),
  As = O("tournament/getResults", async () => (await sr.getResults()).data),
  ...
  En = tn();
En.startListening({
  matcher: ve(ke.getMyTemplate.fulfilled),
  effect: (t, n) => {
    const s = n.getState();
...
En.startListening({
  matcher: ve(ke.getSelectedTemplate.fulfilled, cr),
  effect: (t, n) => {
    const s = n.getState();
...
const Dn = Jr({
    ...
    devTools: !1,
    middleware: t => [Bn.middleware, Jo.middleware, Gs.middleware, jt.middleware, Yo.middleware, En.middleware, ...t()]
  }),
  vs = [],
  Qg = async ({
    dispatch: t,
...
const D_ = m.memo(() => (m.useEffect(() => {
  ...
  Bf = "_divider_1h1qc_19",
  Ef = "_row_1h1qc_24",
  Df = "_row_title_1h1qc_36",
  kf = "_row_title_main_1h1qc_40",
  Rf = "_row_hint_1h1qc_45",
  Mf = "_row_value_1h1qc_51",
  Uf = "_row_value_main_1h1qc_55",
  Of = "_mining_percent_1h1qc_60",
  Ff = "_active_row_1h1qc_70",
  Qf = "_button_1h1qc_81",
  vi = {
    container: Tf,
    divider: Bf,
  ...
  kn = ({
    ...
    return n > 0 && (i = Pn(i, n)), e.jsx("span", {
      className: uo.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ue(`https://t.me/${oi(t)}`) : nn(`https://t.me/${oi(t)}`)
      },
      children: i
    })
  },
  ...
  Qv = () => c(n => n.canvas.coords) === null ? null : e.jsx(te.Fragment, {
    children: e.jsx(Fv, {})
  }),
  zv = "_layout_14eqc_1",
  ...
  Ky = () => {
    ...
    return r && o.push(ht.enabled), e.jsx("button", {
      ...
      onPointerUp: () => {
        if (!i) {
          t(fn(Se.create)), n.push("/tournament");
          return
        }
  ...
  Zy = () => {
    ...
    return i && o.push(ht.enabled), s || o.push(ht.animation), e.jsxs("button", {
      ...
      onPointerUp: l => {
        if (!s || !r) {
          t(fn(Se.main)), n.push("/tournament");
          return
        }
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(Ky, {}), e.jsx(Zy, {}), e.jsx(Ly, {})]
        })
      })
    })
  }),
  ...
  L1 = "_instruction_container_14ts7_1",
  ...
  I0 = () => {
    ...
    return e.jsxs(rn, {
      children: [e.jsx(De, {
        ...
        active: n === "catalog",
        setActive: () => t(_i("catalog")),
        children: "Catalog"
      })]
    })
  },
  P0 = () => e.jsxs(te.Fragment, {
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Oe.uploadTemplate({
              ...
              i(_g(I)), i(Zo()), await v.mainImage.worldTemplate.add(I), i(z({
                id: performance.now(),
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const b = async () => {
          ...
          let q, L;
          j > 1 ? (q = r, L = r / j) : (L = r, q = r * j);
          const He = (r - q) / 2,
            W = (r - L) / 2;
          I.width = r, I.height = r, f.drawImage(t, He, W, q, L);
  ...
  JP = "_template_rank_pxfff_55",
  YP = "_template_recolors_pxfff_75",
  ...
  nC = () => {
    ...
    return m.useEffect(() => (t(ke.getRandomList()), () => {
      ...
      children: [e.jsxs("div", {
        className: Ye.container,
        children: [e.jsx(tC, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(ti, {
          item: i
        }, i.id))]
      }), e.jsx(eC, {})]
    })
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: M(l ? G.success : G.fail),
              children: ["👑 ", r]
            })]
          }), e.jsxs("div", {
            ...
            children: [e.jsx("div", {
              ...
              className: M(i ? G.success : G.fail),
              children: t.rank
            })]
          }), e.jsxs("div", {
            className: G.round_line,
  ...
  FC = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(UC, {}), e.jsx(OC, {}), e.jsx(RC, {}), e.jsx(MC, {})]
    })
  },
  QC = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === Se.create && e.jsx(OP, {}), t === Se.main && e.jsx(uC, {}), t === Se.result && e.jsx(FC, {})]
    })
  },
  zC = () => e.jsxs(te.Fragment, {
    children: [e.jsx(Cg, {}), e.jsx(QC, {})]
  }),
  ...
  ZC = "_layout_17ca7_1",
  $C = "_container_17ca7_6",
  eS = "_close_button_17ca7_20",
  tS = "_title_container_17ca7_28",
  nS = "_title_17ca7_28",
  sS = "_image_container_17ca7_39",
  aS = "_image_17ca7_39",
  iS = "_image_placeholder_17ca7_53",
  oS = "_info_container_17ca7_60",
  rS = "_info_row_17ca7_66",
  cS = "_info_title_17ca7_71",
  lS = "_info_value_blue_17ca7_75",
  dS = "_info_value_white_17ca7_80",
  uS = "_buttons_container_17ca7_84",
  mS = "_button_17ca7_84",
  AS = "_not_button_17ca7_100",
  ...
  wS = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  jS = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  NS = "_container_tuzgg_1",
  IS = "_column_tuzgg_9",
  PS = "_column_rev_tuzgg_17",
  CS = "_title_tuzgg_26",
  SS = "_table_container_tuzgg_32",
  TS = "_table_row_tuzgg_38",
  BS = "_button_tuzgg_45",
  ES = "_value_tuzgg_52",
  DS = "_notpixel_icon_tuzgg_58",
  kS = "_active_row_tuzgg_74",
  RS = "_row_title_tuzgg_74",
  je = {
    container: NS,
    column: IS,
    column_rev: PS,
  ...
  LS = "_container_qn09x_1",
  HS = "_image_container_qn09x_9",
  GS = "_image_qn09x_9",
  ...
  WS = "_bold_qn09x_43",
  KS = "_input_qn09x_47",
  ZS = "_catalog_container_qn09x_71",
  $S = "_catalog_title_qn09x_76",
  e2 = "_catalog_items_container_qn09x_81",
  t2 = "_catalog_item_qn09x_81",
  n2 = "_catalog_item_image_container_qn09x_100",
  s2 = "_catalog_item_image_qn09x_100",
  a2 = "_button_container_qn09x_109",
  i2 = "_button_qn09x_109",
  o2 = "_wrong_helper_text_qn09x_124",
  r2 = "_wrong_button_qn09x_129",
  c2 = "_wrong_button_text2_qn09x_142",
  S = {
    container: LS,
    image_container: HS,
    image: GS,
  ...
  h2 = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif",
  Qn = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
  ...
  g2 = () => {
    ...
    return m.useEffect(() => {
      ...
      (async () => {
        ...
        q.status === 200 && q.data && q.data.forEach(L => {
              ...
              try {
                ...
                if (j.status === 200) {
                  ...
                  if (q.secretWord.success) {
                    let L = "Success!";
                    q.secretWord.reward && (L += ` ${q.secretWord.reward} PX earned`), t(z({
                      id: performance.now(),
                      text: L,
                      icon: ""
...
const K2 = () => {
    ...
    return m.useEffect(() => {
      const s = () => {
        _2.includes(t.pathname) ? n.push("/") : n.goBack()
      };
  ...
  tT = "_container_11ui8_1",
  nT = "_header_11ui8_13",
  sT = "_close_container_11ui8_23",
  aT = "_close_11ui8_23",
  iT = "_title_11ui8_48",
  oT = "_frens_count_11ui8_53",
  rT = "_body_11ui8_58",
  cT = "_content_11ui8_68",
  lT = "_image_container_11ui8_75",
  dT = "_image_11ui8_75",
  uT = "_image_container_charges_11ui8_84",
  mT = "_image_charges_11ui8_89",
  AT = "_description_container_11ui8_94",
  pT = "_bold_11ui8_102",
  hT = "_gray_11ui8_107",
  gT = "_center_11ui8_111",
  _T = "_benefits_container_11ui8_115",
  ...
  NT = "_container_19qal_1",
  IT = "_header_19qal_9",
  PT = "_close_19qal_19",
  CT = "_title_19qal_31",
  ST = "_body_19qal_36",
  TT = "_image_container_19qal_49",
  BT = "_image_19qal_49",
  ET = "_content_container_19qal_60",
  DT = "_description_container_19qal_68",
  kT = "_description_item_19qal_75",
  RT = "_amount_selector_container_19qal_82",
  MT = "_amount_selector_button_19qal_88",
  ...
  HT = "_tokens_selector_19qal_171",
  GT = "_tokens_title_19qal_176",
  XT = "_connect_wallet_text_title_19qal_183",
  VT = "_tokens_container_19qal_192",
  JT = "_token_item_19qal_199",
  YT = "_token_image_container_19qal_210",
  WT = "_token_image_19qal_210",
  KT = "_sale_box_19qal_220",
  ZT = "_sale_text_19qal_232",
  J = {
    container: NT,
    header: IT,
    close: PT,
    ...
    description_item: kT,
    amount_selector_container: RT,
    amount_selector_button: MT,
  ...
  iB = ({
    ...
    const s = g(),
      ...
      [d, u] = m.useState(!1),
      [h, _] = Nn(),
      I = (He = c(W => W.shop.products[a]).prices.filter(W => W.currency_id === i)[0]) == null ? void 0 : He.price,
      f = Rs();
    if (c(W => W.shop.selectedCurrency) === 1 || f === "") return null;
    const q = async W => {
      const ge = Xe.beginCell().storeUint(0, 32).storeStringTail(W.txMemCode).endCell(),
        ni = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
            address: xa,
            amount: String(Xe.toNano(W.strAmount)),
      ...
      const ge = new Ks.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        Fr = await new Ks.token.jetton.JettonMinter(ge, {
          address: Ct[i]
        }).getJettonWalletAddress(new Ks.utils.Address(f)),
        Qr = Xe.Address.parse(f),
        zr = Xe.Address.parse(xa),
        qr = Xe.beginCell().storeUint(0, 32).storeStringTail(W.txMemCode).endCell(),
        Lr = Xe.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(Xe.toNano(W.strAmount)).storeAddress(zr).storeAddress(Qr).storeBit(0).storeCoins(Xe.toNano("0.01")).storeBit(1).storeRef(qr).endCell(),
        Hr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
  ...
  dB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(nB, {}), e.jsx(lB, {}), e.jsx(yo, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: J.error,
...
const pB = () => {
  ...
  hB = () => e.jsxs("div", {
    ...
    children: [e.jsx(eB, {}), e.jsxs("div", {
      className: J.content_container,
      children: [e.jsx(tB, {}), e.jsx(uB, {}), e.jsx(pB, {})]
    }), e.jsx(dB, {})]
  }),
  gB = () => {
  ...
  vB = "_title_9sf1k_30",
  yB = "_body_9sf1k_35",
  wB = "_image_container_9sf1k_47",
  jB = "_image_9sf1k_47",
  bB = "_shake_9sf1k_1",
  NB = "_description_container_9sf1k_60",
  IB = "_buyer_info_9sf1k_70",
  PB = "_avatar_9sf1k_78",
  CB = "_name_9sf1k_84",
  SB = "_squad_info_9sf1k_88",
  TB = "_squad_avatar_9sf1k_94",
  BB = "_text_container_9sf1k_100",
  EB = "_text_9sf1k_100",
  DB = "_thanos_snap_container_9sf1k_110",
  kB = "_thanos_snap_text_9sf1k_119",
  RB = "_button_container_9sf1k_126",
  MB = "_button_9sf1k_126",
  me = {
    layout: _B,
    container: fB,
    header: xB,
...
async function qB() {
  y.enable(y.BLEND), y.blendFunc(y.SRC_ALPHA, y.ONE_MINUS_SRC_ALPHA), y.clearColor(0, 0, 0, 0), y.viewport(0, 0, y.canvas.width, y.canvas.height), be = await LB(y), y.useProgram(be)
}
async function LB(t, n, s) {
  const a = UB,
    i = OB,
...
async function HB(t) {
  GB(), JB(t), Mr(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function JB(t) {
  ...
  ws = l * l, $e(y, be, "u_AnimationDuration", Rr), $e(y, be, "u_ParticleSize", FB), $e(y, be, "u_ViewportWidth", n), $e(y, be, "u_ViewportHeight", s), $e(y, be, "u_TextureWidth", a), $e(y, be, "u_TextureHeight", i), $e(y, be, "u_TextureLeft", o), $e(y, be, "u_TextureTop", r);
...
function YB(t) {
  ...
  $e(y, be, "u_ElapsedTime", s), y.drawArrays(y.POINTS, 0, ws), Mr()
}
...
const WB = () => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                var r, l;
                v.viewport.viewport.fit(), v.viewport.viewport.moveCenter(v.viewport.viewport.worldWidth / 2, v.viewport.viewport.worldHeight / 2), n(gi(!0)), setTimeout(() => {
                  n(gi(!1))
                }, 7e3);
                try {
                  await QB(i ? 0 : Cc)
  ...
  oE = "_image_container_1nuac_30",
  rE = "_image_1nuac_30",
  cE = "_text_container_1nuac_42",
  lE = "_title_1nuac_49",
    ...
    return e.jsx(Le, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === ze.userFromPixelInfo && e.jsx(Ta, {
          ...
          isPopupContent: s
        }), n.dataSource === ze.squadFromData && e.jsx(AE, {})]
      })
    })
  },
  hE = "_overlay_1vl8z_1",
  gE = "_top_container_1vl8z_10",
  _E = "_bottom_container_1vl8z_15",
  ...
  jE = "_icon_1vl8z_79",
  bE = "_icon_not_pixel_1vl8z_87",
  NE = "_gold_pixel_1vl8z_97",
  IE = "_menu_list_li_1vl8z_103",
  PE = "_menu_list_text_1vl8z_109",
  CE = "_menu_list_new_item_1vl8z_113",
  SE = "_button_wrapper_1vl8z_136",
  TE = "_button_content_1vl8z_145",
  BE = "_footer_1vl8z_152",
  EE = "_avatar_1vl8z_158",
  DE = "_ratings_image_container_1vl8z_165",
  ...
  V = {
    ...
    menu_list_li: IE,
    menu_list_text: PE,
    menu_list_new_item: CE,
    button_wrapper: SE,
    button_content: TE,
    footer: BE,
    avatar: EE,
    ratings_image_container: DE,
    ratings_image: kE
  },
  Oi = [.215, .61, .355, 1],
  RE = {
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(vn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(KE, {}), e.jsx(VE, {}), e.jsxs("div", {
...
m.memo(({
  ...
  const [s, a] = m.useState(oD()), [i, o] = m.useState(!1);
  return m.useEffect(() => {
    t && setTimeout(() => {
      o(!0), setTimeout(() => {
        n(!1), o(!1)
...
const rD = "_container_gb8eq_1",
  ...
  CD = "/assets/cup_glad-DGT2PBmm.png",
  SD = () => {
    const t = K(),
      n = c(Ie),
      [s, a] = m.useState(!1),
  ...
  TD = "_layout_xga4i_1",
  BD = "_container_xga4i_14",
  ED = "_header_xga4i_20",
  DD = "_close_xga4i_25",
  kD = "_body_xga4i_38",
  RD = "_image_container_xga4i_42",
  MD = "_image_xga4i_42",
  UD = "_glow_xga4i_55",
...
const ZD = "_layout_15tw0_1",
  $D = "_container_15tw0_7",
  ek = "_close_button_15tw0_16",
  tk = "_title_container_15tw0_24",
  nk = "_image_container_15tw0_31",
  sk = "_image_15tw0_31",
  ak = "_text_container_15tw0_50",
  ...
  rk = () => e.jsxs("div", {
    className: gn.layout,
    children: [e.jsx(eT, {}), e.jsx(W2, {}), e.jsx(D_, {}), e.jsx(f2, {}), e.jsx(K2, {}), e.jsx(ZB, {}), e.jsx(mE, {}), e.jsx(pE, {}), e.jsx(bT, {}), e.jsx(KB, {}), e.jsx(SD, {}), e.jsx(KD, {}), e.jsx(ok, {}), e.jsx(gB, {}), e.jsx(WB, {}), e.jsx(sE, {}), e.jsx($E, {})]
  }),
  ck = () => {
    const t = g(),
  ...
  Ak = "_logo_container_ieygs_17",
  pk = "_logo_ieygs_17",
  hk = "_animate_ieygs_1",
  gk = "_center_ieygs_37",
  _k = "_title_ieygs_51",
  fk = "_description_ieygs_58",
  xk = "_button_container_ieygs_63",
  vk = "_button_ieygs_63",
  yk = "_b_ieygs_63",
  Pt = {
    layout: uk,
  ...
  jk = "/assets/loading-D8SQALTR.gif",
  bk = () => e.jsxs("div", {
  ...
  Dk = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Bc) && dk(), Nk(), Ik(), Pk(), a || o ? e.jsx(wk, {}) : i ? e.jsx(bk, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
...
kc(Dn);
Zp(Dn);
const Fk = Vr.createRoot(document.getElementById("root"));
Fk.render(e.jsx(te.StrictMode, {
  children: e.jsx(Kr, {
    store: Dn,
    children: e.jsx(oc, {
      children: e.jsx(ec, {
