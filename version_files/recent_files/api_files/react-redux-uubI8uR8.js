...
function T() {
  ...
  let o = e.get(s.createContext);
  return o || (o = s.createContext(null), e.set(s.createContext, o)), o
}
var c = T(),
  U = () => {
  ...
  const o = e === c ? R : x(e),
    t = (n, r = {}) => {
      ...
      const v = s.useCallback({
        ...
        } [n.name], [n, b, a.stabilityCheck]),
        S = E(f.addNestedSub, l.getState, u || l.getState, v, i);
  ...
  return {
    ...
    subscribe(t) {
      ...
      return r.prev ? r.prev.next = r : e = r,
        function() {
          !n || e === null || (n = !1, r.next ? r.next.prev = r.prev : o = r.prev, r.prev ? r.prev.next = r.next : e = r.next)
        }
    }
  }
}
...
function z(e, o) {
  ...
  function b() {
    r++, t || (t = e.subscribe(f), n = j())
  }

  function p() {
    r--, t && r === 0 && (t(), t = void 0, n.clear(), n = m)
  }
...
var W = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u",
  ...
  q = W || I ? s.useLayoutEffect : s.useEffect;
...
var G = K();
D(M.useSyncExternalStoreWithSelector);
export {
  F as P, G as a, $ as u
};