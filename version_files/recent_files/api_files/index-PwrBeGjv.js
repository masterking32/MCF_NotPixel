...
var Rn = (t, n, s) => Vr(t, typeof n != "symbol" ? n + "" : n, s);
import {
  j as e,
  r as m,
  R as ee
...
const Hc = {
  ...
  fl = (t, n) => n < 5 ? qt[1] : n < 10 ? qt[5] : n < 100 ? qt[10] : n < 500 ? qt[100] : n < 1e3 ? qt[500] : qt[1e3],
  ii = {
    9: Yi,
    10: Wi,
    11: Ki
  ...
  io = (t, n) => ea[t] ? ea[t](t, n) : ea.default(),
  vl = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  Pl = () => oo() ? Gn.VITE_ADSGRAM_BLOCK_ID : Nl() ? "4853" : "4995",
  ft = {
    isDev: Il(),
    devServer: oo(),
  ...
  sn = async t => {
  ...
  }, uo = t => new Promise(n => setTimeout(n, t)), sd = t => {
  ...
  }, ya = t => !0, rd = "_layout_13e1w_1", cd = "_container_13e1w_10", ld = "_star_13e1w_14", dd = "_move_13e1w_1", Mn = {
    layout: rd,
    container: cd,
    star: ld,
    move: dd
  }, ud = "_link_1fn8i_1", md = "_telegram_icons_1fn8i_13", mo = {
    link: ud,
    telegram_icons: md
  }, N = ({
    children: t,
  ...
  }, () => !1), pd = "_layout_1nbfl_1", hd = "_button_1nbfl_14", li = {
    layout: pd,
    button: hd
  }, gd = () => {
    const t = W();
  ...
  }, _d = "_layout_gx8in_1", fd = "_container_gx8in_5", xd = "_item_gx8in_11", vd = "_active_gx8in_20", yd = "_image_container_gx8in_24", wd = "_image_gx8in_24", jd = "_item_text_container_gx8in_34", bd = "_item_text_gx8in_34", ot = {
    layout: _d,
    container: fd,
    item: xd,
    active: vd,
    ...
    setPixelsSoldOffset: W4,
    setPixelsSoldTotal: K4,
    setPixelsSoldFetchStatus: Z4,
    removePixelsSold: $4,
    addPixelCoins: Mt,
  ...
  }, Ed = t => t.user.userPic, Pe = t => t.user.user, Dd = Ao.reducer, Dt = {
    getPixelsForSale: Xn,
  ...
  }, qd = "_text_layout_1xggq_1", Ld = "_text_1xggq_1", Hd = "_button_layout_1xggq_14", Gd = "_button_layout_placeholder_1xggq_26", Xd = "_button_1xggq_14", ln = {
    text_layout: qd,
    text: Ld,
    button_layout: Hd,
  ...
  }), eu = "_pixels_amount_ngjsa_1", tu = "_general_info_container_ngjsa_6", nu = "_coin_amount_text_ngjsa_12", su = "_description_container_ngjsa_16", au = "_description_ngjsa_16", Un = {
    pixels_amount: eu,
    ...
    logo_container: iu
  }, ru = "_layout_1cvcu_1", cu = "_container_1cvcu_10", lu = "_bubble_1cvcu_16", du = "_move_1cvcu_1", na = {
    layout: ru,
    container: cu,
    bubble: lu,
    move: du
  ...
  }, () => !1), mu = "_container_1aw3i_1", Au = "_logo_1aw3i_9", pu = "_animate_1aw3i_1", hu = "_center_1aw3i_18", gu = "_glow_1aw3i_28", On = {
    container: mu,
    logo: Au,
    animate: pu,
    center: hu,
  ...
  }), xu = "_container_13oyr_1", vu = "_button_13oyr_11", yu = "_info_13oyr_32", _t = {
    container: xu,
    button: vu,
    info: yu
  };
...
const hi = () => {
  ...
  hA = () => {
    const s = w["taskTypeCampaign3_74388"],
      ...
      i = c(r => r.mining.tasks[s]),
      o = 1024;
    return a !== "RU" && a !== "ru" ? null : e.jsx(se, {
      action: () => {
  ...
  _A = () => {
    const t = c(Pe),
      ...
      a = 512;
    return !t || t.id !== 395492139 ? null : e.jsx(se, {
      boost: n,
      reward: a,
      children: e.jsxs("div", {
        className: p.content,
  ...
  wA = () => e.jsxs("div", {
    ...
    children: [e.jsx(iA, {}), e.jsx(yA, {}), e.jsx(pA, {}), e.jsx(uA, {}), e.jsx(hA, {}), e.jsx(bm, {}), e.jsx(ia, {
      text: "Quick start"
    }), e.jsx(Im, {}), e.jsx(Cm, {}), e.jsx(Tm, {}), e.jsx(ia, {
      text: "Special"
    }), e.jsx(Om, {}), e.jsx(rA, {}), e.jsx(lA, {}), e.jsx($m, {}), e.jsx(Hm, {}), e.jsx(qm, {}), e.jsx(vm, {}), e.jsx(Bm, {}), e.jsx(Em, {}), e.jsx(Dm, {}), e.jsx(Mm, {}), e.jsx(_A, {}), e.jsx(ia, {
      text: "Browser"
    }), e.jsx(ym, {}), e.jsx(wm, {}), e.jsx(Fm, {}), e.jsx(Qm, {}), e.jsx(Rm, {}), e.jsx("div", {
      style: {
        height: 30
      }
    })]
  ...
  qA = "_noPixelsContainer_7jsmf_136",
  ...
  za = Ps.getSelectors(t => t.user.pixelsForSale);
Cs.getSelectors(t => t.user.pixelsSold);
const Io = Ss.getSelectors(t => t.daily.list);
...
const Po = _n.getSelectors(t => t.tournament.approvedTemplatesList),
  JA = () => {
    ...
    return c(za.selectTotal) === 0 && t === A.fulfilled ? e.jsx("div", {
...
let Yt = null;
const ja = F("canvas/getPixelInfo", async ({
    id: t
  ...
  sp = () => Oa() ? localStorage.getItem("enableAnimations") ? localStorage.getItem("enableAnimations") === "true" : (localStorage.setItem("enableAnimations", "true"), !0) : !0,
  ap = {
    coords: null,
    animations: sp(),
    stats: null,
...
let Ip = class {
  constructor({
    ...
    this.app = n, this.pixiViewport = s.viewport, this.mainImage = a, this.size = 5, this.bombs = [Ap, pp, hp, gp, _p, fp, xp, vp, yp, wp, jp, bp, Np], this.textureArray = [];
    for (let i = 0; i < 13; i++) {
...
const Pp = "_order_panel_dvy5p_1",
  ...
  gi = window.Telegram.WebApp.CloudStorage;
let Do = class {
  static warn() {
...
const eh = (t, n) => {
    ...
    ya() && (s = {
    ...
    }), At = new sc(Ra.replace("https", "wss").replace("api/v1/", "connection/websocket"), s), At.on("connected", function(a) {
      ...
      if (a.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(a.data)).forEach(r => {
          ...
          if (r.type === Zs.pixanos && ut.dispatch(ih(l)), l.user.userId === n || !jn) return;
      ...
      ac(i, (o, r) => {
        if (o) console.error("Ошибка распаковки данных:", o);
          ...
          if (a.channel === "pixel:message") Object.values(l).forEach(d => {
            ...
            if (d.type === Zp[1] && ut.getState().daily.list.entities[d.good_id]) {
  ...
  }),
  {
    ...
    setReferrerSquadId: Na
  } = Ro.actions,
  uh = Ro.reducer,
  on = Da(t => t.main.settings, t => {
...
const tg = async ({
  ...
  var l, d;
  if (!n && o && (n = o.shop.available[1], s = o.mining.charges, a = o.mining.maxCharges, i = o.shop.useProductStatus), !n || n === 0) return t(Os(10)), t(st(1)), t(at()), t(Uo()), !1;
  if (s === a) return !1;
  ...
  setShowSideMenu: Bt
} = Lo.actions, Ho = t => t.layout.isShowSideMenu, ag = Lo.reducer;
let Ht = null,
  Gt = null;
class Go {
...
jt.startListening({
  ...
  effect: (t, n) => {
    t.payload.activated && (n.dispatch(Pd(t.payload.totalUserPixels)), n.dispatch(ho(t.payload.userBalance))), n.dispatch(Gc(t.payload.goods))
  }
});
jt.startListening({
...
const Gs = tn();
Gs.startListening({
  matcher: ve(qs.getPriceMask.pending, Dt.getPixelsForSale.pending, Dt.getPixelsSold.pending, Ga.get.pending),
  effect: (t, n) => {
    n.dispatch(tt({
      command: Re.start
    }))
...
Gs.startListening({
  matcher: ve(qs.getPriceMask.fulfilled, Dt.getPixelsForSale.fulfilled, Dt.getPixelsSold.fulfilled, Ga.get.fulfilled),
  effect: (t, n) => {
    n.dispatch(tt({
      command: Re.finish
    }))
...
Gs.startListening({
  matcher: ve(qs.getPriceMask.rejected),
  effect: (t, n) => {
...
class Se {
  ...
  static async getTemplateById({
    ...
    return un !== null && (un.abort(), un = null), un = new AbortController, T.get(`/image/template/${n}`, {
      signal: un.signal
    })
  }
...
const mg = "/assets/halloween2-l9FmXxVI.png",
  ...
  cs = F("template/getReferredTemplate", async () => (await Se.getReferredTemplate()).data),
  Ia = F("template/getMyTemplate", async ({
    id: t
  ...
  Zo = he({
    ...
    extraReducers: t => {
      ...
      }).addCase(cs.rejected, (n, s) => {}).addCase(Ia.pending, n => {}).addCase(Ia.fulfilled, (n, s) => {}).addCase(ls.pending, (n, s) => {}).addCase(ls.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: We.world
        };
  ...
  sr = t => t ? t.friends >= Dc.friendsForTemplateCreation || t.isContractor : !1,
  Ee = {
    create: "create",
    main: "main",
    result: "result"
  ...
  Sg = () => {
    ...
    return e.jsxs(rn, {
      children: [a && o && e.jsx(Me, {
        active: n === Ee.create,
        setActive: () => t(fn(Ee.create)),
        children: "My template"
      }), e.jsx(Me, {
        active: n === Ee.main,
        setActive: () => t(fn(Ee.main)),
        children: "Tournament"
      }), e.jsx(Me, {
        active: n === Ee.result,
        setActive: () => t(fn(Ee.result)),
        children: "My results"
      })]
    })
  };
...
const ms = F("tournament/getPeriods", async () => (await ar.getPeriods()).data),
  As = F("tournament/getResults", async () => (await ar.getResults()).data),
  ps = F("tournament/getMyTemplate", async ({
    id: t
  }) => (await Se.getTournamentTemplateById({
    id: t
  })).data),
  hs = F("tournament/getSelectedTemplate", async () => (await Se.getSelectedTemplate()).data),
  ...
  _s = F("tournament/getRandomTemplatesList", async () => (await Se.getRandomTemplates()).data),
...
En.startListening({
  matcher: ve(Ie.getSelectedTemplate.fulfilled, lr),
  effect: (t, n) => {
    const s = n.getState();
...
const Dn = Yr({
    ...
    devTools: !1,
    middleware: t => [Bn.middleware, Yo.middleware, Gs.middleware, jt.middleware, Wo.middleware, En.middleware, ...t()]
  }),
  vs = [],
  zg = async ({
    dispatch: t,
    ...
    await t(rh({
      ...
      id: nt(s),
      color: Tt(a)
    }), v.mainImage.updateTexture(), await t(Yp(a)), await t(rp(s)), await t(Su());
    ...
    try {
      const r = await o;
      r.status === 200 && (r.data.reward_user && r.data.reward_user.reward_id && (v.mainImage.reward.add(s), t(kg({
...
const Xg = ({
  ...
  Vg = async ({
    ...
    if (!a && i && (a = i.shop.available[2]), !a || a === 0) {
      n(Os(10)), n(st(2)), n(at()), n(Ot());
      return
    }
    v.mainImage.bomb.boom(t), n(Qs.useProduct({
      pixelId: nt(t),
      productId: 2
    })), n(Mt(s * Xg(t))), n(Fs({
      product: 2,
...
const v_ = ({
  ...
  y_ = async ({
    ...
    v.mainImage.pumpkin.boom(t), n(Qs.useProduct({
      pixelId: nt(t),
      productId: 7
    })), n(Mt(s * v_(t))), n(Fs({
      product: 7,
...
class I_ {
  ...
  async loadChunk({
    ...
    const s = B.chunkOrder[n],
      a = await this.loadImage(`${Ra}image/block?block_id=${s}`),
...
const k_ = m.memo(() => (m.useEffect(() => {
  ...
  U_ = () => c(za.selectAll).map(n => e.jsx(M_, {
    item: n
  }, nt({
    x: n.x,
    y: n.y
  ...
  bf = () => {
    ...
    return e.jsxs(Ut, {
      show: n,
      setShow: a,
      children: [s === pe.paintReward && e.jsx(yf, {}), s === pe.reChargeSpeed && e.jsx(wf, {}), s === pe.energyLimit && e.jsx(jf, {})]
    })
  },
  Nf = () => e.jsxs("div", {
    className: ys.layout,
  ...
  Pf = () => {
    ...
    return e.jsxs(rn, {
      children: [e.jsx(Me, {
        active: n === "tasks",
        setActive: () => t(wa("tasks")),
        children: "Tasks"
      }), e.jsx(Me, {
        active: n === "boosts",
        setActive: () => t(wa("boosts")),
        children: "Boosts"
      })]
    })
  },
  ...
  Bf = "_container_1h1qc_1",
  Ef = "_divider_1h1qc_19",
  Df = "_row_1h1qc_24",
  kf = "_row_title_1h1qc_36",
  Rf = "_row_title_main_1h1qc_40",
  Mf = "_row_hint_1h1qc_45",
  Uf = "_row_value_1h1qc_51",
  Of = "_row_value_main_1h1qc_55",
  Ff = "_mining_percent_1h1qc_60",
  Qf = "_active_row_1h1qc_70",
  zf = "_button_1h1qc_81",
  yi = {
    container: Bf,
    divider: Ef,
  ...
  Ox = () => (c(t => t.ratings.league), c(go), c(Qo), e.jsx("div", {
  ...
  Jx = () => {
    ...
    return m.useEffect(() => () => {
      ...
      children: [t && e.jsxs("div", {
        ...
        onPointerUp: async r => {
          var d, u;
          r.stopPropagation(), await sn(`${yt}?startapp=x${i.x}_y${i.y}`) ? (u = (d = window.Telegram.WebApp) == null ? void 0 : d.HapticFeedback) == null || u.notificationOccurred("success") : a(!0), n(!1), o.current = setTimeout(() => {
  ...
  nv = "_container_1vu8i_1",
  sv = "_owner_1vu8i_10",
  av = "_id_1vu8i_14",
  iv = "_date_1vu8i_19",
  ov = "_avatar_container_1vu8i_24",
  rv = "_avatar_1vu8i_24",
  cv = "_squad_avatar_container_1vu8i_36",
  lv = "_text_container_1vu8i_48",
  dv = "_dot_1vu8i_54",
  uv = "_user_name_1vu8i_59",
  mv = "_squad_name_1vu8i_64",
  de = {
    container: nv,
    owner: sv,
    id: av,
  ...
  kn = ({
    ...
    return n > 0 && (i = Pn(i, n)), e.jsx("span", {
      className: mo.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? ue(`https://t.me/${ci(t)}`) : nn(`https://t.me/${ci(t)}`)
      },
      children: i
    })
  },
  ...
  yv = () => e.jsxs("div", {
    ...
    children: [e.jsx(vv, {}), e.jsx(gv, {}), e.jsx(xv, {}), e.jsx(_v, {}), e.jsx(fv, {})]
  }),
  wv = "_category_text_epppt_1",
  jv = "_latest_used_container_epppt_8",
  bv = "_color_line_epppt_15",
  Nv = "_color_item_epppt_22",
  Iv = "_pipette_container_epppt_30",
  Pv = "_child_scale_epppt_48",
  xr = {
    category_text: wv,
    latest_used_container: jv,
    color_line: bv,
    color_item: Nv,
    pipette_container: Iv,
    child_scale: Pv
  },
  Cv = ({
    color: t
  ...
  Sv = ({
    ...
    children: t.map((n, s) => e.jsx(Cv, {
      color: n
    }, `${n}_${s}`))
  }),
  Tv = "_unlock_button_fc8qr_1",
  Bv = "_stars_text_fc8qr_13",
  wi = {
    unlock_button: Tv,
    stars_text: Bv
  },
  Ev = () => e.jsxs("div", {
    className: wi.unlock_button,
    children: [e.jsx("span", {
      children: "Unlock all colors for"
    }), e.jsxs("span", {
      className: wi.stars_text,
  ...
  Rv = ({
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(kv, {
        ...
        children: [e.jsx(ev, {
          active: s
        }), s === 1 && e.jsx(Dv, {}), s === 2 && e.jsx(yv, {})]
      })]
    })
  },
  Mv = () => c(Fe) ? null : e.jsxs("button", {
    className: re.button,
    onPointerUp: () => {
  ...
  zv = () => c(n => n.canvas.coords) === null ? null : e.jsx(ee.Fragment, {
    children: e.jsx(Qv, {})
  }),
  qv = "_layout_14eqc_1",
  ...
  Kv = () => e.jsx("div", {
    ...
    children: e.jsxs("div", {
      ...
      children: [e.jsx(Jv, {}), e.jsx(Wv, {})]
    })
  }),
  Zv = () => null,
  $v = "_layout_14a3l_1",
  ey = "_container_14a3l_11",
  ty = "_image_14a3l_26",
  ny = "_text_14a3l_31",
  sy = "_gold_14a3l_37",
  ay = "_winning_14a3l_44",
  iy = "_loosing_14a3l_48",
  Ne = {
    layout: $v,
    container: ey,
    image: ty,
  ...
  ni = "/assets/gold_pixel-CRD2C_ap.gif",
  oy = () => {
    const t = c(dr),
  ...
  gy = ({
    ...
    return m.useEffect(() => {
      ...
      children: [hy[t.repaintRewardType], " ", e.jsx("img", {
        alt: "img",
        className: Bs.image,
        src: ni
      })]
  ...
  Ly = ({
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(zy, {
        ...
        max: Ii,
        onChange: o => {
          n(gg(o)), v.mainImage.worldTemplate.setOpacity(Number(o[0])), v.mainImage.tournamentTemplates.setOpacity(Number(o[0]))
        },
        renderTrack: ({
          props: o,
          children: r
  ...
  Jy = "_animation_14giw_33",
  Yy = "_scaleInfinity_14giw_1",
  Wy = "_gray_14giw_38",
  ...
  Zy = () => {
    ...
    return r && o.push(ht.enabled), e.jsx("button", {
      ...
      onPointerUp: () => {
        if (!i) {
          t(fn(Ee.create)), n.push("/tournament");
          return
        }
        r ? t(Va()) : (v.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
  ...
  $y = () => {
    ...
    return i && o.push(ht.enabled), s || o.push(ht.animation), e.jsxs("button", {
      ...
      onPointerUp: l => {
        if (!s || !r) {
          t(fn(Ee.main)), n.push("/tournament");
          return
        }
        i ? t(Va()) : (v.viewport.viewport.animate({
          scale: 4,
          time: 400,
          position: {
            x: s.x + s.imageSize / 2,
    ...
    children: e.jsx("div", {
      ...
      children: e.jsx("div", {
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx(Zy, {}), e.jsx($y, {}), e.jsx(Hy, {})]
        })
      })
    })
  }),
  ...
  lw = () => e.jsxs("div", {
    className: cw.layout,
    children: [e.jsx(ow, {}), e.jsx(zv, {})]
  }),
  dw = () => e.jsxs(e.Fragment, {
    children: [e.jsx(cy, {}), e.jsx(Gv, {}), e.jsx(ew, {}), e.jsx(Kv, {}), e.jsx(lw, {}), e.jsx(vy, {}), e.jsx(_y, {}), e.jsx(Ry, {}), e.jsx(ly, {}), e.jsx(Zv, {})]
  }),
  ...
  bj = "_close_container_1pvsg_1",
  Nj = "_title_container_1pvsg_12",
  Ij = "_title_1pvsg_12",
  Pj = "_frens_count_1pvsg_21",
  Cj = "_content_1pvsg_25",
  Sj = "_image_container_1pvsg_32",
  Tj = "_image_1pvsg_32",
  Bj = "_description_container_1pvsg_41",
  Ej = "_white_1pvsg_50",
  Dj = "_gray_1pvsg_54",
  kj = "_purple_1pvsg_58",
  Rj = "_bold_1pvsg_64",
  Mj = "_center_1pvsg_68",
  Uj = "_info_layout_1pvsg_72",
  Oj = "_benefits_container_1pvsg_84",
  Fj = "_benefits_item_1pvsg_92",
  Qj = "_divider_1pvsg_98",
  zj = "_buttons_container_1pvsg_105",
  qj = "_button_copy_1pvsg_112",
  ...
  Zj = "_total_10f8u_28",
  $j = "_bold_10f8u_33",
  eb = "_indicator_10f8u_37",
  tb = "_button_container_10f8u_46",
  nb = "_button_10f8u_46",
  Ge = {
    container: Jj,
    text_container: Yj,
  ...
  sb = "_layout_1ulm2_1",
  ab = "_container_1ulm2_11",
  ib = "_stars_1ulm2_17",
  ob = "_animStar_1ulm2_1",
  Fn = {
    layout: sb,
    container: ab,
    stars: ib,
  ...
  ub = "_main_info_container_1gqs9_2",
  mb = "_image_container_1gqs9_11",
  Ab = "_image_1gqs9_11",
  pb = "_title_1gqs9_21",
  hb = "_variants_container_1gqs9_25",
  gb = "_variant_item_1gqs9_33",
  _b = "_variant_left_container_1gqs9_39",
  fb = "_variant_middle_container_1gqs9_45",
  xb = "_dot_1gqs9_53",
  vb = "_variant_right_container_1gqs9_59",
  yb = "_button_container_1gqs9_66",
  wb = "_button_1gqs9_66",
  jb = "_bold_1gqs9_96",
  bb = "_gray_1gqs9_100",
  Nb = "_blue_1gqs9_104",
  Ib = "_text_1gqs9_109",
  G = {
    main_info_container: ub,
    image_container: mb,
    image: Ab,
    title: pb,
    variants_container: hb,
    variant_item: gb,
    variant_left_container: _b,
  ...
  Tb = "_close_container_5xtkt_1",
  Bb = "_title_container_5xtkt_12",
  Eb = "_title_5xtkt_12",
  Db = "_small_title_container_5xtkt_23",
  kb = "_small_title_5xtkt_23",
  Rb = "_content_5xtkt_32",
  Mb = "_image_container_5xtkt_40",
  Ub = "_image_placeholder_5xtkt_46",
  Ob = "_image_5xtkt_40",
  Fb = "_how_container_5xtkt_58",
  Qb = "_description_container_5xtkt_63",
  zb = "_white_5xtkt_72",
  qb = "_gray_5xtkt_76",
  Lb = "_bold_5xtkt_80",
  Hb = "_center_5xtkt_84",
  Gb = "_claim_button_container_5xtkt_88",
  Xb = "_claim_button_5xtkt_88",
  Vb = "_no_button_5xtkt_107",
  Jb = "_info_layout_5xtkt_119",
  Yb = "_rewards_layout_5xtkt_131",
  Wb = "_rewards_grid_container_5xtkt_137",
  Kb = "_reward_item_5xtkt_143",
  Zb = "_reward_item_completed_5xtkt_153",
  $b = "_reward_item_content_container_5xtkt_166",
  e1 = "_reward_item_active_5xtkt_179",
  t1 = "_reward_item_image_container_5xtkt_183",
  n1 = "_reward_item_amount_5xtkt_187",
  s1 = "_reward_item_amount_active_5xtkt_201",
  a1 = "_reward_item_amount_premium_5xtkt_205",
  i1 = "_reward_item_title_5xtkt_210",
  o1 = "_reward_item_title_premium_5xtkt_216",
  r1 = "_reward_item_image_5xtkt_183",
  R = {
    close_container: Tb,
    title_container: Bb,
    title: Eb,
    ...
    info_layout: Jb,
    rewards_layout: Yb,
    rewards_grid_container: Wb,
    reward_item: Kb,
    reward_item_completed: Zb,
    reward_item_content_container: $b,
    reward_item_active: e1,
    reward_item_image_container: t1,
    reward_item_amount: n1,
    reward_item_amount_active: s1,
    reward_item_amount_premium: a1,
    reward_item_title: i1,
    reward_item_title_premium: o1,
    reward_item_image: r1
  },
  c1 = ({
    secondsLeft: t
  }) => {
  ...
  A1 = "_container_1h1qc_1",
  p1 = "_divider_1h1qc_19",
  h1 = "_row_1h1qc_24",
  g1 = "_row_title_1h1qc_36",
  _1 = "_row_title_main_1h1qc_40",
  f1 = "_row_hint_1h1qc_45",
  x1 = "_row_value_1h1qc_51",
        ...
        children: [e.jsx("div", {
          ...
          children: e.jsx("div", {
            ...
            children: n.map((o, r) => {
              ...
              let b = l1;
              return r >= 8 && r <= 15 && (b = d1), r >= 16 && r <= 23 && (b = u1), r >= 24 && r <= 31 && (b = m1), e.jsxs("div", {
                className: u.join(" "),
                onPointerUp: () => {
                  t(O({
                    id: performance.now(),
  ...
  P1 = "_general_info_container_fv8d9_1",
  C1 = "_img_container_fv8d9_7",
  S1 = "_image_fv8d9_13",
  T1 = "_title_fv8d9_19",
  B1 = "_description_container_fv8d9_25",
  E1 = "_description_fv8d9_25",
  Xt = {
    general_info_container: P1,
    img_container: C1,
    image: S1,
    title: T1,
  ...
  D1 = "_info_layout_1p9dg_1",
  k1 = {
    info_layout: D1
  },
  R1 = "_no_template_container_uihlo_1",
  M1 = "_no_template_button_uihlo_10",
  ...
  z1 = "_button_copy_uihlo_53",
  q1 = "_button_uihlo_44",
  L1 = "_create_new_template_uihlo_72",
  Ve = {
    no_template_container: R1,
    no_template_button: M1,
  ...
  H1 = "_instruction_container_14ts7_1",
  G1 = "_img_container_14ts7_9",
  X1 = "_image_14ts7_15",
  V1 = "_instruction_text_14ts7_21",
  J1 = "_preview_container_14ts7_26",
  Y1 = "_preview_image_container_14ts7_32",
  W1 = "_preview_image_14ts7_32",
  K1 = "_preview_image_loader_14ts7_45",
  Z1 = "_template_size_14ts7_60",
  $1 = "_template_title_14ts7_68",
  e0 = "_template_size_container_14ts7_73",
  t0 = "_template_size_item_14ts7_79",
  n0 = "_template_size_item_active_14ts7_87",
  s0 = "_template_coords_14ts7_92",
  a0 = "_template_coordinates_title_14ts7_102",
  i0 = "_template_coords_container_14ts7_107",
  o0 = "_coords_item_14ts7_114",
  r0 = "_coords_input_14ts7_120",
  c0 = "_file_button_container_14ts7_129",
  l0 = "_file_button_14ts7_129",
  te = {
    instruction_container: H1,
    img_container: G1,
    image: X1,
    instruction_text: V1,
    preview_container: J1,
    preview_image_container: Y1,
    preview_image: W1,
    preview_image_loader: K1,
    template_size: Z1,
    template_title: $1,
    template_size_container: e0,
    template_size_item: t0,
    template_size_item_active: n0,
    template_coords: s0,
    template_coordinates_title: a0,
  ...
  A0 = "_template_item_inner_srp11_9",
  p0 = "_template_image_srp11_17",
  h0 = "_template_image_info_layout_srp11_24",
  g0 = "_template_image_info_container_srp11_34",
  hn = {
    template_item_container: m0,
    template_item_inner: A0,
    template_image: p0,
    template_image_info_layout: h0,
    template_image_info_container: g0
  },
  wr = ({
    item: t,
    style: n = {}
    ...
    return e.jsx("div", {
      ...
      onPointerUp: async () => {
        t.templateId && t.templateId !== 0 && s(Pa({
          show: !0,
  ...
  x0 = () => e.jsxs("div", {
    children: [e.jsx(u0, {}), e.jsx(f0, {})]
  }),
  v0 = "_layout_94gj5_1",
  y0 = "_container_94gj5_5",
  w0 = "_button_container_94gj5_11",
  j0 = "_button_94gj5_11",
  Ds = {
    layout: v0,
    container: y0,
  ...
  I0 = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === "my" && e.jsx(x0, {}), t === "catalog" && e.jsx(N0, {})]
    })
  },
  P0 = () => {
    const t = g(),
  ...
  C0 = () => e.jsxs(ee.Fragment, {
    children: [e.jsx(P0, {}), e.jsx(I0, {})]
  }),
  Js = "/assets/paintings_anim2-nk1iBB8J.gif",
  S0 = "_container_1h1qc_1",
  T0 = "_divider_1h1qc_19",
  B0 = "_row_1h1qc_24",
  E0 = "_row_title_1h1qc_36",
  D0 = "_row_title_main_1h1qc_40",
  k0 = "_row_hint_1h1qc_45",
  R0 = "_row_value_1h1qc_51",
  M0 = "_row_value_main_1h1qc_55",
  ...
  H0 = "_title_container_2uiqn_26",
  G0 = "_title_2uiqn_26",
  X0 = "_image_container_2uiqn_37",
  V0 = "_image_2uiqn_37",
  J0 = "_image_placeholder_2uiqn_51",
  Y0 = "_info_container_2uiqn_58",
  W0 = "_info_row_2uiqn_64",
  K0 = "_info_title_2uiqn_69",
  Z0 = "_info_value_blue_2uiqn_73",
  $0 = "_info_value_white_2uiqn_78",
  eN = "_buttons_container_2uiqn_82",
  tN = "_button_2uiqn_82",
  nN = "_not_button_2uiqn_98",
  sN = "_button_copy_2uiqn_109",
  ie = {
    layout: z0,
    container: q0,
    close_button: L0,
    ...
    image_container: X0,
    image: V0,
    image_placeholder: J0,
    info_container: Y0,
    info_row: W0,
    info_title: K0,
    info_value_blue: Z0,
    info_value_white: $0,
    buttons_container: eN,
    button: tN,
    not_button: nN,
    button_copy: sN
  },
        ...
        if (!s) try {
          if (n && n !== 0) {
            if (a(!0), (await t(Rt.subscribe({
              ...
              t(_g(h)), v.mainImage.worldTemplate.deleteTemplate(o.id), v.mainImage.worldTemplate.add(h), t($o())
            } else await t(O({
              id: performance.now(),
  ...
  rN = "_container_s1r1v_1",
  cN = "_page_s1r1v_13",
  lN = "_id_s1r1v_17",
  dN = "_title_s1r1v_22",
  uN = "_avatar_container_s1r1v_28",
  mN = "_avatar_s1r1v_28",
  AN = "_squad_avatar_container_s1r1v_40",
  pN = "_text_container_s1r1v_52",
  hN = "_dot_s1r1v_58",
  gN = "_user_name_s1r1v_63",
  _N = "_squad_name_s1r1v_69",
  fN = "_divider_s1r1v_75",
  xN = "_tabs_content_s1r1v_81",
  vN = "_content_info_s1r1v_85",
  yN = "_content_info_item_s1r1v_92",
  wN = "_content_info_item_title_s1r1v_96",
  jN = "_content_info_item_value_s1r1v_100",
  bN = "_no_content_s1r1v_106",
  NN = "_achievements_container_s1r1v_115",
  q = {
    container: rN,
    page: cN,
    id: lN,
    ...
    tabs_content: xN,
    content_info: vN,
    content_info_item: yN,
    content_info_item_title: wN,
    content_info_item_value: jN,
    no_content: bN,
    achievements_container: NN
  },
  IN = () => {
  ...
  RN = "_not_completed_os5nt_6",
  MN = "_image_container_os5nt_10",
  UN = "_image_os5nt_10",
  ON = "_bold_os5nt_20",
  FN = "_gray_os5nt_24",
  ...
  tI = ({
    ...
    children: [t === "info" && e.jsx(DN, {
      isPopupContent: n
    }), t === "achievements" && e.jsx($N, {
      isPopupContent: n
    }), t === "inventory" && e.jsx(eI, {})]
  }),
  nI = ({
    isPopupContent: t = !0
  }) => {
  ...
  AI = "_avatar_12mk9_28",
  pI = "_text_container_12mk9_39",
  hI = "_dot_12mk9_45",
  gI = "_user_name_12mk9_50",
  _I = "_squad_slug_12mk9_56",
  fI = "_your_squad_button_12mk9_62",
  xI = "_join_squad_button_12mk9_75",
  vI = "_red_12mk9_91",
  yI = "_divider_12mk9_95",
  wI = "_tabs_content_12mk9_101",
  jI = "_content_info_12mk9_105",
  bI = "_content_info_item_12mk9_112",
  NI = "_content_info_item_title_12mk9_116",
  II = "_content_info_item_value_12mk9_120",
  PI = "_content_top_12mk9_127",
  CI = "_content_top_item_12mk9_140",
  SI = "_content_top_item_image_12mk9_150",
  TI = "_content_top_name_12mk9_156",
        ...
        onPointerUp: async () => {
          try {
            ...
            if ((await Se.uploadTemplate({
              ...
              i(fg(I)), i($o()), await v.mainImage.worldTemplate.add(I), i(O({
                id: performance.now(),
    ...
    return m.useEffect(() => {}, []), m.useEffect(() => {
      if (t !== null) {
        ...
        const b = async () => {
          ...
          qI(ge), f.putImageData(ge, 0, 0), a(ge), o(I.toDataURL())
        };
        setTimeout(() => {
          b().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(GI, {}), i !== null && e.jsx(zI, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(d0, {
  ...
  VI = "_general_info_container_1u2nd_1",
  JI = "_img_container_1u2nd_7",
  YI = "_image_1u2nd_17",
  WI = "_image_cup_1u2nd_23",
  KI = "_image_glow_container_1u2nd_29",
  ZI = "_image_glow_1u2nd_29",
  $I = "_rotate_1u2nd_1",
  eP = "_image_glow_reverse_1u2nd_48",
  tP = "_title_1u2nd_53",
  nP = "_description_container_1u2nd_60",
  sP = "_description_1u2nd_60",
  aP = "_gold_1u2nd_73",
  Qe = {
    general_info_container: VI,
    img_container: JI,
    image: YI,
    image_cup: WI,
    image_glow_container: KI,
    image_glow: ZI,
    rotate: $I,
    image_glow_reverse: eP,
    title: tP,
    description_container: nP,
    description: sP,
    gold: aP
  },
  ...
  cP = "_instruction_container_17lvx_1",
  lP = "_img_container_17lvx_9",
  dP = "_img_inner_container_17lvx_16",
  uP = "_image_17lvx_22",
  mP = "_image_status_17lvx_30",
  AP = "_image_status_rejected_17lvx_45",
  pP = "_image_status_review_17lvx_49",
  hP = "_image_status_approved_17lvx_53",
  gP = "_copy_button_container_17lvx_57",
  _P = "_button_copy_17lvx_65",
  fP = "_gray_17lvx_71",
  xP = "_preview_container_17lvx_75",
  vP = "_preview_image_container_17lvx_81",
  yP = "_preview_image_17lvx_81",
  wP = "_preview_image_loader_17lvx_94",
  jP = "_template_size_17lvx_109",
  bP = "_template_title_17lvx_117",
  NP = "_template_size_container_17lvx_122",
  IP = "_template_size_item_17lvx_128",
  PP = "_template_size_item_active_17lvx_136",
  CP = "_template_coords_17lvx_141",
  SP = "_template_coordinates_title_17lvx_151",
  TP = "_template_coords_container_17lvx_156",
  BP = "_coords_item_17lvx_163",
  EP = "_coords_input_17lvx_169",
  DP = "_file_button_container_17lvx_178",
  kP = "_file_button_17lvx_178",
  $ = {
    instruction_container: cP,
    img_container: lP,
    img_inner_container: dP,
    image: uP,
    image_status: mP,
    image_status_rejected: AP,
    image_status_review: pP,
    image_status_approved: hP,
    copy_button_container: gP,
    button_copy: _P,
    gray: fP,
    preview_container: xP,
    ...
    template_size_item: IP,
    template_size_item_active: PP,
    template_coords: CP,
    template_coordinates_title: SP,
    template_coords_container: TP,
    coords_item: BP,
    coords_input: EP,
    ...
    return m.useEffect(() => {
      if (t !== null) {
        ...
        const b = async () => {
          ...
          I.width = r, I.height = r, f.drawImage(t, He, K, L, H);
          const ge = f.getImageData(0, 0, r, r);
          rP(ge), f.putImageData(ge, 0, 0), a(ge), o(I.toDataURL())
        };
        setTimeout(() => {
          b().then(() => {
            _(!1)
      ...
      children: [i === null && e.jsx(RP, {}), i !== null && e.jsx(MP, {
        loading: h,
        dataUrl: i,
        templateSize: r
      }), i !== null && e.jsx(UP, {
  ...
  GP = "_button_1c7e5_11",
  XP = "_end_of_list_button_1c7e5_27",
  Ye = {
    layout: qP,
    container: LP,
    button_container: HP,
    button: GP,
    end_of_list_button: XP
  },
  VP = "_template_item_container_pxfff_1",
  JP = "_template_item_inner_pxfff_12",
  YP = "_template_item_picked_pxfff_28",
  WP = "_template_item_shadow_pxfff_43",
  KP = "_template_rank_pxfff_55",
  ZP = "_template_recolors_pxfff_75",
  $P = "_template_recolors_pixel_pxfff_90",
  eC = "_template_image_pxfff_97",
  ct = {
    template_item_container: VP,
    template_item_inner: JP,
    template_item_picked: YP,
    template_item_shadow: WP,
    template_rank: KP,
    template_recolors: ZP,
    template_recolors_pixel: $P,
    template_image: eC
  },
  si = ({
    item: t,
  ...
  iC = () => {
    ...
    return m.useEffect(() => (t(Ie.getRandomList()), () => {
      ...
      children: [e.jsxs("div", {
        className: Ye.container,
        children: [e.jsx(aC, {}), n.map((i, o) => o + 1 > a ? null : e.jsx(si, {
          item: i
        }, i.id))]
      }), e.jsx(sC, {})]
    })
  ...
  AC = () => {
    ...
    return t ? e.jsxs("div", {
      ...
      children: [e.jsxs("div", {
        children: [e.jsxs("div", {
          className: lt.title,
          children: ["Top ", Xi[t].templateThreshold, " ", "templates will win"]
        }), e.jsx("div", {
  ...
  pC = () => {
    ...
    return e.jsxs("div", {
      children: [e.jsx(AC, {}), t && n === A.fulfilled && e.jsx(nC, {}), !t && n === A.fulfilled && e.jsx(iC, {})]
    })
  },
  hC = "_soon_la5q2_1",
  gC = "_active_round_instruction_la5q2_11",
  _C = "_not_active_round_instruction_la5q2_19",
  fC = "_round_container_la5q2_25",
  xC = "_round_title_la5q2_33",
  vC = "_round_title_text_la5q2_38",
  yC = "_round_indicator_la5q2_43",
  wC = "_round_status_success_la5q2_49",
  jC = "_round_status_fail_la5q2_60",
  bC = "_success_la5q2_71",
  NC = "_fail_la5q2_75",
  IC = "_gray_la5q2_79",
  PC = "_round_main_info_la5q2_83",
  CC = "_round_image_container_la5q2_89",
  SC = "_round_image_la5q2_89",
  TC = "_round_lines_container_la5q2_103",
  BC = "_round_line_la5q2_103",
  EC = "_divider_la5q2_117",
  DC = "_pixels_number_la5q2_124",
  kC = "_pixel_la5q2_124",
  RC = "_past_rounds_la5q2_136",
  MC = "_past_rounds_divider_la5q2_145",
  Q = {
    soon: hC,
    active_round_instruction: gC,
    not_active_round_instruction: _C,
    round_container: fC,
    round_title: xC,
    round_title_text: vC,
    round_indicator: yC,
  ...
  zC = () => {
    ...
    return m.useEffect(() => {
      ...
      children: [e.jsx(FC, {}), e.jsx(QC, {}), e.jsx(UC, {}), e.jsx(OC, {})]
    })
  },
  qC = () => {
    const t = c(n => n.tournament.activeTab);
    return e.jsxs("div", {
      className: oP.info_layout,
      children: [t === Ee.create && e.jsx(zP, {}), t === Ee.main && e.jsx(pC, {}), t === Ee.result && e.jsx(zC, {})]
    })
  },
  LC = () => e.jsxs(ee.Fragment, {
    children: [e.jsx(Sg, {}), e.jsx(qC, {})]
  }),
  ...
  XC = "_container_lc1md_1",
  VC = "_title_lc1md_8",
  JC = "_table_container_lc1md_13",
  YC = "_table_row_lc1md_19",
  WC = "_button_lc1md_26",
  KC = "_active_row_lc1md_50",
  ZC = "_row_title_lc1md_50",
  ga = {
    container: XC,
    title: VC,
    table_container: JC,
  ...
  eS = "_layout_17ca7_1",
  tS = "_container_17ca7_6",
  nS = "_close_button_17ca7_20",
  sS = "_title_container_17ca7_28",
  aS = "_title_17ca7_28",
  iS = "_image_container_17ca7_39",
  oS = "_image_17ca7_39",
  rS = "_image_placeholder_17ca7_53",
  cS = "_info_container_17ca7_60",
  lS = "_info_row_17ca7_66",
  dS = "_info_title_17ca7_71",
  uS = "_info_value_blue_17ca7_75",
  mS = "_info_value_white_17ca7_80",
  AS = "_buttons_container_17ca7_84",
  pS = "_button_17ca7_84",
  hS = "_not_button_17ca7_100",
  gS = "_button_copy_17ca7_111",
  Z = {
    layout: eS,
    container: tS,
    close_button: nS,
        ...
        children: e.jsxs("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: [e.jsxs("div", {
              ...
              onPointerUp: () => {
                n.push("/"), t(ua()), v.viewport.viewport.animate({
                  scale: 4,
                  time: 400,
                  position: {
                    x: a.x + a.imageSize / 2,
  ...
  xS = "_layout_20dlh_1",
  vS = "_container_20dlh_10",
  yS = "_star_20dlh_14",
  wS = "_star_animation_20dlh_21",
  jS = "_move_20dlh_1",
  ks = {
    layout: xS,
    container: vS,
  ...
  bS = "data:image/svg+xml,%3csvg%20width='32'%20height='32'%20viewBox='0%200%2032%2032'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cdefs%3e%3clinearGradient%20id='grad1'%20x1='0%25'%20y1='0%25'%20x2='0%25'%20y2='100%25'%3e%3cstop%20offset='0%25'%20style='stop-color:%23efce32;stop-opacity:1'%20/%3e%3c!--%20более%20светлый%20желтый%20--%3e%3cstop%20offset='100%25'%20style='stop-color:%23f7752e;stop-opacity:1'%20/%3e%3c!--%20более%20темный%20желтый%20--%3e%3c/linearGradient%3e%3c/defs%3e%3cpath%20fill-rule='evenodd'%20clip-rule='evenodd'%20d='M5%200C2.23858%200%200%202.23858%200%205V27C0%2029.7614%202.23858%2032%205%2032H27C29.7614%2032%2032%2029.7614%2032%2027V5C32%202.23858%2029.7614%200%2027%200H5ZM21.4261%2010.5739H10.5739V21.4261H21.4261V10.5739Z'%20fill='url(%23grad1)'/%3e%3c/svg%3e",
  NS = ({
    size: t,
    style: n = {},
    animation: s = !1
  ...
  PS = "_container_tuzgg_1",
  CS = "_column_tuzgg_9",
  SS = "_column_rev_tuzgg_17",
  TS = "_title_tuzgg_26",
  BS = "_table_container_tuzgg_32",
  ES = "_table_row_tuzgg_38",
  DS = "_button_tuzgg_45",
  kS = "_value_tuzgg_52",
  RS = "_notpixel_icon_tuzgg_58",
  MS = "_active_row_tuzgg_74",
  US = "_row_title_tuzgg_74",
  je = {
    container: PS,
    column: CS,
    column_rev: SS,
    ...
    return e.jsx(Ut, {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx("img", {
          ...
          className: je.table_container,
          children: FS.map((a, i) => e.jsxs("div", {
            className: je.table_row,
            children: [e.jsx("div", {
              children: a.name
            }), e.jsxs("div", {
  ...
  LS = () => {
    ...
    return e.jsxs("button", {
      ...
      children: [e.jsx("span", {
        ...
        className: `telegram_icons ${Bi.icon}`,
        children: ""
      })]
    })
  },
  ...
  XS = "_image_container_qn09x_9",
  VS = "_image_qn09x_9",
  JS = "_title_container_qn09x_18",
  ...
  u2 = "/assets/box_1-CzUKXu07.gif",
  m2 = "/assets/box_2-wR9cQS7q.gif",
  A2 = "/assets/box_3-g_PL1kKM.gif",
  p2 = "/assets/dogs-D0jtZggB.gif",
  h2 = "/assets/secret_word-BTKB1fAO.gif",
  g2 = "/assets/cube_youtube_2-BqessN1a.gif",
  _2 = "/assets/cube_twitter_3_m_-Bxf2Qx_E.gif",
  Qn = {
    Ghost: "Ghost",
    Mythical: "Mythical",
    Magical: "Magical",
    ...
    return m.useEffect(() => {
      ...
      (async () => {
        ...
        L.status === 200 && L.data && L.data.forEach(H => {
          H.group_name === Qn.Ghost && d({
            count: H.usage_count,
            limit: H.limit
          }), H.group_name === Qn.Mythical && h({
            count: H.usage_count,
            limit: H.limit
          }), H.group_name === Qn.Magical && b({
            count: H.usage_count,
            limit: H.limit
          }), H.group_name === Qn.Dogs && f({
            count: H.usage_count,
            limit: H.limit
          })
        })
              ...
              try {
                ...
                if (j.status === 200) {
                  ...
                  if (L.secretWord.success) {
                    let H = "Success!";
                    L.secretWord.reward && (H += ` ${L.secretWord.reward} PX earned`), t(O({
                      id: performance.now(),
                      text: H,
                      icon: ""
  ...
  y2 = "_layout_1djp8_1",
  w2 = "_loading_container_1djp8_8",
  j2 = "_image_container_1djp8_20",
  b2 = "_image_1djp8_20",
  N2 = "_text_1djp8_29",
  gn = {
    layout: y2,
    loading_container: w2,
    image_container: j2,
    image: b2,
    text: N2
  },
  ...
  U2 = "_relative_button_rjvnl_89",
  O2 = "_telegram_button_rjvnl_116",
  F2 = "_button_img_rjvnl_124",
  Q2 = "_avatar_img_rjvnl_129",
  z2 = "_open_menu_button_rjvnl_134",
  q2 = "_open_menu_button_image_rjvnl_144",
  ...
  ye = {
    ...
    avatar_img: Q2,
    open_menu_button: z2,
    open_menu_button_image: q2,
    my_pixels_amount: L2,
    header_content: H2
  },
  G2 = () => c(Fe) ? null : e.jsxs("button", {
  ...
  ki = () => {
    const t = c(s => s.user.user),
      n = [ke.league];
    return t !== null && Di.hasOwnProperty(t.league) ? (n.push(Di[t.league]), e.jsx("div", {
      className: n.join(" ")
    })) : null
  },
  Z2 = () => {
...
const $2 = () => {
    ...
    return m.useEffect(() => {
      const s = () => {
        x2.includes(t.pathname) ? n.push("/") : n.goBack()
      };
      return window.Telegram.WebApp.onEvent("backButtonClicked", s), t.pathname !== Ri && (t.pathname === "/" ? window.Telegram.WebApp.BackButton.hide() : window.Telegram.WebApp.BackButton.show(), Ri = t.pathname), () => {
  ...
  mT = "_image_11ui8_75",
  AT = "_image_container_charges_11ui8_84",
  pT = "_image_charges_11ui8_89",
  hT = "_description_container_11ui8_94",
  gT = "_bold_11ui8_102",
  _T = "_gray_11ui8_107",
  fT = "_center_11ui8_111",
  xT = "_benefits_container_11ui8_115",
  vT = "_benefits_item_11ui8_123",
  yT = "_benefits_icon_container_11ui8_128",
  ...
  PT = "_container_19qal_1",
  CT = "_header_19qal_9",
  ST = "_close_19qal_19",
  TT = "_title_19qal_31",
  BT = "_body_19qal_36",
  ET = "_image_container_19qal_49",
  DT = "_image_19qal_49",
  kT = "_content_container_19qal_60",
  RT = "_description_container_19qal_68",
  MT = "_description_item_19qal_75",
  UT = "_amount_selector_container_19qal_82",
  OT = "_amount_selector_button_19qal_88",
  FT = "_amount_selector_count_19qal_101",
  QT = "_button_container_19qal_112",
  zT = "_crypto_button_container_19qal_118",
  qT = "_error_19qal_132",
  LT = "_not_available_19qal_139",
  HT = "_button_19qal_112",
  GT = "_star_color_19qal_165",
  XT = "_tokens_selector_19qal_171",
  VT = "_tokens_title_19qal_176",
  JT = "_connect_wallet_text_title_19qal_183",
  YT = "_tokens_container_19qal_192",
  WT = "_token_item_19qal_199",
  KT = "_token_image_container_19qal_210",
  ZT = "_token_image_19qal_210",
  $T = "_sale_box_19qal_220",
  ...
  J = {
    ...
    description_item: MT,
    amount_selector_container: UT,
    amount_selector_button: OT,
    amount_selector_count: FT,
    button_container: QT,
    ...
    tokens_selector: XT,
    tokens_title: VT,
    connect_wallet_text_title: JT,
    tokens_container: YT,
    token_item: WT,
    token_image_container: KT,
    token_image: ZT,
    sale_box: $T,
    sale_text: eB
  },
  ...
  rB = ({
    ...
    const L = async K => {
      ...
      await h.sendTransaction(ai), n(!0), u(!0), l(A.fulfilled)
    }, H = async K => {
      const ge = new Ks.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        Qr = await new Ks.token.jetton.JettonMinter(ge, {
          address: Ct[i]
        }).getJettonWalletAddress(new Ks.utils.Address(f)),
        zr = Xe.Address.parse(f),
        qr = Xe.Address.parse(va),
        Lr = Xe.beginCell().storeUint(0, 32).storeStringTail(K.txMemCode).endCell(),
        Hr = Xe.beginCell().storeUint(260734629, 32).storeUint(0, 64).storeCoins(Xe.toNano(K.strAmount)).storeAddress(qr).storeAddress(zr).storeBit(0).storeCoins(Xe.toNano("0.01")).storeBit(1).storeRef(Lr).endCell(),
        Gr = {
          validUntil: Math.floor(Date.now() / 1e3) + 600,
          messages: [{
            address: Qr.toString(!0, !0, !0),
            amount: "101000000",
  ...
  cB = () => {
    const [t, n] = Nn(), s = Rs(), a = c(i => i.shop.selectedCurrency);
  ...
  mB = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [e.jsx(aB, {}), e.jsx(uB, {}), e.jsx(wo, {
        runParticle: s,
        setRunParticle: a
      }), t && e.jsx("div", {
        className: J.error,
  ...
  pB = "_container_1rmx4_1",
  hB = "_max_value_1rmx4_9",
  Mi = {
    container: pB,
    max_value: hB
  },
...
const gB = () => {
  ...
  _B = () => e.jsxs("div", {
    ...
    children: [e.jsx(nB, {}), e.jsxs("div", {
      ...
      children: [e.jsx(sB, {}), e.jsx(AB, {}), e.jsx(gB, {})]
    }), e.jsx(mB, {})]
  }),
  fB = () => {
    ...
    return Ke.createPortal(e.jsx(Le, {
      ...
      children: e.jsxs("div", {
        ...
        children: [e.jsx(tB, {}), e.jsx(_B, {})]
      })
    }), document.body)
  },
  xB = "_layout_9sf1k_1",
  vB = "_container_9sf1k_13",
  yB = "_header_9sf1k_20",
  wB = "_title_9sf1k_30",
  jB = "_body_9sf1k_35",
  bB = "_image_container_9sf1k_47",
  NB = "_image_9sf1k_47",
  IB = "_shake_9sf1k_1",
  PB = "_description_container_9sf1k_60",
  CB = "_buyer_info_9sf1k_70",
  SB = "_avatar_9sf1k_78",
  TB = "_name_9sf1k_84",
  BB = "_squad_info_9sf1k_88",
  EB = "_squad_avatar_9sf1k_94",
  DB = "_text_container_9sf1k_100",
  kB = "_text_9sf1k_100",
  RB = "_thanos_snap_container_9sf1k_110",
  MB = "_thanos_snap_text_9sf1k_119",
  UB = "_button_container_9sf1k_126",
  OB = "_button_9sf1k_126",
  me = {
    layout: xB,
    container: vB,
    header: yB,
...
async function HB() {
  y.enable(y.BLEND), y.blendFunc(y.SRC_ALPHA, y.ONE_MINUS_SRC_ALPHA), y.clearColor(0, 0, 0, 0), y.viewport(0, 0, y.canvas.width, y.canvas.height), be = await GB(y), y.useProgram(be)
}
async function GB(t, n, s) {
  const a = FB,
    i = QB,
    o = Oi(t, a, t.VERTEX_SHADER),
    r = Oi(t, i, t.FRAGMENT_SHADER),
    l = t.createProgram();
...
async function XB(t) {
  VB(), WB(t), Ur(), document.getElementById("canvasHolder").style.opacity = "0", setTimeout(() => {
...
function WB(t) {
  ...
  ws = l * l, $e(y, be, "u_AnimationDuration", Mr), $e(y, be, "u_ParticleSize", zB), $e(y, be, "u_ViewportWidth", n), $e(y, be, "u_ViewportHeight", s), $e(y, be, "u_TextureWidth", a), $e(y, be, "u_TextureHeight", i), $e(y, be, "u_TextureLeft", o), $e(y, be, "u_TextureTop", r);
...
function KB(t) {
  y.clear(y.COLOR_BUFFER_BIT), qn == -1 && (qn = t);
  const s = t - qn;
  if (s > Mr) {
    qn = -1, document.getElementById("canvasSnap").remove();
    return
  }
  $e(y, be, "u_ElapsedTime", s), y.drawArrays(y.POINTS, 0, ws), Ur()
}
...
const ZB = () => {
        ...
        children: [e.jsx("div", {
          ...
          children: [e.jsx("div", {
            ...
            children: e.jsx("button", {
              ...
              onPointerUp: async () => {
                var r, l;
                v.viewport.viewport.fit(), v.viewport.viewport.moveCenter(v.viewport.viewport.worldWidth / 2, v.viewport.viewport.worldHeight / 2), n(fi(!0)), setTimeout(() => {
                  n(fi(!1))
                }, 7e3);
                try {
                  await qB(i ? 0 : Sc)
                ...
                t.push("/"), n(oh()), v.mainImage.pixanosRepaint(a.info.seed, B.width, a.info.percentage, a.info.color), (l = (r = window.Telegram.WebApp) == null ? void 0 : r.HapticFeedback) == null || l.notificationOccurred("error")
              },
              children: "Whoosh!"
            })
          })]
  ...
  gE = () => {
    ...
    return e.jsx(Le, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === ze.userFromPixelInfo && e.jsx(Ba, {
          isPopupContent: s
        }), n.dataSource === ze.userFromRating && e.jsx(Ba, {
          isPopupContent: s
        }), n.dataSource === ze.squadFromData && e.jsx(hE, {})]
      })
    })
  },
  _E = "_overlay_1vl8z_1",
  fE = "_top_container_1vl8z_10",
  xE = "_bottom_container_1vl8z_15",
  vE = "_side_menu_1vl8z_20",
  yE = "_menu_safe_area_inset_1vl8z_36",
  wE = "_menu_header_1vl8z_40",
  jE = "_close_button_1vl8z_53",
  bE = "_menu_list_1vl8z_58",
  NE = "_icon_1vl8z_79",
  IE = "_icon_not_pixel_1vl8z_87",
  PE = "_gold_pixel_1vl8z_97",
  CE = "_menu_list_li_1vl8z_103",
  SE = "_menu_list_text_1vl8z_109",
  TE = "_menu_list_new_item_1vl8z_113",
  BE = "_button_wrapper_1vl8z_136",
  EE = "_button_content_1vl8z_145",
  DE = "_footer_1vl8z_152",
  ...
  XE = "_layout_eiymv_1",
  VE = "_container_eiymv_7",
  qi = {
    layout: XE,
    container: VE
  },
  JE = () => localStorage.getItem("canvasFps") ? [Number(localStorage.getItem("canvasFps"))] : [60],
  YE = () => {
    const [t, n] = ee.useState(JE());
    return m.useEffect(() => {
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(vn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx($E, {}), e.jsx(YE, {}), e.jsxs("div", {
...
const lD = "_container_gb8eq_1",
  ...
  gD = "_time_left_container_gb8eq_65",
  _D = "_timer_gb8eq_69",
  fD = "_image_container_gb8eq_73",
  xD = "_image_gb8eq_73",
  vD = "_glow_container_gb8eq_91",
  yD = "_glow_gb8eq_91",
  wD = "_rotate_gb8eq_1",
  jD = "_glow_reverse_gb8eq_107",
  bD = "_description_container_gb8eq_113",
  ND = "_bold_gb8eq_123",
  ID = "_gray_gb8eq_128",
  PD = "_center_gb8eq_132",
  CD = "_gold_gb8eq_136",
  SD = "_button_gb8eq_144",
  _e = {
    container: lD,
    header: dD,
    title: uD,
  ...
  BD = () => {
    ...
    return m.useEffect(() => (Oa() && (localStorage.getItem(i) || a(!0)), () => {}), [n]), e.jsx(Le, {
      show: s,
      children: e.jsx("div", {
  ...
  ED = "_layout_xga4i_1",
  DD = "_container_xga4i_14",
  kD = "_header_xga4i_20",
  RD = "_close_xga4i_25",
  MD = "_body_xga4i_38",
  UD = "_image_container_xga4i_42",
  OD = "_image_xga4i_42",
  FD = "_glow_xga4i_55",
  QD = "_forward_xga4i_62",
  zD = "_rotate_xga4i_1",
  qD = "_reverse_xga4i_66",
...
const ek = "_layout_15tw0_1",
  ...
  lk = () => e.jsxs("div", {
    className: gn.layout,
    children: [e.jsx(nT, {}), e.jsx(Z2, {}), e.jsx(k_, {}), e.jsx(v2, {}), e.jsx($2, {}), e.jsx(eE, {}), e.jsx(pE, {}), e.jsx(gE, {}), e.jsx(IT, {}), e.jsx($B, {}), e.jsx(BD, {}), e.jsx($D, {}), e.jsx(ck, {}), e.jsx(fB, {}), e.jsx(ZB, {}), e.jsx(iE, {}), e.jsx(tD, {})]
  }),
  dk = () => {
    const t = g(),
  ...
  Ak = "_layout_ieygs_1",
  pk = "_container_ieygs_8",
  hk = "_logo_container_ieygs_17",
  gk = "_logo_ieygs_17",
  _k = "_animate_ieygs_1",
  fk = "_center_ieygs_37",
  xk = "_title_ieygs_51",
  vk = "_description_ieygs_58",
  yk = "_button_container_ieygs_63",
  wk = "_button_ieygs_63",
  jk = "_b_ieygs_63",
  Pt = {
    layout: Ak,
  ...
  Nk = "/assets/loading-D8SQALTR.gif",
  Ik = () => e.jsxs("div", {
  ...
  Pk = () => {
    ...
    m.useEffect(() => {
      ...
      n("colors", s => {
        Array.isArray(s) && s.length > 0 ? (t(Wp(s)), t(qa(s[0]))) : console.warn("Полученные данные цветов не являются непустым массивом")
      }), n("boosts", s => {
        t(bu(s))
      })
    }, [t])
  ...
  Sk = () => {
    const t = W();
    m.useEffect(() => {
      Oa() ? localStorage.getItem("skipIntro") || (t.push("/welcome"), localStorage.setItem("skipIntro", "true")) : an.get("skipIntro", (n, s) => {
  ...
  Rk = ({
    ...
    const n = c(l => l.main.timeLimit),
      ...
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(Ec) && mk(), Pk(), Ck(), Sk(), a || o ? e.jsx(bk, {}) : i ? e.jsx(Ik, {}) : e.jsx(e.Fragment, {
      children: t
    })
  };
