...
const Tl = {
  ...
  }),
  {
    ...
    setLimitedGoods: rU,
    clearLimitedGoods: cU,
    showLimitedGoodsPopup: El,
    hideLimitedGoodsPopup: lU
  } = ko.actions,
  ca = t => t.shop.crypto,
  kl = ko.reducer,
  la = {
  ...
  Qo = (t, n) => Ca[t] ? Ca[t](t, n) : Ca.default(),
  od = ({
    item: t,
    active: n,
    amount: s = 1,
  ...
  }),
  {
    ...
    setPixelsSoldOffset: dU,
    setPixelsSoldTotal: uU,
    setPixelsSoldFetchStatus: mU,
    removePixelsSold: AU,
...
class ma {
  ...
  static async checkTask({
    ...
    let s = n,
      a = "";
    if (n === y["channel:notpixel_channel"] || n === y["channel:notcoin_pre_release"] || n === y["channel:GameDevDead"] || n === y["channel:zaegd"] || n === y["channel:fakedonalds"] || n === y["channel:pushinton"] || n === y["channel:notcoin"]) {
      const i = n.split(":");
      s = i[0], a = `?name=${i[1]}`
    }
...
const Yi = () => {
  ...
  Sp = () => {
    const t = y["channel:notcoin_pre_release"],
      n = c(a => a.mining.tasks[t]),
      s = 256;
    return e.jsx(Y, {
      action: () => {
...
const Ag = (t, n, s) => {
    ...
    et = new kc(ci.replace("https", "wss").replace("api/v1/", "connection/websocket"), i), et.on("connected", function(o) {
      ...
      if (o.channel === "event:message") {
        JSON.parse(new TextDecoder().decode(o.data)).forEach(d => {
          ...
          if (d.type === ba.pixanos && at.dispatch(fg(m)), m.user.userId === n || !Gn) return;
  ...
  }),
  {
    ...
    setShowIntro: vU,
    setShowBetaTestIntro: yU,
    setShowMiniPopup: yr,
    addFlyingReward: vg,
    removeFlyingReward: yg,
    showInviteFrensPopup: wU,
    hideInviteFrensPopup: ka,
    showNoChargesPopup: jU,
    hideNoChargesPopup: Da,
    setLastShowChargesPopupTs: bU,
...
const N_ = Dr.reducer,
  ...
  Rr = _e({
    ...
    extraReducers: t => {
      ...
      }).addCase(Os.rejected, (n, s) => {}).addCase(Za.pending, n => {}).addCase(Za.fulfilled, (n, s) => {}).addCase(Qs.pending, (n, s) => {}).addCase(Qs.fulfilled, (n, s) => {
        const a = {
          ...s.payload,
          type: Me.world
        };
...
const Ff = A.memo(() => (A.useEffect(() => {
  ...
  dy = () => {
    ...
    return e.jsx("button", {
      ...
      onPointerUp: () => {
        a !== p.pending && t(Ng.getPixanosRating()), t(Es(!0))
      },
      children: e.jsx("img", {
        alt: "img",
        src: An,
  ...
  xn = ({
    ...
    return n > 0 && (i = qn(i, n)), e.jsx("span", {
      className: Lo.link,
      onPointerUp: o => {
        o.stopPropagation(), a ? W(`https://t.me/${Ri(t)}`) : Bt(`https://t.me/${Ri(t)}`)
      },
      children: i
    })
  },
  ...
  P0 = ({
    ...
    const j = async () => {
      try {
        const x = a.prices[0],
          v = await J.startShopTransaction({
            buyerWallet: l,
            currencyId: 2,
            daily: !0,
            quantity: x.quantity,
    ...
    return A.useEffect(() => {}, []), A.useEffect(() => {
      if (t !== null) {
        ...
        const f = async () => {
          ...
          cP(X), x.putImageData(X, 0, 0), a(X), o(j.toDataURL())
        };
        setTimeout(() => {
          f().then(() => {
            g(!1)
  ...
  ZP = () => {
    const t = _(),
      ...
      l = i >= 1e5,
      d = c(U => U.mining.tasks[y.spendStars]),
      m = c(U => U.mining.tasks[y.spendTokens]),
      h = c(U => U.mining.tasks[y.walletVerification]),
    ...
    let v = 0,
      T = 0;
    i >= 1e5 && (v += 1), h && (v += 1), f && (v += 1), o.forEach(U => {
      U.timestamp && (T += 1)
    });
    const C = () => {
          ...
          children: [e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
              ...
              onPointerUp: async () => {
                ...
                U.meta.requestStatus === p.fulfilled && U.payload[y.spendStars] || n.push("/stars")
              },
              children: [e.jsx("div", {
                children: e.jsx("img", {
                  className: O.item_image,
              ...
              onPointerUp: async () => {
                ...
                U.meta.requestStatus === p.fulfilled && U.payload[y.spendTokens] || C()
              },
              children: [e.jsx("div", {
                children: e.jsx("img", {
                  className: O.item_image,
    ...
    return A.useEffect(() => {
      if (s !== null) {
        ...
        const x = async () => {
          ...
          const X = (d - Ce) / 2,
            U = (d - be) / 2;
          v.width = d, v.height = d, T.drawImage(s, X, U, Ce, be);
          const ft = T.getImageData(0, 0, d, d);
          mS(ft), T.putImageData(ft, 0, 0), o(ft), l(v.toDataURL())
        };
        setTimeout(() => {
          x().then(() => {
            j(!1)
  ...
  H2 = () => {
    ...
    return e.jsxs("div", {
      ...
      children: [t === Oe.create && e.jsx(HS, {}), t === Oe.main && e.jsx(g2, {}), t === Oe.result && e.jsx(L2, {})]
    })
  },
  ...
  vB = () => {
    ...
    return A.useEffect(() => {
      ...
      (async () => {
        const T = await J.getSecretStats();
...
const tE = () => {
  ...
  lk = ({
    ...
    const s = _(),
      ...
      [d, m] = A.useState(!1),
      [h, g] = un(),
      f = c(X => X.color.active),
      x = (be = c(X => X.shop.products[a]).prices.filter(X => X.currency_id === i)[0]) == null ? void 0 : be.price,
      v = Hn();
    if (c(X => X.shop.selectedCurrency) === 1 || v === "") return null;
    const C = async X => {
      ...
      const U = new ja.HttpProvider("https://toncenter.com/api/v2/jsonRPC"),
        gc = await new ja.token.jetton.JettonMinter(U, {
          address: Ot[i]
        }).getJettonWalletAddress(new ja.utils.Address(v)),
        _c = Te.Address.parse(v),
        fc = Te.Address.parse(qa),
        xc = Te.beginCell().storeUint(0, 32).storeStringTail(X.txMemCode).endCell();
...
async function Xk() {
  N.enable(N.BLEND), N.blendFunc(N.SRC_ALPHA, N.ONE_MINUS_SRC_ALPHA), N.clearColor(0, 0, 0, 0), N.viewport(0, 0, N.canvas.width, N.canvas.height), ke = await Vk(N), N.useProgram(ke)
}
...
function $k(t) {
  ...
  qs = l * l, pt(N, ke, "u_AnimationDuration", mc), pt(N, ke, "u_ParticleSize", Hk), pt(N, ke, "u_ViewportWidth", n), pt(N, ke, "u_ViewportHeight", s), pt(N, ke, "u_TextureWidth", a), pt(N, ke, "u_TextureHeight", i), pt(N, ke, "u_TextureLeft", o), pt(N, ke, "u_TextureTop", r);
    ...
    return e.jsx(Je, {
      ...
      children: e.jsxs("div", {
        ...
        children: [n.dataSource === tt.userFromPixelInfo && e.jsx(ni, {
          ...
          isPopupContent: s
        }), n.dataSource === tt.squadFromData && e.jsx(fD, {})]
      })
    })
  },
  vD = "_overlay_12d15_1",
        ...
        children: o && e.jsxs(e.Fragment, {
          children: [e.jsx(Qn.div, {
            ...
            children: [e.jsxs("div", {
              ...
              children: [e.jsx(s4, {}), e.jsx($D, {}), f && f !== "" && e.jsxs("div", {
...
const A4 = "_container_gb8eq_1",
  ...
  sR = () => {
    const t = _(),
      ...
      }, d = c(C => C.user.verificatedWallet), m = di(d), h = Ws(m), g = c(C => C.user.verificatedWalletStatus);
    if (A.useEffect(() => {
        const C = setTimeout(() => {
          o(!0)
        }, 1e3);
...
const aR = "_layout_15tw0_1",
  ...
  XR = () => c(n => n.user.showRobotPopup) ? He.createPortal(e.jsx("div", {
    className: nn.layout,
    children: e.jsxs("div", {
...
const n3 = "_game_container_1afil_1",
  s3 = "_title_1afil_5",
  a3 = "_text_1afil_10",
  i3 = "_items_container_1afil_15",
  o3 = "_item_1afil_15",
  an = {
    game_container: n3,
    title: s3,
  ...
  A3 = () => {
    ...
    return A.useEffect(() => {
      ...
      children: [e.jsx("div", {
        ...
        children: m3.map((i, o) => n[o] ? null : e.jsx("div", {
          className: an.item,
          style: {
  ...
  p3 = () => c(n => n.main.showMiniPopup) ? He.createPortal(e.jsx("div", {
    className: JR.layout,
    children: e.jsx(A3, {})
  }), document.body) : null,
  h3 = () => e.jsxs("div", {
    className: Tn.layout,
    children: [e.jsx(aE, {}), e.jsx(eE, {}), e.jsx(Ff, {}), e.jsx(wB, {}), e.jsx(tE, {}), e.jsx(sD, {}), e.jsx(_D, {}), e.jsx(xD, {}), e.jsx(PE, {}), e.jsx(nD, {}), e.jsx(XR, {}), e.jsx(R4, {}), e.jsx(sR, {}), e.jsx(p3, {}), e.jsx(mR, {}), e.jsx(yk, {}), e.jsx(tD, {}), e.jsx(QR, {}), e.jsx(cD, {}), e.jsx(i4, {})]
  }),
  g3 = () => {
    const t = _(),
  ...
  x3 = "_layout_ieygs_1",
  v3 = "_container_ieygs_8",
  y3 = "_logo_container_ieygs_17",
  w3 = "_logo_ieygs_17",
  j3 = "_animate_ieygs_1",
  b3 = "_center_ieygs_37",
  N3 = "_title_ieygs_51",
  C3 = "_description_ieygs_58",
  I3 = "_button_container_ieygs_63",
  P3 = "_button_ieygs_63",
  S3 = "_b_ieygs_63",
  Be = {
    layout: x3,
  ...
  B3 = "/assets/loading-D8SQALTR.gif",
  E3 = () => e.jsxs("div", {
...
const q3 = () => {
    ...
    return A.useEffect(() => {
      t === "mobile" && n !== "unknown" && !jo && (H3(), jo = !0)
    }, [t]), null
  },
  Y3 = ({
    children: t
  }) => {
    F3(), g3(), _3(), U3(), O3(), Q3(), q3();
    const n = c(l => l.main.timeLimit),
      s = c(l => l.user.getUserFetchStatus),
      a = s === p.rejected && !gt.app.disableBetaError,
      i = s === p.pending || s === p.idle,
      o = n;
    return window.Telegram && !window.Telegram.WebApp.isVersionAtLeast(rl) && f3(), k3(), D3(), R3(), a || o ? e.jsx(T3, {}) : i ? e.jsx(E3, {}) : e.jsx(e.Fragment, {
      children: t
    })
  },
  X3 = () => {
...
function V3() {
  return console.log("version:", window.Telegram.WebApp), window.Telegram.WebApp.isVersionAtLeast("8.0") || window.Telegram.WebApp.version === "6.0" && window.Telegram.WebApp.platform === "unknown" ? e.jsx(Y3, {
    children: e.jsx(h3, {})
  }) : e.jsx(X3, {})
}
const W3 = {
...
dl(Kn);
mg(Kn);
const $3 = bc.createRoot(document.getElementById("root"));
$3.render(e.jsx(ae.StrictMode, {
  children: e.jsx(Pc, {
    store: Kn,
    children: e.jsx(Uc, {
      children: e.jsx(Bc, {
